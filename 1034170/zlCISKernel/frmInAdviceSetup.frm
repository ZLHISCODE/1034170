...
Private Sub cmdOK_Click()
    ...
    If mint场合 = 1 Then
        ...
        Call zldatabase.SetPara("存在未发送医嘱时禁止处理转科医嘱", chkAdTurn.value, glngSys, p住院医嘱发送, blnSetPara)
...
Private Sub Form_Load()
    ...
    If mint场合 = 1 Then
        ...
        chkAdTurn.value = Val(zldatabase.GetPara("存在未发送医嘱时禁止处理转科医嘱", glngSys, p住院医嘱发送, 0, Array(chkAdTurn), bln发送设置))
