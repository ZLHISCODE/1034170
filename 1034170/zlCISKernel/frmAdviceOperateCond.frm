...
Private Sub cmdOK_Click()
    ...
    If chkPauseLast.Visible Then
        Call zlDatabase.SetPara("上次开始暂停", chkPauseLast.Value, glngSys, p住院医嘱发送, InStr(GetInsidePrivs(p住院医嘱发送), ";医嘱选项设置;") > 0)
    End If
    ...
    Else
        ...
        End If
    End If
    Call zlDatabase.SetPara("发送病人", strSel, glngSys, p住院医嘱发送, InStr(GetInsidePrivs(p住院医嘱发送), ";医嘱选项设置;") > 0)
...
Private Sub Form_Load()
    ...
    Else
        ...
        '默认暂停时间
        chkPauseLast.Value = Val(zlDatabase.GetPara("上次开始暂停", glngSys, p住院医嘱发送, "0", Array(chkPauseLast), InStr(GetInsidePrivs(p住院医嘱发送), "医嘱选项设置") > 0))
    End If
