...
'参数：blnClass=是否重建分类卡(应在树形项目改变时才重建)
    ...
    If strTsPriv <> "" And chkShowCause.value <> 1 Then
        ...
        If InStr(strTsPriv, "下达精神药嘱") = 0 Then str药品 = str药品 & " And D.毒理分类 Not IN('精神I类','精神II类')"
    ...
    If chkShowCause.value = 1 Then
        If mrsItem.RecordCount > 0 Then
            ...
            Do While Not mrsItem.EOF
                ...
                ElseIf InStr(",5,6,7,", "," & mrsItem!类别ID & ",") > 0 And InStr(strTsPriv, "下达精神药嘱") = 0 And (mrsItem!毒理分类 & "" = "精神I类" Or mrsItem!毒理分类 & "" = "精神II类") Then
