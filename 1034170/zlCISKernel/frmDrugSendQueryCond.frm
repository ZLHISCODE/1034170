...
Private Sub cmdQuery_Click()
    ...
    '药房
    Call zlDatabase.SetPara("药疗查询药房", cbo药房.ItemData(cbo药房.ListIndex), glngSys, p住院医嘱发送, blnSetup)
    
    '领药部门
    Call zlDatabase.SetPara("药疗查询领药部门", cboReqDruDep.ItemData(cboReqDruDep.ListIndex), glngSys, p住院医嘱发送, blnSetup)
    
    '时间
    Call zlDatabase.SetPara("药疗查询间隔", DateDiff("d", dtpDate(0).value, dtpDate(1).value), glngSys, p住院医嘱发送, blnSetup)
    If chk退药.value = 1 Then
        Call zlDatabase.SetPara("退药查询间隔", DateDiff("d", dtpDate(2).value, dtpDate(3).value), glngSys, p住院医嘱发送, blnSetup)
    End If
    ...
    Else
        i = 1
    End If
    Call zlDatabase.SetPara("药疗查询期效", i, glngSys, p住院医嘱发送, blnSetup)
    ...
    Else
        i = 1
    End If
    Call zlDatabase.SetPara("药疗查询状态", i, glngSys, p住院医嘱发送, blnSetup)
        
    '病人
    Call zlDatabase.SetPara("发送病人", str病人IDs, glngSys, p住院医嘱发送, blnSetup)
    
    '包含出院病人
    Call zlDatabase.SetPara("药疗查询出院病人", chkOut.value, glngSys, p住院医嘱发送, blnSetup)
    '包含预出院病人
    Call zlDatabase.SetPara("药疗查询预出院病人", chkPreOut.value, glngSys, p住院医嘱发送, blnSetup)
    
    '给药途径
    Call zlDatabase.SetPara("药疗查询给药途径", str给药IDs, glngSys, p住院医嘱发送, blnSetup)
...
Private Sub Form_Load()
    ...
    '-------------------------------------------------
    '设置缺省查询时间
    i = Val(zlDatabase.GetPara("药疗查询间隔", glngSys, p住院医嘱发送, "0", Array(lblDate, dtpDate(0), dtpDate(1)), InStr(GetInsidePrivs(p住院医嘱发送), "医嘱选项设置") > 0))
    ...
    i = Val(zlDatabase.GetPara("退药查询间隔", glngSys, p住院医嘱发送, "0", Array(dtpDate(2), dtpDate(3)), InStr(GetInsidePrivs(p住院医嘱发送), "医嘱选项设置") > 0))
    ...
    '缺省查询期效
    i = Val(zlDatabase.GetPara("药疗查询期效", glngSys, p住院医嘱发送, "2", Array(chk期效(0), chk期效(1)), InStr(GetInsidePrivs(p住院医嘱发送), "医嘱选项设置") > 0))
    If i = 2 Then
        chk期效(0).value = 1
        chk期效(1).value = 1
    Else
    ...
    '缺省查询状态
    i = Val(zlDatabase.GetPara("药疗查询状态", glngSys, p住院医嘱发送, "2", Array(chk发药(0), chk发药(1)), InStr(GetInsidePrivs(p住院医嘱发送), "医嘱选项设置") > 0))
    If i = 2 Then
        chk发药(0).value = 1
        chk发药(1).value = 1
    Else
    ...
    '缺省是否包含出院病人
    chkOut.value = Val(zlDatabase.GetPara("药疗查询出院病人", glngSys, p住院医嘱发送, "0", Array(chkOut), InStr(GetInsidePrivs(p住院医嘱发送), "医嘱选项设置") > 0))
    '缺省是否包含预出院病人
    chkPreOut.value = Val(zlDatabase.GetPara("药疗查询预出院病人", glngSys, p住院医嘱发送, "0", Array(chkPreOut), InStr(GetInsidePrivs(p住院医嘱发送), "医嘱选项设置") > 0))
    '病区/病人
...
Private Function Load给药途径() As Boolean
    ...
    str给药IDs = zlDatabase.GetPara("药疗查询给药途径", glngSys, p住院医嘱发送, "", Array(lvwWay), InStr(GetInsidePrivs(p住院医嘱发送), "医嘱选项设置") > 0)
...
Private Function Load药房() As Boolean
    ...
    lng药房 = Val(zlDatabase.GetPara("药疗查询药房", glngSys, p住院医嘱发送, "0", Array(lbl药房, cbo药房), InStr(GetInsidePrivs(p住院医嘱发送), "医嘱选项设置") > 0))
...
'功能：加载领药部门
    ...
    lng部门 = Val(zlDatabase.GetPara("药疗查询领药部门", glngSys, p住院医嘱发送, "0", Array(cboReqDruDep), InStr(GetInsidePrivs(p住院医嘱发送), "医嘱选项设置") > 0))
