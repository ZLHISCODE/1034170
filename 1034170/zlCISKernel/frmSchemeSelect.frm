        ...
        Else
            ...
            For i = 1 To rsTmp.RecordCount
                ...
                If mbln麻醉类权限 And .TextMatrix(i, col毒理分类) = "麻醉药" Or _
                   ...
                   mbln精神类权限 And (.TextMatrix(i, col毒理分类) = "精神I类" Or .TextMatrix(i, col毒理分类) = "精神II类") Or _
...
'功能:验证指定行是否可以选择
    ...
    With vsScheme
        ...
        If mbln精神类权限 And (.TextMatrix(lngRow, col毒理分类) = "精神I类" Or .TextMatrix(lngRow, col毒理分类) = "精神II类") Then
