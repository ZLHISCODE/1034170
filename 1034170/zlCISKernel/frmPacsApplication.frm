...
On Error GoTo errHandle
    ...
    Select Case Control.ID
        ...
        Case TApplicationMenu.amItemRefer
            Call ShowItemRefer
...
'需要对项目范围进行过滤，如病人为住院病人时，只过滤属于住院的检查项目
    ...
    i = 0
    blnShowNormal = False
'    vfgRequestProject.ColComboList(TProjectCol.pcName) = "..."
...
Private Sub InitCommandBars()
    ...
    Set cbrControl = cbrToolBar.Controls.Add(xtpControlButton, TApplicationMenu.amItemRefer, "诊疗参考", "查看当前诊疗项目的参考内容"): cbrControl.IconId = 801: cbrControl.BeginGroup = True
...
Private Sub ShowItemRefer()
    Dim Row As Long
On Error GoTo errHandle
    Row = vfgRequestProject.Row
    
    Call frmClinicHelp.ShowMe(1, Me, Val(vfgRequestProject.Cell(flexcpData, Row, TProjectCol.pcId)), False, "")
Exit Sub
errHandle:
    If ErrCenter() = 1 Then Resume
End Sub
    ...
    With vsMethod
        ...
        ElseIf KeyAscii = vbKeySpace Then
            ...
            If .Cell(flexcpData, .Row, 0) = 1 Then
                ...
                '同时取消该单选项的子项
                If .RowData(.Row) = 1 Or .RowData(.Row) = 2 Then
