...
Private Sub cbsMain_Execute(ByVal Control As XtremeCommandBars.ICommandBarControl)
    Select Case Control.ID
	    ...
	    Case conMenu_Tool_Reference
            Call frmClinicHelp.ShowMe(1, Me, mlng项目id)
...
Private Function SaveData() As Boolean
    ...
    If rs项目!类别 = "C" Then
        ...
        blnCancel = CheckLISAppAdvice(mint调用类型, mlng病人ID, lng就诊id, mint险类, "C", mrsAdvice!诊疗项目ID, mlng开单科室ID, UserInfo.姓名, mrsAdvice!执行科室ID, Val(rs项目!执行科室 & ""), str摘要 & "||0||0|| ||0")
        ...
        blnCancel = CheckLISAppAdvice(mint调用类型, mlng病人ID, lng就诊id, mint险类, "E", mrsAdvice!采集方式ID, mlng开单科室ID, UserInfo.姓名, mrsAdvice!采集科室ID, Val(rsTmp!执行科室 & ""), str摘要 & "||0||0|| ||0")
        If Not blnCancel Then Exit Function
