...
Private Sub chkChina_Click()
    Call Check_ColWidth
    Call zldatabase.SetPara("查看中文", Me.chkChina.value, glngSys, mlngMod, InStr(GetInsidePrivs(mlngMod), IIF(mlngMod = p门诊医嘱下达 Or mlngMod = p住院医嘱下达, ";医嘱选项设置;", ";参数设置;")) > 0)
End Sub

Private Sub chkMB_Click()
    Call Check_ColWidth
    Call zldatabase.SetPara("查看酶标", Me.chkMB.value, glngSys, mlngMod, InStr(GetInsidePrivs(mlngMod), IIF(mlngMod = p门诊医嘱下达 Or mlngMod = p住院医嘱下达, ";医嘱选项设置;", ";参数设置;")) > 0)
End Sub

Private Sub chkReferrence_Click()
    Call Check_ColWidth
    Call zldatabase.SetPara("查看参考", Me.chkReferrence.value, glngSys, mlngMod, InStr(GetInsidePrivs(mlngMod), IIF(mlngMod = p门诊医嘱下达 Or mlngMod = p住院医嘱下达, ";医嘱选项设置;", ";参数设置;")) > 0)
End Sub

Private Sub chkSign_Click()
    Call Check_ColWidth
    Call zldatabase.SetPara("查看标志", Me.chkSign.value, glngSys, mlngMod, InStr(GetInsidePrivs(mlngMod), IIF(mlngMod = p门诊医嘱下达 Or mlngMod = p住院医嘱下达, ";医嘱选项设置;", ";参数设置;")) > 0)
End Sub

Private Sub chkUnit_Click()
    Call Check_ColWidth
    Call zldatabase.SetPara("查看单位", Me.chkUnit.value, glngSys, mlngMod, InStr(GetInsidePrivs(mlngMod), IIF(mlngMod = p门诊医嘱下达 Or mlngMod = p住院医嘱下达, ";医嘱选项设置;", ";参数设置;")) > 0)
End Sub
...
Private Sub chk备注_Click()
    ...
    End If
    Call zldatabase.SetPara("显示备注", Me.chk备注.value, glngSys, mlngMod, InStr(GetInsidePrivs(mlngMod), IIF(mlngMod = p门诊医嘱下达 Or mlngMod = p住院医嘱下达, ";医嘱选项设置;", ";参数设置;")) > 0)
End Sub
...
Private Sub chk诊断_Click()
    ...
    End If
    Call zldatabase.SetPara("显示诊断", Me.chk诊断.value, glngSys, mlngMod, InStr(GetInsidePrivs(mlngMod), IIF(mlngMod = p门诊医嘱下达 Or mlngMod = p住院医嘱下达, ";医嘱选项设置;", ";参数设置;")) > 0)
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    blnSetup = InStr(GetInsidePrivs(mlngMod), IIF(mlngMod = p门诊医嘱下达 Or mlngMod = p住院医嘱下达, ";医嘱选项设置;", ";参数设置;")) > 0
    
    Call zldatabase.SetPara("查看标志", Me.chkSign.value, glngSys, mlngMod, blnSetup)
    Call zldatabase.SetPara("查看单位", Me.chkUnit.value, glngSys, mlngMod, blnSetup)
    Call zldatabase.SetPara("查看参考", Me.chkReferrence.value, glngSys, mlngMod, blnSetup)
    Call zldatabase.SetPara("查看酶标", Me.chkMB.value, glngSys, mlngMod, blnSetup)
    Call zldatabase.SetPara("查看中文", Me.chkChina.value, glngSys, mlngMod, blnSetup)
    Call zldatabase.SetPara("查看备注", Me.chk备注.value, glngSys, mlngMod, blnSetup)
    Call zldatabase.SetPara("查看诊断", Me.chk诊断.value, glngSys, mlngMod, blnSetup)
    mlng医嘱ID = 0
    Set mrsVsf = Nothing
End Sub
