...
'    With objToolBar.Controls
''        Set objControl = .Add(xtpControlLabel, conMenu_Label, "总务科")
'        objControl.BeginGroup = True
'        objControl.Flags = xtpFlagRightAlign
''        Set objCombox = .Add(xtpControlComboBox, conMenu_Combox, "") '总务科
'        objCombox.Flags = xtpFlagRightAlign
'    End With
'    objCombox.Width = 200
         ...
         If .Rows > 1 Then
            ...
            For i = 1 To lngRows
                ...
                If InStr(mstrPrivs, strTemp) <> 0 And strStatus = "未接收" Then
                    If mlngTempId = 0 Then mlngTempId = cboOutDept.ItemData(cboOutDept.ListIndex)
