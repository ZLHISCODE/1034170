...
Public Function zlPrintDocument(ByVal Control As CommandBarControl, ByVal bytMode As Byte, Optional ByVal strPrintDeviceName As String, Optional ByVal lngNo As Long, Optional ByVal blnDoctorAdvice As Boolean = False) As Boolean
        ...
        If strParam <> "" Then
            ...
            If mblnNewTends = False Then
                ...
                If UBound(varParam) >= 1 Then
                    If Val(varParam(1)) = -1 Then
                        mlngRecordKey = Val(varParam(0))
                        Call mclsDockAduits.zlRefreshTendBody(lng病人ID, lng主页ID, Val(varParam(0)), 0, blnDataMoved)
                        Call ShowArchiveTab("体温记录单", strCaption)
                    Else
                        mlngRecordKey = Val(varParam(3))
                        Call mclsDockAduits.zlRefresh(3, Val(varParam(3)), lng病人ID, lng主页ID, Val(varParam(0)), CStr(varParam(2)), , , blnDataMoved)
