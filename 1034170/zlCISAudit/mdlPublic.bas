...
Public Function OpenDir(ByVal hwndOwner As Long, ByVal strTitle As String) As String
'功能：选择Windows的文件夹
    ...
    With tBrowseInfo
       ...
       .ulFlags = BIF_RETURNONLYFSDIRS + BIF_STATUSTEXT + BIF_USENEWUI + BIF_DONTGOBELOWDOMAIN + BIF_EDITBOX
    End With
