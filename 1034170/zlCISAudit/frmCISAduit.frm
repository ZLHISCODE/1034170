...
'    Set objControl = NewCommandBar(objMenu, xtpControlButton, conMenu_Tool_Monitor, "病历质量审查(&V)", True)
...
Private Sub cbsMain_Execute(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Case conMenu_File_BillPrintView                    '预览当前文档
        ...
        If Not mfrmChildDocumentView Is Nothing Then
            ...
            Call mfrmChildDocumentView.zlPrintDocument(Control, 1, , , mblnDoctorAdvice)
    ...
    Case conMenu_File_BillPrint                    '打印当前文档
        ...
        If Not mfrmChildDocumentView Is Nothing Then
            ...
            Call mfrmChildDocumentView.zlPrintDocument(Control, 2, , , mblnDoctorAdvice)
    ...
    Case conMenu_Tool_Monitor
        ...
        Call frmEPRAuditMan.ShowDialog(Me, mlngModul)
...
Private Sub cbsMain_Update(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    With GetChildPatient(mintIndex).VsfBody
        ...
        Case conMenu_Tool_Monitor
            ...
            Control.Visible = IsPrivs(mstrPrivs, "审查病案")
        ...
        Case conMenu_Manage_ReportView
            ...
            End If
        '--------------------------------------------------------------------------------------------------------------
        Case conMenu_View_Filter, conMenu_Tool_Monitor, conMenu_View_Refresh
