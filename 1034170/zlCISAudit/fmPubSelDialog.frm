...
Begin VB.Form frmPubSelDialog 
   ...
   Begin MSComctlLib.ImageList ils16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":6852
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":69AC
            Key             =   "Cur"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":6C42
            Key             =   "All"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":6ED8
            Key             =   "Close"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":7472
            Key             =   "Open"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":780C
            Key             =   "Save"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":E06E
            Key             =   "SelAll"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":148D0
            Key             =   "OK"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":1B132
            Key             =   "ClsAll"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":21994
            Key             =   "Icon"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "fmPubSelDialog.frx":21BCE
            Key             =   "Flag"
         EndProperty
      EndProperty
   End
   Begin XtremeCommandBars.ImageManager ImageManager 
      ...
      _ExtentY        =   635
      _StockProps     =   0
      Icons           =   "fmPubSelDialog.frx":21F68
   End
   ...
   Begin XtremeDockingPane.DockingPane dkpMain 
      Bindings        =   "fmPubSelDialog.frx":23B02
      Left            =   360
      Top             =   15
      _Version        =   589884
      _ExtentX        =   450
...
Private Function CreateRec(ByVal rsFrom As ADODB.Recordset) As ADODB.Recordset
    ...
    For lngCol = 0 To rsFrom.Fields.count - 1
        ...
        Case Else
            ...
            rs.Fields.Append rsFrom.Fields(lngCol).Name, rsFrom.Fields(lngCol).Type, rsFrom.Fields(lngCol).DefinedSize, adFldIsNullable
...
Private Function NodeAddCheck(strNodeKey As String) As Boolean
On Error GoTo ErrH
    Debug.Print tvw.Nodes.Item(strNodeKey).Key
    NodeAddCheck = True
    Exit Function
ErrH:
    Err.Clear
...
Private Sub ReadTreeData()
    ...
    Do While Not mrsData.EOF
        If IIf(IsNull(mrsData("上级id").Value), 0, mrsData("上级id").Value) <> 0 Then
            If Not NodeAddCheck("K" & mrsData("ID").Value) Then
...
Private Sub ReturnSelect()
    ...
    Else
        ...
        End If
    End If
    If mrsSelData.RecordCount = 0 Then
        If MsgBox("你没有选择任何资料！" & vbCrLf & "退出将保存默认值，确认退出吗？", vbOKCancel + vbInformation + vbDefaultButton2, ParamInfo.产品名称) <> vbOK Then
            Exit Sub
        End If
    End If
    mbytOK = 1
...
Private Sub vsf_BeforeRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long, Cancel As Boolean)
    If mblnMuliSelect Then
        If vsf.Cols >= 2 Then vsf.ForeColorSel = vsf.Cell(flexcpForeColor, NewRow, 2)
    End If
End Sub
