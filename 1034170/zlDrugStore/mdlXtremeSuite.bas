...
''参数设置
'处方发药
Public Const mconMenu_File_RecipePar_Save = 3811                '保存（参数设置）
Public Const mconMenu_File_RecipePar_Cancel = 3812              '取消（参数设置）
Public Const mconMenu_File_RecipePar_Help = 3813                '帮助（参数设置）
