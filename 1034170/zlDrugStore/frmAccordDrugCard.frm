    ...
    With mshStructure
        For intRow = 1 To .rows - 1
            If .TextMatrix(intRow, 0) <> "" Then
                ...
                .TextMatrix(intRow, mconIntCol构售价金额) = GetFormat(dblConstruct * .TextMatrix(intRow, mconIntCol构售价), intMoneyDigit)
...
Private Function SaveCard() As Boolean
    ...
    With mshBill
        ...
        gstrSQL = gstrSQL & "," & lng库房id
        '数量精度
        gstrSQL = gstrSQL & "," & mintNumberDigit
        '成本价精度
        gstrSQL = gstrSQL & "," & mintCostDigit
        '售价精度
        gstrSQL = gstrSQL & "," & mintPriceDigit
        '金额精度
        gstrSQL = gstrSQL & "," & mintMoneyDigit
        gstrSQL = gstrSQL & ")"
