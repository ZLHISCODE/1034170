...
Public Sub ShowMe(ByVal strDicName As String, ByVal X As Long, ByVal Y As Long, _
    ...
    Me.Left = X
    Me.Top = Y
    Me.Width = GetSetting("ZLSOFT", "私有模块\" & gstrDBUser & "\" & App.ProductName & "\" & Me.Name, "MainWidth", 4000)
    txtFind.Text = ""
    vgdList.Rows = 1
...
Dim rsTemp As New ADODB.Recordset
    ...
    Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, Me.Caption, Me.stbThis.Panels(1).Text, Trim(Me.txtFind.Text))
