...
Public Function ShowPicMarks(objPic As PictureBox, objSrcPic As StdPicture, objMarks As cPicMarks) As StdPicture
    ...
    objPic.PaintPicture objSrcPic, 0, 0, objPic.Width, objPic.Height, 0, 0, frmPublic.ScaleX(objSrcPic.Width, vbHimetric, vbTwips), frmPublic.ScaleX(objSrcPic.Height, vbHimetric, vbTwips), vbSrcCopy
