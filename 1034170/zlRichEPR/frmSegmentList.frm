...
Dim rptRow As ReportRow
    ...
    Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, Me.Caption, mlngFileID, mlngPatient, mlngVisit, mlngAdvice, 1)
...
Dim rptRcd As ReportRecord
    ...
    Do While Not rsTemp.EOF
        ...
        strView = ""
        Set rsView = zlDatabase.OpenSQLRecord(strVSql, Me.Caption, mlngDemoId, CLng(rsTemp!ID))
