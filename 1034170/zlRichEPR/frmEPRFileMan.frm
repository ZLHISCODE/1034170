...
Dim rptRow As ReportRow
    ...
    gstrSQL = "Select l.Id, l.种类, l.编号, l.名称, l.说明, Nvl(l.保留, 0) As 保留, Decode(f.独立, 1, '单独页面', f.名称) As 页面,l.子类" & _
            ...
            " Where l.种类 = f.种类 And l.页面 = f.编号 and l.保留<>4 and l.保留<>5 "
...
Private Sub cbsThis_Update(ByVal Control As XtremeCommandBars.ICommandBarControl)
	...
	Case conMenu_Edit_Compend: Control.Enabled = (mlngCurFileId <> 0 And InStr(1, mstrPrivs, "样式构造") > 0) And (mintCurKind <> 3 Or mintCurKind = 3 And mstrCurFixed <> "特殊")
