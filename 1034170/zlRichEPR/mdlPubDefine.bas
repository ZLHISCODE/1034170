...
Public Const conMenu__Curve_AddLeft As Long = 30421 '新增左列
Public Const conMenu__Curve_AddRight As Long = 30422 '新增右列
Public Const conMenu__Curve_DeleteCol As Long = 30423 '删除列
Public Const conMenu__Curve_AddUP As Long = 30424 '新增前行
Public Const conMenu__Curve_AddBottom As Long = 30425 '新增后行
Public Const conMenu__Curve_DeleteRow As Long = 30426 '删除行
Public Const conMenu__Curve_BuddySingle As Long = 30427 '绑定单列
Public Const conMenu__Curve_BuddyDouble As Long = 30428 '绑定双列
