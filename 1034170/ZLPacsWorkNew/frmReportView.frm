...
Private Sub rTxtAdvice_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyV And Shift = 2 Then
        Call DoClipboard
    End If
End Sub

Private Sub rTxtAdvice_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
...
Private Sub rtxtCheckView_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyV And Shift = 2 Then
        Call DoClipboard
    End If
End Sub

Private Sub rtxtCheckView_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Button = vbRightButton Then
        Call DoClipboard
    End If
End Sub
...
Private Sub rtxtResult_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyV And Shift = 2 Then
        Call DoClipboard
    End If
End Sub

Private Sub rtxtResult_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Button = vbRightButton Then
        Call DoClipboard
    End If
End Sub
