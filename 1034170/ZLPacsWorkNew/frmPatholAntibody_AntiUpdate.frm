...
On Error GoTo errHandle
    ...
    With mufgParentGrid
        ...
        .Text(lngNewRecordIndex, gstrAntibody_克隆性) = Trim(Substr(cbxCloneType.Text, InStr(1, cbxCloneType.Text, "-") + 1, 50))
...
On Error GoTo errHandle
    ...
    With mufgParentGrid
        ...
        .Text(.SelectionRow, gstrAntibody_克隆性) = Trim(Substr(cbxCloneType.Text, InStr(1, cbxCloneType.Text, "-") + 1, 50))
