...
Begin VB.Form frmPlaying 
   ...
   Begin VB.PictureBox picControl 
      ...
      Top             =   6375
      Width           =   12855
      Begin zl9PacsControl.ImageButton imbSound 
         Height          =   330
         Left            =   4680
         TabIndex        =   17
         Top             =   470
         ...
         Hwnd            =   7737746
      End
      Begin zl9PacsControl.ZLScrollBar scbSound 
         Height          =   195
         Left            =   5040
         TabIndex        =   16
         Top             =   520
      ...
      End
      Begin zl9PacsControl.ImageButton imbCapture 
         Height          =   720
         Left            =   3720
         TabIndex        =   15
         Top             =   240
      ...
      Begin MSComDlg.CommonDialog comDialog 
         ...
         _Version        =   393216
      End
      Begin zl9PacsControl.ImageButton imbFullScreen 
         Height          =   480
         Left            =   3240
         TabIndex        =   10
         Top             =   360
         ...
         Hint            =   "全屏"
      End
      Begin zl9PacsControl.ImageButton imbFirst 
         Height          =   480
         Left            =   1320
         TabIndex        =   8
         ToolTipText     =   "第一帧"
         ...
         Hint            =   "第一帧"
      End
      Begin zl9PacsControl.ImageButton imbLast 
         Height          =   480
         Left            =   1800
         TabIndex        =   7
         ToolTipText     =   "上一帧"
         ...
         Hint            =   "上一帧"
      End
      Begin zl9PacsControl.ImageButton imbEnd 
         Height          =   480
         Left            =   2760
         TabIndex        =   6
         ToolTipText     =   "最后帧"
         ...
         Hint            =   "最后帧"
      End
      Begin zl9PacsControl.ImageButton imbNext 
         Height          =   480
         Left            =   2280
         TabIndex        =   5
         ToolTipText     =   "下一帧"
         ...
         Hint            =   "下一帧"
      End
      Begin zl9PacsControl.ImageButton imbStop 
         Height          =   480
         Left            =   840
         TabIndex        =   4
         ToolTipText     =   "停止"
         ...
         Hint            =   "停止"
      End
      Begin zl9PacsControl.ImageButton imbPlay 
         Height          =   705
         Left            =   120
         TabIndex        =   3
         ToolTipText     =   "播放/暂停"
         ...
         Hint            =   "播放"
      End
      Begin zl9PacsControl.ImageButton imbPause 
         Height          =   720
         Left            =   120
         TabIndex        =   13
         Top             =   240
         ...
         Hint            =   "暂停"
      End
      Begin zl9PacsControl.ImageButton imbNoSound 
         Height          =   330
         Left            =   4680
         TabIndex        =   18
         Top             =   480
   ...
   Begin VB.PictureBox picInf 
      ...
      Top             =   5760
      Width           =   12855
      Begin zl9PacsControl.ZLScrollBar scbState 
         Height          =   200
         Left            =   0
         TabIndex        =   12
         Top             =   375
