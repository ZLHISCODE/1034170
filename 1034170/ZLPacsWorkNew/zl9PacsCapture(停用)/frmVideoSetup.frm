...
Begin VB.Form frmVideoSetup 
   ...
   Begin TabDlg.SSTab stbConfig 
      ...
      Tab(1).Control(4)=   "optDriver(0)"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "optDriver(1)"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "optDriver(2)"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "cmdParameterCfg"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "chkCaptureSound"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "chkCaptureWindow"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "txtDriverPath"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "cmdSelectDriver"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "optDriver(3)"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "cboZoom"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "chkShowBigImg"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).ControlCount=   15
      TabCaption(2)   =   "脚踏设置"
      TabPicture(2)   =   "frmVideoSetup.frx":0044
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "cboAfterTagHotKey"
      Tab(2).Control(1)=   "cboAfterHotKey"
      Tab(2).Control(2)=   "cbxHotKey"
      Tab(2).Control(3)=   "txtComInterval"
      Tab(2).Control(4)=   "cboPort"
      Tab(2).Control(5)=   "cboCommCapType"
      Tab(2).Control(6)=   "lblItem(3)"
      Tab(2).Control(7)=   "lblItem(2)"
      Tab(2).Control(8)=   "lblItem(1)"
      Tab(2).Control(9)=   "labComInterval"
      Tab(2).Control(10)=   "lblItem(0)"
      Tab(2).Control(11)=   "labCaptureWay"
...
On Error GoTo ErrorHand
    ...
    'cbxHotKey.Text = zlDatabase.GetPara("采集热键", glngSys, glngModule, "F8")
...
On Error GoTo errhand
    ...
    '设置采集热键
'    Call zlDatabase.SetPara("采集热键", cbxHotKey.Text, glngSys, glngModule)
