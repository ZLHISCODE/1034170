...
'常规取材显示列
Public Const gstrNormalMaterialCols As String = "|材块ID,key,read,w1000,hide,uncfg|蜡块号>序号,read,w800,align<2,0>|取材位置,w2400|标本名称,uncfg|形状|材块数>蜡块数|制片数|是否蜡块,cbx<0-否 ,1-是>,uncfg|是否脱钙,cbx<0-否 ,1-是>|" & _
                                                "主取医师,uncfg|副取医师|取材时间,fulldatetime,w2400,uncfg|记录医师,read|取材类型,read|确认状态,read|"

'细胞取材显示列
Public Const gstrCellMaterialCols As String = "|材块ID,key,,read,w1000,hide,uncfg|蜡块号>序号,read,w800,align<2,0>|标本名称,uncfg|性质|颜色|标本量,cbx<, ml, 1张, 2张, 4张, 8张>,uncfg|细胞块数>蜡块数|是否蜡块,cbx<0-否 ,1-是>,uncfg|制片数|" & _
                                                "主取医师,uncfg|副取医师|取材时间,fulldatetime,w2400,uncfg|记录医师,read|取材类型,read|确认状态,read|"

'冰冻取材显示列
Public Const gstrIceMaterialCols As String = "|材块ID,key,,read,w1000,hide,uncfg|蜡块号>序号,read,w800,align<2,0>|取材位置,w2400|标本名称,uncfg|形状|是否蜡块,cbx<0-否 ,1-是>|是否冰余,cbx<0-否,1-是>,uncfg|材块数>蜡块数|制片数|" & _
                                                "主取医师,uncfg|副取医师|取材时间,fulldatetime,w2400,uncfg|记录医师,read|取材类型,read|确认状态,read|"
...
Public Const gstrMaterial_蜡块号     As String = "蜡块号"
...
Public Const gstrMaterial_材块数   As String = "材块数"
...
'制片工作清单显示列
Public Const gstrSlicesWorkCols As String = "|病理号,rowcheck,merge,w1600,uncfg|病理医嘱ID,hide,uncfg|号别名称,merge|姓名,merge|制片ID>ID,key,w1000,hide,uncfg|材块ID,hide,uncfg|材块号>序号,w1000,align<2,0>,uncfg|取材位置|标本名称,w1600,uncfg|标本类型|制片类型|制片方式|制片数|取材时间,fulldatetime,w2400,uncfg|当前状态|清单状态|"
Public Const gstrSlicesWorkConvertFormat As String = "病理号:els-<check><source>|标本类型:0-根治标本,1-小标本,2-穿刺细胞,3-脱落细胞,4-液基细胞|制片类型:0-石蜡制片,1-冰冻切片,2-细胞制片|制片方式:0-常规,1-重切,2-深切,3-连切,4-白片,5-重染,6-薄片|当前状态:0-未处理,1-已接受,2-已完成|清单状态:0-未打印,1-已打印"
...
'套餐信息显示列
Public Const gstrAntibodyMealCols As String = "|套餐ID,key,hide,uncfg|套餐名称,uncfg|套餐类别|套餐说明,w3200|创建时间,onlydate,read,w2400|创建人,read|"
...
'过程报告显示列
Public Const gstrProcedureRepCols As String = "|ID,key,hide,uncfg|报告图像,hide,uncfg|报告类型,uncfg|标本名称,uncfg|报告子项|检查结果,hide,uncfg|检查意见,hide,uncfg|报告人>报告医师,uncfg|报告日期,fulldatetime, w2400|当前状态|备注,hide,uncfg|"
...
'============================================================================================================================
'病理号码规则设置列PatholNumSet
  
Public Const gstrPatholNumSetCols As String = "|ID,Key,hide,uncfg|名称,txtleft,w2000|前缀,txtleft,w1000|类型,cbx<0-常规,1-冰冻,2-细胞,3-会诊,4-尸检,5-快速石蜡>,txtleft,w1500前缀,w800|年,txtleft,cbx<0-否,1-是>,w800|月,cbx<0-否,1-是>,txtleft,w800|日,cbx<0-否,1-是>,txtleft,w800|起始数,w1000|序号位数,cbx<3,4,5,6,7,8,9>,txtleft,w500|"
Public Const gstrPatholNumSetConvertFormat As String = "类型:0-常规,1-冰冻,2-细胞,3-会诊,4-尸检,5-快速石蜡|年:0-否,1-是|月:0-否,1-是|日:0-否,1-是"


Public Const gstrPatholNumSet_ID As String = "ID"
Public Const gstrPatholNumSet_类型 As String = "类型"
Public Const gstrPatholNumSet_前缀 As String = "前缀"
Public Const gstrPatholNumSet_年 As String = "年"
Public Const gstrPatholNumSet_月 As String = "月"
Public Const gstrPatholNumSet_日 As String = "日"
Public Const gstrPatholNumSet_年份位数 As String = "年份位数"
Public Const gstrPatholNumSet_序号位数 As String = "序号位数"
Public Const gstrPatholNumSet_起始数 As String = "起始数"
Public Const gstrPatholNumSet_名称 As String = "名称"
