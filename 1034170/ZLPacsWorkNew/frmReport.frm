...
Public Function zlRefreshFace(Optional blnForceRefresh As Boolean = False, Optional blnIsDockActive As Boolean = False, Optional blnRefreshWord As Boolean = False) As Boolean
...
'检查回退签名类型 dblID：电子病历内容.ID  ；lngReportID：电子病历内容.文件ID
