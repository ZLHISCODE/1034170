...
Begin VB.Form frmVideoSetup 
   ...
   Begin TabDlg.SSTab stbConfig 
      ...
      Tab(1).Control(9)=   "txtDriverPath"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "cmdSelectDriver"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "optDriver(3)"
      ...
      Begin VB.ComboBox cboCommCapType 
         ...
         EndProperty
         Height          =   330
         ItemData        =   "frmVideoSetup.frx":01E3
         Left            =   -73485
         List            =   "frmVideoSetup.frx":01F0
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   930
         Width           =   4110
...
'功能，根据是否是病理站改变几个控件的状态，若是病理站，后台采集相关不可见，并且将下面3个多选框上移
    If blnIsPathol Then
