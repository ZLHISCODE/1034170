...
Begin VB.Form frmPACSFilter 
   ...
   Begin VB.Frame Frabase 
      ...
      Begin VB.ComboBox cboAgeType 
         Height          =   330
         ItemData        =   "frmPACSFilter.frx":0010
         Left            =   4545
         List            =   "frmPACSFilter.frx":0020
         Style           =   2  'Dropdown List
         TabIndex        =   18
         Top             =   1920
         Width           =   825
      ...
      Begin VB.ComboBox cboAgeWhere 
         Height          =   330
         ItemData        =   "frmPACSFilter.frx":0040
         Left            =   3090
         List            =   "frmPACSFilter.frx":0056
         Style           =   2  'Dropdown List
         TabIndex        =   16
         Top             =   1920
         Width           =   705
      ...
      Begin VB.ComboBox cboYinYangXing 
         Height          =   330
         ItemData        =   "frmPACSFilter.frx":0072
         Left            =   3885
         List            =   "frmPACSFilter.frx":007F
         Style           =   2  'Dropdown List
         TabIndex        =   27
         Top             =   3975
         Width           =   1530
      ...
      Begin VB.ComboBox cbo质量 
         BackColor       =   &H00FFFFFF&
         Height          =   330
         ItemData        =   "frmPACSFilter.frx":009D
         Left            =   3885
         List            =   "frmPACSFilter.frx":009F
         Style           =   2  'Dropdown List
         TabIndex        =   23
         Top             =   3135
         Width           =   1530
...
Private Sub initImgQuality()
On Error GoTo errH
    Dim i As Integer
    Dim strQua As String
    Dim blDataOK As Boolean
    
    strQua = Nvl(GetDeptPara(mDept, "影像质量等级", "甲,乙"))
    cbo质量.Clear
    
    cbo质量.AddItem ("所有质量")
    blDataOK = True
    
    For i = 0 To UBound(Split(strQua, ","))
        If Split(strQua, ",")(i) <> "" Then
            cbo质量.AddItem (Split(strQua, ",")(i))
        Else
            cbo质量.AddItem "无效等级"
            blDataOK = False
        End If
    ...
    cbo质量.ListIndex = 0
    If blDataOK = False Then MsgBoxD Me, "影像质量等级内容设置异常，请重新设置", vbInformation, gstrSysName
    Exit Sub
errH:
    If ErrCenter() = 1 Then Resume
    Call SaveErrLog
...
Private Sub InitDoc()
Dim rsTmp As ADODB.Recordset
    cboDiagDOC.Clear: cboAuditing.Clear: cbo检查技师.Clear: cbo待处理人.Clear
    cboDiagDOC.AddItem "所有医生": cboAuditing.AddItem "所有医生": cbo检查技师.AddItem "所有医生": cbo待处理人.AddItem "所有医生"
    cboDiagDOC.ListIndex = 0: cboAuditing.ListIndex = 0: cbo检查技师.ListIndex = 0: cbo待处理人.ListIndex = 0
    On Error GoTo errH
...
Dim int时间类型 As Integer
    ...
    If mlngModul = G_LNG_PATHOLSYS_NUM And Not Me.Visible Then
        ...
        cbo待处理人.Top = cbo待处理人.Top - cbo检查技师.Height - cboModality.Height
        Lab待处理人.Top = Lab待处理人.Top - cbo检查技师.Height - cboModality.Height
    ...
    ElseIf mlngModul = G_LNG_VIDEOSTATION_MODULE And Not Me.Visible Then
        ...
        cbo待处理人.Visible = False
        Lab待处理人.Visible = False
        ...
        Frabase.Height = Frabase.Height - cboModality.Height - cbo待处理人.Height
        Picmore.Top = Picmore.Top - cboModality.Height - cbo待处理人.Height
        ...
        Me.Height = Me.Height - cboModality.Height - cbo待处理人.Height
    '医技
    Else
        '......
    End If
