...
'是否屏蔽大图
Property Get ImageShield() As Boolean
    ImageShield = mblnImageShield
End Property

Property Let ImageShield(value As Boolean)
    mblnImageShield = value
End Property
...
On Error GoTo errHandle
    ...
    If mlngBigImageWay <> 1 Or mblnImageShield Then Exit Sub
...
'        frmShowImg.HideMe
    ...
    Else
        '显示大图
        If mlngBigImageWay = 2 And Button = 1 And Not mblnImageShield Then
