...
Public Sub AddImage(Img As Object, ByVal lngPageRecord As Long, Optional objImgTag As Object = Nothing)
'增加图像
    Dim i As Long
    
    If dcmMiniImage.Images.Count < lngPageRecord Then
        ...
        If gblnShowImgDesc Then
            ...
            If mlngSelectIndex < lngPageRecord Then mlngSelectIndex = mlngSelectIndex + 1
        End If
    Else
        If gblnShowImgDesc Then
        '新图像靠左上的处理
    ...
    '设置选中的边框颜色
    With dcmMiniImage.Images(IIf(gblnShowImgDesc, 1, dcmMiniImage.Images.Count))
        .BorderWidth = 1
        .BorderStyle = 6
        .BorderColour = vbRed
    ...
    Call UpdateSelectIndex(IIf(gblnShowImgDesc, 1, dcmMiniImage.Images.Count))
