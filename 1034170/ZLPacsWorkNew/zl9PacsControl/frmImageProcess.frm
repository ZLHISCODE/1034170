...
Public Sub RefreshFace()
    ...
    If Not (mblnIsMark Or mblnPreView) Then
        ...
        Me.picImage.Height = lngBottom - lngTop - 600

        '摆放DViewer
        Me.DViewer.Left = lngLeft + Me.picImage.Width + Me.ucSplitter.Width
        Me.DViewer.Top = lngTop
        Me.DViewer.Width = lngRight - lngLeft - Me.picImage.Width - ucSplitter.Width
...
Private Sub picImage_Resize()
    ...
    Me.ucMiniature.Height = Me.picImage.Height - Me.ucPage.Height
