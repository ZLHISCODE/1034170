...
On Error GoTo errH
    ...
    strSQL = "select a.姓名 from 人员表 a, 部门人员 b where a.id=b.人员ID and b.部门ID=[1] " _
              & " and not Exists( select c.会诊医师 from  病理会诊信息 c where a.姓名=c.会诊医师 and c.病理医嘱id=[2] )"
    Set rsData = zlDatabase.OpenSQLRecord(strSql, Me.Caption, lngDepartmentId, mlngPatholAdviceId)
    ...
    Do While Not rsData.EOF
        If Not NVL(rsData!姓名) = UserInfo.姓名 Then Call cbxConsultationDoctor.AddItem(rsData!姓名)
