...
Begin VB.UserControl UsrMutilEditor 
   BackColor       =   &H00FFFFFF&
   ClientHeight    =   8220
   ClientLeft      =   0
   ClientTop       =   0
   ...
   Begin VB.PictureBox picFilter 
      ...
      Begin VB.CommandButton cmdFilterCancel 
         Height          =   315
         Left            =   1530
         Picture         =   "UsrMutilEditor.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   50
         ToolTipText     =   "取消"
         Top             =   1320
      ...
      Begin VB.CommandButton cmdFilterOK 
         Height          =   315
         Left            =   990
         Picture         =   "UsrMutilEditor.ctx":058A
         Style           =   1  'Graphical
         TabIndex        =   49
         ToolTipText     =   "确认"
         Top             =   1320
   ...
   Begin VB.PictureBox picPati 
      ...
      Begin VB.CommandButton cmdFilterUserOk 
         Height          =   315
         Left            =   3990
         Picture         =   "UsrMutilEditor.ctx":0B14
         Style           =   1  'Graphical
         TabIndex        =   42
         ToolTipText     =   "确认"
         Top             =   6435
      ...
      Begin VB.CommandButton cmdFilterUserCancle 
         Height          =   315
         Left            =   4530
         Picture         =   "UsrMutilEditor.ctx":109E
         Style           =   1  'Graphical
         TabIndex        =   41
         ToolTipText     =   "取消"
         Top             =   6435
   ...
   Begin MSComctlLib.ImageList imgRPT 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "UsrMutilEditor.ctx":1628
            Key             =   "woman"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "UsrMutilEditor.ctx":7E8A
            Key             =   "man"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ils16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   1
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "UsrMutilEditor.ctx":E6EC
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.PictureBox pic过滤条件 
      ...
      Begin VB.CommandButton cmdSift 
         ...
         Height          =   260
         Left            =   9480
         Picture         =   "UsrMutilEditor.ctx":EA86
         Style           =   1  'Graphical
         TabIndex        =   10
         TabStop         =   0   'False
         ToolTipText     =   "选择项目(F4)"
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.PictureBox PicLst 
         ...
         Begin VB.ListBox lstSelect 
            ...
            Height          =   570
            Index           =   0
            ItemData        =   "UsrMutilEditor.ctx":EB7C
            Left            =   -10
            List            =   "UsrMutilEditor.ctx":EB89
            TabIndex        =   23
            Top             =   825
            Visible         =   0   'False
            Width           =   1215
      ...
      Begin VB.ListBox lstSelect 
         ...
         Height          =   1080
         Index           =   1
         ItemData        =   "UsrMutilEditor.ctx":EBA2
         Left            =   2280
         List            =   "UsrMutilEditor.ctx":EBAF
         Style           =   1  'Checkbox
         TabIndex        =   24
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lstNote 
         ...
         EndProperty
         Height          =   930
         ItemData        =   "UsrMutilEditor.ctx":EBC8
         Left            =   120
         List            =   "UsrMutilEditor.ctx":EBD2
         TabIndex        =   16
         Top             =   3120
         Visible         =   0   'False
         Width           =   975
      ...
      Begin VSFlex8Ctl.VSFlexGrid VsfData 
         ...
         FormatString    =   $"UsrMutilEditor.ctx":EBE2
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin VB.PictureBox picHistory 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfHistory 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"UsrMutilEditor.ctx":EC44
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "UsrMutilEditor"
...
Private Function InitEnv() As Boolean
    ...
    blnType = Val(GetSetting("ZLSOFT", "私有模块\UsrMutilEditor\" & gstrUserName, "Value")) = 0
    If blnType Then
...
Private Sub optLevel_MouseUp(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    If optLevel(0).Value Then
         SaveSetting "ZLSOFT", "私有模块\UsrMutilEditor\" & gstrUserName, "Value", 0
    Else
        SaveSetting "ZLSOFT", "私有模块\UsrMutilEditor\" & gstrUserName, "Value", 1
    End If
End Sub
