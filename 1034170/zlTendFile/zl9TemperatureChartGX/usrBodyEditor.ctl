   ...
   Begin VB.PictureBox picBack 
      ...
      Begin VB.PictureBox picMain 
         ...
         Begin VB.PictureBox picDraw 
            ...
            Width           =   7335
         End
         Begin zl9TemperatureChartGX.VsfGrid vsf 
            Height          =   255
            Left            =   120
            TabIndex        =   26
            Top             =   3480
...
Private Sub OutText(ByVal rsPoint As ADODB.Recordset)
'-----------------------------------------------------
...
'-----------------------------------------------------
    ...
    With rsPoint
        ...
        Do While Not .EOF
            X = Val(!X坐标)
            strText = !内容
            Y = GetYCoordinate(mobjDraw, mrsDrawItems, gint体温, 37, mlngMemDC)
            '输出字体信息
            ...
            End If
            Call DrawRotateText(mobjDraw, mlngMemDC, X, Y - lngHeight, strText, !颜色)
            .MoveNext
        Loop
    End With
End Sub
