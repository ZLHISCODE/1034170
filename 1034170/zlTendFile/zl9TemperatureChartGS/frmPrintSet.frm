...
Private Sub cmdOK_Click()
    ...
    '保存打印参数
    Call zlDatabase.SetPara("体温单打印机", mstrPrinter, glngSys, 1255)
    Call zlDatabase.SetPara("体温单进纸", "", glngSys, 1255)
...
'    初始化打印参数
    mstrPrinter = zlDatabase.GetPara("体温单打印机", glngSys, 1255, Printer.DeviceName, Array(cboPrinter), True)
    mstrBin = zlDatabase.GetPara("体温单进纸", glngSys, 1255, Printer.PaperBin, Array(cboBin), True)
