...
Begin VB.Form frmCaseTendBody 
   ...
   Begin VB.PictureBox picCondition 
      ...
      End
   End
   Begin zl9TemperatureChartSX.usrBodyEditor BodyEdit 
      Height          =   4425
      Left            =   255
      TabIndex        =   15
      Top             =   840
...
Private Sub GetPatiInfo()
    ...
    strSQL = "Select A.姓名,B.出院病床 床号, C.颜色,B.当前病区ID,B.病案状态" & vbNewLine & _
...
Private Sub CopyReocrd(ByVal rsPati As ADODB.Recordset)
    ...
    Do While Not rsPati.EOF
        strValue = rsPati!排序 & "|" & rsPati!排序2 & "|" & rsPati!类型 & "|" & rsPati!病人ID & "|" & rsPati!主页ID & "|" & Nvl(rsPati!住院号, 0) & "|" & rsPati!姓名 & "|" & rsPati!性别 & "|" & _
