...
Begin VB.Form frmCaseTendBodySetData 
   ...
   Begin VB.Frame fraOper 
      ...
      Top             =   4005
      Width           =   5415
      Begin zl9TemperatureChartSX.VsfGrid vsfOper 
         Height          =   570
         Left            =   165
         TabIndex        =   49
         Top             =   285
   ...
   Begin VB.PictureBox picTab 
      ...
      Begin VB.Frame FraTable 
         ...
         Begin VB.PictureBox picColor 
            ...
            Visible         =   0   'False
            Width           =   1575
            Begin zl9TemperatureChartSX.ColorPicker usrColor 
               Height          =   2190
               Left            =   120
               TabIndex        =   31
               Top             =   -450
   ...
   Begin VB.PictureBox picCurve 
      ...
      Begin VB.Frame FraData 
         ...
         Begin VB.PictureBox picValue 
            ...
            Visible         =   0   'False
            Width           =   1575
            Begin zl9TemperatureChartSX.ColorPicker usrValue 
               Height          =   2190
               Left            =   120
               TabIndex        =   48
               Top             =   -360
         ...
         Begin VB.PictureBox pic未记 
            ...
            End
         End
         Begin zl9TemperatureChartSX.VsfGrid vsfCurve 
            Height          =   1215
            Left            =   120
            TabIndex        =   10
            Top             =   240
...
Private Function GetTableRowName() As String
    ...
    '提取所有体温曲线项目
    mstrSQL = " Select A.排列序号,A.记录名 项目名,A.项目序号 as 项目号,A.记录法,A.记录色,A.入院首测," & _
    ...
    With rsTemp
        Do While Not .EOF
            ...
            strTmpCurve = strTmpCurve & ";" & Titem.类型 & "'" & Titem.值域 & "," & Titem.项目类型 & "," & _
                ...
                Titem.项目号 & "'" & Titem.项目名
            If Titem.项目号 = gint呼吸 Then mlngColor = Nvl(!记录色, RGB(0, 0, 255))
        .MoveNext
        Loop
    End With
                            ...
                            If blnAdd = True Then
                                ...
                                If mrsCurve.RecordCount = 0 Then
                                    ...
                                    gstrValues = zlCommFun.Nvl(!Id) & "|2)体温表格项目|" & strParam & "|" & _
                                        ...
                                        zlCommFun.Nvl(!未记说明, mlngColor) & "|" & Val(zlCommFun.Nvl(!数据来源, 0)) & "|" & intModify & "|" & Val(zlCommFun.Nvl(!显示, 0)) & "|" & _
