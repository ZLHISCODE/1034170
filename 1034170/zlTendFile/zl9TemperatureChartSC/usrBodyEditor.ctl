   ...
   Begin VB.PictureBox picBack 
      ...
      Begin VB.PictureBox picMain 
         ...
         Begin VB.PictureBox picDraw 
            ...
            Width           =   7335
         End
         Begin zl9TemperatureChartSC.VsfGrid vsf 
            Height          =   255
            Left            =   120
            TabIndex        =   26
            Top             =   3480
...
'                        End If
                        mstrOpValue(i) = String(i, " ") & String(2, " ")
                    Else
                        If Trim(mstrOpValue(i)) <> "" Then
...
'    Next
    ...
    For lngRow = 0 To T_DrawClient.总列数
        ...
        If ((blnDoubleRow Or bln双行) And lngRow Mod 2 = 0) Or (Not blnDoubleRow And Not bln双行) Then
            Call DrawLine(mlngMemDC, lngCurX + 1, lngCurY, lngMaxX, lngCurY, IIf(lngRow Mod 10 = 0, PS_SOLID, PS_DOT), IIf(lngRow Mod 10 = 0 And sigRowStepNew >= 4 And bln粗线, 2, 1), RGB_FleetGRAY)
        End If
    Next
