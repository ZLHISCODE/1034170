   ...
   Begin VB.PictureBox picTab 
      ...
      Begin VB.Frame FraTable 
         ...
         Begin VB.PictureBox picColor 
            ...
            Visible         =   0   'False
            Width           =   1575
            Begin zl9TemperatureChartS3201.ColorPicker usrColor 
               Height          =   2190
               Left            =   120
               TabIndex        =   29
               Top             =   -450
   ...
   Begin VB.PictureBox picCurve 
      ...
      Begin VB.Frame FraData 
         ...
         Begin VB.PictureBox picValue 
            ...
            Visible         =   0   'False
            Width           =   1575
            Begin zl9TemperatureChartS3201.ColorPicker usrValue 
               Height          =   2190
               Left            =   120
               TabIndex        =   49
               Top             =   -360
         ...
         Begin VB.PictureBox pic未记 
            ...
            End
         End
         Begin zl9TemperatureChartS3201.VsfGrid vsfCurve 
            Height          =   1215
            Left            =   120
            TabIndex        =   10
            Top             =   240
   ...
   '刷新数据
    ...
    For intRow = vsfCurve.FixedRows To vsfCurve.Rows - 1
        ...
        If vsfCurve.TextMatrix(intRow, COL_分组名) = "2)上下标说明" Then
             vsfCurve.Cell(flexcpBackColor, intRow, col_颜色, intRow, col_颜色) = RGB(255, 0, 0)
        End If
    Next intRow
    ...
    With mrsNote
        Do While Not .EOF
            If InStr(1, ",2,6,", "," & Val(!记录类型) & ",") <> 0 Then
                ...
                vsfCurve.Cell(flexcpBackColor, intRow, col_颜色, intRow, col_颜色) = IIf(IsNumeric(Nvl(!未记说明)) = False, 255, Val(Nvl(!未记说明)))
                vsfCurve.TextMatrix(intRow, COL_部位) = ""
...
CheckPoint:
    ...
    If Trim(vsfCurve.EditText) <> "" And str值域 <> "" Then
        ...
        For i = 0 To lngCount
            ...
            If Not blnOk And strText <> "" Then strText = Val(Format(strText, "#0" & IIf(int小数 > 0, ".", "") & String(int小数, "0")))
    ...
    Else
        If intType = 0 Then
            ...
            For i = 0 To lngCount
                ...
                If Not blnOk And strText <> "" And blnAllow = True Then strText = Val(Format(strText, "#0" & IIf(int小数 > 0, ".", "") & String(int小数, "0")))
