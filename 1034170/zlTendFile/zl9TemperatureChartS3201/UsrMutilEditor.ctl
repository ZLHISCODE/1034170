...
Begin VB.UserControl UsrMutilEditor 
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.ListBox lstSelect 
         ...
         Height          =   930
         Index           =   0
         ItemData        =   "UsrMutilEditor.ctx":0000
         Left            =   1080
         List            =   "UsrMutilEditor.ctx":000D
         TabIndex        =   27
         Top             =   3120
         Visible         =   0   'False
         Width           =   1215
      ...
      Begin VB.ListBox lstSelect 
         ...
         Height          =   1080
         Index           =   1
         ItemData        =   "UsrMutilEditor.ctx":0026
         Left            =   2280
         List            =   "UsrMutilEditor.ctx":0033
         Style           =   1  'Checkbox
         TabIndex        =   28
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lstNote 
         ...
         EndProperty
         Height          =   930
         ItemData        =   "UsrMutilEditor.ctx":004C
         Left            =   120
         List            =   "UsrMutilEditor.ctx":0056
         TabIndex        =   22
         Top             =   3120
         Visible         =   0   'False
         Width           =   975
      ...
      Begin VB.PictureBox picPati 
         ...
         Begin VB.CommandButton cmdFilterUserCancle 
            Height          =   315
            Left            =   4530
            Picture         =   "UsrMutilEditor.ctx":0066
            Style           =   1  'Graphical
            TabIndex        =   18
            ToolTipText     =   "取消"
            Top             =   5550
         ...
         Begin VB.CommandButton cmdFilterUserOk 
            Height          =   315
            Left            =   3990
            Picture         =   "UsrMutilEditor.ctx":05F0
            Style           =   1  'Graphical
            TabIndex        =   17
            ToolTipText     =   "确认"
            Top             =   5550
      ...
      Begin VB.PictureBox picFilter 
         ...
         Begin VB.CommandButton cmdFilterOK 
            Height          =   315
            Left            =   990
            Picture         =   "UsrMutilEditor.ctx":0B7A
            Style           =   1  'Graphical
            TabIndex        =   13
            ToolTipText     =   "确认"
            Top             =   1320
         ...
         Begin VB.CommandButton cmdFilterCancel 
            Height          =   315
            Left            =   1530
            Picture         =   "UsrMutilEditor.ctx":1104
            Style           =   1  'Graphical
            TabIndex        =   14
            ToolTipText     =   "取消"
            Top             =   1320
      ...
      Begin VSFlex8Ctl.VSFlexGrid VsfData 
         ...
         FormatString    =   $"UsrMutilEditor.ctx":168E
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList imgRPT 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "UsrMutilEditor.ctx":16F0
            Key             =   "woman"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "UsrMutilEditor.ctx":7F52
            Key             =   "man"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ils16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   1
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "UsrMutilEditor.ctx":E7B4
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.PictureBox pic过滤条件 
      ...
      Begin VB.CommandButton cmdSift 
         ...
         Height          =   260
         Left            =   6560
         Picture         =   "UsrMutilEditor.ctx":EB4E
         Style           =   1  'Graphical
         TabIndex        =   8
         TabStop         =   0   'False
         ToolTipText     =   "选择项目(F4)"
...
Private Const c日期 As Integer = 11
Private Const c出院 As Integer = 12
...
Private mlngHours As Integer   '数据补录时限
...
'功能：从注册表读取出院病人的时间范围
    ...
    intDay = Val(zlDatabase.GetPara("出院病人开始间隔", glngSys, p住院护士站, 7))
...
Private Function InitMenuBar() As Boolean
    ...
    With cbrToolBar.Controls
        ...
        Set mcbrMenuBar部位 = .Add(xtpControlButtonPopup, conMenu_Edit_Compend, "部位"): mcbrMenuBar部位.BeginGroup = True: mcbrMenuBar部位.ToolTipText = "体温部位"
...
'功能：初始化体温单批量录入过滤条件
    ...
    txtFilter.Tag = ""
    txtFilter.Text = ""
    strFilter = "全部;入院三天内的病人;手术三天内的病人;三天内体温存在超过37.5度的病人;危/重病人"
...
Private Sub InitEnv()
    ...
    '打开现存在的所有护理记录项目
    mstrSQL = " Select 分组名,项目序号,项目名称,项目类型,项目性质,项目长度,项目小数,项目表示,项目单位,项目值域,护理等级,适用病人,应用方式" & _
              " From 护理记录项目 B" & _
              " Where B.应用方式<>0 " & _
              " Order by 项目序号"
...
Private Sub LoadPatient()
    ...
    If Val(Mid(mstrScope, 5, 1)) <> 0 Then
        strSQL = _
            ...
            " a.病人id, b.主页id, A.门诊号,B.住院号, a.姓名, a.性别, a.年龄," & vbNewLine & _
            ...
            "From 病人信息 A, 病案主页 B, 病人变动记录 C, 部门表 D, 收费项目目录 E, 病区科室对应 H,病人类型 Z,在院病人 R" & vbNewLine & _
            ...
            "      And (c.开始原因 in(1,3) And c.科室id + 0 = h.科室id And h.病区id = [1] or c.开始原因=15 And c.病区id = [1])" & vbNewLine & _
    ...
    If Val(Mid(mstrScope, 1, 1)) <> 0 Then
        strSQL = strSQL & IIf(strSQL <> "", " Union All ", "") & _
            ...
            " lpad(B.出院病床,10,' ') as 床号,E.名称 as 护理等级,B.费别,B.当前病况,B.入院日期,B.出院日期,B.出院方式,B.病人类型," & _
    ...
    If Val(Mid(mstrScope, 2, 1)) <> 0 Then
        strSQL = strSQL & IIf(strSQL <> "", " Union All ", "") & _
            ...
            " A.病人ID,B.主页ID,A.门诊号,B.住院号,A.姓名,A.性别,A.年龄,C.名称 as 科室,B.出院科室ID 科室ID,B.住院医师,B.责任护士,B.病案状态," & _
            " lpad(B.出院病床,10,' ') AS 床号,E.名称 as 护理等级,B.费别,B.当前病况,B.入院日期,B.出院日期,B.出院方式,B.病人类型," & _
            " B.状态,B.险类,A.就诊卡号,Nvl(p.状态,-1) 路径状态,trunc(b.出院日期)-trunc(b.入院日期)+1 as 住院天数,z.颜色" & _
    ...
    If Val(Mid(mstrScope, 4, 1)) <> 0 Then
        strSQL = strSQL & IIf(strSQL <> "", " Union All ", "") & _
            ...
            " A.病人ID,B.主页ID,A.门诊号,B.住院号,A.姓名,A.性别,A.年龄,D.名称 as 科室,C.科室ID,C.经治医师 as 住院医师,B.责任护士,B.病案状态," & _
            " lpad(C.床号,10,' ') as 床号,E.名称 as 护理等级,B.费别,B.当前病况,B.入院日期,B.出院日期,B.出院方式,B.病人类型," & _
            " B.状态,B.险类,A.就诊卡号,Nvl(B.路径状态,-1) 路径状态,trunc(sysdate)-trunc(b.入院日期)+1 as 住院天数,z.颜色" & _
    ...
    strSQL = "SELECT A.排序,A.排序2,A.类型,A.病人ID,A.主页ID,A.门诊号,A.住院号,A.姓名,A.性别,A.年龄,A.科室,A.科室ID,A.住院医师,A.责任护士,A.病案状态," & _
            " lpad(A.床号,10,' ') as 床号,A.护理等级,A.费别,A.当前病况,A.入院日期,A.出院日期,A.出院方式,A.病人类型," & _
            " A.状态,A.险类,A.就诊卡号,A.路径状态,A.住院天数,A.颜色" & _
            " From (" & strSQL & ") A,病人护理文件 B" & _
            " Where A.病人ID=B.病人ID and A.主页ID=B.主页ID And nvl(B.婴儿,0)=0 And B.归档人 is null and B.结束时间 is null and B.格式ID=[8]"
    ...
    Set mrsPati = zlDatabase.OpenSQLRecord(strSQL, "提取病人列表", mlng病区ID, _
        ...
        Val(Mid(mstrScope, 1, 1)), Val(Mid(mstrScope, 2, 1)), Val(Mid(mstrScope, 5, 1)), mintChange, mlng格式ID)
...
Private Sub cbo体温标识_Click()
    ...
    gstrSQL = "ZL_病人体温标识_Update(" & Val(VsfData.TextMatrix(VsfData.Row, c病人ID)) & "," & Val(VsfData.TextMatrix(VsfData.Row, c主页ID)) & "," & _
        Val(VsfData.TextMatrix(VsfData.Row, c婴儿)) & ",'" & cbo体温标识.Text & "')"
    Call zlDatabase.ExecuteProcedure(gstrSQL, "保存病人体温标识")
    VsfData.TextMatrix(VsfData.Row, c体温标识) = cbo体温标识.Text
...
'----------------------------------------
    ...
    On Error GoTo ErrHand
        ...
        mstrTabHead = "|文件ID|床号|姓名|年龄|病人ID|主页ID|婴儿|记录ID|护理等级|体温标识|日期|出院|时间"
        mstrItemNo = ""
...
'-----------------------------------------------------------------------------------------------------------------
    ...
    If Val(arrFilter(0)) = 1 Then '入院三天内的病人
        strPatient = "" & _
            " SELECT 1 AS 性质,B.病人ID, B.主页ID, A.姓名, A.性别,A.年龄, B.住院号, lpad(B.出院病床,10,' ') AS 床号,0 AS 婴儿" & _
            " FROM 病人信息 A,病案主页 B,在院病人 R" & _
            " Where A.病人ID = b.病人ID And A.主页ID=B.主页ID And NVL(b.主页ID, 0) <> 0 " & _
            " AND Nvl(B.病案状态,0)<>5 AND B.封存时间 is NULL" & _
            " AND B.入院日期 BETWEEN [1] AND [2] And A.病人ID=R.病人ID And R.病区ID=[3]" & _
...
'                " SELECT 1 AS 性质,B.病人ID,B.主页ID, A.姓名, A.性别, B.住院号, lpad(B.出院病床,10,' ') AS 床号,0 AS 婴儿" & vbNewLine & _
'                " FROM 病人信息 A,病案主页 B, 病人护理文件 C ,病人护理数据 D,病人护理明细 E,在院病人 R" & vbNewLine & _
'                " WHERE A.病人ID = B.病人ID And A.主页ID=B.主页ID AND NVL(B.主页ID, 0) <> 0 " & vbNewLine & _
...
'                " AND E.记录类型=4 AND E.终止版本 IS NULL" & vbNewLine & _
'                " AND D.发生时间 BETWEEN [1] AND [2] And A.病人ID=R.病人ID And R.病区ID=[3]" & vbNewLine & _
'                IIf(mlng科室ID = -1, "", " And R.科室ID=[4]")

        '从医嘱中提取病人手术信息
        strPatient = strPatient & _
                    " SELECT 1 AS 性质,B.病人ID,B.主页ID, A.姓名, A.性别,A.年龄, B.住院号, lpad(B.出院病床,10,' ') AS 床号,0 AS 婴儿" & vbNewLine & _
                    " FROM  病人信息 A,病案主页 B,在院病人 R,(SELECT D.病人ID,D.主页ID FROM (SELECT DISTINCT A.病人ID,A.主页ID" & vbNewLine & _
                    ...
                    " WHERE A.病人ID = B.病人ID And A.主页ID=B.主页ID AND NVL(B.主页ID, 0) <> 0 " & vbNewLine & _
                    " AND NVL(B.病案状态,0)<>5 AND B.封存时间 IS NULL" & vbNewLine & _
                    " AND B.病人ID=C.病人ID AND B.主页ID=C.主页ID And A.病人ID=R.病人ID And R.病区ID=[3]" & vbNewLine & _
                    IIf(mlng科室id = -1, "", " And R.科室ID=[4]")
    End If
    ...
    If Val(arrFilter(2)) = 1 Then '三天内体温存在超过37.5度的病人
        ...
        strPatient = strPatient & _
                    ...
                    " AND NVL(B.病案状态,0)<>5 AND B.封存时间 IS NULL" & vbNewLine & _
                    " AND B.病人ID=C.病人ID AND B.主页ID=C.主页ID AND C.格式ID=[5] AND C.ID=D.文件ID AND D.ID=E.记录ID" & vbNewLine & _
                    " AND E.记录类型=1 AND E.项目序号=1 AND E.记录内容=CONVERT(记录内容, 'US7ASCII', 'ZHS16GBK') AND E.记录内容>'37.5' AND E.终止版本 IS NULL" & vbNewLine & _
                    " AND D.发生时间 BETWEEN [1] AND [2] And A.病人ID=R.病人ID And R.病区ID=[3]" & vbNewLine & _
                    IIf(mlng科室id = -1, "", " And R.科室ID=[4]")
    End If
    ...
    If Val(arrFilter(3)) = 1 Then '危/重病人
        ...
        strPatient = strPatient & _
               ...
               " Where A.病人ID = B.病人ID And A.主页ID=B.主页ID And NVL(b.主页ID, 0) <> 0 " & _
               " AND Nvl(B.病案状态,0)<>5 AND B.封存时间 is NULL" & _
               " AND Instr(',' || '危,重' || ',',','|| B.当前病况 || ',')>0 And A.病人ID=R.病人ID And R.病区ID=[3] " & _
               IIf(mlng科室id = -1, "", " And R.科室ID=[4]")
    End If
    ...
    mstrSQL = " SELECT  A.性质,A.病人ID,A.主页ID,A.婴儿,A.姓名,A.年龄,lpad(A.床号,10,' ') as 床号,nvl(zl_PatitTendGrade(A.病人ID,A.主页ID),3) 护理等级, MAX(B.ID) AS 文件ID,B.开始时间" & _
              ...
              " GROUP BY A.性质,A.病人ID,A.主页ID,A.婴儿,A.姓名 ,A.年龄,A.床号,B.开始时间" & _
...
Private Sub UserControl_Initialize()
    ...
    With rptPati
        ...
        Set objCol = .Columns.Add(c_入院日期, "入院日期", 70, True)
        Set objCol = .Columns.Add(c_出院日期, "出院日期", 70, True)
...
Private Sub VsfData_EnterCell()
    ...
    If mrsCell.RecordCount > 0 Then
        lngItemNo = Val(Nvl(mrsCell!项目序号))
        mint数据来源 = Val(Nvl(mrsCell!数据来源))
        mintModify = Val(Nvl(mrsCell!修改))
        If InStr(1, ",0,9,", "," & Val(mrsCell!数据来源) & ",") = 0 Then
...
'--------------------------------------------
    ...
    Dim int来源ID As Integer, int共用 As Integer, int显示 As Integer, int修改 As Integer
...
'------------------------------------------------------------------
    ...
    Dim strPart As String, lng来源ID As Long, int共用 As Integer, int显示 As Integer, intModify As Integer
...
'    Next i
    ...
    '检测该点是否存在同步过来的数据
    mstrSQL = "SELECT C.项目序号,C.记录内容,C.数据来源,C.体温部位,C.来源ID,C.共用,C.显示,DECODE(C.项目序号,-1,1,C.记录标记) 记录标记" & vbNewLine & _
        ...
        " AND nvl(C.来源ID,0)>0 AND C.终止版本 IS NULL  AND B.发生时间=[4] Order By B.发生时间,DECODE(C.项目序号,-1,1,0),DECODE(C.项目序号,-1,1,C.记录标记)"
    Set rsTemp = zlDatabase.OpenSQLRecord(mstrSQL, "同步数据", mlng文件ID, mlng病人ID, mlng主页ID, CDate(strTime))
                        ...
                        If blnAllow = True Then
                            If Val(Nvl(!记录标记)) = 0 And InStr(1, ",0,9,", "," & Val(Nvl(!数据来源)) & ",") = 0 Then
                                If strContent <> "" Then
                                    ...
                                    Else
                                        strContent = Nvl(!记录内容) & "/" & Split(strContent, "/")(1)
                                    End If
                                Else
                                    strContent = Nvl(!记录内容)
                                End If
        ...
        If mrsItems!项目类型 = 0 And mrsItems!项目表示 = 0 Then
            ...
            For i = 0 To UBound(arrValue)
                ...
                If Nvl(mrsItems!项目小数, 0) <> 0 And blnAllow = True Then  '等于零是通过控件的MaxLength来控制的
                    ...
                    End If
                End If
                If Not IsNull(mrsItems!项目值域) And Not blnCheck And blnAllow = True Then
