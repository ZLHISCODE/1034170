...
Public Function zlRefresh(ByVal lngPatiID As Long, ByVal lngPageId As Long, ByVal intBaby As Integer, ByVal lngDeptID As Long, ByVal blnEdit As Boolean, _
    ...
    Case 0
        ...
        Call mfrmTendBody.zlRefresh(Me, lngPatiID & ";" & lngPageId & ";" & lngDeptID & ";" & lngKey & ";0;" & IIf(mblnEdit = True, 1, 0) & ";" & intBaby & ";" & intCurveReSize, mstrPrivs)
    Case 1
...
Public Sub zlPrintDocument(ByVal lngPatiID As Long, ByVal lngPageId As Long, ByVal intBaby As Integer, ByVal lngDeptID As Long, ByVal lngFileID As Long, ByVal bytKind As Byte, ByVal strPrintDeviceName As String)
    ...
    If bytKind = 1 Then '体温单
        If Not CreateBodyEditor Then Exit Sub
        Call gobjBodyEditor.zlCurvePrint(2, True, 0, -1, strPrintDeviceName, "", lngFileID & ";" & lngPatiID & ";" & lngPageId & ";" & lngDeptID & ";" & intBaby)
    ...
    Else '记录单
        ...
        End If
        Call zlEvent_Print.zlPrintAsk(lngPatiID, lngPageId, intBaby, lngFileID, True)
        '打印之前先清除打印
        Call zlDatabase.ExecuteProcedure("ZL_病人护理打印_CLEAR(0,0,0," & lngFileID & "," & 1 & ")", "清除打印数据")
        Call SaveSetting("ZLSOFT", "公共模块\" & App.ProductName & "\Default", "DeviceName", strPrintDeviceName)
        zlEvent_Print.zlPrintOrViewTends True, 1
        Call SaveSetting("ZLSOFT", "公共模块\" & App.ProductName & "\Default", "DeviceName", strPrintName)
    End If
End Sub
