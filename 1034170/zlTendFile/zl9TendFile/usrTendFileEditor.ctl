...
Begin VB.UserControl usrTendFileEditor 
      ...
      Begin MSComctlLib.ImageList imgTrueFalse 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "usrTendFileEditor.ctx":10AE
               Key             =   "F"
            EndProperty
         EndProperty
      End
   ...
   Begin VB.PictureBox picSignCheck 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfSignData 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":1648
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.Image imgNote 
         Height          =   480
         Left            =   120
         Picture         =   "usrTendFileEditor.ctx":16AA
         Top             =   90
         Width           =   480
      End
   ...
   Begin MSComctlLib.ImageList imgRow 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   3
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "usrTendFileEditor.ctx":22EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "usrTendFileEditor.ctx":2686
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "usrTendFileEditor.ctx":2A20
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.PictureBox picCloumn 
      ...
      Begin VB.CommandButton cmdFilterOK 
         Height          =   315
         Left            =   2460
         Picture         =   "usrTendFileEditor.ctx":2D72
         Style           =   1  'Graphical
         TabIndex        =   30
         ToolTipText     =   "确认"
         Top             =   2310
      ...
      Begin VB.CommandButton cmdFilterCancel 
         Height          =   315
         Left            =   3000
         Picture         =   "usrTendFileEditor.ctx":32FC
         Style           =   1  'Graphical
         TabIndex        =   31
         ToolTipText     =   "取消"
         Top             =   2310
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.PictureBox picInfo 
         ...
         Begin VB.PictureBox picImg 
            ...
            Height          =   225
            Left            =   840
            Picture         =   "usrTendFileEditor.ctx":3886
            ScaleHeight     =   225
            ScaleWidth      =   285
            TabIndex        =   82
            Top             =   45
      ...
      Begin VB.PictureBox PicLst 
         ...
         Begin VB.ListBox lstSelect 
            ...
            Height          =   1470
            Index           =   0
            ItemData        =   "usrTendFileEditor.ctx":A0D8
            Left            =   -10
            List            =   "usrTendFileEditor.ctx":A0EE
            TabIndex        =   5
            Top             =   825
            Visible         =   0   'False
            Width           =   1215
      ...
      Begin VB.PictureBox picSign 
         ...
         Begin VB.Image imgSign 
            Height          =   240
            Left            =   -30
            Picture         =   "usrTendFileEditor.ctx":A126
            Tag             =   "240"
            Top             =   -30
            Width           =   240
         End
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsfHead 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":10978
         ScrollTrack     =   -1  'True
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.PictureBox picDoubleChoose 
         ...
         Begin VB.PictureBox picChooseRight 
            ...
            Begin VB.ComboBox cboChoose 
               ...
               Height          =   300
               Index           =   1
               ItemData        =   "usrTendFileEditor.ctx":109DA
               Left            =   -30
               List            =   "usrTendFileEditor.ctx":109EA
               Style           =   2  'Dropdown List
               TabIndex        =   60
               Top             =   -30
               Width           =   1605
         ...
         Begin VB.PictureBox picChooseLeft 
            ...
            Begin VB.ComboBox cboChoose 
               ...
               Height          =   300
               Index           =   0
               ItemData        =   "usrTendFileEditor.ctx":109FC
               Left            =   -30
               List            =   "usrTendFileEditor.ctx":10A0C
               Style           =   2  'Dropdown List
               TabIndex        =   58
               Top             =   -30
               Width           =   1605
      ...
      Begin VB.CommandButton cmdWord 
         ...
         Height          =   255
         Left            =   6120
         Picture         =   "usrTendFileEditor.ctx":10A1E
         Style           =   1  'Graphical
         TabIndex        =   23
         TabStop         =   0   'False
         Top             =   1290
      ...
      Begin VB.ListBox lstSelect 
         ...
         Height          =   2340
         Index           =   1
         ItemData        =   "usrTendFileEditor.ctx":10D60
         Left            =   6675
         List            =   "usrTendFileEditor.ctx":10D76
         Style           =   1  'Checkbox
         TabIndex        =   6
         Top             =   1590
         Visible         =   0   'False
      ...
      Begin VSFlex8Ctl.VSFlexGrid VsfData 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":10DAE
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsTest 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"usrTendFileEditor.ctx":10E10
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
    ...
    Case 1  '上下划横线(起始行画上横线，结束行画下横线)
        ...
        If lngRowCount > 1 Then
            If FormatValue(VsfData.TextMatrix(ROW, mlngRowCount)) = lngRowCount & "|1" Then
                Call MoveToEx(hDC, Left, Top + IIf(ROW = 3, 1, 0), lpPoint)
                Call LineTo(hDC, Right, Top + IIf(ROW = 3, 1, 0))
...
Private Sub DataMap_Init(ByVal rsSource As ADODB.Recordset)
    ...
    Call Record_Init(mrsCellMap, "ID," & adLongVarChar & ",50|页号," & adDouble & ",18|行号," & adDouble & ",18|" & _
            ...
            "汇总," & adDouble & ",1|记录组号," & adDouble & ",1|删除," & adDouble & ",1")
...
'        lngRowCurrent = Val(FormatValueVsfData.TextMatrix(lngRow, mlngRowCurrent)))
        ...
        If Val(VsfData.TextMatrix(lngRow, mlngCollectType)) < 0 Then
            ...
            If str发生时间_L <> "" And str发生时间_L = str发生时间 Then
                lngCurrRow = lngLastRow + lngCollectMutilRows '总量行默认为一行(只是针对汇总列的数据)
                ...
                If lngCurrRow < lngRow Then
                    ...
                    '开始进行子类明细数据的填充：处理方式大致如下:
                    '1、在处理分类汇总首条记录时，完成所有所有列的赋值。
                    '2、在处理分类汇总子记录时，只处理具体汇总内容赋值,以及行号的确定
            ...
            If mintPageSpan = 1 Then
                ...
                If lngRowCount > lngRowCurrent Then
                    ...
                    mArrPageInfo(mint页码) = mArrPageInfo(mint页码) & "[LPF]" & "由于勾选了参数:跨页数据只显示在当前页,当前页有" & lngRowCount - lngRowCurrent & "行数据显示在上一页。" & _
                        "数据发生时间:" & Mid(FormatValue(vsTest.TextMatrix(vsTest.Rows - 1, mlngActTime)), 1, 16)
                End If
            End If
            If VsfData.Rows > VsfData.FixedRows Then
                If Val(VsfData.TextMatrix(VsfData.FixedRows, mlngRowCount)) > 0 Then
                    ...
                    If Mid(FormatValue(VsfData.TextMatrix(VsfData.FixedRows, mlngActTime)), 1, 16) = Mid(vsTest.TextMatrix(lngTestRow, mlngActTime), 1, 16) And _
                        FormatValue(VsfData.TextMatrix(VsfData.FixedRows, mlngActTime)) <> vsTest.TextMatrix(lngTestRow, mlngActTime) Then
    ...
    With VsfData
        ...
        Else
            ...
            If mlngOverrunRows > 0 Then
                strInfo = strInfo & "[LPF]" & "当前页发生时间:" & .TextMatrix(3, mlngActTime) & "的数据前" & Val(.TextMatrix(.Rows - 1, mlngRowCurrent)) & "行为上一页的数据。"
            End If
            '50503:刘鹏飞,2012-09-12,数据从某一页第一行就开始跨页，计算添加行不能重复计算，本次修改如果
            '第一行和最后一行的开始行相同，那么说明是同一条数据，超出行累计不加上最后一行的超出行
            lngStartRow = 3
            '加上最后一行的超出行
            If .Rows - 1 <> 3 Then
                If Val(.TextMatrix(.Rows - 1, mlngRowCount)) - Val(.TextMatrix(.Rows - 1, mlngRowCurrent)) > 0 Then
                    If lngStartRow <> GetStartRow(.Rows - 1) Then
                        ...
                        strInfo = strInfo & "[LPF]" & "当前页发生时间:" & Mid(.TextMatrix(.Rows - 1, mlngActTime), 1, 16) & "的数据从第" & Val(.TextMatrix(.Rows - 1, mlngRowCurrent)) + 1 & "行开始跨页,跨页行数" & Val(.TextMatrix(.Rows - 1, mlngRowCount)) - Val(.TextMatrix(.Rows - 1, mlngRowCurrent)) & "行。"
                    End If
                End If
               ' mlngOverrunRows = mlngOverrunRows + Val(.TextMatrix(.Rows - 1, mlngRowCount)) - Val(.TextMatrix(.Rows - 1, mlngRowCurrent))
            End If
    ...
    With VsfData
        For lngCount = .FixedRows To .Rows - 1
            ...
            If Val(.TextMatrix(lngCount, mlngCollectType)) < 0 And FormatValue(VsfData.TextMatrix(lngCount, mlngRowCount)) Like "*|1" Then
                For lngCol = mlngTime + 1 To mlngNoEditor
        ...
        If Not mblnVerify Then
            ...
            If mintSignMode = 1 Then
                gstrSQL = " Select  distinct B.发生时间 " & vbNewLine & _
                          ...
                          " Where A.记录ID=B.ID And B.文件ID=C.ID And A.数据来源=0 And A.记录类型=5 AND A.终止版本 Is NULL And C.ID=[1] " & _
                          " MINUS" & vbNewLine & _
                          " Select  distinct B.发生时间 " & vbNewLine & _
                          " From 病人护理明细 A,病人护理数据 B,病人护理文件 C" & vbNewLine & _
                          " Where A.记录ID=B.ID And B.文件ID=C.ID And A.数据来源=0  And A.记录类型=15  AND A.终止版本 Is NULL And C.ID=[1] "
            Else
                gstrSQL = " Select  distinct B.发生时间 " & vbNewLine & _
                          " From 病人护理明细 A,病人护理数据 B,病人护理文件 C" & vbNewLine & _
    ...
    Else
        ...
        If blnExchange = False Then
            gstrSQL = "" & _
                    ...
                    "SELECT DISTINCT B.发生时间" & vbNewLine & _
                    "FROM 病人护理明细 A,病人护理数据 B" & vbNewLine & _
                    "WHERE A.记录ID=B.ID And A.数据来源=0 AND A.终止版本 IS NULL AND A.记录类型 =5 AND A.记录人=[2] AND B.文件ID=[1]"
            Call SQLDIY(gstrSQL)
        ...
        Else '交班签名
            ...
            gstrSQL = "" & _
                    "SELECT DISTINCT B.发生时间" & vbNewLine & _
                    "FROM 病人护理明细 A,病人护理数据 B" & vbNewLine & _
                    "WHERE A.记录ID=B.ID And A.数据来源=0 AND A.终止版本 IS NULL AND A.记录类型 =5 AND Instr(NVL(B.签名人,'QMR'),'/',1)=0 And B.交班签名人 IS NULL AND A.记录ID=[2] AND B.文件ID=[1]"
            Call SQLDIY(gstrSQL)
            ...
            If lngDemo > 0 Then
                ...
                gstrSQL = "" & _
                    "SELECT DISTINCT B.发生时间" & vbNewLine & _
                    "FROM 病人护理明细 A,病人护理数据 B" & vbNewLine & _
                    "WHERE A.记录ID=B.ID And A.数据来源=0 AND A.终止版本 IS NULL AND A.记录类型 =5 AND INSTR(NVL(B.签名人,'QMR'),'/',1)=0 And B.交班签名人 IS NULL AND B.发生时间 between [2] And [3] AND B.文件ID=[1]"
                Call SQLDIY(gstrSQL)
    ...
    '                    strSQLTime(ReDimArray(strSQLTime)) = gstrSQL
        ...
        '                    他人记录_IN IN NUMBER := 1,
                            ...
                            If strRelationNO = "" Then
                                gstrSQL = gstrSQL & ")"
                            Else
                                gstrSQL = gstrSQL & "," & Val(strRelationNO) & ")"
                            End If
                            strSQL(ReDimArray(strSQL)) = gstrSQL
                            blnSaved = True
                        Next
    ...
    Else
        ...
        Select Case Control.ID
            Case conMenu_Edit_Group_New, conMenu_Edit_Group_Append, conMenu_Edit_Copy, conMenu_Edit_PASTE, _
                conMenu_Edit_Clear, conMenu_Edit_SPECIALCHAR, conMenu_Edit_Element, conMenu_Edit_Append, conMenu_Edit_Word, conMenu_Edit_Brief
...
Private Sub cmdOK_Click()
    ...
    strValue = strKey & "|" & mint页码 & "|" & lngStart & "|" & mlngDate & "|" & lngStart & "|" & Val(VsfData.TextMatrix(lngStart, mlngRecord)) & "|" & _
            txt小结名称.Text & ";" & intType & ";" & cbo标识.ListIndex & ";" & str发生时间 & ";" & txt开始时点.Text & ";" & txt结束时点.Text & "|1|0|0"
    Call Record_Update(mrsCellMap, strField, strValue, "ID|" & strKey)
    ...
    For lngCount = 0 To UBound(arrItem)
        ...
        If InStr(1, "," & Join(arrColCollect, ",") & ",", "," & Split(arrCorrelative(1), ",")(0) & ",") > 0 Then
            ...
            If rsCategorical.RecordCount > 0 Then
                lngCol = Split(arrCorrelative(0), ",")(0) + cHideCols
            ...
            With rsCategorical
                Do While Not .EOF
                    ...
                    For i = 0 To 1
                        lngRows = lngRow
                        lngCol = Split(arrCorrelative(i), ",")(0) + cHideCols
...
'        End If
    ...
    If Val(VsfData.TextMatrix(lngStart, mlngRecord)) > 0 And mstrColCollect <> "" Then
        '不允许修改汇总列数据，也不允许修改日期与时间
        If InStr(1, "|" & mstrColCollect, "|" & VsfData.COL - (cHideCols + VsfData.FixedCols - 1) & ";") <> 0 Or VsfData.COL <= mlngTime Then
            If ISCollectSigned(Mid(VsfData.TextMatrix(lngStart, mlngActTime), 1, 10), VsfData.TextMatrix(lngStart, mlngTime), Val(VsfData.TextMatrix(lngStart, mlngRecord))) Then
                RaiseEvent AfterRowColChange("汇总行数据已签名，不允许修改当前汇总列或日期时间列！", True, mblnSign, mblnArchive)
                Exit Sub
            End If
        End If
    End If
...
Private Function ISCollectSigned(ByVal strDate As String, ByVal strTime As String, ByVal lngRecord As Long) As Boolean
    Dim blnDetail As Boolean
    Dim str发生时间 As String, strStart As String, strEnd As String
    Dim rsTemp As New ADODB.Recordset
    On Error GoTo ErrHand
    '检查传入的记录ID，其是否属于汇总行的统计范围，如果汇总行已审核则不允许修改
    ...
    Set rsTemp = zldatabase.OpenSQLRecord(gstrSQL, "提取当前记录发生时间当天及之后一天的汇总数据", mlng文件ID, CDate(strStart), CDate(strEnd))
    With rsTemp
        '循环检查，发现退出
        Do While Not .EOF
            '拼开始结束时间串
            If IsNull(!类别) Then
                strEnd = Format(DateAdd("s", !汇总类别, !发生时间), "yyyy-MM-dd HH:mm:ss")
                If !结束时点 < !开始时点 Then
                    strStart = Format(DateAdd("d", -1, !发生时间), "YYYY-MM-DD") & " " & !开始时点 & ":00"
                Else
                    strStart = Format(DateAdd("s", -1 * (!类别 + 1), !发生时间), "YYYY-MM-DD") & " " & !开始时点 & ":00"
                End If
            Else
                strEnd = Format(DateAdd("s", -1 * (!类别 + 1), !发生时间), "yyyy-MM-dd HH:mm:ss")
                If !结束 < !开始 Then
                    strStart = Format(DateAdd("d", -1, !发生时间), "YYYY-MM-DD") & " " & !开始 & ":00"
                Else
                    strStart = Format(DateAdd("s", -1 * (!类别 + 1), !发生时间), "YYYY-MM-DD") & " " & !开始 & ":00"
                End If
            End If
...
Private Sub cmdSignCur_Click()
    ...
    End If
    If objESign.VerifySignature(strSource, Val(vsfSignData.TextMatrix(vsfSignData.ROW, 4)), 6) Then
...
Private Function GetRelatiionNo(ByVal strKey As String) As String
'---------------------------------------------------
