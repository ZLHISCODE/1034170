...
Private Function SaveData() As Boolean
    ...
    Dim str站点 As String, cllPro As Collection
    Dim varTemp   As Variant, strValues As String
    Dim blnTrans   As Boolean, intCount As Integer
    ...
    For i = 1 To tab报警.Tabs.Count
        ...
        Do While Not mrsWarn.EOF
            ...
            If zlCommFun.ActualLen(strValues & "," & strTemp) > 4000 Then
                ...
                gstrSQL = "zl_记帐报警线_Modify(" & "'" & strValues & "'," & str站点 & "," & IIf(intCount = 0, 1, 0) & ")"
                intCount = intCount + 1
                Call zlAddArray(cllPro, gstrSQL)
                strValues = ""
            End If
