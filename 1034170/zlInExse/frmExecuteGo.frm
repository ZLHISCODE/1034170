...
Begin VB.Form frmExecuteGo 
   ...
   End
End
Attribute VB_Name = "frmExecuteGo"
...
Private Sub cmdOK_Click()
    If txtNO.Text = "" And txt标识号.Text = "" And txt姓名.Text = "" And txt病人ID.Text = "" Then
...
Private Sub txtNO_LostFocus()
    If txtNO.Text <> "" Then txtNO.Text = GetFullNO(txtNO.Text, 0)
End Sub
