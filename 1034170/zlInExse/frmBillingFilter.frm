...
Begin VB.Form frmBillingFilter 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(0)=   "ListFeeItem(0)"
      Tab(1).Control(1)=   "txtInput(0)"
      Tab(1).Control(2)=   "tlbOpt(0)"
      Tab(1).Control(3)=   "lbl收入项目(0)"
      Tab(1).ControlCount=   4
      TabCaption(2)   =   "收入项目(&2)"
      TabPicture(2)   =   "frmBillingFilter.frx":0044
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "ListFeeItem(1)"
      Tab(2).Control(1)=   "txtInput(1)"
      Tab(2).Control(2)=   "tlbOpt(1)"
      Tab(2).Control(3)=   "lbl收入项目(1)"
...
Private Sub MakeFilter()
    ...
    If IsNumeric(txt住院号.Text) Then
        ...
        Else
            mstrFilter = mstrFilter & " And 病人ID = (Select 病人ID From 病人信息 Where 住院号 = [5])"
        End If
    End If
