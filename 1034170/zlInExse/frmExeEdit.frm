...
Private Sub cmdOK_Click()
    ...
    If Not mblnView Then
        If Not CheckInput(txt结论, "结论", True) Then Exit Sub
...
Private Sub Form_Load()
    ...
    If Not mblnView Then
        ...
        cbo执行人.ListIndex = FindCboIndex(cbo执行人, UserInfo.ID)
        ...
        ElseIf cbo执行人.ListIndex = -1 Then
            cbo执行人.ListIndex = GetCboIndex(cbo执行人, mstrOper)
        End If
    Else
        Caption = "查看登记"
