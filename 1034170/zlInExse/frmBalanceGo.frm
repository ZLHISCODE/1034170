...
Begin VB.Form frmBalanceGo 
   ...
   End
End
Attribute VB_Name = "frmBalanceGo"
...
Private Sub cmdOK_Click()
    If txtNO.Text = "" And txtFact.Text = "" And txt住院号.Text = "" And txt姓名.Text = "" Then
...
Private Sub Form_Load()
    gblnOK = False
    txtFact.MaxLength = gbytFactLength
End Sub
