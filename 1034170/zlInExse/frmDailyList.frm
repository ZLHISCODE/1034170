...
Private Sub mnuExcel_Click()
    ...
    Call PrintContent(3, Split(lvwPati.SelectedItem.Key, "_")(1), Val(cboPage.ItemData(cboPage.ListIndex)))
...
Private Function ReFresh病人信息()
    ...
    '122601:李南春,2018/3/7,关联病人信息进行查询，避免查询过多的住院记录
    strSql = "" & _
    ...
    "   Where I.病人id=L.病人id and P.主页id=I.主页id and P.病人id=L.病人id And P.当前病区ID=X.ID" & _
