...
Private Sub cmdOK_Click()
    ...
    If mEditType = Ed_增加 Then
        lngItemID = zlDatabase.GetNextId("成套项目分类")
        'Zl_成套项目分类_Insert
...
NotPreID:
    If Val(txtParent.Tag) = 0 Then
        ...
        With rsTemp
            ...
            Else
                Me.txtCode.MaxLength = Len(Trim(zlCommFun.Nvl(!编码)))
                Me.txtCode.Tag = Me.txtCode.MaxLength
                If zlCommFun.Nvl(!编码) = String(Me.txtCode.MaxLength, "9") Then
                    ...
                    End If
                Else
                    Me.txtCode.Text = Format(Mid(zlCommFun.Nvl(!编码), Len(Me.txtUpCode.Text) + 1) + 1, String(Me.txtCode.MaxLength, "0"))
                End If
            End If
        End With
    Else
        ...
        Else
            With rsTemp
                Me.txtCode.MaxLength = IIF(Len(zlCommFun.Nvl(!编码)) - Len(Me.txtUpCode.Text) > 0, Len(zlCommFun.Nvl(!编码)) - Len(Me.txtUpCode.Text), 1)
                Me.txtCode.Tag = Me.txtCode.MaxLength
                If Mid(zlCommFun.Nvl(!编码), Len(Me.txtUpCode.Text) + 1) = String(Me.txtCode.MaxLength, "9") Then
                    ...
                    End If
                Else
                    If Len(zlCommFun.Nvl(!编码)) >= Len(Me.txtUpCode.Text) + 1 Then
                        Me.txtCode.Text = Format(Mid(zlCommFun.Nvl(!编码), Len(Me.txtUpCode.Text) + 1) + 1, String(Me.txtCode.MaxLength, "0"))
                    End If
                End If
            End With
