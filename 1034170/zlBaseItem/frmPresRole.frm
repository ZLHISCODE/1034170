...
Private Sub FillRoleAndSystem()
    ...
    On Error GoTo errH
    strSQL = "Select Substr(d.角色, 4) 角色, Decode(e.角色, Null, 0, 1) As 已授权" & vbNewLine & _
            "From (Select a.角色 From zlUserRoles A Where a.用户 = User And a.管理 = 1) D," & vbNewLine & _
            "     (Select b.角色 From zlUserRoles B, 上机人员表 C Where b.用户 = c.用户名 And c.人员id = [1]) E" & vbNewLine & _
            "Where d.角色 = e.角色(+)" & vbNewLine & _
            "Order By d.角色"
