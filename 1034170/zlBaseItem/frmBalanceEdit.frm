...
Private Sub cmb_Click()
    ...
    ElseIf cmb.ListIndex = 2 Or cmb.ListIndex = 3 Then
        ...
        For Each ObjItem In Me.lvw场合.ListItems
            ...
            End If
        Next
    '128370:李南春,2018/7/9,查看不到以前的版本不能明确为什么要禁止性质=7的结算方式用于预交款和就诊卡,
    '                       但场合那里又可以设置性质=7的结算方式，因此取消这里的限制
    ElseIf cmb.ListIndex = 5 Then
        For Each ObjItem In Me.lvw场合.ListItems
            ...
            End If
        Next
    ElseIf cmb.ListIndex <> 1 And cmb.ListIndex <> 2 Then
        '消费卡场合只能设置性质1,2
        For Each ObjItem In Me.lvw场合.ListItems
            If ObjItem.Text = "消费卡" Then
                ObjItem.Checked = False
            End If
        Next
    End If
...
Private Sub lvw场合_ItemCheck(ByVal Item As MSComctlLib.ListItem)
    ...
    ElseIf Item.Text = "消费卡" Then
        If cmb.ListIndex <> 0 And cmb.ListIndex <> 1 Then Item.Checked = False
    '代收款项只能应用于预交款,且不能为缺省
    ...
    ElseIf cmb.ListIndex = 7 Then
        '消费卡
        If Item.Text <> "挂号" And Item.Text <> "就诊卡" And Item.Text <> "收费" And Item.Text <> "结帐" And Item.Text <> "预交款" Then
            Item.Checked = False
        End If
    Else
        mblnChange = True
