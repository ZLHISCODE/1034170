...
Public Sub ShowPictureByField(ByVal objField As Field, ByVal W As Single, ByVal H As Single, ByVal bytSwf As Byte)
    ...
    Case 2
        pic.Visible = False
        swf.Visible = True
        strFile = ReadFlashByField(objField)
    ...
    Case Else
        pic.Visible = True
        swf.Visible = False
        Call DrawPicture(pic, ReadPicByField(objField), W, H)
    End Select
