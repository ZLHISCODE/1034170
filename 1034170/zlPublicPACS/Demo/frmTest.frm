...
Begin VB.Form frmTest 
   ...
   Begin VB.CommandButton Command8 
      Caption         =   "zlDocGetListWithAdvice"
      Height          =   495
      Left            =   960
      TabIndex        =   20
      Top             =   5280
...
Public mobjPublicPACS As New zlPublicPACS.clsPublicPacs
...
Private Sub Command1_Click()
    ...
    Call mobjPublicPACS.zlDocShowReport(Trim(txtAdviceID.Text))
End Sub

Private Sub Command2_Click()
    MsgBox mobjPublicPACS.GetEditerType(64)
End Sub

Private Sub Command3_Click()
    Call mobjPublicPACS.zlDocShowReport(301, "")
End Sub

Private Sub Command4_Click()
    Call mobjPublicPACS.zlDocGetForm().Show
    Call mobjPublicPACS.zlDocRefresh("9032F184E8854C619AD72922BFE21089")
End Sub

Private Sub Command5_Click()
    Call mobjPublicPACS.zlDocGetList(101, 1)
End Sub

Private Sub Command6_Click()
    Call mobjPublicPACS.zlDocViewStateUpdate(True, 101)
End Sub

Private Sub Command7_Click()
    Call mobjPublicPACS.zlDocGetListWithAdvice("301，704")
End Sub
