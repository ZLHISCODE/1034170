...
Private Sub chkMiddle_Click()
    ...
    SaveSetting "ZLSOFT", "公共模块\" & App.ProductName & "\SQLPlanEx", "MiddleTable", chkMiddle.Value
End Sub
...
Private Sub txtBegin_Validate(Cancel As Boolean)
    ...
    If Cancel = False Then
        ...
        SaveSetting "ZLSOFT", "公共模块\" & App.ProductName & "\SQLPlanEx", "MiddleTableRows", txtBegin.Text & "|" & txtEnd.Text
    Else
