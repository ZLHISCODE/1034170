...
Private Function LoadData() As Boolean
    ...
    If rsTemp.RecordCount > 0 Then
        ...
        Next
    End If
    gobjComlib.cbo.SetListWidthAuto cbo登记人, gobjControl.OneCharWidth(cbo登记人.Font) * 70 / cbo登记人.Width
    
    cbo处理人.Clear
    cbo处理人.AddItem "所有登记人-"
    cbo处理人.ListIndex = 0
    If rsTemp.RecordCount > 0 Then
        Call rsTemp.MoveFirst
        For i = 1 To rsTemp.RecordCount
        ...
        Next
    End If
    gobjComlib.cbo.SetListWidthAuto cbo处理人, gobjControl.OneCharWidth(cbo处理人.Font) * 70 / cbo处理人.Width
