...
Private Sub cmdOK_Click()
    ...
    '其它
    Call gobjDatabase.SetPara("中药输入付数", chkPay.Value, glngSys, p医嘱附费管理, blnSetup)
    Call gobjDatabase.SetPara("变价输入数次", chkTime.Value, glngSys, p医嘱附费管理, blnSetup)
    '问题:51762
    Call gobjDatabase.SetPara("显示其它药库库存", chk药库.Value, glngSys, p医嘱附费管理, blnSetup)
    Call gobjDatabase.SetPara("显示其它药房库存", chk药房.Value, glngSys, p医嘱附费管理, blnSetup)
    Call gobjDatabase.SetPara("补费缺省科室", IIf(opt缺省科室(0).Value, 0, 1), glngSys, p医嘱附费管理, blnSetup)
        
    '药品单位
    Call gobjDatabase.SetPara("药品单位", IIf(opt药品单位(0).Value, 0, 1), glngSys, p医嘱附费管理, blnSetup)
    '发药方式:25490
    Call gobjDatabase.SetPara("记帐后发药", cboSendMateria.ListIndex, glngSys, p医嘱附费管理, blnSetup)
    '缺省药房
    Call gobjDatabase.SetPara("门诊缺省西药房", cbo门西药.ItemData(cbo门西药.ListIndex), glngSys, p医嘱附费管理, blnSetup)
    Call gobjDatabase.SetPara("门诊缺省成药房", cbo门成药.ItemData(cbo门成药.ListIndex), glngSys, p医嘱附费管理, blnSetup)
    Call gobjDatabase.SetPara("门诊缺省中药房", cbo门中药.ItemData(cbo门中药.ListIndex), glngSys, p医嘱附费管理, blnSetup)
    Call gobjDatabase.SetPara("门诊缺省发料部门", cbo门发料部门.ItemData(cbo门发料部门.ListIndex), glngSys, p医嘱附费管理, blnSetup)
    Call gobjDatabase.SetPara("住院缺省西药房", cbo住西药.ItemData(cbo住西药.ListIndex), glngSys, p医嘱附费管理, blnSetup)
    Call gobjDatabase.SetPara("住院缺省成药房", cbo住成药.ItemData(cbo住成药.ListIndex), glngSys, p医嘱附费管理, blnSetup)
    Call gobjDatabase.SetPara("住院缺省中药房", cbo住中药.ItemData(cbo住中药.ListIndex), glngSys, p医嘱附费管理, blnSetup)
    Call gobjDatabase.SetPara("住院缺省发料部门", cbo住发料部门.ItemData(cbo住发料部门.ListIndex), glngSys, p医嘱附费管理, blnSetup)
    ...
    Call gobjDatabase.SetPara("收费类别", Replace(strPar, "'", "''"), glngSys, p医嘱附费管理, blnSetup)
...
Private Sub Form_Load()
    ...
    chkPay.Value = Val(gobjDatabase.GetPara("中药输入付数", glngSys, p医嘱附费管理, , Array(chkPay), blnSetup))
    chkTime.Value = Val(gobjDatabase.GetPara("变价输入数次", glngSys, p医嘱附费管理, , Array(chkTime), blnSetup))
    chk药房.Value = Val(gobjDatabase.GetPara("显示其它药房库存", glngSys, p医嘱附费管理, , Array(chk药房), blnSetup))
    chk药库.Value = Val(gobjDatabase.GetPara("显示其它药库库存", glngSys, p医嘱附费管理, , Array(chk药库), blnSetup))
    '问题:36060
    If Val(gobjDatabase.GetPara("补费缺省科室", glngSys, p医嘱附费管理, , Array(opt缺省科室(0), opt缺省科室(1), lblFee), blnSetup)) = 0 Then
    ...
    '药品单位
    i = Val(gobjDatabase.GetPara("药品单位", glngSys, p医嘱附费管理, , Array(opt药品单位(0), opt药品单位(1)), blnSetup))
    ...
    i = Val(gobjDatabase.GetPara("记帐后发药", glngSys, p医嘱附费管理, 0, Array(lbl发药, cboSendMateria), blnSetup))
    ...
    Do While Not rsTmp.EOF
        ...
        rsTmp.MoveNext
    Loop
    strPar = gobjDatabase.GetPara("收费类别", glngSys, p医嘱附费管理, "", Array(lbl收费类别, lst收费类别), blnSetup)
    If strPar = "" Then
