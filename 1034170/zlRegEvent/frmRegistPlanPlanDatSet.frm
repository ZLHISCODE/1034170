...
Private Function Get上一次计划时段() As Recordset
    ...
    "                     Nvl(d.失效时间, To_Date('3000-01-01', 'yyyy-mm-dd')) " & _
    ...
    "                      Nvl(a.失效时间, To_Date('3000-01-01', 'yyyy-mm-dd')) And a.安排id =d.安排id)) "
    str时段 = str时段 & " " & _
    "      Union All" & _
    ...
    "      a.Id=b.计划Id  And" & _
    "                Sysdate Between Nvl(a.生效时间, To_Date('1900-01-01', 'yyyy-mm-dd')) And" & _
    "                Nvl(a.失效时间, To_Date('3000-01-01', 'yyyy-mm-dd')) And A.Id Not In D.Id" & _
