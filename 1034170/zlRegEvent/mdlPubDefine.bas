...
Public Const conMenu_File_Sign = 109            '医生职务标识
...
'临床出诊安排
Public Const conMenu_File_ImportPlan = 6851     '导入安排
Public Const conMenu_Edit_UnAudit = 3565     '取消审批

Public Const conMenu_Edit_AddTemplet = 6861     '增加模板
Public Const conMenu_Edit_ModifyTemplet = 6862  '修改模板
Public Const conMenu_Edit_DeleteTemplet = 6863  '删除模板

Public Const conMenu_Edit_AddMonthPlan = 6865   '增加月安排
Public Const conMenu_Edit_AddWeekPlan = 6866    '增加周安排
Public Const conMenu_Edit_ModifyPlan = 6867     '调整安排

Public Const conMenu_Edit_AddPlanItem = 6868    '增加项目
Public Const conMenu_Edit_ModifyPlanItem = 6869 '修改项目
Public Const conMenu_Edit_DeletePlanItem = 6870 '删除项目

Public Const conMenu_Edit_ApplyToDay = 6871     '应用于"所有单日"
Public Const conMenu_Edit_ApplyToWeekDay = 6872 '应用于"所有星期几"
Public Const conMenu_Edit_CopyPlan = 6873       '复制安排
Public Const conMenu_Edit_PastPlan = 6874       '粘贴安排
Public Const conMenu_Edit_ClearCurPlan = 6875   '清除当前出诊安排
Public Const conMenu_Edit_ClearAllPlan = 6876   '清除当前号源安排
Public Const conMenu_Edit_ClearTempPlan = 6852  '清除当前号源临时安排

Public Const conMenu_Edit_SavePlan = 6877   '保存安排
Public Const conMenu_Edit_UndoPlan = 6878   '放弃保存

Public Const conMenu_Edit_PublishPlan = 6879    '发布安排
Public Const conMenu_Edit_UnPublishPlan = 6880  '取消安排

Public Const conMenu_Edit_NextNewPlan = 6881        '生成出诊表
Public Const conMenu_Edit_NextWeekNewPlan = 6882    '生成下周出诊表
Public Const conMenu_Edit_NextMonthNewPlan = 6883   '生成下月出诊表

Public Const conMenu_Edit_LockResource = 6884   '锁号
Public Const conMenu_Edit_UnLockResource = 6885 '解锁

Public Const conMenu_Edit_AddTempPlan = 6886        '临时出诊安排
Public Const conMenu_Edit_StopOutCall = 6887        '停诊
Public Const conMenu_Edit_UnStopOutCall = 6888      '取消停诊
Public Const conMenu_Edit_ModifyDoctor = 6889       '替诊
Public Const conMenu_Edit_UnModifyDoctor = 6890     '取消替诊
Public Const conMenu_Edit_AddNumberLimit = 6891     '加号
Public Const conMenu_Edit_ReduceNumberLimit = 6892  '减号
Public Const conMenu_Edit_ModifyDoctorOffice = 6893 '调整分诊诊室
Public Const conMenu_Edit_UpdateUnitRegist = 6894   '调整合作单位控制

Public Const conMenu_Edit_ModifyUnitRegist = 6895   '调整合作单位控制
Public Const conMenu_View_PlanChangeInfo = 6896     '查询变动信息
Public Const conMenu_Edit_ClearAll = 6897           '清除所有号源安排
Public Const conMenu_Edit_AddNewSignalSource = 6898   '新增号源安排
Public Const conMenu_Edit_PrintPlan = 6899          '打印出诊表

Public Const conMenu_View_ShowDoctorStopPlan = 6900          '显示医生停诊安排
Public Const conMenu_Edit_PlanSaveAsTemplet = 6901      '另存为模板
Public Const conMenu_Edit_OpenStopPlan = 6902      '开放停诊安排
Public Const conMenu_Edit_UpdatePlan = 6903     '调整发布后的安排
...
Public Const conMenu_View_ShowNoSourceDetial = 737  '显示号源缺省控制信息
