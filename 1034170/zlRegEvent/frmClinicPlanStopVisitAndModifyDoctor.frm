...
Private Sub cbo替诊医生_Click()
    ...
    If cbo替诊医生.Text = "其他科室医生..." Then
        ...
        vRect = GetControlRect(cbo替诊医生.Hwnd)
...
Private Function IsValied() As Boolean
    ...
    If TxtCheckInput(cbo停诊原因, "停诊原因", 50, False) = False Then Exit Function
...
Private Function InitData() As Boolean
    ...
    '加载安排信息
    strSQL = "Select a.Id, a.号源id, a.出诊日期, a.上班时段, a.开始时间, a.终止时间,c.名称 As 项目名称, a.医生姓名," & vbNewLine & _
            "        a.停诊开始时间, a.停诊终止时间, a.停诊原因," & vbNewLine & _
            "        a.替诊开始时间, a.替诊终止时间, a.替诊医生id, a.替诊医生姓名, b.专业技术职务" & vbNewLine & _
            " From 临床出诊记录 A, 人员表 B, 收费项目目录 C" & vbNewLine & _
            " Where a.替诊医生id = b.ID(+) And a.项目id = c.Id And  a.Id = [1]"
    Set rsTemp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, mlng记录ID)
    ...
    With rsSignalSource
        ...
        txtItem.Text = Nvl(rsTemp!项目名称)
        txtDoctor.Text = Nvl(rsTemp!医生姓名)
