...
Public Function LoadPlanDataByRecordset(vsfGrid As VSFlexGrid, ByVal bytDataStyle As gPlanGrid_DataStyle, _
    ...
    Optional ByVal blnPublished As Boolean) As Boolean
    ...
    With vsfGrid
            ...
            If blnFindCol Then
                ...
                If Nvl(rsData!上班时段) <> "" Then
                    ...
                    Case Data_Plan
                        ...
                        .Cell(flexcpData, lngCurRow, lngCurCol + 2) = Array(Val(Nvl(rsData!出诊ID)), Val(Nvl(rsData!安排ID)))
                    End Select
        ...
        Call SetGridFormat(vsfGrid, bytDataStyle, , , blnSortLoad)
...
Public Function RefreshOnePlanData(vsfGrid As VSFlexGrid, ByVal bytDataStyle As gPlanGrid_DataStyle, _
    ...
    Optional ByVal blnPublished As Boolean, Optional ByVal bytTableMode As Byte) As Boolean
    '刷新指定行号源数据
    '入参：
...
'            lngCurRow = lngStartRow
        ...
        '3.设置格式
        Call SetGridFormat(vsfGrid, bytDataStyle, lngStartRow, lngEndRow, False)
'        .Redraw = flexRDBuffered
    End With
    RefreshOnePlanData = True
    Exit Function
...
Private Sub SetGridFormat(vsfGrid As VSFlexGrid, ByVal bytDataStyle As gPlanGrid_DataStyle, _
    ...
    Optional ByVal blnSortLoad As Boolean)
    '设置单元格格式
    '入参：
