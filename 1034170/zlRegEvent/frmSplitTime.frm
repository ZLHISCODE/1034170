...
Private Sub cmdOK_Click()
    ...
    If picStd.Visible Then
        ...
        arrSQL(1) = "zl_时间段_INSERT('白天',To_Date('" & Format(txt上午S.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt下午E.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt下午缺省.Text, "HH:MM:SS") & "','HH24:MI:SS')," & IIf(Replace(Replace(txt上午提前.Text, "_", ""), ":", "") = "", "Null", "To_Date('" & Format(txt上午提前.Text, "HH:MM:SS") & "','HH24:MI:SS')") & ",'" & mstrColor & "')"
        arrSQL(2) = "zl_时间段_INSERT('后夜',To_Date('" & Format(txt后夜S.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt后夜E.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt后夜缺省.Text, "HH:MM:SS") & "','HH24:MI:SS')," & IIf(Replace(Replace(txt后夜提前.Text, "_", ""), ":", "") = "", "Null", "To_Date('" & Format(txt后夜提前.Text, "HH:MM:SS") & "','HH24:MI:SS')") & ",'" & mstrColor & "')"
        arrSQL(3) = "zl_时间段_INSERT('前夜',To_Date('" & Format(txt前夜S.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt前夜E.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt前夜缺省.Text, "HH:MM:SS") & "','HH24:MI:SS')," & IIf(Replace(Replace(txt前夜提前.Text, "_", ""), ":", "") = "", "Null", "To_Date('" & Format(txt前夜提前.Text, "HH:MM:SS") & "','HH24:MI:SS')") & ",'" & mstrColor & "')"
        arrSQL(4) = "zl_时间段_INSERT('全日',To_Date('" & Format(txt上午S.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt后夜E.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt后夜缺省.Text, "HH:MM:SS") & "','HH24:MI:SS')," & "Null,'" & mstrColor & "')"
        arrSQL(5) = "zl_时间段_INSERT('上午',To_Date('" & Format(txt上午S.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt上午E.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt上午缺省.Text, "HH:MM:SS") & "','HH24:MI:SS')," & IIf(Replace(Replace(txt上午提前.Text, "_", ""), ":", "") = "", "Null", "To_Date('" & Format(txt上午提前.Text, "HH:MM:SS") & "','HH24:MI:SS')") & ",'" & mstrColor & "')"
        arrSQL(6) = "zl_时间段_INSERT('下午',To_Date('" & Format(txt下午S.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt下午E.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt下午缺省.Text, "HH:MM:SS") & "','HH24:MI:SS')," & IIf(Replace(Replace(txt下午提前.Text, "_", ""), ":", "") = "", "Null", "To_Date('" & Format(txt下午提前.Text, "HH:MM:SS") & "','HH24:MI:SS')") & ",'" & mstrColor & "')"
        arrSQL(7) = "zl_时间段_INSERT('夜间',To_Date('" & Format(txt前夜S.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt后夜E.Text, "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(txt后夜缺省.Text, "HH:MM:SS") & "','HH24:MI:SS')," & IIf(Replace(Replace(txt前夜提前.Text, "_", ""), ":", "") = "", "Null", "To_Date('" & Format(txt前夜提前.Text, "HH:MM:SS") & "','HH24:MI:SS')") & ",'" & mstrColor & "')"
    Else
        ReDim Preserve arrSQL(lvwSeg.ListItems.Count)
        For i = 1 To lvwSeg.ListItems.Count
            With lvwSeg.ListItems(i)
                arrSQL(i) = "zl_时间段_INSERT('" & .Text & "',To_Date('" & Format(.SubItems(1), "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(.SubItems(2), "HH:MM:SS") & "','HH24:MI:SS'),To_Date('" & Format(.SubItems(3), "HH:MM:SS") & "','HH24:MI:SS')," & IIf(Replace(Replace(.SubItems(4), "_", ""), ":", "") = "", "Null", "To_Date('" & Format(.SubItems(4), "HH:MM:SS") & "','HH24:MI:SS')") & ",'" & mstrColor & "')"
            End With
        Next
    End If
...
'功能:到所有时间段装入到msfTime
    ...
    strSQL = "Select 时间段,To_Char(开始时间,'HH24:MI:SS') As 开始时间,to_char(终止时间,'HH24:MI:SS') As 终止时间 ,to_char(缺省时间,'HH24:MI:SS') As 缺省时间,to_char(提前时间,'HH24:MI:SS') As 提前时间,提前颜色  From 时间段 Where 号类 Is Null And 站点 Is Null"
