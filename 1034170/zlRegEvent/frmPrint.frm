...
Private mbytInFun As Byte                 '1-新单打印;2-退费打印;3-重打; 4-补打票据;6-退费票据(红票)打印
...
Private Function InsureReprint(ByVal blnVirtualPrint As Boolean, ByVal strNos As String, ByVal intInsure As Integer, _
...
Public Sub ReportPrint(ByVal bytInFun As Byte, ByVal strNos As String, ByVal strReclaimInvoice As String, _
                        ...
                        Optional blnPrintBillEmpty As Boolean, Optional ByVal intInsure As Integer, _
                        Optional ByVal lngBalanceID As Long)
    '---------------------------------------------------------------------------------------------------------------------------------------------
    '功能:票据打印,程序入口
    ...
    Dim strReportNO As String, strSql As String, strClearNOs As String, strFormat As String
    ...
    Select Case mbytInFun
        ...
        Case 3, 4 '重打、补打
            ...
            If blnNotPrint Then
                ...
                ''调用医保重打接口
                If InsureReprint(blnVirtualPrint, Replace(Split(strNos, ",")(0), "'", ""), intInsure, lngBalanceID, blnDelRecord, strInvoice) = False Then Exit Sub
            Else
                If gblnBillPrint Then
