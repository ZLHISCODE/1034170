...
Private Sub cmdOK_Click()
    ...
    zlDatabase.SetPara "缺省预约方式", NeedName(cboDefaultStyle.Text), glngSys, 1115, True
    If chkAuto.Value = 1 Then
    ...
    For i = 0 To Me.optPrintBespeak.UBound
        If optPrintBespeak(i).Value Then
            zlDatabase.SetPara "预约挂号单打印方式", i, glngSys, 1115, True
            Exit For
        End If
    Next
    Unload Me
...
Private Sub Form_Load()
    ...
    End If
    Call LoadFactList
    i = Val(zlDatabase.GetPara("预约挂号单打印方式", glngSys, 1115, 1, Array(optPrintBespeak(0), optPrintBespeak(1), optPrintBespeak(2)), True))
