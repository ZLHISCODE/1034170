...
Private Sub cbsThis_Execute(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Case 3839 '换诊
        If mfrmList.tabMain.Item(0).Selected = True Then
            If mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 1) = "" Then Exit Sub
            lngRow = mfrmList.vsfList.Row
            With frmServiceChangeNum
                .InitValue mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 1), mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 3), mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 4), _
                        mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 5), mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 6), mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 9), mfrmList.lblInfo.Caption
                .mlng消息ID = Val(mfrmList.vsfList.RowData(mfrmList.vsfList.Row))
                .Show 1, Me
            End With
        Else
            With frmServiceChangeNum
                lngRow = mfrmList.vsfList.Row
                .InitWithValue mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 2), mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 4), mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 5), _
                        mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 6), mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 1), mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 10), mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 7), mfrmList.vsfList.TextMatrix(mfrmList.vsfList.Row, 9)
                .mlng消息ID = Val(mfrmList.vsfList.RowData(mfrmList.vsfList.Row))
                .Show 1, Me
            End With
        End If
