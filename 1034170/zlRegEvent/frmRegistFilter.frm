...
Private Sub cmdOK_Click()
    '129934:李南春,2018/10/9,为了避免操作员输入查询值，但不点回车的情况，在确定时主动进行查询
    If txtPatient.Text <> "" And mlngPrePatient = 0 And Not IDKind.GetCurCard.名称 Like "姓名*" Then
...
'            End If
        ...
        Case "身份证号", "身份证", "二代身份证"
            strInput = UCase(strInput)
            lng病人ID = GetPatiID(mlngModule, Me, strInput, txtPatient, , , blnCancel)
