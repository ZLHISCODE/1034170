...
'陈东 2005-3-31
                    ...
                    If blnReturn = False Then
                        ...
                        If rsTemp.RecordCount > 0 Then
                            ...
                            Exit Sub
                        Else
                            If Not (mint险类 = TYPE_四川自贡 Or mint险类 = TYPE_沈阳市 Or mint险类 = TYPE_北京 Or mint险类 = TYPE_泸州市 Or mint险类 = TYPE_毕节 Or mint险类 = TYPE_黔南 Or mint险类 = TYPE_宁海 Or mint险类 = TYPE_渝北农医 Or mint险类 = TYPE_慈溪农医 Or mint险类 = TYPE_重庆市) Then
                                .Text = strText
