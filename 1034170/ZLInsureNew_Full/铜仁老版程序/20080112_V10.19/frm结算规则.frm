...
Begin VB.Form frm结算规则 
   Caption         =   "年度结算规则"
   ClientHeight    =   7215
   ClientLeft      =   165
   ClientTop       =   450
   ClientWidth     =   7320
   Icon            =   "frm结算规则.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   7215
   ScaleWidth      =   7320
   ...
   Begin MSComctlLib.ImageList ils32 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":08CA
            Key             =   "Fix"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":0BE4
            Key             =   "FixD"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":0EFE
            Key             =   "Common"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":1218
            Key             =   "CommonD"
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList imgColor 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   7
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":1532
            Key             =   "Preview"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":174C
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":1966
            Key             =   "New"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":1B80
            Key             =   "Modify"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":1D9A
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":1FB4
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":21CE
            Key             =   "Quit"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgGray 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   7
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":23E8
            Key             =   "Preview"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":2602
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":281C
            Key             =   "New"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":2A36
            Key             =   "Modify"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":2C50
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":2E6A
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm结算规则.frx":3084
            Key             =   "Quit"
         EndProperty
      EndProperty
   End
...
'功能：根据当前险类与中心得到年度信息
    ...
    End If
    If lng险类 = TYPE_大连开发区 Or lng险类 = TYPE_大连市 Then
        '更改显示比例
        lbl支付比例 = "起付线比例"
    Else
        lbl支付比例 = "统筹支付比例"
    ...
    '读出该医保中心使用过医保年
    gstrSQL = "select distinct 年度 from 保险支付限额 where 险类=" & lng险类 & " and 中心=" & mlng中心
    Call OpenRecordset(rsTemp, Me.Caption)
...
'参数：传递进来险类、年度，中心由全局变量得到
    ...
    gstrSQL = "select 性质,金额 from 保险支付限额  where 险类=" & _
        lng险类 & " and 中心=" & mlng中心 & " and 年度=" & lng年度 & " order by 性质"
    Call OpenRecordset(rsTemp, Me.Caption)
    ...
    With msh支付限额
        ...
        Else
            ...
            Do Until rsTemp.EOF
                ...
                Else
                    .TextMatrix(lngRow, 0) = "第" & rsTemp("性质") & "次住院起付线"
                End If
                .TextMatrix(lngRow, 1) = Format(rsTemp("金额"), "########0;-########0; ; ")
...
'参数：传递进来险类、年度，中心由全局变量得到
    ...
    '首先得到年龄段
    gstrSQL = "select 在职,年龄段,名称 from 保险年龄段 where 险类=" & lng险类 & " and 中心=" & mlng中心 & " order by 在职,年龄段"
    Call OpenRecordset(rsTemp, Me.Caption)
    ...
    With msh支付比例
        ...
        Else
            ...
            Do Until rsTemp.EOF
                ...
                .RowData(lngRow) = rsTemp("在职") '在职的年龄段与Row相等，退休的不同
                
                If rsTemp("年龄段") = 1 Then
                    col起始行.Add lngRow, "K" & rsTemp("在职")
                End If
                lngRow = lngRow + 1
                rsTemp.MoveNext
            Loop
    ...
    With msh支付比例
        ...
        Else
            ...
            lngCol = 1
            Do Until rsTemp.EOF
                .TextMatrix(0, lngCol) = rsTemp("名称")
                .ColData(lngCol) = rsTemp("档次")
    ...
    '最后得到支付比例
    gstrSQL = "select 在职,年龄段,档次,比例 from 保险支付比例 where 险类=" & lng险类 & " and 中心=" & mlng中心 & " and 年度=" & lng年度
    rsTemp.Close
    Call OpenRecordset(rsTemp, Me.Caption)
    ...
    With msh支付比例
        ...
        Do Until rsTemp.EOF
            lngRow = col起始行("K" & rsTemp("在职")) + rsTemp("年龄段") - 1
            lngCol = rsTemp("档次")
...
Private Sub mnuEditAdd_Click()
    ...
    If lng年度 = 0 Then
        ...
        gstrSQL = "zl_年度结算规则_New(" & lng险类 & "," & mlng中心 & "," & mlng当前年 & ")"
    Else
        ...
        gstrSQL = "zl_年度结算规则_Copy(" & lng险类 & "," & mlng中心 & ")"
...
Private Sub mnuEditDelete_Click()
    ...
    gstrSQL = "zl_年度结算规则_Delete(" & lng险类 & "," & mlng中心 & "," & lng年度 & ")"
    On Error GoTo ErrHand
    Call zlDatabase.ExecuteProcedure(gstrSQL, Me.Caption)
...
Private Sub mnuEditLimit_Click()
    ...
    If frm结算支付限额.编辑支付限额(lng险类, mlng中心, lng年度) = True Then
        Call Fill支付限额(lng险类, lng年度)
    End If
End Sub
...
Private Sub mnuEditProportion_Click()
    ...
    If frm结算支付比例.编辑支付比例(lng险类, mlng中心, lng年度) = True Then
        Call Fill支付比例(lng险类, lng年度)
    End If
End Sub
...
'功能：根据当前的显示内容设置菜单可用性
    ...
    '有年龄档与费用档
    mnuEditProportion.Enabled = msh支付比例.RowData(1) > 0 And msh支付比例.ColData(1) > 0 And blnEnable
...
'说明：使用本功能的主要原因是在出错退出时窗体不会闪
    ...
    gstrSQL = "select 序号,名称,是否固定,具有中心 from 保险类别 where nvl(是否禁止,0)<>1 And  医保部件 Is NULL order by 序号"
    Call OpenRecordset(rsTemp, Me.Caption)
