...
Begin VB.Form frm保险项目选择_渝北农医 
   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择_渝北农医.frx":0E42
            Key             =   "Detail"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择_渝北农医.frx":1C94
            Key             =   "Class"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frm保险项目选择_渝北农医"
...
'返回：成功返回True
    ...
    '固定参数
    gstrSQL = "Select 参数名,参数值 From 保险参数 Where 险类=" & TYPE_渝北农医
    ...
    Do Until rsTemp.EOF
        ...
        rsTemp.MoveNext
    Loop
    If OpenSQLServer(mcnYB, strServer, strUser, strPass, strDatabase) = False Then
        Exit Function
    End If
    
    '显示药品类别
    gstrSQL = "Select 编码,名称,DECODE(名称,'药品','Y','Z') AS 类别 From 保险支付大类 Where 险类=" & TYPE_渝北农医
    ...
    frm保险项目选择_渝北农医.Show vbModal, frm保险项目
    '返回值
    If mblnOK = True Then
        strCode = mstrCode
        strName = mstrName
