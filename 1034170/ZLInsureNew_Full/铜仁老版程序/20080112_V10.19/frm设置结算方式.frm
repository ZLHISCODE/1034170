...
Private mbln住院 As Boolean                 '门诊不调用函数更新，也不更新保险帐户中的数据
...
Private Sub cmdOK_Click()
    ...
    If mbln住院 Then If CommServer("SETCALTYPE") = False Then Exit Sub
    ...
    If mbln住院 Then MsgBox "结算方式设置成功！", vbInformation, gstrSysName
    Unload Me
End Sub
...
Private Sub Form_Load()
    ...
    '读取该病人的医保信息
    gstrSQL = "Select 单病种编码_结算 From 保险帐户 Where 病人ID=" & mlng病人ID & " And 险类=" & mint险类
    Call OpenRecordset(rsTemp, "读取该病人的医保信息")
    txt疾病信息.Text = Nvl(rsTemp!单病种编码_结算)
...
Public Function ShowSelect(ByVal lng病人ID As Long, ByVal int险类 As Integer, ByVal bln住院 As Boolean, ByVal frmParent As Object) As String
    mlng病人ID = lng病人ID
    mint险类 = int险类
    mbln住院 = bln住院
