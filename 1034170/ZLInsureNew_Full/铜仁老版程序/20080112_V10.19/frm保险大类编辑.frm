        ...
        Select Case .Col
            Case mColHead.上限
                ...
                If Not IsNumeric(strKey) And strKey <> "" Then
                    ...
                    Exit Sub
                End If
                If Val(strKey) > 9999999999999# Then
                    MsgBox "上限只能在0~9999999999999范围内,请重输！", vbInformation + vbOKOnly, gstrSysName
                    Cancel = True
                    .TxtSetFocus
                    Exit Sub
                End If
            ...
            Case mColHead.下限
                ...
                End If
                If Val(strKey) > 9999999999999# Then
                    MsgBox "下限只能在0~9999999999999范围内,请重输！", vbInformation + vbOKOnly, gstrSysName
                    Cancel = True
                    .TxtSetFocus
                    Exit Sub
                End If
