...
Private Sub Form_Load()
    ...
    '读取病人信息
    gstrSQL = "Select 姓名,性别,门诊号,住院号 From 病人信息 Where 病人ID=" & mlng病人ID
    Call OpenRecordset(rsTemp, "读取病人信息")
    If mintType = 1 Then
    ...
    '提取收费细目信息
    gstrSQL = "Select '品名:('||编码||')'||名称||' 规格:'||Nvl(规格,'') AS 品名 From 收费细目 Where ID=" & mlng细目ID
    Call OpenRecordset(rsTemp, "提取收费细目信息")
