...
On Error GoTo ErrHand
    ...
    Do Until objStream.AtEndOfLine
        ...
        Call OpenRecordset(rsBzgx, "保险病种", , gcn铜山县)
        
        If rsBzgx.EOF Then
            gstrSQL = "Select 保险病种_ID.nextval as ID from dual"
            Call OpenRecordset(rsBzgx, "保险病种")
            lngID = rsBzgx!ID
...
On Error GoTo ErrHand
    ...
    gstrSQL = "Select a.*," & _
              ...
              " From 收费细目 a"
    Call OpenRecordset(rsSfxm, "收费细目")
    ...
    Do Until rsSfxm.EOF
        ...
        Call OpenRecordset(rsYpzlk, "ypzlk", , gcn铜山县)
        If rsYpzlk.EOF Then
            '写文件
            If rsSfxm!停用 = 0 Then
...
On Error GoTo ErrHand
    ...
    Do Until objStream.AtEndOfLine
        ...
        Call OpenRecordset(rsBzgx, "医院编码", , gcn铜山县)
...
Public Function 参数设置() As Boolean
    ...
    Call OpenRecordset(rsTemp, "czry", , gcn铜山县)
