...
Begin VB.Form frm清算单管理_贵阳 
   ...
   Begin MSComctlLib.ImageList imgBlack 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm清算单管理_贵阳.frx":07A2
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm清算单管理_贵阳.frx":09BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm清算单管理_贵阳.frx":0BD6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm清算单管理_贵阳.frx":0DF0
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgColor 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   4
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm清算单管理_贵阳.frx":100A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm清算单管理_贵阳.frx":1224
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm清算单管理_贵阳.frx":143E
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm清算单管理_贵阳.frx":1658
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub mnuEditDel_Click()
    ...
    '调用接口
    If CommRecServer(IIf(tabShow.Tab = 页面.医疗保险, "DELRECM", "DELRECB")) = False Then Exit Sub
...
Private Sub RefreshData()
    ...
    If tabShow.Tab = 页面.医疗保险 Then
        gstrSQL = "SELECT  " & _
                 "        A.ID, A.期号, A.保险类别名称, A.操作员, A.日期 ,B.门诊人次, B.门诊个人帐户, B.门诊医疗补助, B.特殊门诊人次, B.特殊门诊个人帐户, B.特殊门诊基本统筹, B.特殊门诊大额统筹,  " & _
    ...
    Else
        ...
        gstrSQL = "SELECT  " & _
                 "        A.ID, A.期号, A.保险类别名称, A.操作员, A.日期 , B.分娩包干人次, B.分娩包干费用总额, B.分娩包干统筹支付, B.分娩非包干人次,  " & _
                 "        B.分娩非包干费用总额, B.分娩非包干统筹支付, B.计生人次, B.计生费用总额, B.计生统筹支付, A.清算流水号, A.处理情况 " & _
                 " FROM 清算单 A, 生育清算明细 B" & _
                 " WHERE A.ID=B.清算单ID " & mstrFilter & " And A.性质=" & tabShow.Tab & _
                 " Order by A.期号 Desc,A.保险类别名称"
    End If
    Call OpenRecordset(rsTemp, "提出所有数据", gstrSQL, gcnGYYB)
