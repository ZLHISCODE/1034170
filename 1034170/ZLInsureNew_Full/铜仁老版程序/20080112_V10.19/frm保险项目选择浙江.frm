   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择浙江.frx":0000
            Key             =   "Detail"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frm保险项目选择浙江.frx":0E52
            Key             =   "Class"
         EndProperty
      EndProperty
   End
...
Private Sub cmdOK_Click()
    ...
    mstrMemo = lvwDetail.SelectedItem.ListSubItems(5)
    
    mblnOK = True
    Unload Me
End Sub

Public Function GetCode(strCode As String, strName As String, strMemo As String, ByVal dbl医院价格 As Double, ByVal int险类 As Integer) As Boolean
'功能：获得一个收费项目的医保编码
...
'返回：成功返回True
    ...
    frm保险项目选择浙江.Show vbModal, frm保险项目
    '返回值
    If mblnOK = True Then
        strCode = mstrCode
        strName = mstrName
...
'功能：显示当前类别下的医保明细
    ...
    If tvwClass.SelectedItem.Key = "YAO" Then
        gstrSQL = "Select AKA060 As 医保编码, AKA061 As 项目名称, trim(to_char(nvl(AKA069,0),'99990.00')) As 自付比例, AKA066 As 拼音码, AKA070 As 剂型, Decode(AKA065,'1','甲类药','2','乙类药','丙类药') As 类别 From KA02 Order By AKA061"
    Else
        gstrSQL = "Select AKA090 As 医保编码, AKA091 As 项目名称, trim(to_char(nvl(AKA069,0),'99990.00')) As 自付比例, AKA066 As 拼音码, ' ' As 剂型, Decode(AKA065,'1','甲类','2','乙类','丙类') As 类别 From ka03 Order By AKA091"
    End If
