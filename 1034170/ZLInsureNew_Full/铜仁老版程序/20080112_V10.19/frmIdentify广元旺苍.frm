...
Private Sub cmdChangePassword_Click()
    ...
    If 业务请求_广元旺苍(修改密码_旺苍, StrInput, strOutput) = False Then Exit Sub
...
Private Function IsValid() As Boolean
    ...
    Else
        ...
        gstrSQL = "Select * from 保险帐户 where 险类=" & type_广元旺苍 & " and  医保号='" & g病人身份_广元旺苍.医保证号 & "'"
...
Private Sub Cmd确定_Click()
    ...
    If mbytType = 4 Then
        ...
        rsTemp.Close
    End If
    g病人身份_广元旺苍.密码 = txtPassWord.Text
    ...
    With g病人身份_广元旺苍
        ...
        strAddition = strAddition & ";" & .年内已报销金额                             '21统筹报销累计
    End With
    
    mlng病人ID = BuildPatiInfo(0, strIdentify & strAddition, mlng病人ID, type_广元旺苍)
    ...
    If mbytType = 1 Or mbytType = 4 Then
        ...
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.个人ID & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.参加工作年月 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.退休年月 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.职务级别 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.职称级别 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.异地居住标志 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.单位ID & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.年月 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.住院性质 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.基本医疗标志 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.补充医疗标志 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.公务员标志 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.基本待遇状态 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.补充待遇状态 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.公务员待遇状态 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.年内住院次数 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.年内已报销金额 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.缴费年限 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.提取时间 & "',"
        gstrSQL = gstrSQL & "'" & g病人身份_广元旺苍.住院记录号 & "')"
        ExecuteProcedure_广元旺苍 "保存帐户附加信息"
    Else
    End If
...
Private Function 获取参保人员信息_住院() As Boolean
    ...
    If bln输入 Then
        If 业务请求_广元旺苍(获得人员资料_医保号_旺苍, StrInput, strOutput) = False Then Exit Function
    Else
        If 业务请求_广元旺苍(获得人员资料_读卡_旺苍, StrInput, strOutput) = False Then Exit Function
    End If
    ...
    With g病人身份_广元旺苍
        ...
        .提取时间 = strArr(26)
        .住院记录号 = strArr(27)
        If InitInfor_广元旺苍.适用地区 = 0 Then .帐户余额 = strArr(28)
...
Private Function 获取参保人员信息() As Boolean
    ...
    End If
    g病人身份_广元旺苍.密码 = txtPassWord.Text
    If 业务请求_广元旺苍(获得参保人员资料_旺苍, "", strOutput) = False Then
        Call ClearData
        Exit Function
    End If
    strArr = Split(strOutput, "||")
