...
Private Sub cmdOK_Click()
    ...
    '检查病人状态
    gstrSQL = "select nvl(当前状态,0) as 状态 from 保险帐户 where 险类=" & gintInsure & " and 医保号='" & txtInfo(int医保号).Text & "'"
    ...
    End If
    str出生日期 = Mid(str出生日期, 1, 4) & "-" & Mid(str出生日期, 5, 2) & "-" & Mid(str出生日期, 7, 2)
    ...
    strIdentify = txtInfo(int编号).Text                         '0卡号
