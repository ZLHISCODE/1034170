...
'功能：显示当前类别下的医保明细
    ...
    If tvwClass.SelectedItem.Key = "YAO" Then
        gstrSQL = "Select AKA060 As 医保编码, AKA061 As 项目名称, AKA069 As 自付比例, AKA066 As 拼音码, AKA070 As 剂型, Decode(AKA065,'1','甲类','2','乙类','丙类') As 类别 From KA02 Order By AKA061"
    Else
        gstrSQL = "Select AKA090 As 医保编码, AKA091 As 项目名称, AKA069 As 自付比例, AKA066 As 拼音码, ' ' As 剂型, Decode(AKA065,'1','甲类','2','乙类','丙类') As 类别 From KA03 Order By AKA091"
    End If
