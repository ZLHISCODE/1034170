...
Private Sub cmdOK_Click()
    ...
    '检查是否在院，如果在院，则禁止就诊
    gstrSQL = "Select Nvl(当前状态,0) 状态 From 保险帐户 Where 险类=" & TYPE_毕节 & " And 医保号='" & txt社会保障号.Text & "'"
    Call OpenRecordset(rsTemp, "检查当前状态")
...
Private Sub txt密码_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    With rsTemp
        ...
        If Nvl(IC_Data_毕节.有效卡号, 0) <> Nvl(!有效卡号, 0) Then
            ...
            Exit Sub
        End If
        Me.txt住院次数.Text = Format(Nvl(!住院次数, 0), "#####0.00;-#####0.00; ;")
