...
'功能：显示当前类别下的医保明细
    ...
    Dim cn新都 As New ADODB.Connection, itmTemp As ListItem
    lvwDetail.ListItems.Clear
    On Error Resume Next
    lvwDetail.ColumnHeaders.Remove (6)
    lvwDetail.ColumnHeaders.Remove (5)
    lvwDetail.ColumnHeaders.Remove (4)
    On Error GoTo errHandle
    lvwDetail.ColumnHeaders(3).Text = "自付比例"
    ...
    If tvwClass.SelectedItem.Key = "YAO" Then
        strTemp = "Select ybxmbm As 医保编码,ybxmmc As 项目名称,zfbl1 As 自付比例 From KYH904 "
    Else
    ...
    If tvwClass.SelectedItem.Key <> "YAO" Then
        ...
        lvwDetail.ColumnHeaders.Add , , "二级医院价格"
        lvwDetail.ColumnHeaders.Add , , "三级医院价格"
        lvwDetail.ColumnHeaders.Add , , "自付比例"
    End If
