...
Private Function IsValid() As Boolean
    ...
    If mbytType <> 2 Then
        ...
        Else
            '检查病人状态
            gstrSQL = "select nvl(当前状态,0) as 状态 from 保险帐户 where 险类=" & TYPE_成都德阳 & " and 医保号='" & g病人身份_成都德阳.保障号 & "'"
...
Private Sub cmd确定_Click()
    ...
    lng疾病id = IIf(Val(Me.txt病种.Tag) = 0, "", Me.txt病种.Tag)
    ...
    If mbytType = 4 Then
        ...
        gstrSQL = "Select * from 保险帐户 where 险类=" & gintInsure & " and  医保号='" & g病人身份_成都德阳.保障号 & "'"
    ...
    Else
        ...
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'医疗标志','''" & g病人身份_成都德阳.医疗标志 & "''')"
        Call ExecuteProcedure("医疗标志")
        
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'社保编号','''" & g病人身份_成都德阳.机构编码 & "''')"
        Call ExecuteProcedure("社保编号")
    End If
