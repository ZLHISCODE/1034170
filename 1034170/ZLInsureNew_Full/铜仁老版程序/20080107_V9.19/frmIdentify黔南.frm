...
Private Sub cmd确定_Click()
    ...
    If mbytType = 4 Then
        ...
        gstrSQL = "Select * from 保险帐户 where 险类=" & gintInsure & " and  医保号='" & g病人身份_黔南.医保证号 & "'"
    ...
    If mbytType = 0 Or mbytType = 3 Then
        ...
        '更新保险帐户
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'就诊次数','" & lng就诊次数 & "')"
        ...
        '保存将交易流水号
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'顺序号','''" & str交易流水号 & "''')"
