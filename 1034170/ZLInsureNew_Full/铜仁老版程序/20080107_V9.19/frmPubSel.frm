...
Public Function ShowSelect(frmParent As Object, ByVal strSql As String, bytStyle As Byte, _
    ...
    Optional ByVal strSeek As String, Optional ByVal strNote As String, Optional ByVal blnMessage As Boolean = True, Optional ByVal blnOne As Boolean = False) As ADODB.Recordset
'功能：多功能选择器
'参数：
'     frmParent=显示的父窗体
'     strSQL=数据来源
...
'     2.末级等字段不要带空值
    ...
    If strSql <> "" Then
        ...
        If Not frmParent Is Nothing Then
            frmParent.Refresh
        End If
        Call OpenRecordset(rsSel, mstrTitle & "选择", strSql)
