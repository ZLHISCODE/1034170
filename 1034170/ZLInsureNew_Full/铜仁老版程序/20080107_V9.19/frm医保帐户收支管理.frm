...
Private Sub FillList()
    ...
    End If
    If bln中心 Then
        gstrSQL = "Select B.ID,D.名称 中心,A.卡号,A.医保号,C.病人ID,C.姓名,ltrim(to_char(B.金额,'999999990.00')) 金额,B.经办人, " & _
    ...
    Else
        gstrSQL = "Select B.ID,'' 中心,A.卡号,A.医保号,C.病人ID,C.姓名,ltrim(to_char(B.金额,'999999990.00')) 金额,B.经办人, " & _
                 " To_char(B.时间,'yyyy-MM-dd hh24:mi:ss') 时间,性质,说明 " & _
