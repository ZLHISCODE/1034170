...
Private Function InitFace() As Boolean
    ...
    gstrSQL = "Select B.ID,A.中心,A.卡号,A.医保号,C.病人ID,C.姓名,A.病人ID, " & _
             ...
             " ltrim(to_char(B.金额,'999999990.00')) 金额,B.经办人,Nvl(D.住院次数累计,0) 本院,Nvl(D.外院住院次数,0) 外院, " & _
             ...
             " And A.险类=D.险类(+) And A.病人ID=D.病人ID(+) And A.险类=" & gintInsure & " And B.ID=" & mlng记录ID
    Call OpenRecordset(rsTemp, Me.Caption)
...
Private Function ValidData() As Boolean
    ...
    End If
    If Val(txt调整额.Text) <> 0 Then
        If Abs(txt调整额.Text) > 9999999999.99 Then
