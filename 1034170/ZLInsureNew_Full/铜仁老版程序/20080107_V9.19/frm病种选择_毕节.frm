...
Private Sub Form_Load()
    ...
    '将以前选择的病种显示出来
    gstrSQL = "Select 病种ID,医保号 From 保险帐户 Where 险类=" & TYPE_毕节 & " And 病人ID=" & mlng病人ID
    Call OpenRecordset(rsTemp, "读取当前选择的病种ID")
    ...
    '取病人信息
    gstrSQL = "Select 姓名 From 病人信息 Where 病人ID=" & mlng病人ID
