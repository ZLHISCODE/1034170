...
Private Sub cmd确定_Click()
    ...
    If mbytType <> 3 Then
        ...
        '获取病种ID
        gstrSQL = "Select ID From 疾病编码目录 Where 编码='" & txt疾病信息.Tag & "'"
    ...
    If mbytType <> 2 Then
        '检查病人状态
        gstrSQL = "select nvl(当前状态,0) as 状态 from 保险帐户 where 险类=" & TYPE_渝北农医 & " and 医保号='" & txt医疗证号 & "'"
    ...
    Call ExecuteProcedure("更新家庭帐户余额")
