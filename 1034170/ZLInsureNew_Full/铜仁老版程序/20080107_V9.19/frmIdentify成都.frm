...
Private Sub txtCard_GotFocus()
    ...
    If mblnLED And txtCard.Text = "" Then
        zl9LedVoice.Speak "#5"
    End If
End Sub
...
Private Sub txtPwd_GotFocus()
    ...
    If mblnLED And txtPwd.Text = "" Then
        zl9LedVoice.Speak "#0"
    End If
End Sub
...
Private Sub ThisIdentify()
    ...
    With rsTmp
        ...
        Call OpenRecordset(rsTmp, Me.Caption, strSql)
        ...
        If .State = adStateOpen Then .Close
        .Open "select code from zjycl  where jysxh='" & strSwapNo & "' and jybh='z001'", gcnSybase, adOpenStatic, adLockReadOnly
        If Trim(.Fields(0).Value) <> "0000" Then
            ...
            Me.txtCard.Text = "": Me.txtPwd.Text = ""
            Me.cmdOK.Enabled = False
            Me.txtCard.SetFocus
            mstrPatiInfo = ""
        Else
