...
Private Function IsValid() As Boolean
    ...
    If mbytType <> 2 Then
        ...
        Else
            '检查病人状态
            gstrSQL = "select nvl(当前状态,0) as 状态 from 保险帐户 where 险类=" & TYPE_兴安 & " and 医保号='" & g病人身份_兴安.个人编号 & "'"
...
Private Sub cmd确定_Click()
    ...
    If mbytType = 4 Then
        ...
        gstrSQL = "Select * from 保险帐户 where 险类=" & gintInsure & " and  医保号='" & g病人身份_兴安.个人编号 & "'"
    ...
    If mbytType = 0 Then
        '门诊:
        '更新保险帐户的相关信息
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'当日已用药品','" & g病人身份_兴安.当日已用药品金额 & "')"
        Call ExecuteProcedure("保存当日已用药品金额")
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'当年已用自负段','" & g病人身份_兴安.当年已用自负段 & "')"
        Call ExecuteProcedure("保存当年已用自负段")
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'当年已用慢病','" & g病人身份_兴安.当年已用慢病统筹 & "')"
        Call ExecuteProcedure("保存当年已用慢病统筹")
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'门诊流水号','''" & g病人身份_兴安.门诊流水号 & "''')"
        Call ExecuteProcedure("保存门诊流水号")
    ElseIf mbytType = 1 Then
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'本年已用基本统筹','" & g病人身份_兴安.本年已用基本统筹 & "')"
        Call ExecuteProcedure("保存本年已用基本统筹")
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'本年已用大病统筹','" & g病人身份_兴安.本年已用大病统筹 & "')"
        Call ExecuteProcedure("保存本年已用大病统筹")
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'当年住院次数','" & g病人身份_兴安.当年第几次住院 & "')"
        Call ExecuteProcedure("保存当年第几次住院")
        gstrSQL = "zl_保险帐户_更新信息(" & mlng病人ID & "," & gintInsure & ",'本次住院起付标准','" & g病人身份_兴安.本次住院起付标准 & "')"
        Call ExecuteProcedure("保存本次住院起付标准")
    End If
    '返回格式:中间插入病人ID
    If mlng病人ID > 0 Then
