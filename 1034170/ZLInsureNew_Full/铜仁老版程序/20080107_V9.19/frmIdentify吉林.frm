...
Private Function IsValid() As Boolean
    ...
    If mbytType = 0 And (cboType.ItemData(cboType.ListIndex) = 2 Or cboType.ItemData(cboType.ListIndex) = 3) And txtInfo(14).Tag = "" Then
    ...
    If mbytType <> 2 Then
        ...
        Else
            '检查病人状态
            gstrSQL = "select nvl(当前状态,0) as 状态 from 保险帐户 where 险类=" & TYPE_吉林 & " and 医保号='" & txtInfo(1).Text & "'"
