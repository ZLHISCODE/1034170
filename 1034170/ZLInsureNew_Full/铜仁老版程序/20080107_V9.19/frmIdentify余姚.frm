...
Private Sub txtInfo_KeyPress(Index As Integer, KeyAscii As Integer)
    ...
    If Index = 4 Then
        If Trim(txtInfo(4).Text) <> "" Then
            gstrSQL = "Select * From 病人信息 Where 就诊卡号='" & Trim(UCase(txtInfo(4).Text)) & "'"
            Call OpenRecordset(rs信息, gstrSysName)
            If Not rs信息.EOF Then
                mlng病人ID = rs信息!病人ID
                gstrSQL = "Select 卡号 From 保险帐户 Where 病人ID=" & rs信息!病人ID
                ...
                Else
                    ...
                    gstrSQL = "Select A.姓名,A.性别,nvl(B.单位编码,'0') From 病人信息 A,保险帐户 B Where A.病人ID=B.病人ID And B.险类=" & gintInsure & " And B.卡号='" & Trim(txtInfo(0).Text) & "'"
                    Call OpenRecordset(rsTemp, gstrSysName)
