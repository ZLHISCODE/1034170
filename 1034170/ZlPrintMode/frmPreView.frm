...
Private Sub cmbPageNumber_Click()
    ...
    If gintShow = 1 Then
        ...
        End If
    Else
        If Val(Mid(cmbPageNumber.Text, 2)) = gintColTotal * gintRowTotal Then
            cmbPageNumber.Text = "第" & CStr(gintColTotal * gintRowTotal - 1) & "页"
            Exit Sub
        End If
        If gintPage <> Val(Mid(cmbPageNumber.Text, 2)) Then
            gintPage = Val(Mid(cmbPageNumber.Text, 2))
...
Private Sub Form_Load()
    ...
    Dim i As Integer
    For i = 1 To gintRowTotal * gintColTotal
...
Private Sub mnuViewDual_Click()
    ...
    Else
        ...
        Unload Me.shpBack(2)
    End If
    If gintPage = gintColTotal * gintRowTotal Then
        gintPage = gintPage - 1
        cmbPageNumber.Text = "第" & CStr(gintPage) & "页"
    End If
    Form_Resize
...
Private Sub mnuViewLast_Click()
    ...
    If gintShow = 1 Then
        If gintPage <> gintColTotal * gintRowTotal Then
            intPage = gintColTotal * gintRowTotal
            cmbPageNumber.Text = "第" & CStr(intPage) & "页"
        End If
    Else
        If gintPage < gintColTotal * gintRowTotal - 1 Then
            intPage = gintColTotal * gintRowTotal - 1
            cmbPageNumber.Text = "第" & CStr(intPage) & "页"
        End If
    End If
End Sub
