...
Private Sub cmdList_Click()
    ...
    vsfProc.SaveGrid App.Path & "\变动过程清单.xls", flexFileExcel, True
    MsgBox "保存成功，已经保存至" & VB.App.Path & "\变动过程清单.xls"
...
Private Sub Form_Resize()
    ...
    cmdList.Top = cmdEdit.Top
    cmdList.Left = cmdView.Left - cmdList.Width - 80
