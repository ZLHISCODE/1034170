...
Private Sub Get上次结存(ByVal lng库房id As Long)
    ...
    If cbo核算方法.ListIndex = 1 Then
        ...
        dtpTime.Value = Format(zldatabase.Currentdate, "yyyy-mm-dd hh:mm:ss")
...
Private Sub RefreshNow(ByVal lng库房id As Long)
    ...
    If mint核算方法 = type_全月平均 Then
        ...
        dtpBegin.Value = Format(zldatabase.Currentdate, "yyyy-mm") & "-01 00:00:00"
...
Private Sub cmdIni_Click()
    ...
    If mstr上次结存时间 = "" And DateDiff("m", dtpTime.Value, zldatabase.Currentdate) > intIni Then
