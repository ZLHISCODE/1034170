...
Private Sub Cmd药品_Click()
    ...
    If grsMaster.State = adStateClosed Then
        Call SetSelectorRS(1, "药品移库管理", mfrmMain.cboStock.ItemData(mfrmMain.cboStock.ListIndex), mfrmMain.cboStock.ItemData(mfrmMain.cboStock.ListIndex))
    End If
...
Private Sub Txt药品_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If grsMaster.State = adStateClosed Then
        Call SetSelectorRS(1, "药品移库管理", mfrmMain.cboStock.ItemData(mfrmMain.cboStock.ListIndex), mfrmMain.cboStock.ItemData(mfrmMain.cboStock.ListIndex), mfrmMain.cboStock.ItemData(mfrmMain.cboStock.ListIndex))
    End If
