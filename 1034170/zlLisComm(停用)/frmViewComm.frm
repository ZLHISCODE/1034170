...
Begin VB.Form frmViewComm 
   ...
   Begin RichTextLib.RichTextBox Rtxt_In 
      Height          =   2460
      Left            =   210
      TabIndex        =   0
      Top             =   540
   ...
   End
   Begin RichTextLib.RichTextBox Rtxt_Out 
      Height          =   2460
      Left            =   870
      TabIndex        =   1
      Top             =   2610
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      EndProperty
   End
   Begin RichTextLib.RichTextBox RTxt_Hex 
      Height          =   2460
      Left            =   4380
      TabIndex        =   5
      Top             =   180
...
Private Sub dkpComInit()
    ...
    Set objPaneD = Me.dkpCom.CreatePane(4, 100, 135, DockRightOf, objPaneB)
    objPaneD.Title = "解码结果"
    
    Set objPaneE = Me.dkpCom.CreatePane(5, 100, 135, DockRightOf, objPaneC)
    objPaneE.Title = "未知项目"
