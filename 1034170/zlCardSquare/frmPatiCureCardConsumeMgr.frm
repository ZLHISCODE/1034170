...
Private Sub LoadDataToRpt()
    ...
    strSQL = "       With 预交 As ( " & strTable & ")" & _
        ...
        "          From 预交 " & _
        "          Where  收款时间 Between [2] And [3]  Having Sum(Nvl(金额, 0))>0 " & _
        "          Group By To_Char(收款时间, 'yyyy-mm-dd')" & _
        "          Union All " & _
        ...
        "          Union All " & _
        "          Select 2 as 类别,To_Char(收款时间, 'yyyy-mm-dd') As 收款时间, '充值' As 业务类型, 0 As 期初余额, Sum(Nvl(金额, 0)) As 充值, 0 As 本期消费 " & _
        "          From 预交 " & _
        "          Where  收款时间 Between [2] And [3] Having Sum(Nvl(金额, 0))<0 " & _
    ...
    strSQL = " " & _
        ...
        "   From (" & strSQL & ") Group By  类别,收款时间, 业务类型" & _
        "          Order By 类别,收款时间 "
