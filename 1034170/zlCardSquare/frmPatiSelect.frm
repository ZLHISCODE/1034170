...
Private Function GetBoundData() As Boolean
    ...
    Else
        Set mrsBindings = objDatabase.OpenSQLRecord(mstrSQL, mstrWinTittle & "选择", mstrSQL)
    End If
...
Private Sub cmdPatiMerge_Click()
    ...
    With vsSelect
        ...
        Next
    End With
    If frmMergePatient.zlShowPatiMerge(Me, lng病人ID1, lng病人ID) = False Then Exit Sub
...
Private Function OpenSQLRecord(ByVal strSql As String, strLog As String) As ADODB.Recordset
    ...
    If cmdData.ActiveConnection Is Nothing Then
        Set cmdData.ActiveConnection = IIf(mcnOracle Is Nothing, gcnOracle, mcnOracle) '这句比较慢
    End If
    cmdData.CommandText = strSql
    
    Call SQLTest(App.ProductName, mstrWinTittle & "选择", strLog)
