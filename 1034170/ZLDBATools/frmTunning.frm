...
Private Sub pctStatics_Resize()
    ...
    optSkewOnly.Top = optNull.Top: optAuto.Top = optNull.Top: opt254.Top = optNull.Top
    lblType.Top = optNull.Top: lblTip2.Top = optNull.Top
    optNull.Left = cmdExecute.Left - optNull.Width - 45
    opt254.Left = optNull.Left - opt254.Width - 45
    optSkewOnly.Left = opt254.Left - optSkewOnly.Width - 45
...
Private Sub ChangeAdvice()
    ...
    Else
        ...
        strAdvice = "--DEGREE-当前最大并行度可设置为：" & gintCpuMax & ",建议设置为：" & gintCpuAdvise & "；" & vbNewLine & vbNewLine & _
                                ...
                                "Method_Opt => 'FOR ALL COLUMNS SIZE" & strOption & "' ,no_invalidate => False);"
    End If
