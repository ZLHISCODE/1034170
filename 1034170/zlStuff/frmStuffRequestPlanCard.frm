...
Private Sub mshbill_CommandClick()
    ...
    If mshBill.Col = mHeadCol.材料 Then
        ...
        Set RecReturn = Frm材料选择器.ShowMe(Me, 1, Val(cboEnterStock.ItemData(cboEnterStock.ListIndex)), Val(cboEnterStock.ItemData(cboEnterStock.ListIndex)), , , , , , , , , , , , , , mstrPrivs)
        ...
        Select Case .Col
            ...
            Case mHeadCol.材料
                If strKey <> "" Then
                    ...
                    Set rsTemp = FrmMulitSel.ShowSelect(Me, 1, Val(cboEnterStock.ItemData(cboEnterStock.ListIndex)), Val(cboEnterStock.ItemData(cboEnterStock.ListIndex)), , strKey, sngLeft, sngTop, mshBill.MsfObj.CellWidth, mshBill.MsfObj.CellHeight, , , , , , , , , , , , mstrPrivs)
