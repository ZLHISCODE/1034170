...
Private Sub Form_Load()
    dtpDateBegin.Value = DateAdd("M", -1, zlDatabase.Currentdate)
...
Private Sub FillLVWPatient()
    ...
    Else
        mdatBegin = DateAdd("M", -1, zlDatabase.Currentdate)
...
Private Sub SelPatient(ByVal lsItem As ListItem)
    ...
    gstrSQL = _
        ...
        "         a.供药单位id + 0 = [1] and a.库房id = [2] AND A.记录状态 = 1 And A.单据 = 15 AND B.病人ID = [3] And B.病人科室ID = [4] And " & _
