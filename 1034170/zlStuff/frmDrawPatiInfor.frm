...
Begin VB.Form frmDrawPatiInfor 
   ...
   Begin VB.CommandButton cmdHelp 
      ...
      Height          =   350
      Left            =   90
      Picture         =   "frmDrawPatiInfor.frx":000C
      TabIndex        =   42
      TabStop         =   0   'False
      Top             =   4785
      Width           =   1100
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDrawPatiInfor.frx":0156
            Key             =   "ItemUse"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDrawPatiInfor.frx":06F0
            Key             =   "ItemStop"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDrawPatiInfor.frx":0C8A
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Image Image1 
      ...
      Index           =   0
      Left            =   330
      Picture         =   "frmDrawPatiInfor.frx":2994
      Top             =   105
      Width           =   480
   End
...
Private Function MulitSelectPati(ByVal strkey As String) As Boolean
    ...
    Else
        ...
        gstrSQL = "" & _
            ...
            "          " & strWhere
                ...
                End If
    End If
    vRect = GetControlRect(txtEdit(2).hwnd)
    ...
    If rsTemp Is Nothing Then
        ...
        Exit Function
    End If
    txtEdit(2).Text = NVL(rsTemp!姓名)
    cmdPati.Tag = NVL(rsTemp!Id)
    mlng病人id = Val(NVL(rsTemp!Id))
    Dim i As Integer
    For i = 2 To txtEdit.UBound
        txtEdit(i).Text = NVL(rsTemp.Fields(txtEdit(i).Tag))
    Next
...
Private Function Init病人信息() As Boolean
    ...
    txtEdit(0).Text = "[" & NVL(rsTemp!编码) & "]" & NVL(rsTemp!名称) & Space(5) & NVL(rsTemp!规格) & Space(5) & NVL(rsTemp!产地)
    txtEdit(1).Text = mstr条码
    If mstr使用时间 = "" And mbln编辑 = True Then
        MakTxtEdit.Text = Format(zlDatabase.Currentdate, "yyyy-mm-dd")
    ...
    For i1 = 0 To txtEdit.UBound
        If txtEdit(i1).Tag = "当前科室" Then
            txtEdit(i1).Text = "[" & NVL(rsTemp!编码) & "]" & NVL(rsTemp!名称)
            Exit For
        End If
    Next
    '加载病人信息
    If mlng病人id <> 0 Then
        ...
        Next
        If mlng收发ID <> 0 Then
            txtEdit(1).Text = NVL(rsTemp!条码)
            If NVL(rsTemp!使用时间) <> "" Then
                MakTxtEdit.Text = NVL(rsTemp!使用时间)
            End If
        End If
    End If
Init:
