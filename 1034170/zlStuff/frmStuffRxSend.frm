...
Begin VB.Form frmStuffRxSend 
   ...
   Begin XtremeDockingPane.DockingPane dkpMain 
      Bindings        =   "frmStuffRxSend.frx":13ADC
      Left            =   3960
      Top             =   960
      _Version        =   589884
      _ExtentX        =   450
    ...
    With cboTime
        ...
        If .ListIndex < mTimeRange.指定时间范围 Then
            Select Case .ListIndex
                Case mTimeRange.当天
                    Me.DtpBeginTime.Value = Format(zlDatabase.Currentdate, "yyyy-MM-dd 00:00:00")
                Case mTimeRange.两天内
                    Me.DtpBeginTime.Value = Format(zlDatabase.Currentdate - 1, "yyyy-MM-dd 00:00:00")
                Case mTimeRange.三天内
                    Me.DtpBeginTime.Value = Format(zlDatabase.Currentdate - 2, "yyyy-MM-dd 00:00:00")
            End Select
