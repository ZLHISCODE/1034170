...
'    Me.cbsThis.Icons = frmPubIcons.imgPublic.Icons
    ...
    With mcbrMenuBar.CommandBar.Controls
        ...
        mcbrControl.Visible = IsHavePrivs(mstrPrivs, "停止发料") Or IsHavePrivs(mstrPrivs, "恢复发料")
...
Private Sub 权限控制(ByVal Control As XtremeCommandBars.ICommandBarControl)
  ...
  Select Case Control.Id
    ...
    Case conMenu_File_Parameter:
        '参数设置
       ' Control.Enabled = IsHavePrivs(mstrPrivs, "参数设置")
    Case conMenu_Edit_NewItem, conMenu_Edit_CfPay, conMenu_Edit_BillPay:     '发料
        Control.Visible = IsHavePrivs(mstrPrivs, "卫生材料发料")
    Case conMenu_Edit_StopPay
         Control.Visible = IsHavePrivs(mstrPrivs, "停止发料") Or IsHavePrivs(mstrPrivs, "恢复发料")
    Case conMenu_Manage_Discard:  '拒发
        Control.Visible = IsHavePrivs(mstrPrivs, "卫生材料拒发")
    Case conMenu_Manage_Recall  '恢复发料
        Control.Visible = IsHavePrivs(mstrPrivs, "卫生材料恢复")
    Case conMenu_Manage_Untread, conMenu_Edit_BillBackPay    '退料
        Control.Visible = IsHavePrivs(mstrPrivs, "卫生材料退料")
    Case conMenu_EditPopup
        Control.Visible = IsHavePrivs(mstrPrivs, "卫生材料发料") Or _
                          IsHavePrivs(mstrPrivs, "卫生材料退料") Or _
                          IsHavePrivs(mstrPrivs, "卫生材料拒发") Or _
                          IsHavePrivs(mstrPrivs, "卫生材料恢复") Or _
                          IsHavePrivs(mstrPrivs, "卫生材料退料") Or _
                          IsHavePrivs(mstrPrivs, "卫生材料销帐")
    Case conMenu_Edit_ChargeDelAudit    '销帐
        Control.Visible = IsHavePrivs(mstrPrivs, "卫生材料销帐")
    End Select
End Sub
...
Private Sub zlRptPrint(ByVal bytMode As Byte)
    ...
    Call ObjAppRow.Add("打印时间:" & Format(zlDatabase.Currentdate, "yyyy年MM月DD日"))
