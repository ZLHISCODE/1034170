...
Begin VB.Form frm卫材发放管理Search 
   ...
   Begin TabDlg.SSTab sstFilter 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "常规(&R)"
      TabPicture(0)   =   "frm卫材发放管理Search.frx":0000
      ...
      TabCaption(1)   =   "附加条件(&D)"
      TabPicture(1)   =   "frm卫材发放管理Search.frx":001C
   ...
   End
End
Attribute VB_Name = "frm卫材发放管理Search"
...
Private Sub txtEDIT_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyReturn Then
        ...
        With rsTemp
            ...
            Set rsTemp = zlDatabase.OpenSQLRecord(gstrSQL, "取部门信息", IIf(gstrMatchMethod = "0", "%", "") & txtEDIT(5) & "%")
