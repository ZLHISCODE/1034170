...
Begin VB.Form frmSystemParaSet 
   ...
   Begin TabDlg.SSTab stbPage 
      ...
      Begin VB.ComboBox cmb出库算法 
         Height          =   300
         ItemData        =   "frmSystemParaSet.frx":110D
         Left            =   1800
         List            =   "frmSystemParaSet.frx":110F
         Style           =   2  'Dropdown List
         TabIndex        =   6
         Top             =   5797
         Width           =   2145
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsf库房检查 
         ...
         ColWidthMax     =   0
         ExtendLastCol   =   0   'False
         FormatString    =   $"frmSystemParaSet.frx":1111
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
      ...
      Begin VB.Label lbl虚拟库房 
         Caption         =   $"frmSystemParaSet.frx":1207
         Height          =   540
         Left            =   -74280
         TabIndex        =   28
         Top             =   450
      ...
      Begin VB.Image Image1 
         ...
         Index           =   3
         Left            =   -74880
         Picture         =   "frmSystemParaSet.frx":12CA
         Top             =   480
         Width           =   480
      End
      ...
      Begin VB.Image Image1 
         ...
         Index           =   1
         Left            =   -74880
         Picture         =   "frmSystemParaSet.frx":1B94
         Top             =   450
         Width           =   480
      End
      Begin VB.Image Image1 
         ...
         Index           =   0
         Left            =   -74880
         Picture         =   "frmSystemParaSet.frx":2215
         Stretch         =   -1  'True
         Top             =   480
         Width           =   435
      End
...
Private Function Save数据() As Boolean
    ...
    With vsfParameter
        ...
        Call zlDatabase.SetPara(305, IIf(.TextMatrix(mPara.mint分批卫材批号产地控制, 1) = "1", 1, 0), glngSys, 0)
        Call zlDatabase.SetPara(309, IIf(.TextMatrix(mPara.mint已失效卫材禁止入库, 1) = "1", 1, 0), glngSys, 0)
    End With
...
Private Function LoadPara()
    ...
    mblnChkClick = True
'    chkCheck(5).Tag = ""
    Set rsTemp = ReturnParaData(glngSys, "83,88,95,120,123,127,132,136,140,156,159,258,268,280,281,305,309")
    With rsTemp
        Do While Not .EOF
