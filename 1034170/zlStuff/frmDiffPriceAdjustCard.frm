...
Private Sub mshbill_CommandClick()
    ...
    Set RecReturn = Frm材料选择器.ShowMe(Me, 2, txtStock.Tag, , txtStock.Tag, False, , , , , , , , , , , , mstrPrivs & ";查看成本价;")
        ...
        Select Case .Col
            ...
            Case mconIntCol材料
                If strKey <> "" Then
                    ...
                    Set RecReturn = FrmMulitSel.ShowSelect(Me, 2, txtStock.Tag, , txtStock.Tag, strKey, sngLeft, sngTop, mshBill.MsfObj.CellWidth, mshBill.MsfObj.CellHeight, False, , , , , , , , , , , mstrPrivs)
...
Private Function SaveCard() As Boolean
    ...
    With mshBill
        ...
        If mint编辑状态 = 1 Then   'mbln单据增加 Or
            ...
            End If
            If chrNo = "" Then chrNo = zlDatabase.GetNextNo(71, lng库房id)
    ...
    With mshBill
        Do While Not rsTemp.EOF
           ...
           .TextMatrix(i, mconIntCol效期) = IIf(IsNull(rsTemp!效期), "", Format(rsTemp!效期, "yyyy-MM-dd"))
            ...
            .TextMatrix(i, mconIntCol一次性材料) = NVL(rsTemp!一次性材料)
            .TextMatrix(i, mconIntCol灭菌效期) = NVL(rsTemp!灭菌效期)
