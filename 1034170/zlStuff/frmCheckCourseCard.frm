    ...
    Select Case mint编辑状态
        ...
        Case 2, 3, 4
            ...
            gstrSQL = "" & _
                ...
                "                   And A.药品ID=E.药品ID(+) And A.库房ID=E.库房ID(+) And nvl(A.批次,0) = nvl(E.批次(+),0) AND E.性质(+) = 1 AND A.单据 =23 AND A.No = [1] " & _
                "   ) " & _
    ...
    With mshBill
        ...
        Select Case .Col
            ...
            Case mconIntCol效期
                ...
                If .TextMatrix(.Row, mconIntCol批号) <> "" And Len(Trim(.TextMatrix(.Row, mconIntCol批号))) = 8 And Trim(.TextMatrix(.Row, mconIntCol效期)) = "" Then
                    Dim strxq As String
        ...
        Select Case .Col
            ...
            Case mconIntCol效期
                ...
                ElseIf strKey = "" And strKey <> .TextMatrix(.Row, mconIntCol效期) Then
                    ...
                    If CheckLapse(Trim(.TextMatrix(.Row, mconIntCol效期)), True) = False Then
                        MsgBox "该卫生材料已失效卫材！", vbInformation, gstrSysName
                        Cancel = True
                    End If
                ...
                If Trim(.TextMatrix(intLop, mconIntCol材料)) <> "" Then
                    ...
                    If Val(.TextMatrix(intLop, mconIntCol批次)) = -1 Then  '分批卫材检查产地和批号
                        ...
                        If Val(.TextMatrix(intLop, mconintCol实盘数量)) = 0 Then
                            ShowMsgBox "第" & intLop & "行新增分批材料实盘数量为0，请检查！"
                            mshBill.SetFocus
                            .Row = intLop
                            .MsfObj.TopRow = intLop
                            .Col = mconintCol实盘数量
                        ...
                        If CheckLapse(Trim(mshBill.TextMatrix(intLop, mconIntCol效期)), True) = False Then '检查失效期
