...
Public Function GetCondition(frmMain As Form, ByRef str分类ID, ByRef lng库房ID As Long, _
    ...
    ByRef str供货商ID As String, ByRef bln中标单位 As Boolean, ByRef bln计划数量 As Boolean, ByRef bln不考虑库存 As Boolean) As Boolean
