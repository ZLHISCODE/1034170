...
Public Function ShowMe(frmMain As Object, ByVal lngStPathID As Long)
...
'功能：设置tbcPathName与picStPathDetial的位置大小
    ...
    tbcPathName.Height = Me.ScaleHeight - tbcPathName.Top
    tbcPathName.Width = Me.ScaleWidth * 0.3
    ...
    picStPathDetial.Height = Me.ScaleHeight - picStPathDetial.Top
