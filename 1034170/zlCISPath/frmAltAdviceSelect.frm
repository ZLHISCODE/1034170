...
Public Function ShowSelect(ByVal frmParent As Object, ByVal lng路径项目ID As Long, Optional ByVal strSelectedIDs As String, Optional ByVal int婴儿 As Integer) As String
