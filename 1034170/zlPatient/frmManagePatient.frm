...
Begin VB.Form frmManagePatient 
   ...
   Begin MSComctlLib.ImageList imgColor 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   14
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":13DC1
            Key             =   "Preview"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":13FDB
            Key             =   "Print"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":141F5
            Key             =   "New"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":1440F
            Key             =   "Modi"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":14629
            Key             =   "Del"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":14843
            Key             =   "Merge"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":14F3D
            Key             =   "View"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":15637
            Key             =   "Patis"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":15D31
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":15F4B
            Key             =   "Filter"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":16165
            Key             =   "Help"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":1637F
            Key             =   "Quit"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":16599
            Key             =   "RollingCurtain"
            Object.Tag             =   "RollingCurtain"
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManagePatient.frx":16C93
            Key             =   "PlugIn"
         EndProperty
      EndProperty
   End
...
Private Sub mnuEditPatiInfo_Click()
    ...
    If mobjPublicPatient Is Nothing Then Exit Sub
    '65802:刘鹏飞
    If glngSys Like "8??" Then
        lng病人ID = Val(mshPati.TextMatrix(mshPati.Row, GetColNum("客户ID")))
    Else
    ...
    End If
    '病人信息调整
    blnOK = mobjPublicPatient.ModiPatiBaseInfo(Me, "病人信息管理", lng病人ID, lng就诊ID, 2)
...
Private Sub mnuViewFilter_Click()
    ...
    If gblnOK Then
        With frmPatiFilter
            ...
            SQLCondition.性别 = NeedName(.cbo性别.Text)
            SQLCondition.费别 = NeedName(.cbo费别.Text)
            SQLCondition.区域 = NeedName(.txt区域.Text)
            '59340:刘鹏飞,2013-04-23,姓名匹配添加gstrLike
            If .cboIDKind.ListIndex = 0 And (.chk登记.Value = 1 Or .chk入院.Value = 1 Or .chk出院.Value = 1) Then     '姓名
                SQLCondition.Patient = gstrLike & Trim(.txtIdentity.Text) & "%"
            Else
                SQLCondition.Patient = Trim(.txtIdentity.Text)
            End If
        End With
...
Private Sub Form_Load()
    ...
    Else
        Call mobjPublicPatient.zlInitCommon(gcnOracle, glngSys, gstrDBUser)
    End If
    '扩展功能
    Call LoadPlugInMnu
End Sub
...
Private Sub mnuEdit_View_Click()
    ...
    Else
        ...
        End If
        'frmDegreeCard.mbytView = Val(mshPati.Tag)
        frmDegreeCard.mlng病人ID = CLng(mshPati.TextMatrix(mshPati.Row, GetColNum("病人ID")))
        frmDegreeCard.mlng主页ID = CLng(mshPati.TextMatrix(mshPati.Row, GetColNum("主页ID")))
    ...
    If Not blnSort Then
        ...
        With SQLCondition
            Set mrsPati = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, lngDeptID, mstrUserUnitIDs, .登记时间B, .登记时间E, .出生时间B, .出生时间E, _
                .入院时间B, .入院时间E, .出院时间B, .出院时间E, .住院号, .性别, .区域, .费别, .Patient, mlngCardType)
        End With
    End If
...
Private Sub LoadPlugInMnu()
    ...
    If blnHave Then
        ...
        If strTmp = "" Then '
            mnuEdit_PlugIn.Visible = False
            tbr.Buttons("PlugIn").Visible = False
            tbr.Buttons("SplitPlugIn").Visible = False
            Exit Sub
        Else
            mnuEdit_PlugIn.Visible = True
            tbr.Buttons("PlugIn").Visible = True
            tbr.Buttons("SplitPlugIn").Visible = True
        End If
