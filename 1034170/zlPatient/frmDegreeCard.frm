...
Begin VB.Form frmDegreeCard 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(47)=   "lblMobile"
      Tab(0).Control(47).Enabled=   0   'False
      Tab(0).Control(48)=   "chk担保"
      Tab(0).Control(48).Enabled=   0   'False
      Tab(0).Control(49)=   "cbo(1)"
      Tab(0).Control(49).Enabled=   0   'False
      Tab(0).Control(50)=   "txt(9)"
      Tab(0).Control(50).Enabled=   0   'False
      Tab(0).Control(51)=   "txt(8)"
      Tab(0).Control(51).Enabled=   0   'False
      Tab(0).Control(52)=   "txt(3)"
      Tab(0).Control(52).Enabled=   0   'False
      Tab(0).Control(53)=   "txt(1)"
      Tab(0).Control(53).Enabled=   0   'False
      Tab(0).Control(54)=   "txt(0)"
      Tab(0).Control(54).Enabled=   0   'False
      Tab(0).Control(55)=   "txt(2)"
      Tab(0).Control(55).Enabled=   0   'False
      Tab(0).Control(56)=   "txt(5)"
      Tab(0).Control(56).Enabled=   0   'False
      Tab(0).Control(57)=   "txt(4)"
      Tab(0).Control(57).Enabled=   0   'False
      Tab(0).Control(58)=   "txt(7)"
      Tab(0).Control(58).Enabled=   0   'False
      Tab(0).Control(59)=   "txt(23)"
      Tab(0).Control(59).Enabled=   0   'False
      Tab(0).Control(60)=   "txt(15)"
      Tab(0).Control(60).Enabled=   0   'False
      Tab(0).Control(61)=   "txt(14)"
      Tab(0).Control(61).Enabled=   0   'False
      Tab(0).Control(62)=   "txt(13)"
      Tab(0).Control(62).Enabled=   0   'False
      Tab(0).Control(63)=   "txt(10)"
      Tab(0).Control(63).Enabled=   0   'False
      Tab(0).Control(64)=   "txt(11)"
      Tab(0).Control(64).Enabled=   0   'False
      Tab(0).Control(65)=   "txt(19)"
      Tab(0).Control(65).Enabled=   0   'False
      Tab(0).Control(66)=   "txt(20)"
      Tab(0).Control(66).Enabled=   0   'False
      Tab(0).Control(67)=   "txt(22)"
      Tab(0).Control(67).Enabled=   0   'False
      Tab(0).Control(68)=   "txt(25)"
      Tab(0).Control(68).Enabled=   0   'False
      Tab(0).Control(69)=   "txt(27)"
      Tab(0).Control(69).Enabled=   0   'False
      Tab(0).Control(70)=   "txt(28)"
      Tab(0).Control(70).Enabled=   0   'False
      Tab(0).Control(71)=   "txt(21)"
      Tab(0).Control(71).Enabled=   0   'False
      Tab(0).Control(72)=   "txt(17)"
      Tab(0).Control(72).Enabled=   0   'False
      Tab(0).Control(73)=   "txt(32)"
      Tab(0).Control(73).Enabled=   0   'False
      Tab(0).Control(74)=   "txt(31)"
      Tab(0).Control(74).Enabled=   0   'False
      Tab(0).Control(75)=   "txt(34)"
      Tab(0).Control(75).Enabled=   0   'False
      Tab(0).Control(76)=   "txt(33)"
      Tab(0).Control(76).Enabled=   0   'False
      Tab(0).Control(77)=   "txt(59)"
      Tab(0).Control(77).Enabled=   0   'False
      Tab(0).Control(78)=   "txt(41)"
      Tab(0).Control(78).Enabled=   0   'False
      Tab(0).Control(79)=   "txt(64)"
      Tab(0).Control(79).Enabled=   0   'False
      Tab(0).Control(80)=   "txt(63)"
      Tab(0).Control(80).Enabled=   0   'False
      Tab(0).Control(81)=   "txt(60)"
      Tab(0).Control(81).Enabled=   0   'False
      Tab(0).Control(82)=   "txt(30)"
      Tab(0).Control(82).Enabled=   0   'False
      Tab(0).Control(83)=   "txt(29)"
      Tab(0).Control(83).Enabled=   0   'False
      Tab(0).Control(84)=   "txt(26)"
      Tab(0).Control(84).Enabled=   0   'False
      Tab(0).Control(85)=   "txt(24)"
      Tab(0).Control(85).Enabled=   0   'False
      Tab(0).Control(86)=   "txt(18)"
      Tab(0).Control(86).Enabled=   0   'False
      Tab(0).Control(87)=   "txt(12)"
      Tab(0).Control(87).Enabled=   0   'False
      Tab(0).Control(88)=   "txt(16)"
      Tab(0).Control(88).Enabled=   0   'False
      Tab(0).Control(89)=   "txt(6)"
      Tab(0).Control(89).Enabled=   0   'False
      Tab(0).Control(90)=   "txt(65)"
      Tab(0).Control(90).Enabled=   0   'False
      Tab(0).Control(91)=   "txt(69)"
      Tab(0).Control(91).Enabled=   0   'False
      Tab(0).Control(92)=   "txt(70)"
      Tab(0).Control(92).Enabled=   0   'False
      Tab(0).Control(93)=   "txt(71)"
      Tab(0).Control(93).Enabled=   0   'False
      Tab(0).Control(94)=   "txt(72)"
      Tab(0).Control(94).Enabled=   0   'False
      Tab(0).Control(95)=   "txt(73)"
      Tab(0).Control(95).Enabled=   0   'False
      Tab(0).Control(96)=   "txt(74)"
      Tab(0).Control(96).Enabled=   0   'False
      Tab(0).Control(97)=   "txt(75)"
      ...
      Tab(1).Control(23)=   "Label35"
      Tab(1).Control(24)=   "Label12"
      Tab(1).Control(25)=   "Label37"
      Tab(1).Control(26)=   "Label38"
      Tab(1).Control(27)=   "Label39"
      Tab(1).Control(28)=   "txt(45)"
      Tab(1).Control(29)=   "txt(37)"
      Tab(1).Control(30)=   "txt(36)"
      Tab(1).Control(31)=   "txt(40)"
      Tab(1).Control(32)=   "txt(35)"
      Tab(1).Control(33)=   "txt(44)"
      Tab(1).Control(34)=   "txt(43)"
      Tab(1).Control(35)=   "txt(42)"
      Tab(1).Control(36)=   "txt(49)"
      Tab(1).Control(37)=   "txt(48)"
      Tab(1).Control(38)=   "txt(47)"
      Tab(1).Control(39)=   "txt(39)"
      Tab(1).Control(40)=   "cbo(0)"
      Tab(1).Control(41)=   "txt(57)"
      Tab(1).Control(42)=   "txt(61)"
      Tab(1).Control(43)=   "txt(62)"
      Tab(1).Control(44)=   "txt(38)"
      Tab(1).Control(45)=   "txt(51)"
      Tab(1).Control(46)=   "txt(50)"
      Tab(1).Control(47)=   "txt(54)"
      Tab(1).Control(48)=   "txt(52)"
      Tab(1).Control(49)=   "txt(46)"
      Tab(1).Control(50)=   "txt(53)"
      Tab(1).Control(51)=   "txt(66)"
      Tab(1).Control(52)=   "txt(67)"
      Tab(1).Control(53)=   "txt(68)"
      Tab(1).Control(54)=   "txt(56)"
      Tab(1).Control(55)=   "txt(55)"
      Tab(1).Control(56)=   "txt(58)"
...
'功能：读取指定病人信息,并显示在界面上
    ...
    strSQL = "Select a.病人id," & IIf(lng主页ID = 0, " a.姓名", " NVL(B.姓名,a.姓名) 姓名") & "," & IIf(lng主页ID = 0, " a.性别", " NVL(b.性别,a.性别) 性别") & "," & IIf(lng主页ID = 0, " a.年龄", " NVL(b.年龄,a.年龄) 年龄") & ", a.门诊号, a.费别, a.医疗付款方式, a.险类, a.区域, a.国籍, a.民族, a.学历," & vbNewLine & _
            ...
            "            a.身份证号, a.手机号, a.出生地点, a.家庭地址, a.家庭电话, a.家庭地址邮编, a.户口地址, a.户口地址邮编, a.籍贯, a.联系人姓名,a.联系人身份证号," & vbNewLine & _
    ...
    Else
        strTxt = "病人ID=0,姓名=1,性别=2,年龄=3,门诊号=4,费别=5,医疗付款方式=6,医保号=7,险类=8,区域=9,国籍=10,民族=11,学历=12,婚姻状况=13,职业=14," & _
                ...
                " 出院中医诊断=54,登记时间=63,就诊卡号=64,其他证件=65,病人类型=66,住院预交余额=69,住院费用余额=70,户口地址=71,户口地址邮编=72,籍贯=73,联系人身份证号=74,手机号=75"
    End If
    ...
    For i = 0 To UBound(arrTxt)
        ...
        If strTmp <> "" Then
            ...
            If InStr(1, ",门诊诊断,门诊中医诊断,入院诊断,入院中医诊断,出院诊断,出院中医诊断,转科信息,", "," & Trim(Split(strTmp, "=")(0)) & ",") = 0 Then
                ...
                ElseIf InStr(1, ",身份证号,", "," & Trim(Split(strTmp, "=")(0)) & ",") > 0 Then
                    txt(Trim(Split(strTmp, "=")(1))).Text = "" & zlCommFun.GetNeedName(Nvl(rsTmp.Fields(Trim(Split(strTmp, "=")(0)))))
                Else
    ...
    txt(txtName.姓名).ForeColor = zlDatabase.GetPatiColor(Nvl(rsTmp!病人类型), True)
    '其它专门处理
    '----------------------------------------------
    ...
    If strPlus <> "" Then
        ...
        If Not rsTmp.EOF Then
            If Not IsNull(rsTmp!信息值) Then txt(txtName.身份证号).Text = zlCommFun.GetNeedName(rsTmp!信息值)
        End If
    End If
...
'    If Not bln查看某次住院 Then lng主页Id =Val(Nvl(rsTmp!就诊次数, 0))
    ...
    If lng主页ID > 0 Then
        '问题27832 by lesfeng 2010-01-18 增加“出院情况”
        strSQL = "Select 诊断类型,疾病ID,诊断描述,出院情况 From 病人诊断记录 Where 诊断次序=1 And 记录来源 In(2,3) And 病人ID=[1] And 主页ID=[2] Order By 记录来源 Desc"
        Set rsTmp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, lng病人ID, lng主页ID)
        ...
        strSQL = "Select 诊断类型,疾病ID,诊断描述,出院情况 From 病人诊断记录 Where 诊断类型 in (3,13) and 诊断次序>1 And 记录来源=3 And 病人ID=[1] And 主页ID=[2]"
        Set rsTmp = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, lng病人ID, lng主页ID)
