...
Private Const mstrLvw As String = "名称,1300,0,1;编码,800,0,2;简码,900,0,0;地址,1440,0,0;电话,1440,0,0;开户银行,1440,0,0;帐号,1440,0,0;联系人,1440,0,0;建档时间,1100,0,0;撤档时间,1100,0,0;所属分类,2000,0,0;站点,800,0,0"
...
'参数:str合约单位ID 分类的标识
    ...
    If mnuViewShowAll.Checked = True Then
        gstrSQL = "select A.ID,A.上级ID,A.名称,A.编码,A.简码,A.地址,A.电话,A.开户银行,A.帐号,A.联系人,A.建档时间,A.撤档时间,A.站点,B.名称 as 所属分类 from " & _
            "(select ID,上级ID,名称,编码,简码,地址,电话,开户银行,帐号,联系人,to_char(建档时间,'YYYY-MM-DD') as 建档时间,to_char(撤档时间,'YYYY-MM-DD') as 撤档时间,站点 from 合约单位 where " & _
    ...
    Else
        gstrSQL = "select ID,上级ID,名称,编码,简码,地址,电话,开户银行,帐号,联系人,to_char(建档时间,'YYYY-MM-DD') as 建档时间,to_char(撤档时间,'YYYY-MM-DD') as 撤档时间,'' as 所属分类,站点 from 合约单位 where " & _
