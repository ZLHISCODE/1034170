...
Public Sub ShowVsList(ByVal lng流水号 As Long)
    ...
    Case 1
        '输液
        strListHead = "状态,450,4;序号,0,4;顺序,450,4;内容,2300,1;单量,600,7;单位,0,4;金额,700,7;执行频率,900,1;用法,900,1;皮试结果,0,1;输液费,700,7;滴速,450,7;容量(ml),450,7;时间(分),450,4;进度,1300,1;执行人,675,1;剩余次数,450,7;备注,500,1;billKey,0,1;GroupKey,0,1;修改标志,0,1"
    Case 2
        '注射
        strListHead = "状态,450,4;序号,0,4;顺序,0,4;内容,2300,1;剂量,600,7;单位,0,4;金额,700,7;执行频率,900,1;用法,900,1;皮试结果,0,1;注射费,700,7;滴速,0,7;容量(ml),0,7;时间(分),0,4;进度,0,1;执行人,675,1;剩余次数,450,7;备注,500,1;billKey,0,1;GroupKey,0,1;修改标志,0,1"
    Case 3
        '皮试
        strListHead = "状态,450,4;序号,0,4;顺序,0,4;内容,2300,1;剂量,0,7;单位,0,4;金额,0,7;执行频率,900,1;用法,1800,1;皮试结果,450,1;皮试费,700,7;滴速,0,7;容量(ml),0,7;时间(分),0,4;进度,1300,1;执行人,675,1;剩余次数,450,7;备注,500,1;billKey,0,1;GroupKey,0,1;修改标志,0,1"
    Case Else
        '治疗
        '1 左对齐 4 居中 7 右对齐
        strListHead = "状态,450,4;序号,0,4;顺序,0,4;内容,2300,1;单量,600,7;单位,0,4;金额,0,7;执行频率,900,1;用法,900,1;皮试结果,0,1;治疗费,700,7;滴速,0,7;容量(ml),0,7;时间(分),0,4;进度,0,1;执行人,675,1;剩余次数,450,7;备注,500,1;billKey,0,1;GroupKey,0,1;修改标志,0,1"
    End Select
