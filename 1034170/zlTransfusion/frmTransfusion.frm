...
Object = "{AF9744ED-CAFC-4877-8437-2C20C14CEA4E}#6.0#0"; "zlIDKind.ocx"
    ...
    If KeyAscii = vbKeyReturn Then
        ...
        If Not rsTmp.EOF Then
            ...
            Else
                ...
                vRect = GetControlRect(cboDept.hwnd)
...
Private Sub Puncture()
    ...
    If mstr挂号单 <> "" Then
        ...
        If objPati Is Nothing Then
            MsgBox "当前病人未找到，拒绝穿刺！", vbInformation, gstrSysName
            Exit Sub
        End If
        ...
        If rsTmp.EOF = False Then
            ...
            Else
                '门诊留观
                strNextNo = "" & rsTmp!病人ID & "_" & rsTmp!主页id
            End If
        Else
            strNextNo = ""
        End If
...
Private Sub CallOnePlay(ByVal strNo As String)
    ...
    If lngNO > 0 Then
        If Not mobjRecord.Item(CStr(lngNO)) Is Nothing Then
            ...
            If bln治疗 Then
                '治疗类的医嘱不呼叫穿刺台窗口内容
                Call QueueOnePlay(strNo, "请、" & patiList.Item(strNo).姓名 & "、、来治疗")
            End If
        End If
    End If
    If bln治疗 = False Then
        Call QueueOnePlay(strNo, "请、" & patiList.Item(strNo).姓名 & "、到、" & patiList.Item(strNo).穿刺台 & "号窗口输液")
    End If
...
'    End If
    ...
    If Not Me.idkSelect.GetCurCard Is Nothing Then
        If Me.idkSelect.GetCurCard.名称 = "挂号单" Then
            '挂号单自动补齐内容
            txtInfo.Text = mdlTransfusion.GetFullNO(txtInfo.Text, 12)
        End If
    End If
...
Public Function ExecStart(ByVal str流水号 As String, ByVal strGroupKey As String, Optional ByVal blnUndo As Boolean = False) As Boolean
    ...
    Else
        ...
        If Not (int执行状态 >= 1 And int执行状态 <= 2) Then
            ...
            If frmRecordStart.ShowSelect(objOutNurse, strDate, strOper) Then
