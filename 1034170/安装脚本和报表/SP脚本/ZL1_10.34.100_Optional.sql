--[连续升级]1
--[管理工具版本号]10.34.90
--本脚本支持从ZLHIS+ v10.34.90 升级到 v10.34.100
...
--103024:刘鹏飞,2017-03-17,输血申请单孕产情况可录入修改
--基于调整原有输血申请记录.孕产情况字段为字符类型的后续处理。该过程用于删除输血申请记录中废弃字段孕产情况_bak
Create Or Replace Procedure Zl1_Optional_输血申请记录_删除 Is
Begin
  If Zl_Checkobject(2, '输血申请记录', '孕产情况_bak') > 0 Then
    Execute Immediate 'ALTER TABLE 输血申请记录 DROP COLUMN 孕产情况_bak';
  End If;
End Zl1_Optional_输血申请记录_删除;
/
-------------------------------------------------------------------------------------------------------
--更改系统及部件的版本号
-------------------------------------------------------------------------------------------------------
