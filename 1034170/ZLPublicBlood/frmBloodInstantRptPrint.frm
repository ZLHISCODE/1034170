...
'功能：初始化表格，并加载表格数据
    ...
    strSQL = _
        "Select a.Id, a.血袋编号, a.Abo, a.Rh, e.名称 As 血液名称, e.规格 血液规格," & vbNewLine & _
        "        Decode(Nvl(f.执行状态, 0), 1, '正在执行', 2, '完成执行', 3, '停止执行') 血液状态, g.开始执行人, g.开始时间, g.结束执行人, g.结束时间" & vbNewLine & _
