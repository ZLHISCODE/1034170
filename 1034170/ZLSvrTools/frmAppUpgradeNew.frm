...
Begin VB.Form frmAppUpgradeNew 
      ...
      Begin MSComctlLib.ImageList imgStep 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAppUpgradeNew.frx":058A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAppUpgradeNew.frx":20DC
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmAppUpgradeNew.frx":3C2E
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin VB.Frame fraStep 
      ...
      Begin VB.Label lblValiUser 
         AutoSize        =   -1  'True
         Caption         =   $"frmAppUpgradeNew.frx":44C0
         BeginProperty Font 
            Name            =   "宋体"
            Size            =   9
            Charset         =   134
   ...
   Begin VB.Frame fraStep 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsPlan 
         ...
         FormatString    =   $"frmAppUpgradeNew.frx":44D2
         ScrollTrack     =   -1  'True
         ScrollBars      =   0
         ScrollTips      =   0   'False
         MergeCells      =   0
         ...
         Begin MSComctlLib.ImageList imgPlan 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               NumListImages   =   3
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmAppUpgradeNew.frx":44FC
                  Key             =   "Finish"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmAppUpgradeNew.frx":4A96
                  Key             =   "Doing"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmAppUpgradeNew.frx":5030
                  Key             =   "Wait"
               EndProperty
            EndProperty
         End
...
Public Function HistoryUp(frmParent As Object, objStep As Object, ByVal lngSys As Long, ByVal strBakDB As String, ByVal strIntFile As String, ByVal strUserName As String, ByVal strPassword As String, ByVal strServer As String, ByVal strMaxVer As String, ByVal strDbLink As String) As Boolean
 ...
 '该公共过程仅使用当前窗体的两个对象,mrsSysFiles,与mclsRunScript
    ...
    '设置参数类参数
    Call mclsRunScript.InitGlobalPara(frmParent, lngSys, False, GetLogPath(LT_历史库升迁, lngSys, strUserName), , , , , True)
...
Private Sub chkParallel_Click()
    Call SetCtrlEnabled(chkParallel.Enabled And chkParallel.value = 1, lblParallel, txtCpu(0), udCpu(0))
...
Private Sub StepSwitch(ByVal intWay As Integer)
    ...
    If mintStep = SI_系统升迁 Then
        ...
        Call mclsRunScript.InitGlobalPara(Me, 0, optErrOption(ET_忽略所有错误).value, _
                                                            lblLogModi.Tag, IIf(chkLogLong.value = 0, 0, Val(txtLogLong.Text)), chkStat.value = 1, mblnExecBef And ckhIdxOnLine.value = 1, optLogType(1).value, True)
        '初始化用户密码信息，加密块可能用到
