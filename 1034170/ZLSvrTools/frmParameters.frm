...
Begin VB.Form frmParameters 
   ...
   Begin VB.PictureBox picPage 
      ...
      Begin VB.PictureBox picParInfo 
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsParaInfo 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmParameters.frx":9096
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.PictureBox picParaChangeLog 
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsChangeLog 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmParameters.frx":90E8
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.PictureBox picDetailParas 
         ...
         Begin VB.Frame fraDetaisModi 
            ...
            Begin VB.CommandButton cmdSearch 
               Height          =   240
               Left            =   3435
               Picture         =   "frmParameters.frx":91CF
               Style           =   1  'Graphical
               TabIndex        =   24
               TabStop         =   0   'False
               Top             =   180
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDetailParas 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmParameters.frx":94E3
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList ils16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   1
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParameters.frx":967F
            Key             =   "Root"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgEdit 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   7
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParameters.frx":B411
            Key             =   "Check"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParameters.frx":B9AB
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParameters.frx":BF45
            Key             =   "签名"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParameters.frx":C297
            Key             =   "Woman"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParameters.frx":12AF9
            Key             =   "Man"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParameters.frx":1935B
            Key             =   "UnCheck"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmParameters.frx":19823
            Key             =   "AllCheck"
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Image imgMain 
      Height          =   384
      Left            =   180
      Picture         =   "frmParameters.frx":19CEB
      Top             =   576
      Width           =   384
   End
...
Public Sub SubPrint(ByVal bytMode As Byte)
    ...
    If Me.ActiveControl Is vsDetailParas Then
        objPrint.Title.Text = "分站点或用户的参数清单打印"
    Else
    ...
    With rsComInfo
        ...
        Do While Not .EOF
            ...
            Select Case rsComInfo!State
                ...
                Case 1 '新增
                    strSQL = "Insert Into zlParameters (ID, 系统, 模块, 私有, 本机, 授权, 固定, 参数号, 参数名, 参数值, 缺省值,参数说明) " & _
                                    "  Select zlParameters_ID.NextVal, " & ZVal(arrTmp(0)) & ", " & ZVal(arrTmp(1)) & ", " & Val(!私有_New & "") & ", " & Val(!本机_New & "") & " , " & Val(!授权_New & "") & ", " & Val(!固定_New & "") & " , " & _
                                    !参数号_New & " , '" & arrTmp(2) & "', " & SQLAdjust(!参数值_New) & " , " & SQLAdjust(!缺省值_New) & ", " & SQLAdjust(!参数说明_New) & " From Dual" & _
        ...
        If blnDetails Then
            ...
            Do While Not .EOF
                If (!私有 = 1 Or !本机 = 1) Or (!私有_New = 1 Or !本机_New = 1) Then          '删除原来有参数详细配置，现在没有的参数配置
...
'功能：初始化界面
    ...
    Set objItem = tbPage.InsertItem(Pag_Computer, "站点及用户", picDetailParas.hwnd, 0)
...
'功能：获取参数相关信息
    ...
    Dim int公共全局 As Integer, int私有全局 As Integer, int公共模块 As Integer, int私有模块 As Integer, int本机公共 As Integer, int本机私有 As Integer
    ...
    Set mrsModule = CopyNewRec(rsTmp, True, "系统,模块,模块名称,模块简码", Array("Key", adVarChar, 200, Empty, "Fixed", adInteger, 3, 0, "Total", adInteger, 5, 0, _
                                                                            "公共全局", adInteger, 3, 0, "私有全局", adInteger, 3, 0, "公共模块", adInteger, 3, 0, "私有模块", adInteger, 3, 0, _
                                                                            "本机公共模块", adInteger, 3, 0, "本机私有模块", adInteger, 3, 0, "Index", adInteger, 5, 0))
    mrsPars.Filter = ""
        ...
        Do While Not mrsPars.EOF
            If strKey <> !系统 & "_" & !模块 Then
                If strKey <> "" Then
                    ...
                    mrsModule.AddNew Array("Key", "系统", "模块", "模块名称", "模块简码", "Fixed", "Total", "公共全局", "私有全局", "公共模块", "私有模块", "本机公共模块", "本机私有模块"), _
                                                    Array(strKey, Val(arrTmp(0)), Val(arrTmp(1)), strName, strCode, intFixed, intTotal, int公共全局, int私有全局, int公共模块, int私有模块, int本机公共, int本机私有)
                End If
                strKey = !系统 & "_" & !模块
            ...
            End If
            strParType = GetParaType(Val(Nvl(!模块)), Val(Nvl(!私有)), Val(Nvl(!本机)), 0)
        ...
        ElseIf ctInput = CT_Module Then
            ...
            Else
                ...
                Else
                    ...
                    .Filter = strOldFilter
                End If
                arrParType = Array("公共全局", "私有全局", "公共模块", "私有模块", "本机公共模块", "本机私有模块")
                ...
                If blnShowFixed And Not blnMuiltRow Then '全部是固定参数，则固定参数显示勾选
                    ...
                    End If
                End If
                '所有参数类型,"公共全局","私有全局","公共模块","私有模块","本机公共模块","本机私有模块"
...
Private Function LoadParas() As Boolean
    ...
    With vsPara
        ...
        For i = 1 To mrsPars.RecordCount
            ...
            .TextMatrix(i, .ColIndex("参数说明")) = Nvl(mrsPars!参数说明)
...
Private Function LoadDetailParas(ByVal lng参数id As Long, Optional blnSearch As Boolean = False) As Boolean
    ...
    '-----------------------------------------------------------------------------------------------------------
    Dim i As Long
    Dim int本机 As Integer, int私有 As Integer, strOwner As String
    
    If blnSearch And mrsDetailParas Is Nothing Then
        mstrOwner = ""
        Set mrsDetailParas = GetDetailParas(lng参数id, mrsSys, 0, int本机, int私有, mstrOwner)
        fraDetaisModi.Tag = int本机 & "," & int私有
    End If
...
Private Sub vsPara_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    ...
    With vsPara
        cmdModify.Enabled = Not (Val(.TextMatrix(.Row, .ColIndex("Fixed"))) = 1)
        ...
        End If
        '填充参数说明信息
        vsParaInfo.Cell(flexcpFontBold, PR_参数说明, 0, PR_参数说明, 0) = True
        vsParaInfo.Cell(flexcpText, PR_参数说明, 1, PR_参数说明, 1) = "" '清空上次信息
        vsParaInfo.TextMatrix(PR_参数说明, 1) = .TextMatrix(.Row, .ColIndex("参数说明"))
        Call vsParaInfo.AutoSize(1)
