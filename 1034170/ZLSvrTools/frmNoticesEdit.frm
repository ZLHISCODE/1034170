...
Begin VB.Form frmNoticesEdit 
   ...
   Begin TabDlg.SSTab tbs 
      ...
      Tab(1).Control(1)=   "lbl(2)"
      Tab(1).Control(2)=   "lbl(5)"
      Tab(1).Control(3)=   "lvwDept"
      Tab(1).Control(4)=   "lvwStation"
      Tab(1).Control(5)=   "lvwHuman"
      Tab(1).Control(6)=   "chk(4)"
      Tab(1).Control(7)=   "cmdRemove(2)"
      Tab(1).Control(8)=   "cmdAdd(2)"
      Tab(1).Control(9)=   "cmdRemove(1)"
      Tab(1).Control(10)=   "cmdAdd(1)"
      Tab(1).Control(11)=   "Frame1"
      Tab(1).Control(12)=   "Frame2"
      Tab(1).Control(13)=   "cmdRemove(0)"
      Tab(1).Control(14)=   "cmdAdd(0)"
      Tab(1).Control(15)=   "Frame3"
      Tab(1).Control(16)=   "Frame4"
      Tab(1).Control(17)=   "chk(1)"
