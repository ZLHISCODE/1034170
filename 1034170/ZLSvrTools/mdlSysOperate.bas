...
'返回：检查并修复是否成功
    ...
    If gcllMustObj Is Nothing Then
        ...
        'zlOptions表参数值字段长度由100变为500
        Set objCurent = objGetTmp.GetObject("参数值", OT_FildLength, "Alter Table zltools.zlOptions Modify 参数值 Varchar2(500)", , objGetTmp.GetObject("zlOptions", OT_Table), , 500)
        gcllMustObj.Add objCurent, UCase("ZLTOOLS|zlOptions|参数值")
    End If
