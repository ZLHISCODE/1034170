        ...
        If mlngSys = 0 Then '非应用系统授权
            ...
            Select Case cmbSystem.Text
                Case "基础编码"
                    ...
                    mrsTable.Filter = "": mrsTable.Sort = "系统,表名"
                    With mrsTable
                        Do While Not .EOF
                            If strPre <> !系统 & "" Then
...
'                            End If
                ...
                Case "取数函数"
                    ...
                    mrsFunction.Filter = "": mrsFunction.Sort = "系统,函数名"
                    With mrsFunction
                        Do While Not .EOF
                            If strPre <> !系统 & "" Then
                                Set objNode = tvwMenu(MT_模块).Nodes.Add(, , "K_" & !系统, "【" & !系统 & "】" & !系统名, "分类", "分类_选中")
...
'                            End If
                ...
                Case "基础工具", "自定义报表"
                    ...
                    mrsModsInfo.Filter = "系统=0 And " & IIf(cmbSystem.Text = "基础工具", "序号<100", "序号 >=100")
                    mrsModsInfo.Sort = "序号"
                    With mrsModsInfo
                        Do While Not .EOF
...
Private Sub cmdOK_Click()
    ...
    If mclsPrivilege.InitPrivilege("", mstrRole, mrsModule, mrsTable, mrsFunction) Then
        '一、清除**********************************************************************************************************
