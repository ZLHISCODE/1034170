...
Private Sub cmdOK_Click()
    ...
    If svrCreate(lblSqlFile.Caption) = True Then
        MsgBox "管理工具成功创建！", vbInformation, "提示"
    ...
    Else
        ...
        Call UnInstall(Me, False, stbThis, "ZLTOOLS", lblTmpName.Caption & "," & lblTbsName.Caption, 0)
        Me.txtPwd.Enabled = True
        fraTbs.Enabled = True
        cmdSqlFile.Enabled = True
        cmdRegFile.Enabled = True
...
Private Function svrCreate(strSqlFile As String) As Boolean
    ...
    gcnOracle.Execute "grant ADMINISTER DATABASE Trigger To ZLTOOLS"
    ...
    With mclsRunScript
        ...
        Do While Not mclsRunScript.EOF
            ...
            If pgbState.value > 90 Then
                Debug.Print ""
            End If
            cnTools.Execute .SQLInfo.ExecSQL
            If err <> 0 Then
