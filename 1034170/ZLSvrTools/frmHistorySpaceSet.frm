...
Begin VB.Form frmHistorySpaceSet 
   ...
   Begin VB.Frame fraDelete 
      ...
      Begin VB.Image Image4 
         Height          =   525
         Left            =   120
         Picture         =   "frmHistorySpaceSet.frx":058A
         Stretch         =   -1  'True
         Top             =   720
         Width           =   540
      End
   ...
   Begin VB.Frame fraMerge 
      ...
      Begin VB.Image Image6 
         Height          =   480
         Left            =   360
         Picture         =   "frmHistorySpaceSet.frx":160C
         Top             =   840
         Width           =   480
      End
   End
   Begin VB.Frame fraSetup 
      ...
      Begin VB.Frame fra 
         ...
         Begin VB.TextBox txtDbaServer 
            ...
            MaxLength       =   200
            TabIndex        =   10
            ToolTipText     =   $"frmHistorySpaceSet.frx":49EE
            Top             =   1410
            Width           =   1635
         End
      ...
      Begin VB.Image Image1 
         Height          =   480
         Left            =   240
         Picture         =   "frmHistorySpaceSet.frx":4A96
         Top             =   720
         Width           =   480
      End
      Begin VB.Label lbl 
   ...
   Begin VB.Frame fraImport 
      ...
      Begin VB.Image Image5 
         Height          =   480
         Left            =   360
         Picture         =   "frmHistorySpaceSet.frx":6E08
         Top             =   840
         Width           =   480
      End
   ...
   Begin VB.Frame fraSetup 
      ...
      Begin TabDlg.SSTab tbHistory 
         ...
         TabHeight       =   520
         TabCaption(0)   =   "常规"
         TabPicture(0)   =   "frmHistorySpaceSet.frx":A1EA
         ...
         TabCaption(1)   =   "数据文件"
         TabPicture(1)   =   "frmHistorySpaceSet.frx":A206
         ...
         Begin VB.Image Image3 
            Height          =   480
            Left            =   240
            Picture         =   "frmHistorySpaceSet.frx":B2A4
            Top             =   600
            Width           =   480
         End
         Begin VB.Label lbl 
   ...
   Begin VB.Frame fraTrans 
      ...
      Begin MSComctlLib.ImageList imgSys 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmHistorySpaceSet.frx":E686
               Key             =   "Other"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmHistorySpaceSet.frx":F718
               Key             =   "Run"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmHistorySpaceSet.frx":12B0A
               Key             =   "Lock"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmHistorySpaceSet.frx":15EFC
               Key             =   "LockAndRun"
            EndProperty
         EndProperty
      End
      ...
      Begin VB.Image Image7 
         Height          =   525
         Left            =   180
         Picture         =   "frmHistorySpaceSet.frx":192EE
         Stretch         =   -1  'True
         Top             =   720
         Width           =   540
      End
...
Private Sub Form_Load()
    ...
    HookDefend txtBakPWD.hwnd
    HookDefend txtDba口令.hwnd
