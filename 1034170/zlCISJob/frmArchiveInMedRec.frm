      ...
      Begin VB.Frame fraBack 
         ...
         Begin VB.Frame fraInfo 
            ...
            Begin VB.Frame fraAdvEvent 
               ...
               Begin VB.ListBox lstAdvEvent 
                  Height          =   960
                  ItemData        =   "frmArchiveInMedRec.frx":0C28
                  Left            =   120
                  List            =   "frmArchiveInMedRec.frx":0C2A
                  TabIndex        =   294
                  Top             =   240
                  Width           =   3405
               End
            ...
            Begin VB.Frame fraInfection 
               ...
               Begin VB.ListBox lstInfection 
                  Height          =   1320
                  ItemData        =   "frmArchiveInMedRec.frx":0C2C
                  Left            =   120
                  List            =   "frmArchiveInMedRec.frx":0C2E
                  TabIndex        =   292
                  Top             =   240
                  Width           =   3405
               End
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsFlxAddICU 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"frmArchiveInMedRec.frx":0C30
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsTSJC 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"frmArchiveInMedRec.frx":0CE6
               ScrollTrack     =   -1  'True
               ScrollBars      =   0
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame fraInfo 
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsKSS 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"frmArchiveInMedRec.frx":0D54
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsSpirit 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"frmArchiveInMedRec.frx":0E3B
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame fraInfo 
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsChemotherapy 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"frmArchiveInMedRec.frx":0EFB
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsRadiotherapy 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"frmArchiveInMedRec.frx":1011
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame fraInfo 
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsOPS 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"frmArchiveInMedRec.frx":1137
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsAller 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"frmArchiveInMedRec.frx":12DB
               ScrollTrack     =   -1  'True
               ScrollBars      =   0
               ScrollTips      =   0   'False
               MergeCells      =   0
...
'功能：刷新或清除医嘱清单
    ...
    If Not mbln共享 Then
        fraInfo(FRA_特定药品).Height = vsKSS.Top + vsKSS.Height + 90
        fraInfo(FRA_特定药品).Tag = fraInfo(FRA_特定药品).Height
        lblInfo(126).Visible = False
        vsSpirit.Visible = False
    End If
...
Private Sub vsSpirit_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    Call vsSpirit.ShowCell(NewRow, NewCol)
End Sub
...
'功能：读取病人的首页信息
    ...
    For i = 1 To rsTmp.RecordCount
        Select Case UCase(Nvl(rsTmp!信息名))
            ...
            Case "感染与死亡关系"
                txtInfo(txt感染与死亡).Text = Nvl(rsTmp!信息值, " ")
            Case "感染部位"
                arrTmp = Split(Nvl(rsTmp!信息值), "|")
                strTmp = ""
                For j = LBound(arrTmp) To UBound(arrTmp)
                    If arrTmp(j) <> "" Then
                        strTmp = strTmp & IIf(strTmp = "", "", ",") & arrTmp(j)
                    End If
                Next j
                txtInfo(txt感染部位).Text = strTmp
            Case Else
                '多个抗生素名称
...
Private Function Load精神(ByVal lng病人ID As Long, lng主页ID As Long) As Boolean
    ...
    With rsTemp
        If .RecordCount = 0 Then
            vsSpirit.Rows = 2
        Else
            vsSpirit.Rows = .RecordCount + 1
        End If
        i = 1
        Do While Not .EOF
            vsSpirit.TextMatrix(i, C_药物名称) = Nvl(!药物名称)
            vsSpirit.TextMatrix(i, C_疗程) = Nvl(!疗程)
            vsSpirit.TextMatrix(i, C_最高日量) = Nvl(!最高日量)
            vsSpirit.TextMatrix(i, C_特殊反应) = Nvl(!特殊反应)
            vsSpirit.TextMatrix(i, C_疗效) = Nvl(!疗效)
            i = i + 1
            .MoveNext
        Loop
    End With
...
Private Function Load附页内容(ByVal lng病人ID As Long, ByVal lng主页ID As Long) As Boolean
    ...
    With vsFlxAddICU
        ...
        lngRow = 1
        Do While Not rsTemp.EOF
            .TextMatrix(lngRow, 0) = Nvl(rsTemp!监护室名称)
            .TextMatrix(lngRow, 1) = Nvl(rsTemp!进入时间)
            .TextMatrix(lngRow, 2) = Nvl(rsTemp!退出时间)
            lngRow = lngRow + 1
            rsTemp.MoveNext
        Loop
    End With
