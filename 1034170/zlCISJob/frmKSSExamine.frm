...
Begin VB.Form frmKSSExamine 
   Caption         =   "抗菌用药审核"
   ClientHeight    =   10935
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   15165
   Icon            =   "frmKSSExamine.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   10935
   ScaleWidth      =   15165
   ...
   Begin VB.PictureBox picUnAudited 
      ...
      Begin VSFlex8Ctl.VSFlexGrid vsAudit 
         ...
         FormatString    =   $"frmKSSExamine.frx":6852
         ScrollTrack     =   -1  'True
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      _ExtentX        =   26749
      _ExtentY        =   635
      SimpleText      =   $"frmKSSExamine.frx":68ED
      _Version        =   393216
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmKSSExamine.frx":6934
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmKSSExamine.frx":71C8
            Key             =   "Male"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmKSSExamine.frx":DA2A
            Key             =   "feMale"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmKSSExamine.frx":1428C
            Key             =   "unCheck"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmKSSExamine.frx":14826
            Key             =   "Check"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imgAdvice 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   3
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmKSSExamine.frx":14DC0
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmKSSExamine.frx":1535A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmKSSExamine.frx":158F4
            Key             =   "签名"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmKSSExamine"
...
'共公接口
    ...
    Call frmKSSExamine.Show(0, frmParent)
...
'加载权限比操作员低的医生
    ...
    If tbcSub.Selected.Tag = "待审核" Then
        ...
        strTmp = ",(Select Distinct 开嘱医生 From 病人医嘱记录 F Where  f.审核状态 = 1 and f.医嘱状态=1 And F.开嘱时间 Between [4] And [5] And f.诊疗类别 In ('5','6')) F"
    Else
    ...
    StrSQL = "Select DISTINCT a.Id, A.性别" & IIf(Val(cboDept.ItemData(cboDept.ListIndex)) = -1, "", ",b.部门ID,e.名称 as 所属部门") & ",a.姓名,a.专业技术职务,Decode(c.级别,1,'非限制使用',2,'限制使用',3,'特殊使用','无使用权限') as 抗菌用药权限, Upper(zlSpellCode(a.姓名)) As 拼音简码, Upper(Zlwbcode(a.姓名)) As 五笔简码" & vbNewLine & _
            "From 人员表 A, 部门人员 B, 人员抗菌药物权限 C, 人员性质说明 D,部门表 E" & IIf(chkIsShowAll.Value, strTmp, "") & vbNewLine & _
            "Where c.人员id(+) = a.Id And a.Id = b.人员id And e.ID=b.部门ID And d.人员id = a.Id And C.场合=[3] And d.人员性质 = '医生' And " & vbNewLine & _
            "      (a.撤档时间 = To_Date('3000-01-01', 'YYYY-MM-DD') Or a.撤档时间 Is Null) And" & vbNewLine & _
            "      (((c.记录状态 = 1 And c.级别 <[1]) Or (c.人员id Is Null))) " & IIf(Val(cboDept.ItemData(cboDept.ListIndex)) = -1, "", "And b.部门id=[2]") & _
    ...
    Set rsTmp = zlDatabase.OpenSQLRecord(StrSQL, Me.Caption, mlngLevel, Val(cboDept.ItemData(cboDept.ListIndex)), IIf(optOccasion(0).Value, 1, 2), datBegint, datEnd)
...
Private Sub Form_Load()
    ...
    'vsFlexGrid
    '-----------------------------------------------------
    strHead = ",450,1; ;审核说明,2560,1;审核时间;病人姓名,1000,1;医嘱内容,3500,1;用药目的,1050,1;用药理由,2500,1;期效,500,1;总量;单量;频率,1350,1;给药途径,1350,1;开始时间,2000,1;执行时间方案,1350,1;医嘱ID;相关ID;性别;年龄;体重;入院时间;床号;组号;病况;护理等级;病人ID;主页ID;挂号单;组ID;诊疗类别;病人来源;挂号单据;签名id;医嘱状态"
...
'参数：是否加载已审核医嘱,为空为加载待审核医嘱
    ...
    StrSQL = "Select a.Id, a.相关id, Nvl(a.相关id, a.Id) As 组id, Nvl(x.序号, a.序号) As 组号, a.诊疗类别, Null As 选择, Null As 输入, A.姓名, p.当前床号 As 床号," & vbNewLine & _
            ...
            " And a.医嘱状态 = 1 And a.审核状态 = 1 ") & vbNewLine & _
