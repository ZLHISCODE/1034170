...
'功能：取上一次的日期范围从注册表中取
    ...
    If strTmp <> "" Then
        If strTmp <> dtpRPS(e_R0_dtpRPS_开始时间_0).Value & "," & dtpRPE(e_R0_dtpRPE_结束时间_0).Value Then
            ...
            Call zlControl.CboLocate(cboTimRP(e_R0_dtpRPS_开始时间_0), "自定义", False)
        End If
    End If
    ...
    If strTmp <> "" Then
        If strTmp <> dtpRPS(e_R1_dtpRPS_开始时间_1).Value & "," & dtpRPE(e_R1_dtpRPE_结束时间_1).Value Then
            ...
            Call zlControl.CboLocate(cboTimRP(e_R1_dtpRPS_开始时间_1), "自定义", False)
        End If
    End If
    ...
    If strTmp <> "" Then
        If strTmp <> dtpRPS(e_R2_dtpRPS_开始时间_2).Value & "," & dtpRPE(e_R2_dtpRPE_结束时间_2).Value Then
            ...
            Call zlControl.CboLocate(cboTimRP(e_R2_dtpRPS_开始时间_2), "自定义", False)
        End If
    End If
    ...
    If strTmp <> "" Then
        If strTmp <> dtpRPS(e_R3_dtpRPS_开始时间_3).Value & "," & dtpRPE(e_R3_dtpRPE_结束时间_3).Value Then
            ...
            Call zlControl.CboLocate(cboTimRP(e_R3_dtpRPS_开始时间_3), "自定义", False)
        End If
    End If
    ...
    If strTmp <> "" Then
        If strTmp <> dtpCountS(e_C0_dtpCountS_开始时间_0).Value & "," & dtpCountE(e_C0_dtpCountE_结束时间_0).Value Then
            ...
            Call zlControl.CboLocate(cboTimCount(e_C0_dtpCountS_开始时间_0), "自定义", False)
        End If
    End If
    ...
    If strTmp <> "" Then
        If strTmp <> dtpCountS(e_C1_dtpCountS_开始时间_1).Value & "," & dtpCountE(e_C1_dtpCountE_结束时间_1).Value Then
            ...
            Call zlControl.CboLocate(cboTimCount(e_C1_dtpCountS_开始时间_1), "自定义", False)
        End If
    End If
    ...
    If strTmp <> "" Then
        If strTmp <> dtpCountS(e_C2_dtpCountS_开始时间_2).Value & "," & dtpCountE(e_C2_dtpCountE_结束时间_2).Value Then
            ...
            Call zlControl.CboLocate(cboTimCount(e_C2_dtpCountS_开始时间_2), "自定义", False)
        End If
    End If
    ...
    If strTmp <> "" Then
        If strTmp <> dtpCountS(e_C3_dtpCountS_开始时间_3).Value & "," & dtpCountE(e_C3_dtpCountE_结束时间_3).Value Then
            ...
            Call zlControl.CboLocate(cboTimCount(e_C3_dtpCountS_开始时间_3), "自定义", False)
        End If
    End If
    ...
    If strTmp <> "" Then
        If strTmp <> dtpCountS(e_C4_dtpCountS_开始时间_4).Value & "," & dtpCountE(e_C4_dtpCountE_结束时间_4).Value Then
            ...
            Call zlControl.CboLocate(cboTimCount(e_C4_dtpCountS_开始时间_4), "自定义", False)
        End If
    End If
    ...
    If strTmp <> "" Then
        If strTmp <> dtpCountS(e_C5_dtpCountS_开始时间_5).Value & "," & dtpCountE(e_C5_dtpCountE_结束时间_5).Value Then
            ...
            Call zlControl.CboLocate(cboTimCount(e_C5_dtpCountS_开始时间_5), "自定义", False)
        End If
    End If
...
Private Sub InitTimeList()
    ...
    With cboTimRP(e_R0_cboTimRP_统计时间_0)
        ...
        .AddItem "自定义"
    End With
    Call zlControl.CboLocate(cboTimRP(e_R0_cboTimRP_统计时间_0), lngTmp & "年", False)
...
Private Sub dtpRPE_Change(Index As Integer)
    Call zlControl.CboLocate(cboTimRP(Index), "自定义", False)
End Sub
...
Private Sub dtpCountE_Change(Index As Integer)
    Call zlControl.CboLocate(cboTimCount(Index), "自定义", False)
End Sub
...
'功能：加载   住院医嘱抗菌用药统计  界面表格数据加载
    ...
    '取首页的第一条出院诊断，包括中西医
    strSQL = "select a.病人id,a.主页id,a.诊断描述 as 诊断 from 病人诊断记录 a where a.记录来源=3 and a.诊断次序=1 and a.诊断类型 in (3,13) and (a.病人id,a.主页id) In (" & strTable & ")"
            ...
            If Not vsgCopy.ColHidden(i) Then
                ...
                For j = 0 To vsgCopy.Rows - 1 '行
                    If Not vsgCopy.RowHidden(j) Then
                        .ColAlignment(i) = vsgCopy.ColAlignment(i)
