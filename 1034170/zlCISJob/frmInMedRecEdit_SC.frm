...
Begin VB.Form frmInMedRecEdit_SC 
   ...
   ClientTop       =   330
   ClientWidth     =   11085
   Icon            =   "frmInMedRecEdit_SC.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   7695
   ...
   Begin TabDlg.SSTab sstInfo 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "基本信息"
      TabPicture(0)   =   "frmInMedRecEdit_SC.frx":058A
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "fraInfo(0)"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "西医诊断"
      TabPicture(1)   =   "frmInMedRecEdit_SC.frx":05A6
      Tab(1).ControlEnabled=   -1  'True
      Tab(1).Control(0)=   "fraInfo(1)"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "picInfectInfo"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).ControlCount=   2
      TabCaption(2)   =   "中医诊断"
      TabPicture(2)   =   "frmInMedRecEdit_SC.frx":05C2
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "fraInfo(2)"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "过敏与手术"
      TabPicture(3)   =   "frmInMedRecEdit_SC.frx":05DE
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "fraInfo(3)"
      Tab(3).ControlCount=   1
      TabCaption(4)   =   "住院情况"
      TabPicture(4)   =   "frmInMedRecEdit_SC.frx":05FA
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "fraInfo(4)"
      Tab(4).ControlCount=   1
      TabCaption(5)   =   "放疗与化疗"
      TabPicture(5)   =   "frmInMedRecEdit_SC.frx":0616
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "fraInfo(5)"
      Tab(5).ControlCount=   1
      TabCaption(6)   =   "附页1"
      TabPicture(6)   =   "frmInMedRecEdit_SC.frx":0632
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "fraInfo(6)"
      Tab(6).ControlCount=   1
      TabCaption(7)   =   "附页2"
      TabPicture(7)   =   "frmInMedRecEdit_SC.frx":064E
      ...
      Begin VB.PictureBox picInfectInfo 
         ...
         Begin VB.ComboBox cboinfo 
            Height          =   300
            Index           =   61
            ItemData        =   "frmInMedRecEdit_SC.frx":066A
            Left            =   1920
            List            =   "frmInMedRecEdit_SC.frx":066C
            Style           =   2  'Dropdown List
            TabIndex        =   120
            Top             =   120
            Width           =   1695
         End
         Begin MSComctlLib.ListView lvwInfectParts 
            Height          =   2535
            Left            =   240
            TabIndex        =   122
            Top             =   840
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   30
            ItemData        =   "frmInMedRecEdit_SC.frx":066E
            Left            =   5880
            List            =   "frmInMedRecEdit_SC.frx":0670
            Style           =   2  'Dropdown List
            TabIndex        =   318
            Top             =   600
            Width           =   1500
         ...
         Begin VB.Frame fraAdvEvent 
            ...
            Begin VB.ComboBox cboinfo 
               ...
               IMEMode         =   3  'DISABLE
               Index           =   47
               ItemData        =   "frmInMedRecEdit_SC.frx":0672
               Left            =   1440
               List            =   "frmInMedRecEdit_SC.frx":0674
               Style           =   2  'Dropdown List
               TabIndex        =   315
               Top             =   2160
               Width           =   2775
            ...
            Begin VB.ComboBox cboinfo 
               ...
               IMEMode         =   3  'DISABLE
               Index           =   48
               ItemData        =   "frmInMedRecEdit_SC.frx":0676
               Left            =   1440
               List            =   "frmInMedRecEdit_SC.frx":0678
               Style           =   2  'Dropdown List
               TabIndex        =   316
               Top             =   2520
               Width           =   2775
            ...
            Begin VB.ComboBox cboinfo 
               ...
               IMEMode         =   3  'DISABLE
               Index           =   45
               ItemData        =   "frmInMedRecEdit_SC.frx":067A
               Left            =   1440
               List            =   "frmInMedRecEdit_SC.frx":067C
               Style           =   2  'Dropdown List
               TabIndex        =   313
               Top             =   1800
               Width           =   1335
            ...
            Begin VB.ComboBox cboinfo 
               ...
               IMEMode         =   3  'DISABLE
               Index           =   46
               ItemData        =   "frmInMedRecEdit_SC.frx":067E
               Left            =   3315
               List            =   "frmInMedRecEdit_SC.frx":0680
               Style           =   2  'Dropdown List
               TabIndex        =   314
               Top             =   1800
               Width           =   900
            ...
            Begin VB.ListBox lstAdvEvent 
               Height          =   1530
               ItemData        =   "frmInMedRecEdit_SC.frx":0682
               Left            =   120
               List            =   "frmInMedRecEdit_SC.frx":0689
               Style           =   1  'Checkbox
               TabIndex        =   312
               Top             =   240
               Width           =   4125
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsKSS 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_SC.frx":069B
            ScrollTrack     =   -1  'True
            ScrollBars      =   2
            ScrollTips      =   0   'False
            MergeCells      =   0
            ...
            AccessibleRole  =   24
         End
         Begin VSFlex8Ctl.VSFlexGrid vsFlx附页重症 
            Height          =   1305
            Left            =   120
            TabIndex        =   307
            Top             =   2040
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_SC.frx":07B1
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsInfect 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_SC.frx":08A0
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsSample 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_SC.frx":092E
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
            ...
            AccessibleRole  =   24
         End
         Begin VSFlex8Ctl.VSFlexGrid vsFlx器械和导管 
            Height          =   1275
            Left            =   120
            TabIndex        =   308
            Top             =   3720
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_SC.frx":09BC
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VSFlex8Ctl.VSFlexGrid vs化疗 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_SC.frx":0AC4
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vs放疗 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_SC.frx":0BF1
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VB.CommandButton cmdMove 
            ...
            Index           =   1
            Left            =   5400
            Picture         =   "frmInMedRecEdit_SC.frx":0D18
            Style           =   1  'Graphical
            TabIndex        =   387
            ToolTipText     =   "诊断下移"
            Top             =   0
         ...
         Begin VB.CommandButton cmdMove 
            ...
            Index           =   0
            Left            =   4800
            Picture         =   "frmInMedRecEdit_SC.frx":11C9
            Style           =   1  'Graphical
            TabIndex        =   386
            ToolTipText     =   "诊断上移"
            Top             =   0
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   58
            ItemData        =   "frmInMedRecEdit_SC.frx":1682
            Left            =   8760
            List            =   "frmInMedRecEdit_SC.frx":1684
            Style           =   2  'Dropdown List
            TabIndex        =   140
            Top             =   4425
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   31
            ItemData        =   "frmInMedRecEdit_SC.frx":1686
            Left            =   1410
            List            =   "frmInMedRecEdit_SC.frx":1688
            Style           =   2  'Dropdown List
            TabIndex        =   142
            Top             =   4770
            Width           =   1470
         ...
         Begin VB.CommandButton cmdInfo 
            ...
            Index           =   27
            Left            =   9950
            Picture         =   "frmInMedRecEdit_SC.frx":168A
            Style           =   1  'Graphical
            TabIndex        =   357
            TabStop         =   0   'False
            ToolTipText     =   "选择(F4)"
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   34
            ItemData        =   "frmInMedRecEdit_SC.frx":1780
            Left            =   5010
            List            =   "frmInMedRecEdit_SC.frx":1782
            Style           =   2  'Dropdown List
            TabIndex        =   144
            Top             =   4770
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   32
            ItemData        =   "frmInMedRecEdit_SC.frx":1784
            Left            =   4650
            List            =   "frmInMedRecEdit_SC.frx":1786
            Style           =   2  'Dropdown List
            TabIndex        =   155
            Top             =   5610
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   53
            ItemData        =   "frmInMedRecEdit_SC.frx":1788
            Left            =   8760
            List            =   "frmInMedRecEdit_SC.frx":178A
            Style           =   2  'Dropdown List
            TabIndex        =   134
            Top             =   4080
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   52
            ItemData        =   "frmInMedRecEdit_SC.frx":178C
            Left            =   5010
            List            =   "frmInMedRecEdit_SC.frx":178E
            Style           =   2  'Dropdown List
            TabIndex        =   132
            Top             =   4080
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   33
            ItemData        =   "frmInMedRecEdit_SC.frx":1790
            Left            =   8760
            List            =   "frmInMedRecEdit_SC.frx":1792
            Style           =   2  'Dropdown List
            TabIndex        =   146
            Top             =   4770
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   35
            ItemData        =   "frmInMedRecEdit_SC.frx":1794
            Left            =   5010
            List            =   "frmInMedRecEdit_SC.frx":1796
            Style           =   2  'Dropdown List
            TabIndex        =   138
            Top             =   4425
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   36
            ItemData        =   "frmInMedRecEdit_SC.frx":1798
            Left            =   1410
            List            =   "frmInMedRecEdit_SC.frx":179A
            Style           =   2  'Dropdown List
            TabIndex        =   136
            Top             =   4425
            Width           =   1470
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDiagXY 
            ...
            FormatString    =   $"frmInMedRecEdit_SC.frx":179C
            ScrollTrack     =   -1  'True
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsOPS 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmInMedRecEdit_SC.frx":1969
            ScrollTrack     =   -1  'True
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsAller 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_SC.frx":1CC1
            ScrollTrack     =   -1  'True
            ScrollBars      =   2
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VB.CommandButton cmdMove 
            ...
            Index           =   3
            Left            =   5760
            Picture         =   "frmInMedRecEdit_SC.frx":1D58
            Style           =   1  'Graphical
            TabIndex        =   389
            ToolTipText     =   "诊断下移"
            Top             =   0
         ...
         Begin VB.CommandButton cmdMove 
            ...
            Index           =   2
            Left            =   5160
            Picture         =   "frmInMedRecEdit_SC.frx":2209
            Style           =   1  'Graphical
            TabIndex        =   388
            ToolTipText     =   "诊断上移"
            Top             =   0
         ...
         Begin VB.Frame fraSub 
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   2
               ItemData        =   "frmInMedRecEdit_SC.frx":26C2
               Left            =   825
               List            =   "frmInMedRecEdit_SC.frx":26C4
               Style           =   2  'Dropdown List
               TabIndex        =   179
               Top             =   270
               Width           =   1455
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   11
               ItemData        =   "frmInMedRecEdit_SC.frx":26C6
               Left            =   825
               List            =   "frmInMedRecEdit_SC.frx":26C8
               Style           =   2  'Dropdown List
               TabIndex        =   181
               Top             =   720
               Width           =   1455
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   12
               ItemData        =   "frmInMedRecEdit_SC.frx":26CA
               Left            =   825
               List            =   "frmInMedRecEdit_SC.frx":26CC
               Style           =   2  'Dropdown List
               TabIndex        =   183
               Top             =   1140
               Width           =   1455
         ...
         Begin VB.Frame fraSub 
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   57
               ItemData        =   "frmInMedRecEdit_SC.frx":26CE
               Left            =   4530
               List            =   "frmInMedRecEdit_SC.frx":26D0
               Style           =   2  'Dropdown List
               TabIndex        =   196
               Top             =   1140
               Width           =   1410
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   56
               ItemData        =   "frmInMedRecEdit_SC.frx":26D2
               Left            =   4530
               List            =   "frmInMedRecEdit_SC.frx":26D4
               Style           =   2  'Dropdown List
               TabIndex        =   194
               Top             =   705
               Width           =   1410
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   55
               ItemData        =   "frmInMedRecEdit_SC.frx":26D6
               Left            =   4530
               List            =   "frmInMedRecEdit_SC.frx":26D8
               Style           =   2  'Dropdown List
               TabIndex        =   192
               Top             =   240
               Width           =   1410
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   13
               ItemData        =   "frmInMedRecEdit_SC.frx":26DA
               Left            =   1575
               List            =   "frmInMedRecEdit_SC.frx":26DC
               Style           =   2  'Dropdown List
               TabIndex        =   190
               Top             =   1140
               Width           =   1410
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   14
               ItemData        =   "frmInMedRecEdit_SC.frx":26DE
               Left            =   1215
               List            =   "frmInMedRecEdit_SC.frx":26E0
               Style           =   2  'Dropdown List
               TabIndex        =   188
               Top             =   705
               Width           =   1410
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   15
               ItemData        =   "frmInMedRecEdit_SC.frx":26E2
               Left            =   1215
               List            =   "frmInMedRecEdit_SC.frx":26E4
               Style           =   2  'Dropdown List
               TabIndex        =   186
               Top             =   270
               Width           =   1410
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   37
            ItemData        =   "frmInMedRecEdit_SC.frx":26E6
            Left            =   4335
            List            =   "frmInMedRecEdit_SC.frx":26E8
            Style           =   2  'Dropdown List
            TabIndex        =   172
            Top             =   4035
            Width           =   1395
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   38
            ItemData        =   "frmInMedRecEdit_SC.frx":26EA
            Left            =   1470
            List            =   "frmInMedRecEdit_SC.frx":26EC
            Style           =   2  'Dropdown List
            TabIndex        =   170
            Top             =   4035
            Width           =   1395
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDiagZY 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmInMedRecEdit_SC.frx":26EE
            ScrollTrack     =   -1  'True
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VB.CommandButton cmdInfo 
            ...
            Index           =   69
            Left            =   9015
            Picture         =   "frmInMedRecEdit_SC.frx":2888
            Style           =   1  'Graphical
            TabIndex        =   371
            TabStop         =   0   'False
            ToolTipText     =   "选择(F4)"
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsCheck 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_SC.frx":297E
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   59
            ItemData        =   "frmInMedRecEdit_SC.frx":29F5
            Left            =   7860
            List            =   "frmInMedRecEdit_SC.frx":29F7
            Style           =   2  'Dropdown List
            TabIndex        =   292
            Top             =   5614
            Width           =   1425
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   41
            ItemData        =   "frmInMedRecEdit_SC.frx":29F9
            Left            =   1575
            List            =   "frmInMedRecEdit_SC.frx":29FB
            Style           =   2  'Dropdown List
            TabIndex        =   208
            Top             =   1305
            Width           =   1380
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   16
            ItemData        =   "frmInMedRecEdit_SC.frx":29FD
            Left            =   9480
            List            =   "frmInMedRecEdit_SC.frx":29FF
            Locked          =   -1  'True
            Style           =   2  'Dropdown List
            TabIndex        =   253
            TabStop         =   0   'False
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   21
            ItemData        =   "frmInMedRecEdit_SC.frx":2A01
            Left            =   7860
            List            =   "frmInMedRecEdit_SC.frx":2A03
            TabIndex        =   280
            Top             =   4900
            Width           =   1425
         End
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   44
            ItemData        =   "frmInMedRecEdit_SC.frx":2A05
            Left            =   1260
            List            =   "frmInMedRecEdit_SC.frx":2A07
            Style           =   2  'Dropdown List
            TabIndex        =   247
            Top             =   2925
            Width           =   1500
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   19
            ItemData        =   "frmInMedRecEdit_SC.frx":2A09
            Left            =   1260
            List            =   "frmInMedRecEdit_SC.frx":2A0B
            TabIndex        =   277
            Top             =   4900
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   18
            ItemData        =   "frmInMedRecEdit_SC.frx":2A0D
            Left            =   1575
            List            =   "frmInMedRecEdit_SC.frx":2A0F
            Style           =   2  'Dropdown List
            TabIndex        =   206
            Top             =   921
            Width           =   1380
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   43
            ItemData        =   "frmInMedRecEdit_SC.frx":2A11
            Left            =   1575
            List            =   "frmInMedRecEdit_SC.frx":2A13
            Style           =   2  'Dropdown List
            TabIndex        =   202
            Top             =   165
            Width           =   1380
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   50
            ItemData        =   "frmInMedRecEdit_SC.frx":2A15
            Left            =   1260
            List            =   "frmInMedRecEdit_SC.frx":2A17
            TabIndex        =   300
            Top             =   6330
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   17
            ItemData        =   "frmInMedRecEdit_SC.frx":2A19
            Left            =   1575
            List            =   "frmInMedRecEdit_SC.frx":2A1B
            Style           =   2  'Dropdown List
            TabIndex        =   204
            Top             =   543
            Width           =   1380
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   20
            ItemData        =   "frmInMedRecEdit_SC.frx":2A1D
            Left            =   4020
            List            =   "frmInMedRecEdit_SC.frx":2A1F
            TabIndex        =   279
            Top             =   4900
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   22
            ItemData        =   "frmInMedRecEdit_SC.frx":2A21
            Left            =   4020
            List            =   "frmInMedRecEdit_SC.frx":2A23
            TabIndex        =   284
            Top             =   5257
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   23
            ItemData        =   "frmInMedRecEdit_SC.frx":2A25
            Left            =   7860
            List            =   "frmInMedRecEdit_SC.frx":2A27
            TabIndex        =   285
            Top             =   5257
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   24
            ItemData        =   "frmInMedRecEdit_SC.frx":2A29
            Left            =   1260
            List            =   "frmInMedRecEdit_SC.frx":2A2B
            TabIndex        =   287
            Top             =   5614
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   25
            ItemData        =   "frmInMedRecEdit_SC.frx":2A2D
            Left            =   1260
            List            =   "frmInMedRecEdit_SC.frx":2A2F
            TabIndex        =   282
            Top             =   5257
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   26
            ItemData        =   "frmInMedRecEdit_SC.frx":2A31
            Left            =   4020
            List            =   "frmInMedRecEdit_SC.frx":2A33
            TabIndex        =   290
            Top             =   5614
            Width           =   1425
         End
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   39
            ItemData        =   "frmInMedRecEdit_SC.frx":2A35
            Left            =   4020
            List            =   "frmInMedRecEdit_SC.frx":2A37
            TabIndex        =   296
            Top             =   5971
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   40
            ItemData        =   "frmInMedRecEdit_SC.frx":2A39
            Left            =   1260
            List            =   "frmInMedRecEdit_SC.frx":2A3B
            TabIndex        =   294
            Top             =   5971
            Width           =   1425
         End
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   0
            ItemData        =   "frmInMedRecEdit_SC.frx":2A3D
            Left            =   7800
            List            =   "frmInMedRecEdit_SC.frx":2A3F
            Style           =   2  'Dropdown List
            TabIndex        =   6
            Top             =   135
            Width           =   2475
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   1
            ItemData        =   "frmInMedRecEdit_SC.frx":2A41
            Left            =   4410
            List            =   "frmInMedRecEdit_SC.frx":2A43
            Style           =   2  'Dropdown List
            TabIndex        =   10
            Top             =   615
            Width           =   1605
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   3
            ItemData        =   "frmInMedRecEdit_SC.frx":2A45
            Left            =   8535
            List            =   "frmInMedRecEdit_SC.frx":2A47
            Style           =   2  'Dropdown List
            TabIndex        =   24
            Top             =   990
            Width           =   1740
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   4
            ItemData        =   "frmInMedRecEdit_SC.frx":2A49
            Left            =   7785
            List            =   "frmInMedRecEdit_SC.frx":2A4B
            Style           =   2  'Dropdown List
            TabIndex        =   39
            Top             =   1725
            Width           =   2490
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   8
            ItemData        =   "frmInMedRecEdit_SC.frx":2A4D
            Left            =   4410
            List            =   "frmInMedRecEdit_SC.frx":2A4F
            Style           =   2  'Dropdown List
            TabIndex        =   37
            Top             =   1725
            Width           =   2250
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   9
            ItemData        =   "frmInMedRecEdit_SC.frx":2A51
            Left            =   3645
            List            =   "frmInMedRecEdit_SC.frx":2A53
            Style           =   2  'Dropdown List
            TabIndex        =   79
            Top             =   3990
            Width           =   1700
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   6
            ItemData        =   "frmInMedRecEdit_SC.frx":2A55
            Left            =   1320
            List            =   "frmInMedRecEdit_SC.frx":2A57
            TabIndex        =   52
            Top             =   2415
            Width           =   4035
         End
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   49
            ItemData        =   "frmInMedRecEdit_SC.frx":2A59
            Left            =   1320
            List            =   "frmInMedRecEdit_SC.frx":2A5B
            Style           =   2  'Dropdown List
            TabIndex        =   95
            Top             =   5535
            Width           =   1545
   ...
   Begin VB.Image imgButtonDel 
      Height          =   240
      Left            =   3240
      Picture         =   "frmInMedRecEdit_SC.frx":2A5D
      Top             =   7305
      Visible         =   0   'False
      Width           =   240
   End
   Begin VB.Image imgButtonNew 
      Height          =   240
      Left            =   4080
      Picture         =   "frmInMedRecEdit_SC.frx":92AF
      Top             =   7320
      Visible         =   0   'False
      Width           =   240
   End
...
Private mrsAdvice As ADODB.Recordset '诊断医嘱关系
...
'    If sstInfo.Tab = TAB_西医诊断 And Index <> cbo感染与死亡 And picInfectInfo.Visible Then
...
'    End If
    ...
    If cboinfo(Index).ItemData(cboinfo(Index).ListIndex) = -1 And Visible Then
        ...
        If Index = cbo门诊医师 Or Index = cbo科主任 Or Index = cbo主任医师 Or Index = cbo主治医师 Or Index = cbo住院医师 _
            Or Index = cbo实习医师 Or Index = cbo进修医师 Or Index = cbo主诊医师 Or Index = cbo质控医师 Or Index = cbo质控护士 Or Index = cbo责任护士 Then
    ...
    ElseIf Index = cbo出院方式 Then
        ...
        Else
            ...
            cmdInfo(txt出院转入).Enabled = False
            txtInfo(txt出院转入).BackColor = vbButtonFace
        End If
    ElseIf Index = cbo输液反应 Then
        If NeedName(cboinfo(Index).Text) = "有" Then
            txtInfo(txt引发药物).Enabled = True
            txtInfo(txt引发药物).TabStop = True
            txtInfo(txt引发药物).BackColor = vbWindowBackground
            txtInfo(txt临床表现).Enabled = True
            txtInfo(txt临床表现).TabStop = True
            txtInfo(txt临床表现).BackColor = vbWindowBackground
        Else
            txtInfo(txt引发药物).Enabled = False
            txtInfo(txt引发药物).TabStop = False
            txtInfo(txt引发药物).BackColor = vbButtonFace
            txtInfo(txt引发药物).Text = ""
            txtInfo(txt临床表现).Enabled = False
            txtInfo(txt临床表现).TabStop = False
            txtInfo(txt临床表现).BackColor = vbButtonFace
            txtInfo(txt临床表现).Text = ""
        End If
    End If
End Sub
...
'功能：根据输入的内容,自动匹配执行科室
    ...
    If Index = cbo门诊医师 Or Index = cbo科主任 Or Index = cbo主任医师 Or Index = cbo主治医师 Or Index = cbo住院医师 _
        Or Index = cbo实习医师 Or Index = cbo进修医师 Or Index = cbo主诊医师 Or Index = cbo质控医师 Or Index = cbo质控护士 Then
...
Private Sub chkInfo_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case chk会诊情况
            If chkInfo(Index).Value = 1 Then
                txtInfo(txt外院会诊).Enabled = True
                txtInfo(txt外院会诊).BackColor = vbWindowBackground
                txtInfo(txt院内会诊).Enabled = True
                txtInfo(txt院内会诊).BackColor = vbWindowBackground
                txtInfo(txt其他会诊).Enabled = True
                txtInfo(txt其他会诊).BackColor = vbWindowBackground
            Else
                txtInfo(txt外院会诊).Enabled = False
                txtInfo(txt外院会诊).Text = ""
                txtInfo(txt外院会诊).BackColor = vbButtonFace
                txtInfo(txt院内会诊).Enabled = False
                txtInfo(txt院内会诊).Text = ""
                txtInfo(txt院内会诊).BackColor = vbButtonFace
                txtInfo(txt其他会诊).Enabled = False
                txtInfo(txt其他会诊).Text = ""
                txtInfo(txt其他会诊).BackColor = vbButtonFace
            End If
        Case chk尸检
            '设置诊断符合情况
...
Private Sub chkInfo_GotFocus(Index As Integer)
    If sstInfo.Tab = TAB_西医诊断 And picInfectInfo.Visible Then
        Call ShowInfectInfo(False)
    End If
End Sub
    ...
    Select Case Index
        ...
        Case 1
            ...
            If InStr(strPrivs, "内部接口") > 0 Then
                lblAutoInfo.Top = cmdAutoLoad(1).Top + 90
                lblAutoInfo.Height = 300
                lblAutoInfo = "数据来源：手麻管理系统(默认)"
                Set rsTmp = AutoGetOPSInfo(True, mlng病人ID, mlng主页ID)
            Else
                If mblnHaveOPS Then
                    lblAutoInfo.Top = cmdAutoLoad(1).Top - 180
                    lblAutoInfo.Height = 540
                    lblAutoInfo = "数据来源：病人医嘱相关(没有【手麻管理系统-手麻接口管理-内部接口】权限)"
                Else
                    lblAutoInfo.Top = cmdAutoLoad(1).Top - 60
                    lblAutoInfo.Height = 480
                    lblAutoInfo = "数据来源：病人医嘱相关(未安装手麻管理系统)"
                End If
...
'说明：注意界面上要求CMD和对应TXT的Index相同
    ...
    Select Case Index
        ...
        Case txt出院转入
            ...
            On Error GoTo errH
            vPoint = GetCoordPos(txtInfo(Index).Container.hwnd, txtInfo(Index).Left, txtInfo(Index).Top)
            StrSQL = "Select Rownum ID,编码,名称,简码 From 出院转入 Order by 编码"
            Set rsTmp = zlDatabase.ShowSQLMultiSelect(Me, StrSQL, 0, "", True, "", "", True, True, True, vPoint.X, vPoint.Y, txtInfo(Index).Height, blnCancel, True, True)

            If rsTmp Is Nothing Then
                If Not blnCancel Then
                    MsgBox "没有设置""出院转入""数据，请先到字典管理工具中设置。", vbInformation, gstrSysName
                End If
                txtInfo(Index).SetFocus
            Else
                While Not rsTmp.EOF
...
Private Sub cmdInfo_GotFocus(Index As Integer)
    If sstInfo.Tab = TAB_西医诊断 And picInfectInfo.Visible Then
        Call ShowInfectInfo(False)
    End If
End Sub
...
Private Sub cmdMove_Click(Index As Integer)
    Call MoveDiagRows(IIf(Index \ 2 = 0, vsDiagXY, vsDiagZY), IIf(Index Mod 2 = 0, -1, 1))
End Sub
...
Private Sub cmdPrintdown_GotFocus()
    If sstInfo.Tab = TAB_西医诊断 And picInfectInfo.Visible Then
        Call ShowInfectInfo(False)
    End If
End Sub
...
Private Sub cmdPriview_GotFocus()
    If sstInfo.Tab = TAB_西医诊断 And picInfectInfo.Visible Then
        Call ShowInfectInfo(False)
    End If
End Sub
...
Private Sub cmdPriviewDown_GotFocus()
    If sstInfo.Tab = TAB_西医诊断 And picInfectInfo.Visible Then
        Call ShowInfectInfo(False)
    End If
End Sub
...
'功能：签名
    ...
    '判断是否启用数字签名
    If gintCA > 0 And CheckSign(1, 0, 0, mlng科室ID, 2) Then
...
Private Sub Form_Load()
    ...
    '设置过敏输入来源控件属性
    mblnUseTYT = False
    Call SetContolsByAllerPara(p住院医生站, mint过敏输入来源, optAller(0), optAller(1))
    ...
    mblnHaveOPS = CheckHaveSys(2400) '2400手麻系统号
    '卡片设置
...
Private Sub lvwInfectParts_ItemCheck(ByVal Item As MSComctlLib.ListItem)
    If Visible Then mblnChange = True
End Sub

Private Sub lvwInfectParts_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyEscape Then
        Call ShowInfectInfo(False)
    End If
End Sub

Private Sub lvwInfectParts_KeyPress(KeyAscii As Integer)
...
Private Sub optInput_GotFocus(Index As Integer)
    If sstInfo.Tab = TAB_西医诊断 And picInfectInfo.Visible Then
        Call ShowInfectInfo(False)
    End If
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Call zlDatabase.SetPara("过敏输入来源", IIf(optAller(0).Value, "0", "1"), glngSys, p住院医生站, optAller(0).Enabled And optAller(0).Visible)
...
Private Sub sstInfo_Click(PreviousTab As Integer)
    If PreviousTab = TAB_西医诊断 And picInfectInfo.Visible Then
        Call ShowInfectInfo(False)
    End If
End Sub
...
'                strMask = "1234567890"
            ...
            Case txt家庭电话, txt单位电话, txt联系人电话
                strMask = "1234567890-()"
            Case txt住院号, txt户口邮编, txt家庭邮编, txt单位邮编, txt抢救次数, txt成功次数, txt随诊期限, txt入院前小时, txt入院前分钟, txt入院后小时, txt入院后分钟, txt呼吸机小时, txtqq, txt外院会诊, txt院内会诊
                strMask = "1234567890"
            Case txt输红细胞, txt输血小板, txt输血浆, txt输全血, txt自体回收, txt输白蛋白
                strMask = "1234567890."
            Case txt身高, txt体重
                strMask = "1234567890."
            Case txt新生儿体重, txt新生儿入院体重
                strMask = "1234567890.;"
        End Select
        If strMask <> "" Then
...
'功能：初始化首页编辑时所需要的一些数据
    ...
    Call zlControl.CboSetHeight(cboinfo(cbo主诊医师), cboinfo(cbo主诊医师).Height * 16)
    ...
    Call SetCboFromList(Array(" ", "0-院外", "1-住院期间"), Array(cbo压疮发生期间))
    ...
    Call SetCboFromList(Array("", "0-直接", "1-间接", "2-无"), Array(cbo感染与死亡), 0)
    ...
    StrSQL = "Select A.ID,A.编号,A.姓名,Null as 简码" & _
        ...
        " And (A.站点='" & gstrNodeNo & "' Or A.站点 is Null)" & _
        " Order by A.姓名"
    Call SetCboFromSQL(StrSQL, Array(cbo进修医师, cbo主诊医师, cbo实习医师, cbo质控医师), strSQLExt, mcol人员SQL)
    ...
    '感染部位
    StrSQL = "select 名称 from 感染部位 order by 编码"
    Set rsTmp = zlDatabase.OpenSQLRecord(StrSQL, Me.Caption)
    While Not rsTmp.EOF
        lvwInfectParts.ListItems.Add , , rsTmp!名称
        rsTmp.MoveNext
    Wend
    lvwInfectParts.HideColumnHeaders = True
...
Private Function Check重症监护() As Boolean
    '---------------------------------------------------------------------------------------------------------------------
    '功能:检查附页的输入内容是否合法
    '参数:
    '返回:输入的附页数据合法,返回true,否则返回false
    '编制:刘兴宏
    '日期:2007/05/18
    '---------------------------------------------------------------------------------------------------------------------
    Dim i As Integer
    ...
    With vsFlx附页重症
        For i = 1 To .Rows - 1
            strValue = Trim(.TextMatrix(i, 1))
            If strValue <> "" Then
                If InStr(1, strValue, "'") > 0 Then
                     sstInfo.Tab = TAB_附页1
                    .Col = 1
                    .Row = i
                    ShowMessage vsFlx附页重症, "你输入的重症监护室名称中包含了非法字符单引号,请检查!"
                    .SetFocus
                    Exit Function
                End If
                ...
                If zlCommFun.ActualLen(strValue) > 100 Then
                    ...
                    .Col = 1
                    .Row = i
                    ShowMessage vsFlx附页重症, "你输入的重症监护室名称长度不能超过100个符或50个汉字,请检查!"
                    .SetFocus
                    Exit Function
                End If
                strValue = Trim(.TextMatrix(i, 2))
                If strValue <> "" Then
                    If Not IsDate(strValue) Then
                        sstInfo.Tab = TAB_附页1
                        .Col = 2
                        .Row = i
                        ShowMessage vsFlx附页重症, "你输入的进入时间不是日期型,请检查!"
                        .SetFocus
                        Exit Function
                    End If
                Else
                    ...
                    .Col = 2
                    .Row = i
                    ShowMessage vsFlx附页重症, "转入时间必须填写,请检查!"
                    .SetFocus
                    Exit Function
                End If
                strValue = Trim(.TextMatrix(i, 3))
                ...
                If strValue <> "" Then
                    ...
                    If Not IsDate(strValue) Then
                        ...
                        .Col = 3
                        .Row = i
                        ShowMessage vsFlx附页重症, "你输入的退出时间不是日期型,请检查!"
                        .SetFocus
                        Exit Function
                    End If
                    If Trim(.TextMatrix(i, 2)) <> "" Then
                        If CDate(strValue) < CDate(Trim(.TextMatrix(i, 2))) And (i <> .Rows - 1 Or i = .Rows - 1 And Trim(.TextMatrix(i, 2)) <> "") Then
                            sstInfo.Tab = TAB_附页1
                            .Col = 2
                            .Row = i
                            ShowMessage vsFlx附页重症, "你输入的进入时间大于了退出时间,请检查!"
                            .SetFocus
                            Exit Function
                        End If
                    End If
                Else
                    If i <> .Rows - 1 Then
                        If .TextMatrix(.Rows - 1, 1) <> "" Or i <> .Rows - 2 Then
                            sstInfo.Tab = TAB_附页1
                            .Col = 3
                            .Row = i
                            ShowMessage vsFlx附页重症, "转出时间必须填写,请检查!"
                            .SetFocus
                            Exit Function
                        End If
                    End If
                End If
                If Valied重症(i) = False Then
                    Exit Function
                End If
            End If
        Next
...
Private Function Valied重症(ByVal lngRow As Long) As Boolean
    '-----------------------------------------------------------------------------------------------------------
    '功能:检查重症病人的时间
    '入参:
    '出参:
    ...
    With vsFlx附页重症
        If Trim(.TextMatrix(lngRow, 1)) <> "" Then
            str进入时间 = Trim(.TextMatrix(lngRow, 2))
            str退出时间 = Trim(.TextMatrix(lngRow, 3))
            
           If str进入时间 >= str退出时间 And str退出时间 <> "" Then
               ShowMessage vsFlx附页重症, "注:" & vbCrLf & "  进入时间大于了退出时间,请检查！"
               sstInfo.Tab = TAB_附页1
              .Row = lngRow: .TopRow = lngRow: .Col = 3
               If IsCtrlSetFocus(vsFlx附页重症) Then vsFlx附页重症.SetFocus
               Exit Function
           End If
        End If
    End With
...
Private Function Load附页内容(ByVal lng病人ID As Long, ByVal lng主页ID As Long) As Boolean
    ...
    With vsFlx附页重症
        ...
        Loop
    End With
    For i = 1 To vsFlx附页重症.Rows - 1
        vsFlx附页重症.TextMatrix(i, 0) = i
    Next
    '器械导管情况
    StrSQL = "" & _
    ...
    With vsFlx器械和导管
        ...
        Do While Not rsTemp.EOF
            ...
            .Cell(flexcpText, lngRow, 5) = Nvl(rsTemp!序号)
            lngRow = lngRow + 1
            rsTemp.MoveNext
        Loop
    End With
    vsFlx器械和导管_AfterRowColChange 0, 0, 1, 0
...
Private Sub SetCheckValue(ByVal lngNum As Long, ByVal lngRow As Long)
'功能：根据编号值设置检查的值
    With vsCheck
        If lngNum = 1 Then
            .TextMatrix(lngRow, 1) = "1-阳性"
        ElseIf lngNum = 2 Then
            .TextMatrix(lngRow, 1) = "2-阴性"
        ElseIf lngNum = 3 Then
            .TextMatrix(lngRow, 1) = "3-未做"
        End If
    End With
End Sub
...
'功能：读取病人的首页信息
    ...
    '病人信息部份
    '---------------------------------------------------------------
    StrSQL = "Select A.病人id, A.主页id, 病人性质, 再入院, 入院病区id, 入院科室id, 医疗小组id, 入院日期, 入院病况, 入院方式, 入院属性, 二级院转入, 住院目的, 入院病床, 是否陪伴, 当前病况, 护理等级id," & vbNewLine & _
            "       出院科室id, 出院病床, 出院日期, 住院天数, 出院方式, 是否确诊, 确诊日期, 新发肿瘤, 血型, 抢救次数, 成功次数, 随诊标志, 随诊期限, 尸检标志, 门诊医师, 责任护士, 住院医师, 病案号, 编目员编号," & vbNewLine & _
            "       编目员姓名, 编目日期, 状态, 费用和, 身高, 体重, 单位地址, 中医治疗类别, 社区, 审核标志, 审核人, 审核日期, 是否上传, 数据转出, 登记人, 备注, 病案状态, 病人类型, 封存时间, 路径状态, 单病种," & vbNewLine & _
            "       待转出, 婴儿科室id, 婴儿病区id, 母婴转科标志, 医嘱重整时间, B.名称 As 入院科室, C.名称 As 出院科室, 门诊号, 就诊卡号, 卡验证码, Nvl(A.姓名, D.姓名) 姓名," & vbNewLine & _
            "       Nvl(A.性别, D.性别) 性别, Nvl(A.年龄, D.年龄) 年龄, 出生日期, 出生地点, 身份证号, 其他证件, 身份, 民族, 籍贯, 监护人, Email, Qq, 合同单位id, 工作单位, 单位开户行," & vbNewLine & _
            "       单位帐号, 担保人, 担保额, 担保性质, 就诊时间, 就诊状态, 就诊诊室, 住院次数, 当前科室id, 当前床号, 入院时间, 出院时间, 在院, Ic卡号, 健康号, 医保号, 查询密码, 停用时间, 锁定, A.住院号," & vbNewLine & _
            "       A.费别, A.医疗付款方式, A.职业, A.国籍, A.区域, A.学历, A.婚姻状况, A.家庭地址, A.家庭电话, A.家庭地址邮编, A.联系人姓名, A.联系人关系, A.联系人地址, A.联系人电话," & vbNewLine & _
            "       A.户口地址, A.户口地址邮编, A.单位电话, A.单位邮编, A.当前病区id, A.险类, A.登记时间, A.联系人身份证号" & vbNewLine & _
    ...
    Set rsTmp = zlDatabase.OpenSQLRecord(StrSQL, "获取病案主页与病人信息", mlng病人ID, mlng主页ID)
    ...
    For i = 1 To rsTmp.RecordCount
        Select Case UCase(Nvl(rsTmp!信息名))
            ...
            Case "主诊医师"
                Call GetCboIndex(cboinfo(cbo主诊医师), Nvl(rsTmp!信息值))
                If Not IsNull(rsTmp!信息值) And cboinfo(cbo主诊医师).ListIndex = -1 Then Call SetCboFromName(rsTmp!信息值, cboinfo(cbo主诊医师))
            Case "实习医师"
            ...
            Case "外院会诊"
                ...
                txtInfo(txt外院会诊).Text = Val(Nvl(rsTmp!信息值))
            Case "院内会诊"
                chkInfo(chk会诊情况).Value = 1
                txtInfo(txt院内会诊).Text = Val(Nvl(rsTmp!信息值))
            Case "会诊情况"
                If Nvl(rsTmp!信息值) = "0" Then
                    chkInfo(chk会诊情况).Value = 0
                Else
                    chkInfo(chk会诊情况).Value = 1
                    txtInfo(txt其他会诊).Text = Trim(Nvl(rsTmp!信息值))
                End If
            Case "CT"
                Call SetCheckValue(Val(Nvl(rsTmp!信息值)), rowct)
            Case "PETCT"
                Call SetCheckValue(Val(Nvl(rsTmp!信息值)), rowPETCT)
            Case "双源CT"
                Call SetCheckValue(Val(Nvl(rsTmp!信息值)), row双源CT)
            Case "X片"
                Call SetCheckValue(Val(Nvl(rsTmp!信息值)), rowX片)
            Case "B超"
                Call SetCheckValue(Val(Nvl(rsTmp!信息值)), rowB超)
            Case "超声心动图"
                Call SetCheckValue(Val(Nvl(rsTmp!信息值)), row超声心动图)
            Case "MRI"
                Call SetCheckValue(Val(Nvl(rsTmp!信息值)), rowMRI)
            Case "同位素检查"
                Call SetCheckValue(Val(Nvl(rsTmp!信息值)), row同位素检查)
            Case "输液药物"
            ...
            Case "透析尿素氮值"
                txtInfo(txt离院时透析).Text = Nvl(rsTmp!信息值)
            Case "生育状况"
            ...
            Case "发病时间"
                ...
                End If
            Case "感染与死亡关系"
                Call GetCboIndex(cboinfo(cbo感染与死亡), Nvl(rsTmp!信息值))
            Case "感染部位"
                If lvwInfectParts.ListItems.Count > 0 Then
                    For j = 1 To lvwInfectParts.ListItems.Count
                        If InStr("|" & rsTmp!信息值, "|" & lvwInfectParts.ListItems.Item(j).Text & "|") > 0 Then
                            lvwInfectParts.ListItems.Item(j).Checked = True
                        End If
                    Next j
                End If
            Case Else
    ...
    If str诊断IDs <> "" Then
        ...
        Set mrsAdvice = getAdviceDiagRec(str诊断IDs)
        If Not mrsAdvice.EOF Then
            With vsDiagXY
                For i = .FixedRows To .Rows - 1
                    If Val(.Cell(flexcpData, i, col是否疑诊) & "") > 0 Then
                        mrsAdvice.Filter = "诊断ID=" & Val(.Cell(flexcpData, i, col是否疑诊) & "")
                        If Not mrsAdvice.EOF Then
                            mrsAdvice.MoveFirst
                            .RowData(i) = mrsAdvice!医嘱IDs & ""
                        End If
                    End If
                Next
            End With
    ...
    '首读取首页整理保存的内容
    StrSQL = "Select a.助产护士,a.手术情况,a.切口,a.愈合,a.记录日期,a.记录人,a.取消时间,a.取消人,NVl(B.编码,C.编码) as 手术编码,a.ID,a.病人ID,a.主页ID,a.记录来源,a.手术日期,a.手术开始时间,a.手术结束时间,a.拟行手术,a.手术操作ID,a.诊疗项目ID,a.已行手术,a.主刀医师,a.第一助手,a.第二助手,a.手术护士,a.麻醉开始时间,a.麻醉结束时间,a.麻醉方式,a.麻醉类型,a.麻醉质量,a.输液总量,a.麻醉医师,a.输氧开始时间,a.输氧结束时间,a.手术情况,a.ASA分级,a.再次手术,a.NNIS分级,decode(a.手术级别,1,'一级手术',2,'二级手术',3,'三级手术',4,'四级手术',' ') as 手术级别,a.准备天数,a.抗菌用药时间,a.切口部位,a.重返计划,a.重返目的,a.切口感染,a.并发症" & _
    ...
    If Not rsTmp.EOF Then
        With vsOPS
            ...
            For i = 1 To rsTmp.RecordCount
                ...
                '记录用于编辑恢复
                For j = 0 To .Cols - 1
                    If j = col手术名称 And .TextMatrix(i, col手术编码) <> "" Then
                        .Cell(flexcpData, i, j) = Get手术名称(Val(rsTmp!手术操作ID & ""), Val(rsTmp!诊疗项目id & ""))
            ...
            For j = .FixedRows To .Rows - 1
                If .TextMatrix(j, 1) = "" Then
                    ...
                    If .RowData(j) <> 0 Then
                        ...
                        .TextMatrix(j, KSSDDD数) = IIf(Val(rsTmp!DDD数 & "") > 0 And Val(rsTmp!DDD数 & "") < 1, "0", "") & rsTmp!DDD数 & ""
    ...
    Select Case Index
        Case txt确诊日期
            ...
            ElseIf Not CheckDateRange(txtInfo(Index).Text, , True) Then
                txtInfo(Index).Text = ""
            End If
        Case txt抢救次数, txt成功次数, txt随诊期限, txt输红细胞, txt输血小板, txt输血浆, txt输全血, txt自体回收, txt输白蛋白, txtqq
            If txtInfo(Index).Text <> "" Then
        ...
        Case txtEmail
            If txtInfo(Index).Text <> "" Then
                If InStr(txtInfo(txtEmail).Text, "@") <= 1 Or InStr(txtInfo(txtEmail).Text, ".") <= 3 Then
                    MsgBox "输入的Email的格式不正确，正确格式：""XXX@XX.XX""。", vbInformation, Me.Caption
                    txtInfo(Index).Text = ""
                    Cancel = True
                End If
            End If
...
Private Sub vsCheck_KeyPress(KeyAscii As Integer)
    If mbln护士站 Or mblnReadOnly Then Exit Sub
    If KeyAscii <> vbKeyReturn Then Exit Sub
    KeyAscii = 0
    If vsCheck.Rows > vsCheck.Row + 1 Then
        vsCheck.Row = vsCheck.Row + 1
    Else
        Call zlCommFun.PressKey(vbKeyTab)
    End If
End Sub

Private Sub vsCheck_ValidateEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    If vsCheck.EditText <> vsCheck.TextMatrix(Row, Col) Then mblnChange = True: vsCheck.Tag = ""
End Sub
...
Private Sub vsDiagXY_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    ...
    With vsDiagXY
        ...
        Else
            ...
            If .TextMatrix(NewRow, 0) = "院内感染" Then
                Call ShowInfectInfo(False)
                If .TextMatrix(NewRow, col诊断描述) <> "" Then
                    If NewCol = col诊断描述 Or NewCol = col备注 Then
...
Private Sub vsDiagXY_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If mblnReadOnly Or mbln护士站 Then Exit Sub
...
Private Sub KSSEnterNextCell()
    With vsKSS
        If Not (.Row = .Rows - 1 And .Col = .Cols - 1 And .TextMatrix(.Row, .FixedCols) = "") Then
            If .TextMatrix(.Row, kss名称) <> "" Then
...
Private Function XYCellEditable(ByVal lngRow As Long, ByVal lngCol As Long) As Boolean
    With vsDiagXY
        ...
        If .RowData(lngRow) & "" <> "" And lngCol = col诊断描述 Then Exit Function
...
Private Sub vsFlx附页重症_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    vsFlx器械和导管_AfterRowColChange 0, 0, 1, 0
    If NewCol = 3 Then
        If vsFlx附页重症.TextMatrix(NewRow, 2) = "" Or Not IsDate(vsFlx附页重症.TextMatrix(NewRow, 2)) Then
            vsFlx附页重症.Editable = flexEDNone
        Else
            vsFlx附页重症.Editable = flexEDKbdMouse
        End If
    Else
        vsFlx附页重症.Editable = flexEDKbdMouse
    End If
...
Private Sub vsFlx附页重症_ChangeEdit()
    mblnChange = True
    vsFlx附页重症.Tag = ""
End Sub


Private Sub vsFlx附页重症_KeyDownEdit(ByVal Row As Long, ByVal Col As Long, KeyCode As Integer, ByVal Shift As Integer)
        ...
        With vsFlx附页重症
            Select Case Col
            Case 1
                strKEY = Trim(vsFlx附页重症.EditText)
                ...
                .SetFocus
            Case 2, 3
'                If CheckInPutIsDate(vsFlx附页重症, Row, Col) = False Then
'                    KeyCode = 0
...
'                    Exit Sub
'                End If
'                Call VsGriedFocuesMove(vsFlx附页重症, Row, Col, vbKeyReturn, 2)
            End Select
        End With
End Sub
...
Private Sub VsGriedFocuesMove(ByVal vsBill As Object, ByVal lngRow As Long, ByVal lngCol As Long, ByVal KeyCode As Integer, _
    ...
    With vsBill
        ...
        Select Case lngCol
        Case 0
            If Trim(.TextMatrix(lngRow, lngFiexCol)) = "" And strCurrValue = "" And vsBill <> vsFlx附页重症 Then
...
Private Function CheckInPutIsDate(ByVal vsObj As Object, lngRow As Long, lngCol As Long) As Boolean
    ...
    Dim str开始使用时间 As String, str结束使用时间 As String
    ...
    If strKEY <> "" And strKEY <> "-  -     :" And strKEY <> "____-__-__ __:__" And InStr("0123456789", Mid(strKEY, 1, 1)) > 0 Then
        ...
        Case 2
            str入住时间 = strKEY
            str转出时间 = Trim(vsObj.TextMatrix(lngRow, 3))
            If Not IsDate(str转出时间) Then str转出时间 = ""
            If str转出时间 <> "" Then
                If CDate(str入住时间) > CDate(IIf(str转出时间 = "", 0, str转出时间)) Then
                    MsgBox "注:" & vbCrLf & "  入住时间大于了转出时间,请检查！", vbInformation + vbDefaultButton1, Me.Caption
                    Exit Function
                End If
            End If
            If lngRow > 1 Then strTmp = vsObj.TextMatrix(lngRow - 1, 2)
            strTmp = Replace(strTmp, ":", "")
            strTmp = Replace(strTmp, "-", "")
            strTmp = Replace(strTmp, "_", "")
            strTmp = Replace(strTmp, " ", "")
            If strTmp <> "" Then
                strTmp = vsObj.TextMatrix(lngRow - 1, 3)
                If Not IsDate(strTmp) Then strTmp = ""
                If str入住时间 <> "" And CDate(str入住时间) < CDate(IIf(strTmp = "", 0, strTmp)) And strTmp <> "" Then
                    MsgBox "注:" & vbCrLf & "  上次转出时间大于了本次转入时间,请检查！", vbInformation + vbDefaultButton1, Me.Caption
                    Exit Function
                End If
            End If
        Case 3
            str入住时间 = Trim(vsObj.TextMatrix(lngRow, 2))
            str转出时间 = strKEY
            If InStr("0123456789", Mid(str入住时间, 1, 1)) > 0 Then
                If str入住时间 <> "" And CDate(str入住时间) >= CDate(str转出时间) Then
                    MsgBox "注:" & vbCrLf & "  转出时间小于了入住时间,请检查！", vbInformation + vbDefaultButton1, Me.Caption
                    Exit Function
                End If
                If vsObj.Rows > lngRow + 1 Then strTmp = vsObj.TextMatrix(lngRow + 1, 2)
                If Not IsDate(strTmp) Then strTmp = ""
                If str转出时间 <> "" And CDate(str转出时间) > CDate(IIf(strTmp = "", 0, strTmp)) And strTmp <> "" Then
                    MsgBox "注:" & vbCrLf & "  转出时间大于了下一次转入时间,请检查！", vbInformation + vbDefaultButton1, Me.Caption
                    Exit Function
                End If
            End If
        
        End Select
    ElseIf strKEY = "-  -     :" Or strKEY = "____-__-__ __:__" Then
        vsObj.EditText = ""
        vsObj.TextMatrix(lngRow, lngCol) = ""
    End If
    CheckInPutIsDate = True
End Function

Private Sub vsFlx附页重症_KeyDown(KeyCode As Integer, Shift As Integer)
    Dim lngCol As Long, i As Long, byt序号 As Long
    If mbln护士站 Or mblnReadOnly Then Exit Sub
    If KeyCode = vbKeyDelete Then
            If MsgBox("你是否真的要删除该行数据吗?", vbQuestion + vbYesNo + vbDefaultButton2) = vbNo Then Exit Sub
               
            With vsFlx器械和导管
                For i = .Rows - 1 To 1 Step -1
                    byt序号 = Val(.TextMatrix(i, 5))
                    If Val(.TextMatrix(i, 5)) = vsFlx附页重症.Row Then
                        .RemoveItem i
                    End If
                    If byt序号 > vsFlx附页重症.Row Then
                        .TextMatrix(i, 0) = byt序号 - 1 & "-" & Split(.TextMatrix(i, 0), "-")(1)
                        .TextMatrix(i, 5) = byt序号 - 1
                    End If
                Next
                
                If .Rows = 1 Then .AddItem "": Call vsFlx器械和导管_AfterRowColChange(0, 0, 1, 0)
            End With
    ...
    If KeyCode = vbKeyReturn Then
        If Trim(vsFlx附页重症.TextMatrix(vsFlx附页重症.Row, 1)) = "" Then
            zlCommFun.PressKey vbKeyTab
            Exit Sub
        End If
    End If
    Call VsGriedFocuesMove(vsFlx附页重症, vsFlx附页重症.Row, vsFlx附页重症.Col, KeyCode, 2)
    For i = 1 To vsFlx附页重症.Rows - 1
        vsFlx附页重症.TextMatrix(i, 0) = i
    Next
    vsFlx器械和导管_AfterRowColChange 0, 0, 1, 0
End Sub
Private Sub vsFlx附页重症_KeyPress(KeyAscii As Integer)
    If mbln护士站 Or mblnReadOnly Then Exit Sub
    If KeyAscii = vbKeyReturn Then
        KeyAscii = 0
    End If
...
Private Sub vsFlx附页重症_KeyPressEdit(ByVal Row As Long, ByVal Col As Long, KeyAscii As Integer)
        Dim strKEY As String
        Dim i As Long
        ...
        Select Case Col
        Case 2, 3
            Call VsFlxGridCheckKeyPress(vsFlx附页重症, Row, Col, KeyAscii, m文本式)
        Case Else
        End Select
End Sub

Private Sub vsFlx附页重症_ValidateEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    ...
    Case 1
        vsFlx器械和导管_AfterRowColChange 0, 0, 1, 0
    Case 2, 3
        strIn = vsFlx附页重症.TextMatrix(Row, 2)
        If CheckInPutIsDate(vsFlx附页重症, Row, Col) = False Then
            Cancel = True
            Exit Sub
        End If
        If Not IsDate(vsFlx附页重症.EditText) And IsDate(vsFlx附页重症.TextMatrix(Row, 3)) And Col = 2 Then
            MsgBox "您没有删除转出时间。", vbInformation, Me.Caption
            vsFlx附页重症.TextMatrix(Row, Col) = strIn
            vsFlx附页重症.EditText = strIn
            Cancel = True
            
            
            Exit Sub
        End If
        strTemp = Trim(vsFlx附页重症.EditText)
        strTemp = Replace(strTemp, Chr(vbKeyReturn), "")
        strTemp = Replace(strTemp, Chr(10), "")
        If strTemp <> "" And strTemp <> "-  -     :" And strTemp <> "____-__-__ __:__" And InStr("0123456789", Mid(strTemp, 1, 1)) > 0 Then
            If Not CheckDateRange(strTemp) Then
                MsgBox "您输入的时间必须在病人的住院期间。", vbInformation, Me.Caption
                Cancel = True
                Exit Sub
            End If
        End If
    Case 5
        If LenB(StrConv(vsFlx附页重症.EditText, vbFromUnicode)) > 100 Then
            MsgBox "不能超过50个汉字的长度。", vbInformation, Me.Caption
            Cancel = True
            Exit Sub
        End If
    End Select
    If vsFlx附页重症.EditText <> vsFlx附页重症.TextMatrix(Row, Col) Then vsFlx附页重症.Tag = "": mblnChange = True
End Sub

Private Function init附页() As Boolean
    '--------------------------------------------------------------------------------------------------
    '功能:初始附页中的信息
    '参数:
    ...
    With vsFlx附页重症
        ...
        .Clear 1
        .Rows = 2
        vsFlx器械和导管.AllowUserResizing = flexResizeColumns
        vsFlx器械和导管.Clear 1
        vsFlx器械和导管.Rows = 2
        .ColAlignment(1) = flexAlignLeftCenter
        .ColAlignment(2) = flexAlignCenterCenter
        .ColAlignment(3) = flexAlignCenterCenter
        .ColEditMask(2) = "9999-99-99 99:99"
        .ColEditMask(3) = "9999-99-99 99:99"
        vsFlx器械和导管.ColEditMask(2) = "9999-99-99 99:99"
        vsFlx器械和导管.ColEditMask(3) = "9999-99-99 99:99"
        vsFlx器械和导管.ColEditMask(4) = "9999:99"
        vsFlx器械和导管.ColAlignment(2) = flexAlignCenterCenter
        vsFlx器械和导管.ColAlignment(3) = flexAlignCenterCenter
        vsFlx器械和导管.ColAlignment(4) = flexAlignCenterCenter
        
        StrSQL = "Select 0 类型,编码 ||'.'|| 名称 名称,简码 From ICU类型 Union All Select 1 类型,编码 ||'.'|| 名称 名称,简码 From 器械导管目录"
        Set rsTemp = zlDatabase.OpenSQLRecord(StrSQL, "")
        rsTemp.Filter = "类型=0"
        .ColComboList(1) = .BuildComboList(rsTemp, "名称")
        rsTemp.Filter = "类型=1"
        vsFlx器械和导管.ColComboList(1) = .BuildComboList(rsTemp, "名称")
        .Editable = flexEDKbdMouse
        'vsFlx器械和导管.Editable = flexEDKbdMouse
    End With
    ...
    With vsInfect
        ...
        .ColEditMask(0) = "9999-99-99"
        
        StrSQL = "Select 编码||'.'||名称 名称,简码 From 感染部位"
        Set rsTemp = zlDatabase.OpenSQLRecord(StrSQL, "")
        .ColComboList(1) = .BuildComboList(rsTemp, "名称")
        .Editable = flexEDKbdMouse
    End With
    ...
    With vsSample
        ...
        .ColAlignment(1) = flexAlignLeftCenter
        .ColAlignment(2) = flexAlignLeftCenter
        .ColEditMask(2) = "9999-99-99"
        .ColComboList(0) = "1.血液|2.尿液|3.粪便|4.痰液|5.其他分泌物"
        
        StrSQL = "Select 编码||'-'||名称 名称,简码 From 病原学目录"
        Set rsTemp = zlDatabase.OpenSQLRecord(StrSQL, "")
        .ColComboList(1) = .BuildComboList(rsTemp, "名称")
        .Editable = flexEDKbdMouse
    End With
...
Private Sub vsFlx器械和导管_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    Dim strTmp As String, i As Long
    
    If NewCol = 0 Then
        For i = 1 To vsFlx附页重症.Rows - 1
            If vsFlx附页重症.TextMatrix(i, 1) <> "" And vsFlx附页重症.TextMatrix(i, 2) <> "" Then
                strTmp = strTmp & "|" & vsFlx附页重症.TextMatrix(i, 0) & "-" & vsFlx附页重症.TextMatrix(i, 1)
            End If
        Next
        strTmp = Mid(strTmp, 2)
        vsFlx器械和导管.ColComboList(0) = strTmp
        If strTmp = "" Then
            vsFlx器械和导管.Editable = flexEDNone
        Else
            vsFlx器械和导管.Editable = flexEDKbdMouse
        End If
    ElseIf NewCol = 1 Then
        If vsFlx器械和导管.TextMatrix(NewRow, 0) = "" Then
            vsFlx器械和导管.Editable = flexEDNone
        Else
            vsFlx器械和导管.Editable = flexEDKbdMouse
        End If
...
Private Sub vsFlx器械和导管_BeforeEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    vsFlx器械和导管_AfterRowColChange 0, 0, Row, Col
    If Col = 2 Or Col = 3 Then
        If vsFlx器械和导管.TextMatrix(Row, 0) = "" Then Cancel = True
    End If
End Sub

Private Sub vsFlx器械和导管_ChangeEdit()
    mblnChange = True
    vsFlx器械和导管.Tag = ""
End Sub

Private Sub vsFlx器械和导管_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    End If
    If KeyCode = vbKeyReturn Then
        If Trim(vsFlx器械和导管.TextMatrix(vsFlx器械和导管.Row, 0)) = "" Then
            zlCommFun.PressKey vbKeyTab
            Exit Sub
        End If
    End If
    Call VsGriedFocuesMove(vsFlx器械和导管, vsFlx器械和导管.Row, vsFlx器械和导管.Col, KeyCode, 0)
End Sub

Private Sub vsFlx器械和导管_KeyPress(KeyAscii As Integer)
    If mbln护士站 Or mblnReadOnly Then Exit Sub
    If KeyAscii = vbKeyReturn Then KeyAscii = 0
End Sub

Private Sub vsFlx器械和导管_KeyPressEdit(ByVal Row As Long, ByVal Col As Long, KeyAscii As Integer)
    If KeyAscii = vbKeyReturn Then
        KeyAscii = 0
        Call VsGriedFocuesMove(vsFlx器械和导管, Row, Col, vbKeyReturn, 0)
        Exit Sub
    End If
End Sub

Private Sub vsFlx器械和导管_ValidateEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    Dim intCol As Integer
    Dim strKEY As String
    Dim str入住时间 As String, str转出时间 As String
    Dim str开始使用时间 As String, str结束使用时间 As String
    ...
    With vsFlx器械和导管
        ...
        strKEY = Replace(strKEY, Chr(vbKeyReturn), "")
        strKEY = Replace(strKEY, Chr(10), "")
        If strKEY = "" Then strKEY = .TextMatrix(Row, Col)
        Select Case Col
        Case 0
            If .EditText <> "" Then
                .TextMatrix(Row, 5) = Mid(.EditText, 1, InStr(.EditText, "-") - 1)
            End If
        Case 1
            For i = 1 To .Rows - 1
                If .TextMatrix(i, 1) = .EditText And .TextMatrix(i, 5) = .TextMatrix(Row, 5) And .TextMatrix(Row, 5) <> "" And i <> Row Then
                    MsgBox "同一个ICU记录不能对应多个相同的器械。", vbInformation, Me.Caption
                    Cancel = True
                    Exit Sub
                End If
            Next
        Case 2
            str入住时间 = Trim(vsFlx附页重症.TextMatrix(Val(.TextMatrix(Row, 5)), 2))
            str转出时间 = Trim(vsFlx附页重症.TextMatrix(Val(.TextMatrix(Row, 5)), 3))
            str开始使用时间 = strKEY
            If Not IsDate(str开始使用时间) And str开始使用时间 <> "" Then
                MsgBox "必须为日期型,请重新输入！", vbInformation + vbDefaultButton1, Me.Caption
                Cancel = True
                Exit Sub
            End If
            If IsDate(str入住时间) Then
                If CDate(strKEY) < CDate(str入住时间) Then
                    .EditText = str入住时间
                    ShowMessage vsFlx器械和导管, "注:" & vbCrLf & "  开始使用时间小于了入住时间,请检查！"
                    Cancel = True
                    Exit Sub
                End If
            End If
            If IsDate(str转出时间) Then
                If CDate(strKEY) > CDate(str转出时间) Then
                    .EditText = str入住时间
                    ShowMessage vsFlx器械和导管, "注:" & vbCrLf & "  开始使用时间大于了转出时间,请检查！"
                    Cancel = True
                    Exit Sub
                End If
            End If
            If IsDate(str开始使用时间) Then

                If Not CheckDateRange(str开始使用时间) Then
                    ShowMessage vsFlx器械和导管, "您输入的时间必须在病人的住院期间。"
                    Cancel = True
                    Exit Sub
                End If
            End If
        Case 3
            str开始使用时间 = Trim(.TextMatrix(Row, 2))
            str转出时间 = Trim(vsFlx附页重症.TextMatrix(Val(.TextMatrix(Row, 5)), 3))
            str结束使用时间 = strKEY
            If Not IsDate(str结束使用时间) And str结束使用时间 <> "" Then
                MsgBox "必须为日期型,请重新输入！", vbInformation + vbDefaultButton1, Me.Caption
                Cancel = True
                Exit Sub
            End If
            If IsDate(str开始使用时间) And IsDate(str结束使用时间) Then


                If str开始使用时间 <> "" And CDate(str结束使用时间) < CDate(str开始使用时间) Then
                    ShowMessage vsFlx器械和导管, "注:" & vbCrLf & "  结束使用时间小于了开始使用时间,请检查！"
                    .EditText = str入住时间
                    Cancel = True
                    Exit Sub
                End If
            End If
            If str转出时间 <> "" Then
                If IsDate(str转出时间) And IsDate(str结束使用时间) Then
                    If CDate(str结束使用时间) > CDate(str转出时间) Then
                        ShowMessage vsFlx器械和导管, "注:" & vbCrLf & "  结束使用时间小于了转出时间,请检查！"
                        .EditText = str入住时间
                        Cancel = True
                        Exit Sub
                    End If
            ...
            If IsDate(str结束使用时间) Then
                If Not CheckDateRange(str结束使用时间) Then
                    ShowMessage vsFlx器械和导管, "您输入的时间必须在病人的住院期间。"
                    Cancel = True
                    Exit Sub
                End If
        ...
        Case 4
            If InStr(strKEY, ":") > 0 Then
                If Val(Mid(strKEY, InStr(strKEY, ":") + 1)) >= 60 Then
                    ShowMessage vsFlx器械和导管, "输入的分钟数不能超过59分钟。"
                    Cancel = True
                    Exit Sub
                End If
            End If
        End Select
    End With
    If vsFlx器械和导管.EditText <> vsFlx器械和导管.TextMatrix(Row, Col) Then vsFlx器械和导管.Tag = "": mblnChange = True
End Sub
...
Private Sub vsfMain_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
        ...
        Select Case vsfMain.Col
            ...
            Case 1, 4, 7
                If vsfMain.Col = 7 And vsfMain.Row <> vsfMain.Rows - 1 Then
                    vsfMain.Col = 0
                    vsfMain.Row = vsfMain.Row + 1
                ElseIf vsfMain.Col = 7 And vsfMain.Row = vsfMain.Rows - 1 Then
                    cmdOK.SetFocus
                Else
...
Private Sub vsInfect_AfterEdit(ByVal Row As Long, ByVal Col As Long)
    Call vsInfect_AfterRowColChange(-1, -1, vsInfect.Row, vsInfect.Col)
End Sub
...
Private Sub vsInfect_AfterRowColChange(ByVal OldRow As Long, ByVal OldCol As Long, ByVal NewRow As Long, ByVal NewCol As Long)
    ...
    vsInfect.ColComboList(2) = "..."
    'vsInfect.FocusRect = flexFocusSolid

End Sub

Private Sub vsInfect_CellButtonClick(ByVal Row As Long, ByVal Col As Long)
    Dim StrSQL As String, blnCancle As Boolean
    Dim rsTemp As ADODB.Recordset
    StrSQL = "select rownum as id, 编码,名称,简码 from 医院感染目录"
    Set rsTemp = zlDatabase.ShowSQLSelect(Me, StrSQL, 0, "感染目录", False, "", "", False, False, False, 0, 0, 0, blnCancle, False, False, 1)
    If rsTemp Is Nothing Then
        If Not blnCancle Then
            MsgBox "没有感染项目可以选择。", vbInformation, gstrSysName
        End If
    Else
        vsInfect.RowData(Row) = "" & rsTemp!编码
        vsInfect.TextMatrix(Row, Col) = rsTemp!名称
        Call VsGriedFocuesMove(vsInfect, Row, Col, 13)
    End If
End Sub

Private Sub vsInfect_ChangeEdit()
    mblnChange = True
    vsInfect.Tag = ""
End Sub
...
Private Sub vsInfect_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    End If
    If KeyCode = vbKeyReturn Then
        If Trim(vsInfect.TextMatrix(vsInfect.Row, 0)) = "" Then
            zlCommFun.PressKey vbKeyTab
            Exit Sub
        End If
    ...
    If KeyCode = Asc("*") Then
        KeyCode = 0
        Call vsInfect_CellButtonClick(vsInfect.Row, vsInfect.Col)
    Else
        vsInfect.ColComboList(2) = "" '使按钮状态进入输入状态
    End If
    Call VsGriedFocuesMove(vsInfect, vsInfect.Row, vsInfect.Col, KeyCode)
End Sub
...
Private Sub vsInfect_KeyPressEdit(ByVal Row As Long, ByVal Col As Long, KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
        KeyAscii = 0
        Call VsGriedFocuesMove(vsInfect, Row, Col, vbKeyReturn)
        Exit Sub
    End If
    
    Select Case Col
    Case 0, 1, 2
        Call VsFlxGridCheckKeyPress(vsInfect, Row, Col, KeyAscii, m文本式)
    Case Else
    End Select
...
Private Sub vsInfect_ValidateEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    ...
    With vsInfect
        ...
        Case 0
            ...
            strKEY = Replace(strKEY, Chr(10), "")
            If Not IsDate(strKEY) Then
                MsgBox vsInfect.TextMatrix(Row, Col) & "必须为日期型,请重新输入！", vbInformation + vbDefaultButton1, Me.Caption
                Cancel = 0
                zlCommFun.PressKey vbKeySpace
                vsInfect.EditSelStart = 0
                vsInfect.EditSelLength = 1000
                Exit Sub
            End If
            If Not CheckDateRange(strKEY, "yyyy-MM-dd") Then
                MsgBox "您输入的时间必须在病人的住院期间。", vbInformation, Me.Caption
                Cancel = True
                Exit Sub
            End If
        Case 2
            ...
            StrSQL = "select rownum as id, 编码,名称,简码 from 医院感染目录 Where 简码 Like(UPPER([1])) or 编码 Like([1]) or 名称 like ([2]) "
            Set rsTemp = zlDatabase.ShowSQLSelect(Me, StrSQL, 0, "感染目录", False, "", "", False, False, False, 0, 0, 0, blnCancel, False, True, UCase(strKEY) & "%", mstrLike & UCase(strKEY) & "%")
            If rsTemp Is Nothing Then
                If Not blnCancel Then
                    MsgBox "没有感染项目可以选择。", vbInformation, gstrSysName
                    Cancel = True
        ...
        End Select
    End With
    If vsInfect.EditText <> vsInfect.TextMatrix(Row, Col) Then vsInfect.Tag = "": mblnChange = True
End Sub
    ...
    With vsKSS
        If Col = kss名称 Then
            ...
            Else
                ...
                Else
                    vPoint = GetCoordPos(.hwnd, .CellLeft + 15, .CellTop)
                    Set rsTmp = zlDatabase.ShowSQLSelect(Me, StrSQL, 0, "抗菌药物列表", _
                        False, "", "", False, False, True, vPoint.X, vPoint.Y, .CellHeight, blnCancel, False, True, _
...
Private Sub vsOPS_AfterEdit(ByVal Row As Long, ByVal Col As Long)
    ...
    With vsOPS
        If Col = col开始日期 Or Col = col结束日期 Or Col = col麻醉开始时间 Or Col = col抗菌用药时间 Then
            strInput = GetFullDate(.TextMatrix(Row, Col), True)
            If Not IsDate(strInput) Then
                .TextMatrix(Row, Col) = .Cell(flexcpData, Row, Col)
            '抗菌用药可能是在院外使用，因此不做检查
            ElseIf Not CheckDateRange(strInput) And Col <> col抗菌用药时间 And txtInfo(txt出院时间).Text <> "" Then
                .TextMatrix(Row, Col) = .Cell(flexcpData, Row, Col)
            Else
        ...
        ElseIf Col = col切口愈合 Then
            ...
            mblnChange = True
            .Tag = ""
        ElseIf Col = col手术级别 Or Col = col再次手术 Or Col = col重返手术室计划 Or Col = col并发症 Or Col = col切口感染 Or Col = col麻醉类型 Then
            mblnChange = True
            .Tag = ""
        End If
    End With
    ...
    With vsOPS
        If lngCol = col手术编码 Or lngCol = col手术名称 Then
            ...
            If Not rsInput Is Nothing And lngRow > .FixedRows And lngRow = .Rows - 1 Then
                If .TextMatrix(lngRow, col开始日期) = .TextMatrix(lngRow - 1, col开始日期) Then
...
Private Sub vsOPS_KeyPressEdit(ByVal Row As Long, ByVal Col As Long, KeyAscii As Integer)
    ...
    With vsOPS
        If KeyAscii = 13 Then
            ...
            If Col = col开始日期 Or Col = col结束日期 Or Col = col麻醉开始时间 Or Col = col抗菌用药时间 Then
                KeyAscii = 0
                strInput = GetFullDate(.EditText, True)
                If IsDate(strInput) Then
                    '抗菌用药可能是在院外使用，因此不做检查
                    If Not CheckDateRange(strInput) And Col <> col抗菌用药时间 And txtInfo(txt出院时间).Text <> "" Then
                        MsgBox "您输入的时间必须在病人的住院期间。", vbInformation, Me.Caption
                        .TextMatrix(Row, Col) = .Cell(flexcpData, Row, Col)
                        Exit Sub
                    Else
                    ...
                    End If
                End If
                If strInput = "" And (Col = col麻醉开始时间 Or Col = col抗菌用药时间) Then
                    KeyAscii = 13
                    .TextMatrix(Row, Col) = strInput
                    .Cell(flexcpData, Row, Col) = .TextMatrix(Row, Col)
                    mblnChange = True
...
Private Function OPSCellEditable(ByVal lngRow As Long, ByVal lngCol As Long) As Boolean
    With vsOPS
        ...
        '必须先输入手术日期,手术名称
        If Not IsDate(.TextMatrix(lngRow, col开始日期)) Then
            If lngCol > col开始日期 Then Exit Function
        End If
...
Private Sub OPSEnterNextCell()
    ...
    With vsOPS
        '从下一单元开始循环搜索
        For i = .Row To .Rows - 1
            For j = IIf(i = .Row, .Col + 1, col开始日期) To col并发症
                If OPSCellEditable(i, j) Then Exit For
            Next
            If j <= col并发症 Then Exit For
        Next
        If i <= .Rows - 1 Then
            Call .Select(i, j)
            .ShowCell .Row, .Col
...
'参数：blnBeforSign-是否签名时保存前调用
    ...
    If Not mbln护士站 Then
        ...
        '必须要输入的内容检查
        '-----------------------------------------------------------------------------------------
        arrInfo = Array(txt住院号, txt区域)
        arrName = Array("住院号", "区域")
        ...
        arrInfo = Array(cbo付款方式, cbo民族, cbo职业, cbo入院病情)
        arrName = Array("付款方式", "民族", "职业", "入院病情")
        For i = 0 To UBound(arrInfo)
        ...
        '结构化地址长度检查
        If mbln启用结构化地址 Then
            If PatiAddress现住址.Value <> "" Then
                If zlCommFun.ActualLen(PatiAddress现住址.Value) > 100 Then
                    Call ShowMessage(PatiAddress现住址, "现住址的内容太长，只允许100个字符或50个汉字。")
                    Exit Function
                End If
            End If
            If PatiAddress户口地址.Value <> "" Then
                If zlCommFun.ActualLen(PatiAddress户口地址.Value) > 100 Then
                    Call ShowMessage(PatiAddress户口地址, "户口地址的内容太长，只允许100个字符或50个汉字。")
                    Exit Function
                End If
            End If
            If PatiAddress出生地.Value <> "" Then
                If zlCommFun.ActualLen(PatiAddress出生地.Value) > 100 Then
                    Call ShowMessage(PatiAddress出生地, "出生地的内容太长，只允许100个字符或50个汉字。")
                    Exit Function
                End If
            End If
        End If
        ...
        '会诊情况
        If chkInfo(chk会诊情况).Value = 1 Then
            If txtInfo(txt外院会诊).Text = "" And txtInfo(txt院内会诊).Text = "" And txtInfo(txt其他会诊).Text = "" Then
                Call ShowMessage(txtInfo(txt院内会诊), "勾选了会诊情况，必须填写一种会诊情况。")
                Exit Function
            End If
        End If
        ...
        With vsDiagXY
            For i = .FixedRows To .Rows - 1
                ...
                If .TextMatrix(i, col诊断类型) = "入院诊断" And .TextMatrix(i, col诊断描述) = "" Then
                    If Not sstInfo.TabVisible(TAB_中医诊断) Then
                        .Row = i: .Col = col诊断描述
                        Call ShowMessage(vsDiagXY, "必须填写入院诊断。")
                        Exit Function
                    Else
                       bln入院诊断 = True
                    End If
        ...
        If mbln中医 Then
            With vsDiagZY
                For i = .FixedRows To .Rows - 1
                    ...
                    If sstInfo.TabVisible(TAB_中医诊断) And bln入院诊断 Then
                        If .TextMatrix(i, col诊断类型) = "入院诊断" And .TextMatrix(i, col诊断描述) = "" Then
                            .Row = i: .Col = col诊断描述
                            Call ShowMessage(vsDiagZY, "必须填写入院诊断。")
                            Exit Function
                        End If
                    End If
    ...
    '                                    End If
        ...
        With vsOPS
            For i = .FixedRows To .Rows - 1
                If Trim(.TextMatrix(i, col手术名称)) <> "" Then
                    If Not IsDate(.TextMatrix(i, col开始日期)) Then
                        .Row = i: .Col = col开始日期
                        Call ShowMessage(vsOPS, "手术开始日期输入不正确。")
                        Exit Function
                    ElseIf txtInfo(txt出院时间).Text <> "" And Format(.TextMatrix(i, col开始日期), "yyyy-MM-dd HH:mm") > Format(txtInfo(txt出院时间).Text, "yyyy-MM-dd HH:mm") Or _
                        Format(.TextMatrix(i, col开始日期), "yyyy-MM-dd HH:mm") < Format(txtInfo(txt入院时间).Text, "yyyy-MM-dd HH:mm") Then
                        .Row = i: .Col = col开始日期
                        Call ShowMessage(vsOPS, "手术开始日期不在入出院日期范围内。")
                        Exit Function
                    End If
                    
                    If Not IsDate(.TextMatrix(i, col结束日期)) Then
                        .Row = i: .Col = col结束日期
                        Call ShowMessage(vsOPS, "结束日期输入不正确。")
                        Exit Function
                    ElseIf Format(.TextMatrix(i, col结束日期), "yyyy-MM-dd HH:mm") < Format(.TextMatrix(i, col开始日期), "yyyy-MM-dd HH:mm") Then
                        .Row = i: .Col = col结束日期
                        Call ShowMessage(vsOPS, "手术结束时间必须大于手术开始时间。")
                        Exit Function
                    ElseIf txtInfo(txt出院时间).Text <> "" And Format(.TextMatrix(i, col结束日期), "yyyy-MM-dd HH:mm") > Format(txtInfo(txt出院时间).Text, "yyyy-MM-dd HH:mm") Or _
                        Format(.TextMatrix(i, col结束日期), "yyyy-MM-dd HH:mm") < Format(txtInfo(txt入院时间).Text, "yyyy-MM-dd HH:mm") Then
                        .Row = i: .Col = col结束日期
                        Call ShowMessage(vsOPS, "手术结束日期不在入出院日期范围内。")
                        Exit Function
                    End If
                    
                    If .TextMatrix(i, col麻醉开始时间) <> "" Then
                        If Not IsDate(.TextMatrix(i, col麻醉开始时间)) Then
                            .Row = i: .Col = col麻醉开始时间
                            Call ShowMessage(vsOPS, "麻醉开始时间输入不正确。")
                            Exit Function
                        ElseIf txtInfo(txt出院时间).Text <> "" And Format(.TextMatrix(i, col麻醉开始时间), "yyyy-MM-dd HH:mm") > Format(txtInfo(txt出院时间).Text, "yyyy-MM-dd HH:mm") Or _
                            Format(.TextMatrix(i, col麻醉开始时间), "yyyy-MM-dd HH:mm") < Format(txtInfo(txt入院时间).Text, "yyyy-MM-dd HH:mm") Then
                            .Row = i: .Col = col麻醉开始时间
                            Call ShowMessage(vsOPS, "麻醉开始时间不在入出院日期范围内。")
                            Exit Function
                        End If
                    End If
                    
                    If Not IsDate(.TextMatrix(i, col抗菌用药时间)) And .TextMatrix(i, col抗菌用药时间) <> "" Then
                        .Row = i: .Col = col抗菌用药时间
                        Call ShowMessage(vsOPS, "抗菌用药时间输入不正确。")
                        Exit Function
                    End If
            ...
            For i = .FixedRows To .Rows - 1
                If .TextMatrix(i, 0) <> "" Then
                    If Not IsDate(.TextMatrix(i, 0)) Then
                        If .TextMatrix(i, 1) <> "" Or .RowData(i) <> "" Then
                            .Row = i: .Col = 0
                            Call ShowMessage(vsInfect, "输入的确诊日期不是日期类型，请检查。")
                            Exit Function
                        End If
                    Else
                        If .TextMatrix(i, 1) = "" Then
                            .Row = i: .Col = 1
                            Call ShowMessage(vsInfect, "必须填写感染部位。")
                            Exit Function
        
                        End If
                        If .RowData(i) = "" Then
                            .Row = i: .Col = 2
                            Call ShowMessage(vsInfect, "必须填写医院感染名称。")
                            Exit Function
                        End If
                    End If
        ...
        With vsSample
            For i = .FixedRows To .Rows - 1
                If .TextMatrix(i, 0) <> "" Then
                    If .TextMatrix(i, 1) = "" Then
                        .Row = i: .Col = 1
                        Call ShowMessage(vsSample, "必须填写病原学代码。")
                        Exit Function
                    End If
                    
                    If .TextMatrix(i, 2) = "" Then
                        .Row = i: .Col = 2
                        Call ShowMessage(vsSample, "必须填写送检日期。")
                        Exit Function
                    Else
                        If Not IsDate(.TextMatrix(i, 2)) Then
                            .Row = i: .Col = 2
                            Call ShowMessage(vsSample, "输入的确诊日期不是日期类型，请检查。")
                            Exit Function
                        End If
                    End If
        ...
        If Check重症监护() = False Then Exit Function
        
        '器械和导管
        For i = 1 To vsFlx器械和导管.Rows - 1
            If vsFlx器械和导管.TextMatrix(i, 1) <> "" And vsFlx器械和导管.TextMatrix(i, 0) <> "" Then
                vsFlx器械和导管.Row = i: vsFlx器械和导管.Col = 2
                If vsFlx器械和导管.TextMatrix(i, 2) = "" Then
                    ShowMessage vsFlx器械和导管, "器械导管的开始使用时间必须输入。"
                    Exit Function
                End If
                
                Call vsFlx器械和导管_ValidateEdit(i, 2, blnCancel)
                If blnCancel Then Exit Function
                
                vsFlx器械和导管.Row = i: vsFlx器械和导管.Col = 3
                If vsFlx器械和导管.TextMatrix(i, 3) = "" Then
                    ShowMessage vsFlx器械和导管, "器械导管的结束使用时间必须输入。"
                    Exit Function
                End If
                Call vsFlx器械和导管_ValidateEdit(i, 3, blnCancel)
                If blnCancel Then Exit Function
...
'参数:lngIndex-传入的年龄索引，分为婴儿的和病人本身的
    Dim strTmp As String
    Dim lng单位 As Long
    '是否可以使用年龄单位，可以使用年龄单位的格式为：数字+年龄单位
    Dim blnUse单位 As Boolean
    ...
    If InStr(strOld, "岁") > 0 And lngIndex = txt年龄 Then
        If InStr(strOld, "岁") = Len(strOld) Then
            ...
            If IsNumeric(strTmp) Then
                ...
                If cboinfo(lng单位).ListCount > 0 Then
                    cboinfo(lng单位).ListIndex = 0
                End If
            End If
        End If
    ElseIf InStr(strOld, "月") > 0 Then
        If InStr(strOld, "月") = Len(strOld) Then
            ...
            If IsNumeric(strTmp) Then
                blnUse单位 = True
                txtInfo(lngIndex).Text = Val(strTmp)
    ...
    ElseIf InStr(strOld, "天") > 0 Then
        If InStr(strOld, "天") = Len(strOld) Then
            ...
            If IsNumeric(strTmp) Then
                ...
                txtInfo(lngIndex).Text = Val(strTmp)
                If cboinfo(lng单位).ListCount > 1 Then
                    cboinfo(lng单位).ListIndex = IIf(lngIndex = txt年龄, 2, 1)
                End If
            End If
        End If
    ElseIf InStr(strOld, "小时") > 0 Then
        If InStr(strOld, "小时") + 1 = Len(strOld) Then
            ...
            If IsNumeric(strTmp) Then
                ...
                txtInfo(lngIndex).Text = Val(strTmp)
                If cboinfo(lng单位).ListCount > 1 Then
                    cboinfo(lng单位).ListIndex = IIf(lngIndex = txt年龄, 3, 2)
                End If
            End If
        End If
    ElseIf InStr(strOld, "分钟") > 0 Then
        If InStr(strOld, "分钟") + 1 = Len(strOld) Then
            ...
            If IsNumeric(strTmp) Then
                ...
                txtInfo(lngIndex).Text = Val(strTmp)
                If cboinfo(lng单位).ListCount > 1 Then
                    cboinfo(lng单位).ListIndex = IIf(lngIndex = txt年龄, 4, 3)
                End If
            End If
        End If
    ElseIf IsNumeric(strOld) Then
        blnUse单位 = True
        txtInfo(lngIndex).Text = Val(strOld)
        If cboinfo(lng单位).ListCount > 0 Then
            cboinfo(lng单位).ListIndex = 0
        End If
    End If
    
    If blnUse单位 = False Then
...
'参数：blnBeforSign-是否签名时保存前调用
    ...
    Dim arrTmp As Variant
    Dim str感染部位 As String, str感染与死亡 As String
    Dim str关联医嘱IDs As String
    ...
    '感染部位   感染与死亡关系
    '填写了院内感染才读取，否则默认空值
    If Trim(vsDiagXY.TextMatrix(GetRow(5), col诊断描述)) <> "" Then
        str感染部位 = ""
        For i = 1 To lvwInfectParts.ListItems.Count
            If lvwInfectParts.ListItems.Item(i).Checked = True Then
                str感染部位 = Trim(lvwInfectParts.ListItems.Item(i).Text) & "|" & str感染部位
            Else
                str感染部位 = "" & "|" & str感染部位
            End If
        Next i
        ...
        If str感染部位 <> "" Then
            If Trim(Replace(str感染部位, "|", "")) = "" Then
                str感染部位 = ""
            End If
        End If
        
        str感染与死亡 = NeedName(cboinfo(cbo感染与死亡).Text)
    End If
    '生育状况
    ...
    If mbln护士站 And mbln医生护士分填首页 Or Not mbln护士站 And Not mbln医生护士分填首页 Then
        arrField护士 = Array("不良事件", "压疮发生期间", "压疮分期", "跌倒或坠床伤害", "跌倒或坠床原因", "输液药物", "输液表现", "身体约束", "透析尿素氮值", "输液反应")
        arrValue护士 = Array(str不良事件, IIf(blnIsYCcheck, cboinfo(cbo压疮发生期间).Text, ""), IIf(blnIsYCcheck, cboinfo(cbo压疮分期).Text, ""), _
                    ...
                    txtInfo(txt引发药物).Text, txtInfo(txt临床表现).Text, chkInfo(chk住院期间身体约束).Value, txtInfo(txt离院时透析).Text, NeedName(cboinfo(cbo输液反应).Text))
    End If
    '医生站保存医生需填信息部分
    If Not mbln护士站 Then
        arrField医生 = Array("入院病室", "出院病室", "转科记录", _
                    "中医危重", "中医急症", "中医疑难", "中医抢救方法", "自制中药制剂", "死亡根本原因", "死亡时间", _
                    "入院前经外院治疗", "示教病案", "科研病案", "Rh", "输血反应", "输红细胞", "输血小板", "输血浆", "输全血", "输其他", _
                    "科主任", "主任医师", "主治医师", "进修医师", "主诊医师", "实习医师", _
                    "质控医师", "质控护士", "病原学检查", "输血检查", _
                    ...
                    "输白蛋白", "疑难病历", "告病重病危", "临床路径", "退出原因", "变异原因", "会诊情况", "院内会诊", "外院会诊", "CT", "PETCT", _
                    "双源CT", "X片", "B超", "超声心动图", "MRI", "同位素检查", "生育状况", "发病时间", _
                    "医学警示", "其他医学警示", "感染与死亡关系", "感染部位")
        ...
        arrValue医生 = Array(txtInfo(txt入院病室).Text, txtInfo(txt出院病室).Text, str转科科室, _
                    ...
                    chkInfo(chk科研病案).Value, NeedName(cboinfo(cboRh).Text), IIf(cboinfo(cbo输血反应).ListIndex = -1, "", cboinfo(cbo输血反应).ListIndex), _
                    txtInfo(txt输红细胞).Text, txtInfo(txt输血小板).Text, txtInfo(txt输血浆).Text, _
                    txtInfo(txt输全血).Text, txtInfo(txt输其他).Text, _
                    ...
                    NeedName(cboinfo(cbo主诊医师).Text), NeedName(cboinfo(cbo实习医师).Text), _
                    NeedName(cboinfo(cbo质控医师).Text), NeedName(cboinfo(cbo质控护士).Text), _
                    chkInfo(chk病原学).Value, NeedName(cboinfo(cbo输血检查).Text), _
                     str病例分型, str感染因素, str出院去向, IIf(cboinfo(cbo出院方式).Text = "转院" Or cboinfo(cbo出院方式).Text = "转社区", txtInfo(txt出院转入).Text, ""), _
                    ...
                    , txtInfo(txt输白蛋白).Text, chkInfo(chk疑难病例).Value, chkInfo(chk住院期间告病重或病危).Value, chkInfo(chk进入路径).Value, IIf(chkInfo(chk完成路径).Value = 1, "1", txtInfo(txt退出原因).Text), IIf(chkInfo(chk变异).Value = 0, "0", IIf(txtInfo(txt变异原因).Text = "", " ", txtInfo(txt变异原因).Text)) _
                    , IIf(chkInfo(chk会诊情况).Value = 0, "0", txtInfo(txt其他会诊).Text), txtInfo(txt院内会诊).Text, txtInfo(txt外院会诊).Text, Mid(vsCheck.TextMatrix(rowct, 1), 1, 1), Mid(vsCheck.TextMatrix(rowPETCT, 1), 1, 1), Mid(vsCheck.TextMatrix(row双源CT, 1), 1, 1), Mid(vsCheck.TextMatrix(rowX片, 1), 1, 1) _
                    , Mid(vsCheck.TextMatrix(rowB超, 1), 1, 1), Mid(vsCheck.TextMatrix(row超声心动图, 1), 1, 1), Mid(vsCheck.TextMatrix(rowMRI, 1), 1, 1), Mid(vsCheck.TextMatrix(row同位素检查, 1), 1, 1), _
                    str生育状况, str发病, txtInfo(txt医学警示).Text, txtInfo(txt其他医学警示).Text, str感染与死亡, str感染部位)
    End If
    ...
    If Not mbln护士站 Then
        ...
        arrSQL(UBound(arrSQL)) = "ZL_病人信息_首页整理(" & _
            ...
            ZVal(lng单位ID) & ",'" & IIf(mbln启用结构化地址, PatiAddress户口地址.Value, txtInfo(txt户口地址).Text) & "','" & txtInfo(txt户口邮编).Text & "','" & IIf(mbln启用结构化地址, PatiAddress籍贯.Value, txtInfo(txt籍贯).Text) & "','" & _
            txtInfo(txtEmail).Text & "','" & txtInfo(txtqq).Text & "')"
            ...
            With vsDiagXY
                ...
                For i = .FixedRows To .Rows - 1
                    If Trim(.TextMatrix(i, col诊断描述)) <> "" Then
                        ...
                        End If
                        str关联医嘱IDs = IIf(.RowData(i) & "" = "", "Null", "'" & .RowData(i) & "'")
                        ...
                        If blnDiagChange Then
                            arrSQL(UBound(arrSQL)) = "ZL_病人诊断记录_INSERT(" & mlng病人ID & "," & mlng主页ID & ",3,NULL," & _
                                ...
                                str关联医嘱IDs & "," & intIdx & ",'" & .TextMatrix(i, col备注) & "','" & .TextMatrix(i, col入院病情) & "',Null,'" & UserInfo.姓名 & "')"
                        Else
                            arrSQL(UBound(arrSQL)) = "ZL_病人诊断记录_INSERT(" & mlng病人ID & "," & mlng主页ID & ",3,NULL," & _
                                Val(.TextMatrix(i, col类型)) & "," & ZVal(.TextMatrix(i, col疾病ID)) & "," & ZVal(.TextMatrix(i, col诊断ID)) & "," & _
                                "NULL,'" & str诊断描述 & "','" & NeedName(.TextMatrix(i, col出院情况)) & "'," & _
                                ...
                                str关联医嘱IDs & "," & intIdx & ",'" & .TextMatrix(i, col备注) & "','" & .TextMatrix(i, col入院病情) & "',Null,'" & mrsXYDiag!记录人 & "')"
                        End If
                    ...
                    If Trim(.TextMatrix(i, col诊断描述)) <> "" Then
                        ...
                        Else
                            arrSQL(UBound(arrSQL)) = "ZL_病人诊断记录_INSERT(" & mlng病人ID & "," & mlng主页ID & ",3,NULL," & _
                                ...
                                str关联医嘱IDs & "," & intIdx & ",'" & .TextMatrix(i, col备注) & "','" & .TextMatrix(i, col入院病情) & "',Null,'" & mrsZYDiag!记录人 & "')"
                ...
                For i = .FixedRows To .Rows - 1
                    If Trim(.TextMatrix(i, col手术名称)) <> "" Then
                        ...
                        arrSQL(UBound(arrSQL)) = "ZL_病人手麻记录_Insert(" & _
                            ...
                            "To_Date('" & Format(.TextMatrix(i, col开始日期), "yyyy-MM-dd") & "','YYYY-MM-DD'),To_Date('" & Format(.TextMatrix(i, col开始日期), "yyyy-MM-dd HH:mm") & "','YYYY-MM-DD HH24:MI')," & _
                            "To_Date('" & Format(.TextMatrix(i, col结束日期), "yyyy-MM-dd HH:mm") & "','YYYY-MM-DD HH24:MI'),NULL," & ZVal(.TextMatrix(i, col手术操作ID)) & "," & ZVal(.TextMatrix(i, col诊疗项目ID)) & "," & _
                            "'" & .TextMatrix(i, col手术名称) & "','" & .TextMatrix(i, col主刀医师) & "','" & .TextMatrix(i, col助产护士) & "'," & _
                            "'" & .TextMatrix(i, col助手1) & "','" & .TextMatrix(i, col助手2) & "',NULL,To_Date('" & Format(.TextMatrix(i, col麻醉开始时间), "yyyy-MM-dd HH:mm") & "','YYYY-MM-DD HH24:MI'),NULL," & _
                            ...
                            lng手术分级 & "," & IIf(.TextMatrix(i, col准备天数) = "", "NULL", .TextMatrix(i, col准备天数)) & ",To_Date('" & Format(.TextMatrix(i, col抗菌用药时间), "yyyy-MM-dd HH:mm") & "','YYYY-MM-DD HH24:MI'),'" & .TextMatrix(i, col切口部位) & "'," & IIf(Val(.TextMatrix(i, col切口感染)) = -1, 1, "Null") & _
                            "," & IIf(Val(.TextMatrix(i, col并发症)) = -1, 1, "Null") & "," & IIf(Val(.TextMatrix(i, col重返手术室计划)) = -1, 1, "Null") & ",'" & .TextMatrix(i, col重返手术室目的) & "')"
                    End If
                Next
            End With
        End If
            ...
            With vsKSS
                ...
                For i = 0 To UBound(ArrDel)
                    ...
                    arrSQL(UBound(arrSQL)) = "Zl_病人抗生素记录_Update(" & _
                            "2," & mlng病人ID & "," & mlng主页ID & "," & ArrDel(i) & ",'" & .TextMatrix(i, kss名称) & "',NULL,NULL,NULL,'" & UserInfo.姓名 & "',To_Date('" & Format(curDate, "yyyy-MM-dd HH:mm:ss") & "','YYYY-MM-DD HH24:MI:SS'))"
                Next
                '插入、如果存在则修改界面上的数据
                For i = 1 To .Rows - 1
                    If Val(.RowData(i) & "") <> 0 Then
                        ...
                        arrSQL(UBound(arrSQL)) = "Zl_病人抗生素记录_Update(" & _
                                ...
                                "','" & .TextMatrix(i, kss使用阶段) & "'," & Val(.TextMatrix(i, kss使用天数)) & ",'" & UserInfo.姓名 & "',To_Date('" & Format(curDate, "yyyy-MM-dd HH:mm:ss") & "','YYYY-MM-DD HH24:MI:SS')" & _
        ...
        If vsFlx附页重症.Tag = "" Then
            ...
            With vsFlx附页重症
                For lngRow = 1 To .Rows - 1
                    ...
                    '  进入时间_In   In 病案重症监护情况.进入时间%Type,
                    '  退出时间_In   In 病案重症监护情况.退出时间%Type
                    If .TextMatrix(lngRow, 1) <> "" Then
                        StrSQL = "Zl_病案重症监护情况_Insert("
                        StrSQL = StrSQL & "" & mlng病人ID & ","
                        StrSQL = StrSQL & "" & mlng主页ID & ","
                        StrSQL = StrSQL & "" & lngRow & ","
                        StrSQL = StrSQL & "'" & Split(Trim(.TextMatrix(lngRow, 1)), ".")(1) & "',"
                        '入住时间
                        strTemp = Trim(.TextMatrix(lngRow, 2))
                        If strTemp <> "" Then
                            strTemp = "to_date('" & strTemp & "','yyyy-mm-dd hh24:mi')"
                        Else
                            strTemp = "NULL"
                        End If
                        ...
                        '转出时间
                        strTemp = Trim(.TextMatrix(lngRow, 3))
                        ...
                        '再入住计划
                        StrSQL = StrSQL & .Cell(flexcpChecked, lngRow, 4) & ",'"
                        '再入住原因
                        StrSQL = StrSQL & Trim(.TextMatrix(lngRow, 5)) & "')"
                        ReDim Preserve arrSQL(UBound(arrSQL) + 1)
                        arrSQL(UBound(arrSQL)) = StrSQL
                    End If
                Next
        ...
        If vsFlx器械和导管.Tag = "" Then
            ReDim Preserve arrSQL(UBound(arrSQL) + 1)
            arrSQL(UBound(arrSQL)) = "Zl_器械导管使用情况_Delete(" & mlng病人ID & "," & mlng主页ID & ")"
            
            With vsFlx器械和导管
                For lngRow = 1 To .Rows - 1
    
                    If .TextMatrix(lngRow, 0) <> "" And .TextMatrix(lngRow, 1) <> "" Then
                        StrSQL = "Zl_器械导管使用情况_Insert("
                        StrSQL = StrSQL & "" & mlng病人ID & ","
                        StrSQL = StrSQL & "" & mlng主页ID & ","
                        StrSQL = StrSQL & "" & .TextMatrix(lngRow, 5) & ","
                        StrSQL = StrSQL & "'" & Mid(.TextMatrix(lngRow, 0), InStr(.TextMatrix(lngRow, 0), "-") + 1) & "','"
       
                        '器械及导管
                        arrTmp = Split(Trim(.TextMatrix(lngRow, 1)), ".")
                        If UBound(arrTmp) > 0 Then
                            StrSQL = StrSQL & arrTmp(0) & "',"
                        Else
                            StrSQL = StrSQL & "',"
                        End If
                        '开始使用时间
                        ...
                        StrSQL = StrSQL & "" & strTemp & ","
                        '感染累计时间
                        StrSQL = StrSQL & "'" & Trim(.TextMatrix(lngRow, 4)) & "')"
                        ReDim Preserve arrSQL(UBound(arrSQL) + 1)
                        arrSQL(UBound(arrSQL)) = StrSQL
                    End If
                Next
        ...
        '感染情况
        If vsInfect.Tag = "" Then
            ReDim Preserve arrSQL(UBound(arrSQL) + 1)
            arrSQL(UBound(arrSQL)) = "Zl_病人感染记录_Delete(" & mlng病人ID & "," & mlng主页ID & ")"
            With vsInfect
                For lngRow = 1 To .Rows - 1
                    If .TextMatrix(lngRow, 0) <> "" And .RowData(lngRow) <> "" And .TextMatrix(lngRow, 1) <> "" Then
                        StrSQL = "Zl_病人感染记录_Insert("
                        StrSQL = StrSQL & "" & lngRow & ","
                        StrSQL = StrSQL & "" & mlng病人ID & ","
                        StrSQL = StrSQL & "" & mlng主页ID & ","
                        '确诊日期
                        strTemp = Trim(.TextMatrix(lngRow, 0))
                        If strTemp <> "" Then
                            strTemp = "to_date('" & strTemp & "','yyyy-mm-dd hh24:mi')"
                        Else
                            strTemp = "NULL"
                        ...
                        arrTmp = Split(Trim(.TextMatrix(lngRow, 1)), ".")
                        If UBound(arrTmp) > 0 Then
                            StrSQL = StrSQL & "'" & arrTmp(1) & "',"
                        Else
                            StrSQL = StrSQL & "',"
                        End If
                        '感染名称
                        StrSQL = StrSQL & "'" & .RowData(lngRow) & "')"
                        ReDim Preserve arrSQL(UBound(arrSQL) + 1)
                        arrSQL(UBound(arrSQL)) = StrSQL
                    End If
                Next
        ...
        '标本来源
        If vsSample.Tag = "" Then
            ReDim Preserve arrSQL(UBound(arrSQL) + 1)
            arrSQL(UBound(arrSQL)) = "Zl_病人病原学检查_Delete(" & mlng病人ID & "," & mlng主页ID & ")"
            With vsSample
                For lngRow = 1 To .Rows - 1
                    If .TextMatrix(lngRow, 0) <> "" And .TextMatrix(lngRow, 1) <> "" And .TextMatrix(lngRow, 2) <> "" Then
                        StrSQL = "Zl_病人病原学检查_Insert("
                        StrSQL = StrSQL & "" & lngRow & ","
                        StrSQL = StrSQL & "" & mlng病人ID & ","
                        StrSQL = StrSQL & "" & mlng主页ID & ","
                        '标本
                        arrTmp = Split(Trim(.TextMatrix(lngRow, 0)), ".")
                        If UBound(arrTmp) > 0 Then
                            StrSQL = StrSQL & "'" & arrTmp(0) & "',"
                        Else
                            StrSQL = StrSQL & "'',"
...
'功能：根据当前是否只读，设置界面的可编辑属性
    ...
    For Each objControl In Me.Controls
        ...
        If InStr("TextBox;MaskEdBox;ComboBox;CheckBox;VSFlexGrid;ListBox;OptionButton;CommandButton;DTPicker;PatiAddress", strTypeName) > 0 Then
            'TabStop=False表示当前确实不可编辑的
            If TypeName(objControl.Container) = "Frame" And (objControl.TabStop = True Or strTypeName = "OptionButton" And objControl.TabStop = False) Then
               '首页可编辑
                If Not blnTmp Then
                    If mbln医生护士分填首页 And mbln护士站 Then '护士站调用首页时只能填写不良事件
                        If strTypeName <> "PatiAddress" Then
                            If objControl.Container.hwnd <> fraAdvEvent.hwnd And InStr("," & cboinfo(cbo输液反应).hwnd & "," & txtInfo(txt引发药物).hwnd & _
                                "," & txtInfo(txt临床表现).hwnd & "," & chkInfo(chk住院期间身体约束).hwnd & "," & txtInfo(txt离院时透析).hwnd & ",", "," & objControl.hwnd & ",") = 0 Then
                                blnTmp = True
                    ...
                    Else
                        ...
                        '入院时间之后的不受控制,病人基本信息：姓名，性别，年龄，出生日期不可编辑
                            If objControl.TabIndex < 85 Then
                                Select Case strTypeName
                                    Case "TextBox", "ComboBox"
                                        If objControl.hwnd = txtInfo(txt姓名).hwnd Then '病人基本信息，年龄，性别，出生日期，姓名 不允许修改
                                            blnTmp = True
                                        ElseIf objControl.hwnd = cboinfo(cbo性别).hwnd Then
                                            blnTmp = True
                                        ElseIf objControl.hwnd = txtInfo(txt年龄).hwnd Then
                                            blnTmp = True
                                        ElseIf objControl.hwnd = cboinfo(cbo年龄单位).hwnd Then
                                            blnTmp = True
                                        ElseIf objControl.Text <> "" Then
                                            If bln首页 Then blnTmp = True
                                        End If
                                        
                                    Case "MaskEdBox"
                                        If objControl.Name = "txt出生日期" Then
                                            blnTmp = True
                                        ElseIf objControl.Name = "txt出生时间" Then
                                            blnTmp = True
                                        End If
                                    Case "CheckBox"
                        ...
                        If mbln不使用西医项目 And mbln中医 Then
                            ...
                            "," & cboinfo(cbo输血检查).hwnd & "," & txtInfo(txt输白蛋白).hwnd & _
                             "," & cboinfo(cbo随诊Ex).hwnd & "," & txtInfo(txt输红细胞).hwnd & "," & txtInfo(txt输其他).hwnd & _
                            ...
                            End If
                        End If
                        If mbln医生护士分填首页 And Not mbln护士站 And strTypeName <> "PatiAddress" Then '医生站不能填写不良事件
                            If objControl.Container.hwnd = fraAdvEvent.hwnd Or InStr("," & cboinfo(cbo输液反应).hwnd & "," & txtInfo(txt引发药物).hwnd & _
                            "," & txtInfo(txt临床表现).hwnd & "," & chkInfo(chk住院期间身体约束).hwnd & "," & txtInfo(txt离院时透析).hwnd & ",", "," & objControl.hwnd & ",") > 0 Then
                                blnTmp = True
                                objControl.TabStop = False
                            End If
                    ...
                    End If
                End If
                If strTypeName = "TextBox" And objControl.Enabled Then
                    objControl.BackColor = IIf(blnTmp, vbButtonFace, vbWindowBackground)
                    objControl.Locked = blnTmp
                ElseIf strTypeName = "MaskEdBox" Then
                    '没有Locked属性,用Enabled实现
                    objControl.Enabled = Not blnTmp
                    objControl.BackColor = IIf(blnTmp, vbButtonFace, vbWindowBackground)
                ElseIf strTypeName = "ComboBox" And objControl.Enabled Then
                    If Not ((objControl Is cboinfo(cbo科主任) Or objControl Is cboinfo(cbo主任医师) _
                        ...
                        objControl.Locked = blnTmp
                    End If
                ElseIf strTypeName = "CheckBox" Then
                    '没有Locked属性,用Enabled实现
                    objControl.Enabled = Not blnTmp
                ElseIf strTypeName = "DTPicker" Then
                    objControl.Enabled = Not blnTmp
                ElseIf strTypeName = "VSFlexGrid" Then
                    '同时注意要在键盘鼠标事件中进行一些控制
                ...
                ElseIf strTypeName = "ListBox" Then
                    objControl.Enabled = IIf(blnTmp, False, True)
                    objControl.BackColor = IIf(blnTmp, vbButtonFace, vbWindowBackground)
                ElseIf strTypeName = "CommandButton" Then
                    If objControl.Name = "cmdAutoLoad" Or objControl.Name = "cmdPathLoad" Then
                        objControl.Enabled = IIf(blnTmp, False, True)
                    End If
                ElseIf strTypeName = "PatiAddress" Then
                    objControl.ControlLock = blnTmp
                End If
            End If
            '"OptionButton"这种用Enabled判断
            If strTypeName = "OptionButton" And TypeName(objControl.Container) = "Frame" And objControl.Enabled = True Then
                objControl.Enabled = IIf(blnTmp, False, True)
    ...
    Next
    '首页不可编辑的状况下，隐藏诊断移动按钮
    For i = cmdMove.LBound To cmdMove.UBound
        cmdMove(i).Visible = Not mblnReadOnly And Not mbln护士站
    Next
End Sub
...
'                '不处理.Cell(flexcpData, Row, Col)，以便修改内容时再次使用like判断
        ...
        ElseIf Col = col助产护士 Then
            ...
            End If
            mblnReturn = False
        ElseIf Col = COL手术情况.COL手术情况 Or Col = colASA分级 Or Col = colNNIS分级 Or Col = col重返手术室目的 Or Col = col切口部位 Or Col = col准备天数 Then
            If .TextMatrix(Row, Col) <> .EditText Then
                If Col = col重返手术室目的 Or Col = col切口部位 Then
                    If LenB(StrConv(.EditText, vbFromUnicode)) > 100 Then
                        MsgBox "不能超过50个汉字的长度。", vbInformation, Me.Caption
                        Cancel = True
                        Exit Sub
                    End If
                ElseIf Col = col准备天数 Then
                    If Val(.EditText) > 999 Then
                        MsgBox "准备天数不能超过三位数。", vbInformation, Me.Caption
                        Cancel = True
                        Exit Sub
                    End If
                End If
...
Private Function CheckDateRange(ByVal strDate As String, Optional strFomart As String, Optional ByVal blnCheckData As Boolean) As Boolean
    '检查录入日期是否在入出院日期范围内，
    ...
    If UCase(strFomart) = "YYYY-MM-DD" Then
...
Private Sub vsSample_ChangeEdit()
    mblnChange = True
    vsSample.Tag = ""
End Sub
...
Private Sub vsSample_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    End If
    If KeyCode = vbKeyReturn Then
        If Trim(vsSample.TextMatrix(vsSample.Row, 0)) = "" Then
            If sstInfo.Tabs > sstInfo.Tab + 1 Then sstInfo.Tab = sstInfo.Tab + 1
            If lstAdvEvent.Enabled Then lstAdvEvent.SetFocus
            Exit Sub
        End If
        
    End If
    Call VsGriedFocuesMove(vsSample, vsSample.Row, vsSample.Col, KeyCode)
End Sub

Private Sub vsSample_KeyDownEdit(ByVal Row As Long, ByVal Col As Long, KeyCode As Integer, ByVal Shift As Integer)
    Dim strKEY As String
    ...
    With vsSample
        Select Case Col
        Case 2
            Call VsGriedFocuesMove(vsSample, Row, Col, vbKeyReturn)
        End Select
    End With
End Sub

Private Sub vsSample_KeyPress(KeyAscii As Integer)
    If mbln护士站 Or mblnReadOnly Then Exit Sub
    If KeyAscii = vbKeyReturn Then KeyAscii = 0
End Sub

Private Sub vsSample_KeyPressEdit(ByVal Row As Long, ByVal Col As Long, KeyAscii As Integer)
    Dim strKEY As String
    ...
    Select Case Col
    Case 0, 1, 2
        Call VsFlxGridCheckKeyPress(vsSample, Row, Col, KeyAscii, m文本式)
    Case Else
    End Select
End Sub
...
Private Sub vsSample_ValidateEdit(ByVal Row As Long, ByVal Col As Long, Cancel As Boolean)
    Dim intCol As Integer
    Dim strTemp As String, strKEY As String
    ...
    Case 2
        ...
        strKEY = Replace(strKEY, Chr(10), "")
        If Not IsDate(strKEY) Then
            MsgBox vsSample.TextMatrix(Row, Col) & "必须为日期型,请重新输入！", vbInformation + vbDefaultButton1, Me.Caption
            Cancel = True
            zlCommFun.PressKey vbKeySpace
            vsSample.EditSelStart = 0
            vsSample.EditSelLength = 1000
            Exit Sub
        End If
        If Not CheckDateRange(strKEY, "yyyy-MM-dd") Then
            MsgBox "您输入的时间必须在病人的住院期间。", vbInformation, Me.Caption
        ...
        End If
    End Select
    If vsSample.EditText <> vsSample.TextMatrix(Row, Col) Then vsSample.Tag = "": mblnChange = True
End Sub
...
Private Sub FillVsf()
    ...
    If (rsTemp.RecordCount Mod 3) <> 0 Then
        vsfMain.Rows = rsTemp.RecordCount \ 3 + 2
    Else
        vsfMain.Rows = rsTemp.RecordCount \ 3 + 1
    End If
    With vsfMain
        .Cols = 9
        For lngRow = 0 To 6 Step 3
            .TextMatrix(0, lngRow) = "项目"
            .TextMatrix(0, lngRow + 1) = "内容"
            .ColWidth(0 + lngRow) = 1600
            .ColWidth(1 + lngRow) = 1600
        ...
        .Cell(flexcpBackColor, 1, 6, .Rows - 1, 6) = &HFCE7D8
        .ColAlignment(0) = flexAlignCenterCenter
        .ColAlignment(3) = flexAlignCenterCenter
...
Private Sub ShowInfectInfo(Optional ByVal blnShow As Boolean = True, Optional ByVal lngLeft As Long, Optional ByVal lngTop As Long)
'功能：对感染信息显示并设置位置或隐藏
'参数：blnShow=true,显示感染信息；false,隐藏感染信息
'      lngLeft,lngTop=感染信息的位置，相对于首页信
    picInfectInfo.Visible = blnShow
    picInfectInfo.Top = lngTop - Me.Top - sstInfo.Top - fraInfo(TAB_西医诊断).Top - 60
    picInfectInfo.Left = lngLeft - Me.Left - sstInfo.Left - fraInfo(TAB_西医诊断).Left - 30
End Sub

Private Sub GetDiagTypeScope(ByVal lngType As Long, ByRef lngBgn As Long, ByRef lngEnd As Long)
'功能：获取当前诊断类型的范围
'参数：lngType=当前类型
'返回：lngBgn=当前类型的起始行
'      lngEnd=当前类型结束行
    ...
    lngCol = IIf(lngType > 10, colzy类型, col类型)
    Set vsDiagTmp = IIf(lngType > 10, vsDiagZY, vsDiagXY)
    
    With vsDiagTmp
        For i = .FixedRows To .Rows - 1
            If Val(.TextMatrix(i, lngCol)) = lngType Then
...
'   lngRow=需判定的行，一般为当前行
    ...
    i = IIf(lngType > 10, 1, 0)
    '根据当前行的位置设置移动诊断控件的可用性
    Call GetDiagTypeScope(lngType, lngBgn, lngEnd)
    If lngBgn = lngEnd Then '只有一行诊断，则不可移动
        DiagRowCanMove = False
    ElseIf lngRow = lngBgn Then '当前行是本分类第一行，则只能下移
        DiagRowCanMove = intStep = 1 And Not mblnReadOnly And Not mbln护士站
    ElseIf lngRow = lngEnd Then '当前行是本分类最后一行，则只能上
        DiagRowCanMove = intStep = -1 And Not mblnReadOnly And Not mbln护士站
    Else  '当前行是本分类中间某一行，则可以上下移动
        DiagRowCanMove = Not mblnReadOnly And Not mbln护士站
    End If
End Function

Private Sub MoveDiagRows(ByRef vsDiagTmp As VSFlexGrid, ByVal intStep As Integer)
'功能：移动诊断行
'参数：vsDiagTmp=当前诊断表格
'      intStep=移动位置，1-向下移动，-1向上移动
    ...
    bln西医 = vsDiagTmp.Name = "vsDiagXY"
    
    With vsDiagTmp
        If Not DiagRowCanMove(intStep, Val(.TextMatrix(.Row, IIf(bln西医, col类型, colzy类型))), .Row) Then Exit Sub
        If .Row < 0 Then
            Exit Sub
        End If
        ...
        If bln西医 Then
            If .TextMatrix(IIf(intStep > 0, .Row, .Row + intStep), col诊断类型) = "出院诊断" Then
                strTmp = UCase(Trim(.TextMatrix(IIf(intStep > 0, .Row, .Row + intStep), col诊断编码)))
            ...
            End If
            '设置诊断符合情况
            Call Set西医诊断相关(IIf(intStep > 0, .Row, .Row + intStep))
            Call Set病原学
        End If
        .Row = .Row + intStep
