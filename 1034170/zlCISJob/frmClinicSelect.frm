    ...
    If strSel <> "" Then
        ...
        Do While Not rsTemp.EOF
            ...
            If blnAdd = True Then
                ...
                vfgBound.TextMatrix(vfgBound.Rows - 1, 2) = CStr(zlcommfun.Nvl(rsTemp!类别))
                vfgBound.TextMatrix(vfgBound.Rows - 1, 3) = CStr(zlcommfun.Nvl(rsTemp!编码))
                vfgBound.TextMatrix(vfgBound.Rows - 1, 4) = CStr(zlcommfun.Nvl(rsTemp!名称))
