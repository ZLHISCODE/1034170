...
Begin VB.Form frmTechnicStation 
   ...
   Begin MSComctlLib.ImageList imgPati 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   20
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":C042
            Key             =   "Pati"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":C5DC
            Key             =   "Meet"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":CB76
            Key             =   "MeetFinish"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":D110
            Key             =   "Notify"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":D6AA
            Key             =   "等待审查"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":DC44
            Key             =   "拒绝审查"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":E1DE
            Key             =   "正在审查"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":E778
            Key             =   "正在抽查"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":F18A
            Key             =   "审查反馈"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":FB9C
            Key             =   "抽查反馈"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":10136
            Key             =   "审查整改"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":10B48
            Key             =   "抽查整改"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":1155A
            Key             =   "未导入"
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":11AF4
            Key             =   "变异结束"
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":1208E
            Key             =   "正常结束"
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":12628
            Key             =   "不符合"
         EndProperty
         BeginProperty ListImage17 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":1303A
            Key             =   "执行中"
         EndProperty
         BeginProperty ListImage18 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":135D4
            Key             =   "Child"
         EndProperty
         BeginProperty ListImage19 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":13B6E
            Key             =   "单病种"
         EndProperty
         BeginProperty ListImage20 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTechnicStation.frx":1A3D0
            Key             =   "Out"
         EndProperty
      EndProperty
   End
   ...
   Begin XtremeDockingPane.DockingPane dkpMain 
      Bindings        =   "frmTechnicStation.frx":1A96A
      Left            =   705
      Top             =   210
      _Version        =   589884
      _ExtentX        =   450
...
'       int费用性质 1-门诊费用，2-住院费用'
    ...
    If bln单独执行 Then
        ...
        strSQL = "Select -1 * Sum(Nvl(a.付数, 1) * a.数次 / b.数量) As 最大已销数" & vbNewLine & _
                ...
                "Where a.医嘱序号 = [1] And A.NO=[3] And b.医嘱id = a.医嘱序号 And b.收费细目id = a.收费细目id And Nvl(B.费用性质,0)=0 And (a.记录状态 = 2 And a.记录性质 in(1,2) or a.记录性质=11) And a.价格父号 Is Null And" & vbNewLine & _
    ...
    Else
        strSQL = "Select Max(c.已销数) 最大已销数" & vbNewLine & _
                ...
                "             b.收费细目id = a.收费细目id And Nvl(B.费用性质,0)=0 And (a.记录状态 = 2 And a.记录性质 in(1,2) or a.记录性质=11) And a.价格父号 Is Null And a.收费类别 Not In ('5', '6', '7') And" & vbNewLine & _
...
'功能：判断界面上的"收"字是否显示，调用费用公共部件接口进行判断
    ...
    If strNos <> "" Then
        ...
        End If
    End If
    Set收费标记 = (bytState = 2 Or bytState = 1)
    Exit Function
errH:
    If ErrCenter() = 1 Then Resume
    Call SaveErrLog
