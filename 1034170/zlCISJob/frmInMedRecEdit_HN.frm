...
Begin VB.Form frmInMedRecEdit_HN 
   ...
   ClientTop       =   330
   ClientWidth     =   11085
   Icon            =   "frmInMedRecEdit_HN.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   7575
   ...
   Begin TabDlg.SSTab sstInfo 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "基本信息"
      TabPicture(0)   =   "frmInMedRecEdit_HN.frx":058A
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "fraInfo(0)"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "西医诊断"
      TabPicture(1)   =   "frmInMedRecEdit_HN.frx":05A6
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "fraInfo(1)"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "中医诊断"
      TabPicture(2)   =   "frmInMedRecEdit_HN.frx":05C2
      Tab(2).ControlEnabled=   -1  'True
      Tab(2).Control(0)=   "fraInfo(2)"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "过敏与手术"
      TabPicture(3)   =   "frmInMedRecEdit_HN.frx":05DE
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "fraInfo(3)"
      Tab(3).ControlCount=   1
      TabCaption(4)   =   "住院情况"
      TabPicture(4)   =   "frmInMedRecEdit_HN.frx":05FA
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "fraInfo(4)"
      Tab(4).ControlCount=   1
      TabCaption(5)   =   "放疗与化疗"
      TabPicture(5)   =   "frmInMedRecEdit_HN.frx":0616
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "fraInfo(5)"
      Tab(5).ControlCount=   1
      TabCaption(6)   =   "其他"
      TabPicture(6)   =   "frmInMedRecEdit_HN.frx":0632
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VB.Frame fraHNAddtion 
            ...
            Begin VB.TextBox txtInfo 
               ...
               Width           =   360
            End
            Begin VB.OptionButton optHaveICU 
               Caption         =   "有"
               Height          =   180
               Index           =   1
               Left            =   2040
         ...
         Begin VB.Frame fraAdvEvent 
            ...
            Begin VB.ListBox lstAdvEvent 
               Height          =   1530
               ItemData        =   "frmInMedRecEdit_HN.frx":064E
               Left            =   120
               List            =   "frmInMedRecEdit_HN.frx":0655
               Style           =   1  'Checkbox
               TabIndex        =   323
               Top             =   240
               Width           =   4125
            ...
            Begin VB.ComboBox cboinfo 
               ...
               IMEMode         =   3  'DISABLE
               Index           =   46
               ItemData        =   "frmInMedRecEdit_HN.frx":0667
               Left            =   3315
               List            =   "frmInMedRecEdit_HN.frx":0669
               Style           =   2  'Dropdown List
               TabIndex        =   327
               Top             =   1800
               Width           =   900
            ...
            Begin VB.ComboBox cboinfo 
               ...
               IMEMode         =   3  'DISABLE
               Index           =   45
               ItemData        =   "frmInMedRecEdit_HN.frx":066B
               Left            =   1440
               List            =   "frmInMedRecEdit_HN.frx":066D
               Style           =   2  'Dropdown List
               TabIndex        =   325
               Top             =   1800
               Width           =   1335
            ...
            Begin VB.ComboBox cboinfo 
               ...
               IMEMode         =   3  'DISABLE
               Index           =   48
               ItemData        =   "frmInMedRecEdit_HN.frx":066F
               Left            =   1440
               List            =   "frmInMedRecEdit_HN.frx":0671
               Style           =   2  'Dropdown List
               TabIndex        =   331
               Top             =   2520
               Width           =   2775
            ...
            Begin VB.ComboBox cboinfo 
               ...
               IMEMode         =   3  'DISABLE
               Index           =   47
               ItemData        =   "frmInMedRecEdit_HN.frx":0673
               Left            =   1440
               List            =   "frmInMedRecEdit_HN.frx":0675
               Style           =   2  'Dropdown List
               TabIndex        =   329
               Top             =   2160
               Width           =   2775
         ...
         Begin VB.Frame fraInfection 
            ...
            Begin VB.ListBox lstInfection 
               Height          =   1320
               ItemData        =   "frmInMedRecEdit_HN.frx":0677
               Left            =   120
               List            =   "frmInMedRecEdit_HN.frx":067E
               Style           =   1  'Checkbox
               TabIndex        =   322
               Top             =   240
               Width           =   4125
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsTSJC 
            ...
            FormatString    =   $"frmInMedRecEdit_HN.frx":0690
            ScrollTrack     =   -1  'True
            ScrollBars      =   0
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VSFlex8Ctl.VSFlexGrid vs化疗 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_HN.frx":06FE
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vs放疗 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_HN.frx":082B
            ScrollTrack     =   0   'False
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VB.CommandButton cmdMove 
            ...
            Index           =   1
            Left            =   5640
            Picture         =   "frmInMedRecEdit_HN.frx":0952
            Style           =   1  'Graphical
            TabIndex        =   384
            ToolTipText     =   "诊断下移"
            Top             =   0
         ...
         Begin VB.CommandButton cmdMove 
            ...
            Index           =   0
            Left            =   5040
            Picture         =   "frmInMedRecEdit_HN.frx":0E03
            Style           =   1  'Graphical
            TabIndex        =   383
            ToolTipText     =   "诊断上移"
            Top             =   0
         ...
         Begin VB.PictureBox picInfectInfo 
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   65
               ItemData        =   "frmInMedRecEdit_HN.frx":12BC
               Left            =   1920
               List            =   "frmInMedRecEdit_HN.frx":12BE
               Style           =   2  'Dropdown List
               TabIndex        =   117
               Top             =   120
               Width           =   1695
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   58
            ItemData        =   "frmInMedRecEdit_HN.frx":12C0
            Left            =   8760
            List            =   "frmInMedRecEdit_HN.frx":12C2
            Style           =   2  'Dropdown List
            TabIndex        =   136
            Top             =   4425
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   31
            ItemData        =   "frmInMedRecEdit_HN.frx":12C4
            Left            =   1410
            List            =   "frmInMedRecEdit_HN.frx":12C6
            Style           =   2  'Dropdown List
            TabIndex        =   138
            Top             =   4770
            Width           =   1470
         ...
         Begin VB.CommandButton cmdInfo 
            ...
            Index           =   27
            Left            =   9950
            Picture         =   "frmInMedRecEdit_HN.frx":12C8
            Style           =   1  'Graphical
            TabIndex        =   352
            TabStop         =   0   'False
            ToolTipText     =   "选择(F4)"
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   34
            ItemData        =   "frmInMedRecEdit_HN.frx":13BE
            Left            =   5010
            List            =   "frmInMedRecEdit_HN.frx":13C0
            Style           =   2  'Dropdown List
            TabIndex        =   140
            Top             =   4770
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   32
            ItemData        =   "frmInMedRecEdit_HN.frx":13C2
            Left            =   4650
            List            =   "frmInMedRecEdit_HN.frx":13C4
            Style           =   2  'Dropdown List
            TabIndex        =   151
            Top             =   5610
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   53
            ItemData        =   "frmInMedRecEdit_HN.frx":13C6
            Left            =   8760
            List            =   "frmInMedRecEdit_HN.frx":13C8
            Style           =   2  'Dropdown List
            TabIndex        =   130
            Top             =   4080
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   52
            ItemData        =   "frmInMedRecEdit_HN.frx":13CA
            Left            =   5010
            List            =   "frmInMedRecEdit_HN.frx":13CC
            Style           =   2  'Dropdown List
            TabIndex        =   128
            Top             =   4080
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   33
            ItemData        =   "frmInMedRecEdit_HN.frx":13CE
            Left            =   8760
            List            =   "frmInMedRecEdit_HN.frx":13D0
            Style           =   2  'Dropdown List
            TabIndex        =   142
            Top             =   4770
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   35
            ItemData        =   "frmInMedRecEdit_HN.frx":13D2
            Left            =   5010
            List            =   "frmInMedRecEdit_HN.frx":13D4
            Style           =   2  'Dropdown List
            TabIndex        =   134
            Top             =   4425
            Width           =   1470
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   36
            ItemData        =   "frmInMedRecEdit_HN.frx":13D6
            Left            =   1410
            List            =   "frmInMedRecEdit_HN.frx":13D8
            Style           =   2  'Dropdown List
            TabIndex        =   132
            Top             =   4425
            Width           =   1470
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDiagXY 
            ...
            FormatString    =   $"frmInMedRecEdit_HN.frx":13DA
            ScrollTrack     =   -1  'True
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsOPS 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmInMedRecEdit_HN.frx":15A7
            ScrollTrack     =   -1  'True
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsAller 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   -1  'True
            FormatString    =   $"frmInMedRecEdit_HN.frx":1800
            ScrollTrack     =   -1  'True
            ScrollBars      =   2
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VB.CommandButton cmdMove 
            ...
            Index           =   3
            Left            =   5880
            Picture         =   "frmInMedRecEdit_HN.frx":1897
            Style           =   1  'Graphical
            TabIndex        =   386
            ToolTipText     =   "诊断下移"
            Top             =   0
         ...
         Begin VB.CommandButton cmdMove 
            ...
            Index           =   2
            Left            =   5280
            Picture         =   "frmInMedRecEdit_HN.frx":1D48
            Style           =   1  'Graphical
            TabIndex        =   385
            ToolTipText     =   "诊断上移"
            Top             =   0
         ...
         Begin VB.Frame fraSub 
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   2
               ItemData        =   "frmInMedRecEdit_HN.frx":2201
               Left            =   825
               List            =   "frmInMedRecEdit_HN.frx":2203
               Style           =   2  'Dropdown List
               TabIndex        =   174
               Top             =   270
               Width           =   1455
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   11
               ItemData        =   "frmInMedRecEdit_HN.frx":2205
               Left            =   825
               List            =   "frmInMedRecEdit_HN.frx":2207
               Style           =   2  'Dropdown List
               TabIndex        =   176
               Top             =   720
               Width           =   1455
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   12
               ItemData        =   "frmInMedRecEdit_HN.frx":2209
               Left            =   825
               List            =   "frmInMedRecEdit_HN.frx":220B
               Style           =   2  'Dropdown List
               TabIndex        =   178
               Top             =   1140
               Width           =   1455
         ...
         Begin VB.Frame fraSub 
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   57
               ItemData        =   "frmInMedRecEdit_HN.frx":220D
               Left            =   4530
               List            =   "frmInMedRecEdit_HN.frx":220F
               Style           =   2  'Dropdown List
               TabIndex        =   191
               Top             =   1140
               Width           =   1410
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   56
               ItemData        =   "frmInMedRecEdit_HN.frx":2211
               Left            =   4530
               List            =   "frmInMedRecEdit_HN.frx":2213
               Style           =   2  'Dropdown List
               TabIndex        =   189
               Top             =   705
               Width           =   1410
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   55
               ItemData        =   "frmInMedRecEdit_HN.frx":2215
               Left            =   4530
               List            =   "frmInMedRecEdit_HN.frx":2217
               Style           =   2  'Dropdown List
               TabIndex        =   187
               Top             =   240
               Width           =   1410
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   13
               ItemData        =   "frmInMedRecEdit_HN.frx":2219
               Left            =   1575
               List            =   "frmInMedRecEdit_HN.frx":221B
               Style           =   2  'Dropdown List
               TabIndex        =   185
               Top             =   1140
               Width           =   1410
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   14
               ItemData        =   "frmInMedRecEdit_HN.frx":221D
               Left            =   1215
               List            =   "frmInMedRecEdit_HN.frx":221F
               Style           =   2  'Dropdown List
               TabIndex        =   183
               Top             =   705
               Width           =   1410
            ...
            Begin VB.ComboBox cboinfo 
               Height          =   300
               Index           =   15
               ItemData        =   "frmInMedRecEdit_HN.frx":2221
               Left            =   1215
               List            =   "frmInMedRecEdit_HN.frx":2223
               Style           =   2  'Dropdown List
               TabIndex        =   181
               Top             =   270
               Width           =   1410
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   37
            ItemData        =   "frmInMedRecEdit_HN.frx":2225
            Left            =   4335
            List            =   "frmInMedRecEdit_HN.frx":2227
            Style           =   2  'Dropdown List
            TabIndex        =   167
            Top             =   4035
            Width           =   1395
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   38
            ItemData        =   "frmInMedRecEdit_HN.frx":2229
            Left            =   1470
            List            =   "frmInMedRecEdit_HN.frx":222B
            Style           =   2  'Dropdown List
            TabIndex        =   165
            Top             =   4035
            Width           =   1395
         ...
         Begin VSFlex8Ctl.VSFlexGrid vsDiagZY 
            ...
            ColWidthMax     =   0
            ExtendLastCol   =   0   'False
            FormatString    =   $"frmInMedRecEdit_HN.frx":222D
            ScrollTrack     =   -1  'True
            ScrollBars      =   3
            ScrollTips      =   0   'False
            MergeCells      =   0
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VB.CommandButton cmdInfo 
            ...
            Index           =   58
            Left            =   9020
            Picture         =   "frmInMedRecEdit_HN.frx":23C7
            Style           =   1  'Graphical
            TabIndex        =   354
            TabStop         =   0   'False
            ToolTipText     =   "选择(F4)"
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   59
            ItemData        =   "frmInMedRecEdit_HN.frx":24BD
            Left            =   7860
            List            =   "frmInMedRecEdit_HN.frx":24BF
            Style           =   2  'Dropdown List
            TabIndex        =   282
            Top             =   5454
            Width           =   1425
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   41
            ItemData        =   "frmInMedRecEdit_HN.frx":24C1
            Left            =   1320
            List            =   "frmInMedRecEdit_HN.frx":24C3
            Style           =   2  'Dropdown List
            TabIndex        =   205
            Top             =   1680
            Width           =   1425
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   16
            ItemData        =   "frmInMedRecEdit_HN.frx":24C5
            Left            =   7320
            List            =   "frmInMedRecEdit_HN.frx":24C7
            Locked          =   -1  'True
            Style           =   2  'Dropdown List
            TabIndex        =   264
            TabStop         =   0   'False
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   27
            ItemData        =   "frmInMedRecEdit_HN.frx":24C9
            Left            =   8610
            List            =   "frmInMedRecEdit_HN.frx":24CB
            Style           =   2  'Dropdown List
            TabIndex        =   234
            Top             =   921
            Width           =   1425
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   28
            ItemData        =   "frmInMedRecEdit_HN.frx":24CD
            Left            =   8610
            List            =   "frmInMedRecEdit_HN.frx":24CF
            Style           =   2  'Dropdown List
            TabIndex        =   232
            Top             =   543
            Width           =   1425
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   29
            ItemData        =   "frmInMedRecEdit_HN.frx":24D1
            Left            =   8640
            List            =   "frmInMedRecEdit_HN.frx":24D3
            Style           =   2  'Dropdown List
            TabIndex        =   230
            Top             =   165
            Width           =   1425
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   44
            ItemData        =   "frmInMedRecEdit_HN.frx":24D5
            Left            =   1260
            List            =   "frmInMedRecEdit_HN.frx":24D7
            Style           =   2  'Dropdown List
            TabIndex        =   244
            Top             =   2925
            Width           =   1500
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   19
            ItemData        =   "frmInMedRecEdit_HN.frx":24D9
            Left            =   1260
            List            =   "frmInMedRecEdit_HN.frx":24DB
            TabIndex        =   266
            Top             =   4700
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   30
            ItemData        =   "frmInMedRecEdit_HN.frx":24DD
            Left            =   1320
            List            =   "frmInMedRecEdit_HN.frx":24DF
            Style           =   2  'Dropdown List
            TabIndex        =   203
            Top             =   1299
            Width           =   1425
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   18
            ItemData        =   "frmInMedRecEdit_HN.frx":24E1
            Left            =   1320
            List            =   "frmInMedRecEdit_HN.frx":24E3
            Style           =   2  'Dropdown List
            TabIndex        =   201
            Top             =   921
            Width           =   1425
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   43
            ItemData        =   "frmInMedRecEdit_HN.frx":24E5
            Left            =   1320
            List            =   "frmInMedRecEdit_HN.frx":24E7
            Style           =   2  'Dropdown List
            TabIndex        =   197
            Top             =   165
            Width           =   1425
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   50
            ItemData        =   "frmInMedRecEdit_HN.frx":24E9
            Left            =   1260
            List            =   "frmInMedRecEdit_HN.frx":24EB
            TabIndex        =   290
            Top             =   6210
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   17
            ItemData        =   "frmInMedRecEdit_HN.frx":24ED
            Left            =   1320
            List            =   "frmInMedRecEdit_HN.frx":24EF
            Style           =   2  'Dropdown List
            TabIndex        =   199
            Top             =   543
            Width           =   1425
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   20
            ItemData        =   "frmInMedRecEdit_HN.frx":24F1
            Left            =   3900
            List            =   "frmInMedRecEdit_HN.frx":24F3
            TabIndex        =   268
            Top             =   4700
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   21
            ItemData        =   "frmInMedRecEdit_HN.frx":24F5
            Left            =   7860
            List            =   "frmInMedRecEdit_HN.frx":24F7
            TabIndex        =   270
            Top             =   4700
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   22
            ItemData        =   "frmInMedRecEdit_HN.frx":24F9
            Left            =   3900
            List            =   "frmInMedRecEdit_HN.frx":24FB
            TabIndex        =   274
            Top             =   5077
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   23
            ItemData        =   "frmInMedRecEdit_HN.frx":24FD
            Left            =   7860
            List            =   "frmInMedRecEdit_HN.frx":24FF
            TabIndex        =   276
            Top             =   5077
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   24
            ItemData        =   "frmInMedRecEdit_HN.frx":2501
            Left            =   1260
            List            =   "frmInMedRecEdit_HN.frx":2503
            TabIndex        =   272
            Top             =   5077
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   25
            ItemData        =   "frmInMedRecEdit_HN.frx":2505
            Left            =   1260
            List            =   "frmInMedRecEdit_HN.frx":2507
            TabIndex        =   278
            Top             =   5454
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   26
            ItemData        =   "frmInMedRecEdit_HN.frx":2509
            Left            =   3900
            List            =   "frmInMedRecEdit_HN.frx":250B
            TabIndex        =   280
            Top             =   5454
            Width           =   1425
         End
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   39
            ItemData        =   "frmInMedRecEdit_HN.frx":250D
            Left            =   3900
            List            =   "frmInMedRecEdit_HN.frx":250F
            TabIndex        =   286
            Top             =   5831
            Width           =   1425
         End
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   40
            ItemData        =   "frmInMedRecEdit_HN.frx":2511
            Left            =   1260
            List            =   "frmInMedRecEdit_HN.frx":2513
            TabIndex        =   284
            Top             =   5831
            Width           =   1425
         End
      ...
      Begin VB.Frame fraInfo 
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   0
            ItemData        =   "frmInMedRecEdit_HN.frx":2515
            Left            =   7800
            List            =   "frmInMedRecEdit_HN.frx":2517
            Style           =   2  'Dropdown List
            TabIndex        =   6
            Top             =   135
            Width           =   2475
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   1
            ItemData        =   "frmInMedRecEdit_HN.frx":2519
            Left            =   4410
            List            =   "frmInMedRecEdit_HN.frx":251B
            Style           =   2  'Dropdown List
            TabIndex        =   10
            Top             =   615
            Width           =   1605
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   3
            ItemData        =   "frmInMedRecEdit_HN.frx":251D
            Left            =   8535
            List            =   "frmInMedRecEdit_HN.frx":251F
            Style           =   2  'Dropdown List
            TabIndex        =   24
            Top             =   990
            Width           =   1740
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   4
            ItemData        =   "frmInMedRecEdit_HN.frx":2521
            Left            =   7785
            List            =   "frmInMedRecEdit_HN.frx":2523
            Style           =   2  'Dropdown List
            TabIndex        =   39
            Top             =   1725
            Width           =   2490
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   8
            ItemData        =   "frmInMedRecEdit_HN.frx":2525
            Left            =   4410
            List            =   "frmInMedRecEdit_HN.frx":2527
            Style           =   2  'Dropdown List
            TabIndex        =   37
            Top             =   1725
            Width           =   2250
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   9
            ItemData        =   "frmInMedRecEdit_HN.frx":2529
            Left            =   3645
            List            =   "frmInMedRecEdit_HN.frx":252B
            Style           =   2  'Dropdown List
            TabIndex        =   76
            Top             =   3990
            Width           =   1700
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   6
            ItemData        =   "frmInMedRecEdit_HN.frx":252D
            Left            =   1320
            List            =   "frmInMedRecEdit_HN.frx":252F
            TabIndex        =   49
            Top             =   2415
            Width           =   4035
         End
         ...
         Begin VB.ComboBox cboinfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   49
            ItemData        =   "frmInMedRecEdit_HN.frx":2531
            Left            =   1320
            List            =   "frmInMedRecEdit_HN.frx":2533
            Style           =   2  'Dropdown List
            TabIndex        =   92
            Top             =   5175
            Width           =   1545
   ...
   Begin VB.Image imgButtonDel 
      Height          =   240
      Left            =   3120
      Picture         =   "frmInMedRecEdit_HN.frx":2535
      Top             =   7200
      Visible         =   0   'False
      Width           =   240
   End
   Begin VB.Image imgButtonNew 
      Height          =   240
      Left            =   3840
      Picture         =   "frmInMedRecEdit_HN.frx":8D87
      Top             =   7200
      Visible         =   0   'False
      Width           =   240
   End
...
Private Sub lvwInfectParts_ItemClick(ByVal Item As MSComctlLib.ListItem)
    If Visible Then mblnChange = True
End Sub
...
Private Sub optHaveICU_Click(Index As Integer)
'功能：根据是否实施重症监护来设置是否可以输入重症监护天数以及小时
'参数：Index 0-没有实施重症监护，1-实施重症监护

        If optHaveICU(0).Value Then
            txtInfo(txt重症监护小时).Enabled = False
            txtInfo(txt重症监护天数).Enabled = False
            txtInfo(txt重症监护天数).Text = ""
            txtInfo(txt重症监护小时).Text = ""
            txtInfo(txt重症监护天数).BackColor = &H8000000F
            txtInfo(txt重症监护小时).BackColor = &H8000000F
        Else
            txtInfo(txt重症监护小时).Enabled = True
            txtInfo(txt重症监护天数).Enabled = True
            txtInfo(txt重症监护天数).BackColor = &H80000005
            txtInfo(txt重症监护小时).BackColor = &H80000005
        End If
End Sub

Private Sub optHaveICU_KeyPress(Index As Integer, KeyAscii As Integer)
    If KeyAscii = 13 Then
        KeyAscii = 0
        Call zlCommFun.PressKey(vbKeyTab)
    End If
...
'                strMask = "1234567890"
            ...
            Case txt家庭电话, txt单位电话, txt联系人电话
                strMask = "1234567890-()"
            Case txt住院号, txt户口邮编, txt家庭邮编, txt单位邮编, txt抢救次数, txt成功次数, txt随诊期限, txt入院前小时, txt入院前分钟, txt入院后小时, txt入院后分钟, txt呼吸机小时, txt重症监护天数, txt重症监护小时, txtApgar
                strMask = "1234567890"
        ...
        End Select
        If strMask <> "" Then
            If InStr(strMask, UCase(Chr(KeyAscii))) = 0 Then
                KeyAscii = 0: Exit Sub
            Else
                Select Case Index
                    Case txtApgar
                        '保证txtApgar输入值在0-10之间
                        If txtInfo(Index).Text <> "" And txtInfo(Index).Text <> "1" Or _
                            txtInfo(Index).Text <> "" And txtInfo(Index).Text = "1" And Chr(KeyAscii) <> "0" Then
                            KeyAscii = 0: Exit Sub
                        End If
                End Select
            End If
...
'功能：初始化首页编辑时所需要的一些数据
    ...
    Call SetCboFromList(Array("", "1-未进入", "2-变异退出", "3-完成"), Array(cbo临床路径), 0)
    Call SetCboFromList(Array("", "1-无", "2-按病种", "3-按费用", "4-两者都有"), Array(cboDRGs), 0)
    Call SetCboFromList(Array("", "1-甲类", "2-乙类", "3-丙类"), Array(cbo传染病), 0)
    Call SetCboFromList(Array("", "1-0期", "2-I期", "3-Ⅱ期", "4-Ⅲ期", "5-Ⅳ期", "6-不详"), Array(cbo肿瘤分期), 0)
...
'功能：读取病人的首页信息
    ...
    For i = 1 To rsTmp.RecordCount
        Select Case UCase(Nvl(rsTmp!信息名))
            ...
            Case "临床路径"
                cboinfo(cbo临床路径).ListIndex = Nvl(rsTmp!信息值, 0)
            Case "DRGS"
                cboinfo(cboDRGs).ListIndex = Nvl(rsTmp!信息值, 0)
            Case "抗生素"
                chkInfo(chk抗生素).Value = Val(Nvl(rsTmp!信息值, 0))
            Case "标本送检"
                chkInfo(chk标本送检).Value = Val(Nvl(rsTmp!信息值, 0))
            Case "传染病"
                cboinfo(cbo传染病).ListIndex = Nvl(rsTmp!信息值, 0)
            Case "肿瘤分期"
                cboinfo(cbo肿瘤分期).ListIndex = Nvl(rsTmp!信息值, 0)
            Case "肿瘤T"
                txtInfo(txt肿瘤T).Text = Nvl(rsTmp!信息值, "")
            Case "肿瘤M"
                txtInfo(txt肿瘤M).Text = Nvl(rsTmp!信息值, "")
            Case "肿瘤N"
                txtInfo(txt肿瘤N).Text = Nvl(rsTmp!信息值, "")
            Case "APGAR"
    ...
    Select Case Index
        ...
        Case txt病原学
            ...
            Else
                ...
                End If
            End If
        Case txt重症监护天数, txt重症监护天数
            If Trim(txtInfo(Index).Text) <> "" Then
                txtInfo(Index).Text = Val(txtInfo(Index).Text)
            End If
    End Select
    Exit Sub
errH:
...
Private Sub vsfMain_KeyPress(KeyAscii As Integer)
    If vsfMain.Rows <= 1 Then Call chkInfo(chkCT).SetFocus: Exit Sub
    If mbln护士站 Or mblnReadOnly Then Exit Sub
    If KeyAscii = vbKeyReturn Then
        KeyAscii = 0
        Select Case vsfMain.Col
...
'参数：blnBeforSign-是否签名时保存前调用
    ...
    If Not mbln护士站 Then
        ...
        For i = 0 To UBound(arrInfo)
            ...
            End If
        Next
        '实施中重症监护，选有时，必需输入小时或天
        If optHaveICU(1).Value Then
            If Val(txtInfo(txt重症监护天数)) = 0 And Val(txtInfo(txt重症监护小时)) = 0 Then
                Call ShowMessage(txtInfo(txt重症监护天数), "当前病人有重症监护但是没输入有效的重症监护时间。", False)
                Exit Function
            End If
        End If
...
'参数：blnBeforSign-是否签名时保存前调用
    ...
    If Not mbln护士站 Then
        arrField医生 = Array("入院病室", "出院病室", "转科记录", "HBsAg", "HCV-Ab", "HIV-Ab", _
                    ...
                    "重症监护天数", "重症监护小时", "单病种", "临床路径", "肿瘤分期", "肿瘤T", "肿瘤M", "肿瘤N", "标本送检", "传染病", "APGAR", "抗生素", "DRGS", _
        ...
        arrValue医生 = Array(txtInfo(txt入院病室).Text, txtInfo(txt出院病室).Text, str转科科室, _
                    ...
                    , str生育状况, str发病, BVal(txtInfo(txt重症监护天数).Text), BVal(txtInfo(txt重症监护小时).Text), chkInfo(chk单病种).Value, BVal(cboinfo(cbo临床路径).ListIndex), BVal(cboinfo(cbo肿瘤分期).ListIndex), txtInfo(txt肿瘤T).Text, _
                    txtInfo(txt肿瘤M).Text, txtInfo(txt肿瘤N).Text, chkInfo(chk标本送检).Value, BVal(cboinfo(cbo传染病).ListIndex), BVal(txtInfo(txtApgar).Text), chkInfo(chk抗生素).Value, BVal(cboinfo(cboDRGs).ListIndex), txtInfo(txt医学警示).Text, txtInfo(txt其他医学警示).Text, str感染与死亡, str感染部位)
   ...
   If mbln护士站 Or mblnReadOnly Then Exit Sub
    ...
    With vs放疗
        If Val(.Cell(flexcpData, .Row, .ColIndex("放射治疗编码"))) = 0 Or Trim(.TextMatrix(.Row, .ColIndex("开始日期"))) = "" Then
            ...
            If sstInfo.TabVisible(sstInfo.Tab + IIf(sstInfo.TabVisible(sstInfo.Tab + 1), 1, 2)) Then sstInfo.Tab = sstInfo.Tab + IIf(sstInfo.TabVisible(sstInfo.Tab + 1), 1, 2)
            Call optHaveICU(IIf(optHaveICU(1).Value, 1, 0)).SetFocus
            Exit Sub
        End If
        Select Case .Col
        Case .Cols - 1
