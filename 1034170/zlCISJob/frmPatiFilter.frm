    ...
    If cbo科室.Text <> "" Then
        ...
        If blnDo Then
            ...
            If Not rsTmp.EOF Then
                Call FindCboIndex(cbo科室, rsTmp!ID)
            ElseIf mlngPreDept <> 0 Then
                Call FindCboIndex(cbo科室, mlngPreDept)
            Else
                cbo科室.Text = ""
                Call cbo科室_Click
            End If
    ...
    If KeyAscii = 13 Then
        ...
        If cbo医生.Text <> "" Then
            ...
            If blnDo Then
                ...
                If Not rsTmp.EOF Then
                    Call GetCboIndex(cbo医生, rsTmp!姓名)
                Else
                    cbo医生.Text = ""
                End If
            End If
...
Private Sub Form_Load()
    ...
    Call FindCboIndex(cbo科室, mlng科室ID)
    Call GetCboIndex(cbo医生, mstr医生)    
    ...
    Do While Not rsTmp.EOF
        ...
        If rsTmp!ID = mlng科室ID Then
            Call zlControl.CboSetIndex(cbo科室.hwnd, cbo科室.NewIndex)
        End If
        rsTmp.MoveNext
    Loop
