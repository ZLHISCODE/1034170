      ...
      Begin VB.Frame fraBack 
         ...
         Begin VB.Frame fraInfo 
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsAller 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"frmArchiveInMedRec_YN.frx":0F86
               ScrollTrack     =   -1  'True
               ScrollBars      =   0
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame fraInfo 
            ...
            Begin VB.Frame fraInfection 
               ...
               Begin VB.ListBox lstInfection 
                  Height          =   1320
                  ItemData        =   "frmArchiveInMedRec_YN.frx":0FF3
                  Left            =   120
                  List            =   "frmArchiveInMedRec_YN.frx":0FF5
                  TabIndex        =   288
                  Top             =   240
                  Width           =   3405
               End
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsTSJC 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"frmArchiveInMedRec_YN.frx":0FF7
               ScrollTrack     =   -1  'True
               ScrollBars      =   0
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame fraInfo 
            ...
            Begin VB.Frame fraAdvEvent 
               ...
               Begin VB.ListBox lstAdvEvent 
                  Height          =   960
                  ItemData        =   "frmArchiveInMedRec_YN.frx":1065
                  Left            =   120
                  List            =   "frmArchiveInMedRec_YN.frx":1067
                  TabIndex        =   307
                  Top             =   240
                  Width           =   3405
               End
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsKSS 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   0   'False
               FormatString    =   $"frmArchiveInMedRec_YN.frx":1069
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
         ...
         Begin VB.Frame fraInfo 
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsChemotherapy 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"frmArchiveInMedRec_YN.frx":1150
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
            ...
            Begin VSFlex8Ctl.VSFlexGrid vsRadiotherapy 
               ...
               ColWidthMax     =   0
               ExtendLastCol   =   -1  'True
               FormatString    =   $"frmArchiveInMedRec_YN.frx":1266
               ScrollTrack     =   -1  'True
               ScrollBars      =   3
               ScrollTips      =   0   'False
               MergeCells      =   0
...
'功能：读取病人的首页信息
    ...
    For i = 1 To rsTmp.RecordCount
        Select Case UCase(Nvl(rsTmp!信息名))
            ...
            Case "约束方式"
                txtInfo(txt约束方式).Text = Nvl(rsTmp!信息值)
            Case "约束工具"
                txtInfo(txt约束工具).Text = Nvl(rsTmp!信息值)
            Case "约束原因"
                txtInfo(txt约束原因).Text = Nvl(rsTmp!信息值)
            Case "新生儿离院方式"
                txtInfo(txt新生儿离院方式).Text = Nvl(rsTmp!信息值)
            Case "围术期死亡"
...
'    vsDiagXY.ColData(col出院情况) = str治疗结果
    ...
    '---------------------------------------------------------------
    '首读取首页整理保存的内容
    StrSQL = "Select a.助产护士,a.手术情况,a.切口,a.愈合,NVl(B.编码,C.编码) as 手术编码,a.手术日期,a.已行手术,a.主刀医师,a.第一助手," & _
    "a.第二助手,a.麻醉类型,a.麻醉医师,a.ASA分级,a.再次手术,a.NNIS分级,decode(a.手术级别,1,'一级手术',2,'二级手术',3,'三级手术',4,'四级手术',' ') as 手术级别" & _
...
Private Function Load附页内容(ByVal lng病人ID As Long, ByVal lng主页ID As Long) As Boolean
   '-------------------------------------------------------------------------------------------------------------------------
    ...
    If rsTemp.RecordCount > 0 Then
        ...
        txtInfo(txt重返间隔时间).Text = Nvl(rsTemp!重返间隔时间)
    End If
