...
Begin VB.Form frmSysConfig 
   ...
   Begin TabDlg.SSTab sstabConfiguration 
      ...
      Tab(1).Control(0)=   "cmdExportInf"
      Tab(1).Control(1)=   "Frame29"
      Tab(1).Control(2)=   "Frame26"
      Tab(1).Control(3)=   "cmdInfoLabelUpDown(2)"
      Tab(1).Control(4)=   "cmdInfoLabelUpDown(0)"
      Tab(1).Control(5)=   "cmdDeSelInfoLabel"
      Tab(1).Control(6)=   "cmdSelInfoLabel(3)"
      Tab(1).Control(7)=   "cmdSelInfoLabel(4)"
      Tab(1).Control(8)=   "cmdSelInfoLabel(2)"
      Tab(1).Control(9)=   "cmdSelInfoLabel(1)"
      Tab(1).Control(10)=   "Frame6(4)"
      Tab(1).Control(11)=   "Frame6(3)"
      Tab(1).Control(12)=   "Frame6(2)"
      Tab(1).Control(13)=   "Frame6(1)"
      Tab(1).Control(14)=   "lstInfoLabelAll"
      ...
      Tab(5).Control(0)=   "Frame33"
      Tab(5).Control(1)=   "Frame23"
      Tab(5).Control(2)=   "Frame21(1)"
      Tab(5).Control(3)=   "fram22"
      Tab(5).Control(4)=   "Frame21(0)"
      Tab(5).Control(5)=   "Frame19"
      ...
      Begin TabDlg.SSTab sstabModality 
         ...
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "cmdLayoutApplyAll"
         Tab(1).Control(1)=   "cmdDelLayoutModality"
         Tab(1).Control(2)=   "cmdModifyLayoutModality"
         Tab(1).Control(3)=   "cmdAddLayoutModality"
         Tab(1).Control(4)=   "cboLayoutModality"
         Tab(1).Control(5)=   "Frame2"
         Tab(1).Control(6)=   "frmSeriesLayout"
         ...
         Begin VB.ComboBox cboLayoutModality 
            Height          =   300
            ItemData        =   "frmSysConfig.frx":27FC
            Left            =   -73920
            List            =   "frmSysConfig.frx":280C
            Style           =   2  'Dropdown List
            TabIndex        =   217
            Top             =   600
            Width           =   1960
         ...
         Begin VB.ComboBox cboWWModality 
            Height          =   300
            ItemData        =   "frmSysConfig.frx":2820
            Left            =   1080
            List            =   "frmSysConfig.frx":2830
            Style           =   2  'Dropdown List
            TabIndex        =   215
            Top             =   600
            Width           =   1960
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ListBox lstImageRows 
               Height          =   240
               ItemData        =   "frmSysConfig.frx":2844
               Left            =   360
               List            =   "frmSysConfig.frx":2860
               TabIndex        =   38
               Top             =   1440
               Width           =   855
            End
            Begin VB.ListBox lstImageCols 
               Height          =   240
               ItemData        =   "frmSysConfig.frx":287C
               Left            =   1800
               List            =   "frmSysConfig.frx":2898
               TabIndex        =   37
               Top             =   1440
               Width           =   855
            End
         ...
         Begin VB.Frame frmSeriesLayout 
            ...
            Begin VB.ListBox lstSeriesCols 
               Height          =   240
               ItemData        =   "frmSysConfig.frx":28B4
               Left            =   1800
               List            =   "frmSysConfig.frx":28D0
               TabIndex        =   33
               Top             =   1440
               Width           =   855
            End
            Begin VB.ListBox lstSeriesRows 
               Height          =   240
               ItemData        =   "frmSysConfig.frx":28EC
               Left            =   360
               List            =   "frmSysConfig.frx":2908
               TabIndex        =   32
               Top             =   1440
               Width           =   855
            End
         ...
         Begin VB.ComboBox cboImageShutter 
            Height          =   300
            ItemData        =   "frmSysConfig.frx":2924
            Left            =   -73920
            List            =   "frmSysConfig.frx":2934
            Style           =   2  'Dropdown List
            TabIndex        =   243
            Top             =   600
            Width           =   1960
...
'------------------------------------------------
    ...
    If (Me.chkAutoSeriesLayout <> IIf(aPresetLayout(intModality).bSeriesAutoFormat = True, 1, 0)) Or _
       ...
       (Me.lstImageRows.list(Me.lstImageRows.TopIndex) <> aPresetLayout(intModality).lngImageRows) Then
