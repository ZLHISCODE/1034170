...
Public Sub zlDefCommandBars(ByVal cbsThis As Object, Optional ByVal blnChildToolBar As Boolean = False)
    ...
    With cbrMenuBar.CommandBar.Controls
        ...
        If IsStandardDLL Then
            Set cbrControl = .Add(xtpControlButton, conMenu_Edit_Oper, "手术设置(&D)")
        Else
    ...
    With cbrToolBar.Controls
        ...
        If IsStandardDLL Then
            Set cbrControl = .Add(xtpControlButton, conMenu_Edit_Oper, "手术", cbrControl.Index + 1): cbrControl.ToolTipText = "体温单手术设置"
        Else
            Set cbrControl = .Add(xtpControlButton, conMenu_Edit_Curve_Show, "显示", cbrControl.Index + 1): cbrControl.ToolTipText = "体温单显示设置"
        End If
...
Public Function IsStandardDLL() As Boolean
    '检查是否是标准体温单
    On Error GoTo errHand
    If Not gobjBodyEditor Is Nothing Then
        IsStandardDLL = gobjBodyEditor.GetNewEditor
    Else
        IsStandardDLL = True
    End If
    Exit Function
