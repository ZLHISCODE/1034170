...
Begin VB.Form frmImportOrder 
   ...
   Begin VSFlex8Ctl.VSFlexGrid vsfList 
      ...
      Begin MSComctlLib.ImageList imgList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   2
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmImportOrder.frx":755F
               Key             =   "未导入"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmImportOrder.frx":DDC1
               Key             =   "已导入"
            EndProperty
         EndProperty
      End
   ...
   Begin VSFlex8Ctl.VSFlexGrid vsfItem 
      ...
      ColWidthMax     =   0
      ExtendLastCol   =   0   'False
      FormatString    =   $"frmImportOrder.frx":14623
      ScrollTrack     =   -1  'True
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
' 功能:加载医嘱信息
    ...
    gstrSQL = " Select a.Id,a.相关ID, e.发送号, a.开嘱医生, a.医嘱内容, b.名称,Decode(Substr('' || Nvl(a.单次用量, 0), 1, 1), '.', 0, '') || a.单次用量 as 单次用量 , b.计算单位 单位, c.医嘱内容 用药途径, e.首次时间,Decode(Substr('' || Nvl(a.总给予量, 0), 1, 1), '.', 0, '') || a.总给予量 as 总给予量, a.执行频次," & vbNewLine & _
    ...
    If Not rsTmp.EOF Then
        ...
        For i = 1 To rsTmp.RecordCount
            ...
            vsfList.TextMatrix(i, vsfList.ColIndex("相关ID")) = NVL(rsTmp!相关ID)
    ...
    For i = vsfList.FixedRows To vsfList.Rows - 1
        If vsfList.TextMatrix(i, vsfList.ColIndex("合并")) = "" Then
            Call SetTag一并给药(i)
        End If
    Next
