...
Private Sub mnuFilePrint_Click()
    ...
    '56134:刘鹏飞,2012-12-19,首先要定位到表格起始页
    If gintPage <> 1 Then Call frmTendFileReader.ShowPage(mlngStartPage)
    
    lngPages = mlngMaxPage - mlngStartPage + 1
    gblnPrintMode = True
