...
'        End With
    ...
    Case conMenu_File_PrintDayDetail, conMenu_Edit_Curve, conMenu_Edit_CurveTable, conMenu_Edit_Curve_Show, conMenu_Edit_Oper '批量录入,设置记录,显示,手术
...
Public Sub zlUpdateCommandBars(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Case conMenu_Edit_Curve, conMenu_Edit_CurveTable, conMenu_Edit_Curve_Show, conMenu_Edit_Oper '设置记录和显示,手术
...
'        Call FormSetCaption(mclsDockAduits.zlGetFormTendBody, False, False)
    ...
    Case "刷新数据"
        ...
        If mlngPatiID <> 0 Then
            ...
            gstrSQL = "Select 数据转出,出院日期 From 病案主页 Where 病人ID=[1] And 主页ID=[2]"
...
Private Sub vfgFile_DblClick()
    ...
    If Val(vfgFile.TextMatrix(vfgFile.ROW, mCol.f保留)) = -1 Then
        ...
        End If
        If Not CreateBodyEditor Then Exit Sub
        RaiseEvent ViewAnimalHeat(mlngPatiID & ";" & mlngPageId & ";" & mlngDeptId & ";" & Val(vfgFile.TextMatrix(vfgFile.ROW, mCol.fID)) & ";" & IIf(gblnOut = True, 1, 0) & ";" & intEdit & ";" & mintBaby & ";1", 0, mstrPrivs, IIf(mbytFontSize = 9, 0, IIf(mbytFontSize = 12, 1, mbytFontSize)))
