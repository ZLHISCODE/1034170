...
Public Const conMenu_Edit_Element = 3044          '标签要素
Public Const conMenu_Edit_Oper = 3055             '体温单手术设置
...
Public Const conMenu_Tool_SignShiftExchange = 8046          '*交班签名(&K)
...
Public Const conMenu_Tool_UnitSubject = 820     '病区标记设置
...
Public Const conMenu_Pathol_Antibody_Manage = 3901 '8126     '抗体管理
Public Const conMenu_Pathol_MealManage = 3902 '8127         '套餐维护
Public Const conMenu_Pathol_Request = 3903 '8128      '病理申请
Public Const conMenu_Pathol_ReportDelay = 3904 ' 8129        '报告延迟
Public Const conMenu_Pathol_ConRequest = 3905 ' 8130         '会诊申请
Public Const conMenu_Pathol_ConFeedback = 3906 '8131        '会诊反馈
Public Const conMenu_Pathol_Decalin_Task = 3907 ' 8132        '脱钙任务管理
Public Const conMenu_Pathol_BatSlicesAccept = 3908 '8133    '制片批量接受
Public Const conMenu_Pathol_BatSlicesSure = 3909 '8134      '制片批量确认
Public Const conMenu_Pathol_BatSpeExamAccept = 3910 ' 8135   '特检批量接受
Public Const conMenu_Pathol_BatSpeExamSure = 3911 '8136     '特检批量确认
Public Const conMenu_Pathol_BatProcess = 3912 '8137         '批量处理
Public Const conMenu_Pathol_Quality_Manage = 3913 '8138      '病理质量管理
Public Const conMenu_Pathol_NumConfig = 3914 '8139    '病理号码配置
...
'Pacs占用部分
Public Const conMenu_Reserve_03 = 3938
Public Const conMenu_Reserve_04 = 3941
Public Const conMenu_Reserve_05 = 3944
Public Const conMenu_Reserve_06 = 3948
Public Const conMenu_Reserve_07 = 3951
Public Const conMenu_Reserve_08 = 3954
Public Const conMenu_Reserve_09 = 3958
Public Const conMenu_Reserve_10 = 3961
Public Const conMenu_Reserve_11 = 3964
Public Const conMenu_Reserve_12 = 3968
...
Public Const conMenu_Queue_LocateValue = 8265    '定位值
Public Const conMenu_Queue_LocateType = 8266    '定位类型

Public Const conMenu_Queue_LocateType1 = 8267        '门诊号
Public Const conMenu_Queue_LocateType2 = 8268        '姓名
Public Const conMenu_Queue_LocateType3 = 8269        '就诊卡号
Public Const conMenu_Queue_LocateType4 = 8270        '医保号
Public Const conMenu_Queue_LocateType5 = 8271        '排队号
