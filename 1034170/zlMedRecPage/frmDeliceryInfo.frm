...
Private Sub initFetus(i_intIndex As Integer)
    Dim intRow As Integer
    '15126
    LoadComboFromArray Array("1.正常分娩", "2.剖宫产", "3.早产", "4.产钳", "5.臀抽", "6.臀助", "7.其他"), cmb分娩方式(i_intIndex) '刘兴洪:臀抽改为臀助,问题:21778,by lesfeng 2009-9-23 由于臀抽是老方法、臀助是新方法，不是替代，是增加
    ...
    LoadComboFromArray Array("1.男", "2.女", "3.未知"), cmb婴儿性别(i_intIndex)
    ...
    For intIndex = 1 To tab胎数.Tabs.Count
        With mrs胎儿情况
            ...
            If Not .EOF Then
                ...
                End If
                AddComboItem cmb分娩方式(intIndex - 1), !分娩方式
