...
Public gclsArchive As New clsArchive
Public gclsDiagEdit As New clsDiagEdit
Public gclsInOutMedRec As New clsInOutMedRec
Public gclsPageMedRec As New clsPageMedRec
Public gcolclsMain As Collection
Public gcolclsPros As Collection
