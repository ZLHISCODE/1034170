...
Private Sub Form_Activate()
    ...
    If Not mfrmMedRecEdit Is Nothing Then
        If mfrmMedRecEdit.Name Like "frmInMedRecEdit*" Then
            strKEY = "住院首页"
        ElseIf mfrmMedRecEdit.Name Like "frmOutMedRecEdit*" Then
            strKEY = "门诊首页"
        ElseIf mfrmMedRecEdit.Name Like "frmPageMedRecEdit*" Then
            strKEY = "病案首页"
        ElseIf mfrmMedRecEdit.Name Like "frmArchive*" Then
            strKEY = "病案查阅"
        End If
        Call FormMouseMove(strKEY, mfrmMedRecEdit.Name)
    End If
End Sub
