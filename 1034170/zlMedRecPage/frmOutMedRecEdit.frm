...
Begin VB.Form frmOutMedRecEdit 
   ...
   Begin TabDlg.SSTab sstInfo 
      ...
      Begin VB.Frame fraMain 
         ...
         Begin VB.ComboBox cboBaseInfo 
            ...
            IMEMode         =   3  'DISABLE
            Index           =   61
            ItemData        =   "frmOutMedRecEdit.frx":0B33
            Left            =   900
            List            =   "frmOutMedRecEdit.frx":0B35
            TabIndex        =   24
            Top             =   1875
            Width           =   2340
         End
   ...
   Begin VB.Image imgButtonNew 
      Height          =   240
      Left            =   7920
      Picture         =   "frmOutMedRecEdit.frx":0B37
      Top             =   6480
      Visible         =   0   'False
      Width           =   240
   End
   Begin VB.Image imgButtonDel 
      Height          =   240
      Left            =   7920
      Picture         =   "frmOutMedRecEdit.frx":10C1
      Top             =   6840
      Visible         =   0   'False
      Width           =   240
   End
...
Private Sub Form_Activate()
    Call FormMouseMove("门诊首页", Me.Name)
End Sub
