   ...
   Begin MSComctlLib.StatusBar staThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2619
            MinWidth        =   882
            Picture         =   "frmReplenishTheBalanceBill.frx":6AA1
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
         ...
         BeginProperty Panel6 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   882
            MinWidth        =   882
            Picture         =   "frmReplenishTheBalanceBill.frx":7335
            Key             =   "Calc"
...
Private Sub Form_Load()
    ...
    PatiIdentify.IDKindIDX = Val(strTmp)
End Sub

Private Sub Form_Unload(Cancel As Integer)
    Call SaveRegisterItem(g私有模块, Me.Name, "idkind", PatiIdentify.IDKindIDX)
...
Private Function CancelBalance() As Boolean
    ...
    Dim rsBalance As ADODB.Recordset, str结算方式 As String
    ...
    If MCPAR.门诊结算作废 Then
        strSQL = _
            ...
            "From 病人预交记录 A, 结算方式 B" & vbNewLine & _
            "Where a.结算方式 = b.名称 And b.性质 In(3,4) And a.结算序号 = [1]"
        Set rsBalance = zlDatabase.OpenSQLRecord(strSQL, Me.Caption, Val(mstr结算序号))
        With rsBalance
            Do While Not .EOF
                If Not gclsInsure.GetCapability(support门诊结算作废, mobjPatiInfor.病人ID, mintInsure, Nvl(!结算方式)) Then
        ...
        End With
        If str结算方式 <> "" Then
            MsgBox "医保结算方式【" & Mid(str结算方式, 2) & "】不支持作废，不能作废本次结算！", vbInformation, gstrSysName
            Exit Function
        End If
    Else
        MsgBox "医保不支持门诊结算作废，不能作废本次结算！", vbInformation, gstrSysName
        Exit Function
    End If
