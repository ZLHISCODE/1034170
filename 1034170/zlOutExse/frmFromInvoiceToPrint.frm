...
Private Sub cmdOK_Click()
    ...
    With vsInvoiceList
       ...
       End If
       If MsgBox("你确认要重打发票号为『" & strReclaimInvoice & "』的票据吗?", _
        vbQuestion + vbYesNo + vbDefaultButton2, gstrSysName) = vbNo Then cmdOK.Enabled = True: Exit Sub
    End With
    With vsList
       ...
       Next
    End With
    If Not CheckFP() Then cmdOK.Enabled = True: Exit Sub
