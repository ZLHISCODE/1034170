...
// PASTLWTR : 1.2
// File generated on 2011/1/24 14:48:31 from Type Library described below.

// ************************************************************************  //
// Type Lib: E:\Demo\Capture Com(Delphi)\ZLDSVideoProcess.tlb (1)
...
// *********************************************************************//
  ...
  TCaptureParameter = packed record
    ...
    IsSoundHint: WordBool;
    DebugFilter: WordBool;
  end;
...
// *********************************************************************//
  IDSCaptureDisp = dispinterface
    ...
    property RecordTimeLen: Integer readonly dispid 266;
  end;
...
// *********************************************************************//
  IDSPlay = interface(IDispatch)
    ...
    property IsSoundHint: WordBool read Get_IsSoundHint write Set_IsSoundHint;
    property IsDebugFilter: WordBool read Get_IsDebugFilter write Set_IsDebugFilter;
    property VideoFile: WideString read Get_VideoFile write Set_VideoFile;
  end;
...
// *********************************************************************//
  IDSPlayDisp = dispinterface
    ...
    function CaptureBmpImage: IPictureDisp; dispid 262;
    property IsSoundHint: WordBool dispid 263;
    property IsDebugFilter: WordBool dispid 264;
    property VideoFile: WideString dispid 265;
  end;
...
// *********************************************************************//
  ...
  published
    ...
    property IsSoundHint: WordBool index 263 read GetWordBoolProp write SetWordBoolProp stored False;
    property IsDebugFilter: WordBool index 264 read GetWordBoolProp write SetWordBoolProp stored False;
    property VideoFile: WideString index 265 read GetWideStringProp write SetWideStringProp stored False;
...
// *********************************************************************//
  ...
  public
    ...
    property RecordTimeLen: Integer index 266 read GetIntegerProp;
  published
    property Anchors;
    property  ParentColor;
    property  ParentFont;
