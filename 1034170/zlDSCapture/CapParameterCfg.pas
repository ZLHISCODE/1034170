...
uses
  ...
  IniFiles, VideoProcessDefine, jpeg, SizerControl, ZLDSVideoProcess_TLB;
...
type
  ...
  public
    ...
    class procedure ReadCaptureParameterFromFile(
      const filename: WideString; var captureParameter: TCaptureParameter);
    //保存采集参数
...
uses Types, DirectShow9Ex, CaptureDebug, ComObj, ACTIVEX, Math;
