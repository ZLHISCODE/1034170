...
Private Function SaveData() As Boolean
    ...
    For intCol = 0 To intColCount - 1
        For mlngLoop = 1 To Vsf.Rows - 1
            ...
            If Val(Vsf.Cell(flexcpData, mlngLoop, intCol * mintColCount, mlngLoop, intCol * mintColCount)) > 0 And Val(Vsf.TextMatrix(mlngLoop, mCol.标本ID + intCol * mintColCount)) > 0 Then
                bytResultFlag = 0
                ...
                End If
                strsql(ReDimArray(strsql)) = "ZL_检验标本记录_报告填写(" & Val(Vsf.TextMatrix(mlngLoop, mCol.标本ID + intCol * mintColCount)) & "," & _
                ...
                ",'" & Vsf.TextMatrix(mlngLoop, mCol.原始结果 + intCol * mintColCount) & "'," & Val(Vsf.TextMatrix(mlngLoop, mCol.诊疗项目id + intCol * mintColCount)) & _
                "," & IIf(Vsf.TextMatrix(mlngLoop, mCol.排列序号 + intCol * mintColCount) = "", Val(Vsf.TextMatrix(mlngLoop, intCol * mintColCount)), Val(Vsf.TextMatrix(mlngLoop, mCol.排列序号 + intCol * mintColCount))) & _
...
Private Sub LoadLastValue()
    ...
    intFindMode = 0 'zlDatabase.GetPara("历史病人识别", 100, 1208, 0)
