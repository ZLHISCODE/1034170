...
Begin VB.Form frmLisStationPara 
   ...
   Begin TabDlg.SSTab tbs 
      ...
      Tab(1).Control(3)=   "lblNotify"
      Tab(1).Control(4)=   "dtpEnd"
      Tab(1).Control(5)=   "dtpStart"
      Tab(1).Control(6)=   "cardSet"
      Tab(1).Control(7)=   "optRange(1)"
      Tab(1).Control(8)=   "optRange(0)"
      Tab(1).Control(9)=   "cboDevice"
      Tab(1).Control(10)=   "cmdFile"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "txtFile"
      ...
      Tab(2).Control(1)=   "lvwDept"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "cmdClearAll"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "cmdSelectAll"
