...
Public Function VerifyAuditingRule(lngSampleID As Long, Optional strErrMessage As String, Optional ByVal iLoadProg As Integer = 1) As Integer
    ...
    int病人id = 0 'zlDatabase.GetPara("历史病人识别", 100, 1208, 0)
...
Public Function ReadVerifyData(lngID As Long, intRule As Integer) As String
    ...
    If intRule = 1 Then
        '得到基本信息
        gstrSql = "Select ID, 医嘱id, 标本序号, 采样人, 采样时间, 标本类型, 核收人, 核收时间, 检验人, 检验时间, '' As 审核人, '' As 审核时间, 申请类型," & vbNewLine & _
...
Public Function Str2Array(ByVal strTxt As String, ByVal strDeli As String, ByVal intLength As Integer) As Variant
    ...
    Do While Len(strTxt) >= intLength And Len(strDeli) = 1 And InStr(1, strTxt, strDeli) > 0
