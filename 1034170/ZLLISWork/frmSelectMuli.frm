...
Private Sub SaveFormState()
    ...
    zlDatabase.SetPara "frmSelectMuli_宽度", Me.Width, 100, 1208
    zlDatabase.SetPara "frmSelectMuli_高度", Me.Height, 100, 1208
    ...
    zlDatabase.SetPara "frmSelectMuli_列宽", strTmp, 100, 1208
...
Private Sub RestoreFormState()
    ...
    Me.Width = zlDatabase.GetPara("frmSelectMuli_宽度", 100, 1208, Me.Width)
    Me.Height = zlDatabase.GetPara("frmSelectMuli_高度", 100, 1208, Me.Height)
    ...
    strTmp = zlDatabase.GetPara("frmSelectMuli_列宽", 100, 1208, strTmp)
