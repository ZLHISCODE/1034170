...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox picMainBack 
      ...
      Begin TTF160Ctl.F1Book F1Main 
         ...
         _3              =   $"frmMain.frx":2B02
         _4              =   $"frmMain.frx":2F0B
         _5              =   "-@@@@@@@@B@F@)F@q@)M@!@)i@)n@C@@@H@A@I@)l4@@@@@@F@,7479"
         _count          =   6
         _ver            =   2
      End
   ...
   Begin MSComctlLib.ImageList imgColor 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":3D1B
            Key             =   "FORECOLOR"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":3E68
            Key             =   "FILLCOLOR"
         EndProperty
      EndProperty
   End
...
Dim bfrmMode As Byte
    ...
    If Not Me.Visible Then
        'bfrmMode = 0
        If editType = TabET_病历文件定义 Or editType = TabET_全文示范编辑 Then bfrmMode = 1
...
46        Exit Function
errHand:
    Call WriteDebugLOG("SaveDoc错误行：" & Erl)
    If ErrCenter = 1 Then
        Resume
    End If
    mblnInit = False: zlCommFun.StopFlash
...
Dim IntReturn As Integer
    Err.Clear: Debug.Print "Form_Unload"
    On Error GoTo errHand
...
28    Unload frmPicTypeset
      ...
      Exit Sub
errHand:
      Call WriteDebugLOG("frmMain:Unload错误行" & Erl())
      Err.Clear
End Sub
...
53    Exit Function
errHand:
    Call WriteDebugLOG("AddSign错误行:" & Erl)
    If ErrCenter = 1 Then
        Resume
    End If
End Function
...
9    End If
    Exit Function
errHand:
    Call WriteDebugLOG("RollBack错误行:" & Erl())
    If ErrCenter = 1 Then
        Resume
    End If
End Function
