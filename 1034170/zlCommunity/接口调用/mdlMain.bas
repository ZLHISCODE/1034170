...
'功能：获取登陆用户信息
    ...
    If Not rsTmp Is Nothing Then
        If Not rsTmp.EOF Then
            ...
            UserInfo.部门码 = zlCommFun.Nvl(rsTmp!部门码)
            UserInfo.部门名 = zlCommFun.Nvl(rsTmp!部门名)
            GetUserInfo = True
        End If
    End If
End Function

Public Function OraDataOpen(ByVal strServerName As String, ByVal strUserName As String, ByVal strUserPwd As String, ByVal blnOralce As Boolean) As Boolean
    '------------------------------------------------
    '功能： 打开指定的数据库
    '参数：
    '   strServerName：主机字符串
    ...
    With gcnOracle
        ...
        If blnOralce Then
            ...
            .Open "Data Source=" & strServerName & ";PLSQLRSet=1", strUserName, strUserPwd
        Else
