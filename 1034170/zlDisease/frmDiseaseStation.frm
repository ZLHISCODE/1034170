...
Object = "{AF9744ED-CAFC-4877-8437-2C20C14CEA4E}#3.5#0"; "zlIDKind.ocx"
Begin VB.Form frmDiseaseStation 
   ...
   Begin VB.PictureBox picBasisNew 
      ...
      Begin VB.Image imgPati 
         Height          =   1365
         Left            =   120
         Picture         =   "frmDiseaseStation.frx":6852
         Stretch         =   -1  'True
         Top             =   120
         Width           =   1290
      End
      Begin VB.Image imgPatiPhoto 
         ...
         Height          =   1000
         Left            =   3720
         Picture         =   "frmDiseaseStation.frx":9C5F
         Stretch         =   -1  'True
         Top             =   2520
         Visible         =   0   'False
         Width           =   930
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmDiseaseStation.frx":A64F
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
         EndProperty
   ...
   Begin MSComctlLib.ImageList imgList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDiseaseStation.frx":AEE1
            Key             =   ""
            Object.Tag             =   "已删除"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDiseaseStation.frx":11743
            Key             =   ""
            Object.Tag             =   "待填写"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDiseaseStation.frx":17FA5
            Key             =   ""
            Object.Tag             =   "待返修"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDiseaseStation.frx":1E807
            Key             =   ""
            Object.Tag             =   "待上报"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDiseaseStation.frx":25069
            Key             =   ""
            Object.Tag             =   "待审核"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDiseaseStation.frx":2B8CB
            Key             =   ""
            Object.Tag             =   "返修待审核"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDiseaseStation.frx":3212D
            Key             =   ""
            Object.Tag             =   "已上报"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDiseaseStation.frx":3898F
            Key             =   ""
            Object.Tag             =   "待处理"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDiseaseStation.frx":3F1F1
            Key             =   ""
            Object.Tag             =   "非传染病"
         EndProperty
      EndProperty
   ...
   Begin XtremeDockingPane.DockingPane dkpMain 
      Bindings        =   "frmDiseaseStation.frx":45A53
      Left            =   960
      Top             =   135
      _Version        =   589884
      _ExtentX        =   450
...
Private Sub cbsMain_Execute(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Select Case Control.ID
        ...
        Case conMenu_Help_Web_Forum '中联论坛
            Call frmDiseaseRegist.ShowDiseaseRegist(Me, 2, 1)
...
Private Sub cbsMain_Update(ByVal Control As XtremeCommandBars.ICommandBarControl)
    ...
    Select Case Control.ID
        ...
        Case conMenu_Edit_Audit
            ...
            Control.Enabled = (mstrCurId <> "" And (mIntState = 0 Or mIntState = 1 Or mIntState = 5))
        Case conMenu_Edit_Send
        ...
        Case conMenu_Edit_NewTable
            Control.Visible = mstrFiles <> "" And mblnReportCheck
        Case conMenu_Edit_Add
            Control.Visible = (InStr(1, mstrPrivs, "报送") > 0)
            If Control.Visible Then Control.Visible = (mTcbSelectID = tcb上报)
...
On Error GoTo errHand
    ...
    Set rsData = gobjComlib.zlDatabase.OpenSQLRecord(strSQL, "加载病人照片", lng病人ID)
    If rsData.BOF = False Then
        imgPatient.Picture = Nothing
        strTmp = gobjComlib.zlDatabase.ReadPicture(rsData, "照片", strFile)
...
Public Function ShowDiseaseStation(ByVal frmParent As Object, ByVal strName As String, ByVal lng病人ID As Long, ByVal lng主页ID As Long, _
                ByVal intPatiFrom As Integer, ByVal lng科室ID As Long, ByVal str疾病ID As String, ByVal str诊断ID As String) As Boolean
