...
Public Function ShowMe(ByVal objParent As Object, ByVal strPrivs As String, ByVal lng文件ID As Long, ByVal lng病人ID As Long, _
    ByVal lng主页ID As Long, ByVal lngDeptID As Long, ByVal intLevel As Integer, _
...
Private Function Validation() As Boolean
    ...
    If chkEsign.Value = vbChecked Then
        ...
        lngCertID = 0
        strSign = gobjESign.signature(mstrSource, gstrDBUser, lngCertID, str时间戳, , str时间戳信息, , mlng病人ID, mlng主页ID) '返回签名信息,lngCertID返回签名使用的证书记录ID
        If strSign = "" Then
