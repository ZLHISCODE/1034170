...
Private Sub Form_Load()
    ...
    If UBound(Split(strFtp, ";")) >= 3 Then
        ...
        If Split(strFtp, ";")(1) Like "ZLSV*:*" Then
            txtPassWord = gobjComLib.zlStr.Sm4DecryptEcb(Split(strFtp, ";")(1))
        Else
...
Private Sub OKButton_Click()
    ...
    Else
        ...
        If strOpenFTP = "" Then
            '保存参数
            strFTPSet = txtUser & ";" & gobjComLib.zlStr.Sm4EncryptEcb(txtPassWord) & ";" & txtDevAdress & ";" & txtFtpPath
