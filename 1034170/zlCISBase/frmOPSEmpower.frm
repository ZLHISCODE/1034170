...
Begin VB.Form frmOPSEmpower 
   ...
   Begin MSComctlLib.StatusBar stbThis 
      ...
      _ExtentX        =   22675
      _ExtentY        =   635
      SimpleText      =   $"frmOPSEmpower.frx":68ED
      _Version        =   393216
      BeginProperty Panels {8E3867A5-8586-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Panel1 {8E3867AB-8586-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2355
            MinWidth        =   882
            Picture         =   "frmOPSEmpower.frx":6934
            Text            =   "中联软件"
            TextSave        =   "中联软件"
            Key             =   "ZLFLAG"
   ...
   Begin MSComctlLib.ImageList img16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPSEmpower.frx":71C8
            Key             =   "Male"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPSEmpower.frx":DA2A
            Key             =   "feMale"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPSEmpower.frx":1428C
            Key             =   "unCheck"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPSEmpower.frx":14826
            Key             =   "AllCheck"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmOPSEmpower.frx":14DC0
            Key             =   "Check"
         EndProperty
      EndProperty
   End
...
'参数：lngType：0-授开单和执行权，1-授开单权，2-授执行权
    ...
    Else
        ...
        If rsTmp.RecordCount > 0 Then
            ...
            Do While Not rsTmp.EOF
                If Len(strItems & "," & rsTmp!ID) > 4000 Then
                    ...
                    arrSql(UBound(arrSql)) = "Zl_人员手术权限_Update('" & strDocs & "','" & Mid(strItems, 2) & "'," & lngType & "," & IIf(UBound(arrSql) = 0, 1, 0) & ")"
                    strItems = ""
                End If
        ...
        Else
            ReDim Preserve arrSql(UBound(arrSql) + 1)
            arrSql(UBound(arrSql)) = "Zl_人员手术权限_Update('" & strDocs & "',''," & lngType & ",1)"
        End If
    ...
    With vsOPS
        ...
        For i = 1 To .Rows - 1
            If .Cell(flexcpChecked, i, col开单) <> .Cell(flexcpData, i, col开单) And chkEdit.Value = 1 Or .Cell(flexcpChecked, i, col执行) <> .Cell(flexcpData, i, col执行) And chkExec.Value = 1 Then
                ...
                End If
                ReDim Preserve arrSql(UBound(arrSql) + 1)
                arrSql(UBound(arrSql)) = "Zl_人员手术权限_Update('" & Val(rptDoc.SelectedRows(0).Record(COL_人员ID).Value) & "','" & .RowData(i) & "'," & intType & "," & intDelete & ")"
            End If
        Next
        On Err GoTo errH
        gcnOracle.BeginTrans: blnTrans = True
...
'功能：加载医嘱拥有的权限。
    ...
    If rptDoc.SelectedRows.Count > 0 Then
        If rptDoc.SelectedRows(0).GroupRow = False Then
            strSql = "Select b.Id,Decode(Min(记录性质), 1, 1, 2) As 开单权, Decode(Max(记录性质), 2, 1, 2) As 执行权, b.编码, b.名称, b.操作类型, decode(B.服务对象,1,'门诊',2,'住院',3,'门诊和住院',4,'体检','不直接应用于病人') as 服务对象, b.站点, d.手术类型,Upper(E.简码) as 简码" & vbNewLine & _
                "From 人员手术权限 A, 诊疗项目目录 B, 疾病诊断对照 C, 疾病编码目录 D,诊疗项目别名 E" & vbNewLine & _
                "Where a.诊疗项目id = b.Id And b.Id = c.手术id(+) And c.疾病id = d.Id(+) AND E.诊疗项目ID=B.ID And a.人员id = [1] and e.码类=[2] And (B.撤档时间 Is Null Or B.撤档时间 = To_Date('3000-01-01', 'YYYY-MM-DD'))" & vbNewLine & _
                IIf(chkEdit.Value = 0, " And a.记录性质 <>1", "") & IIf(chkExec.Value = 0, " And a.记录性质 <>2", "") & _
                "Group By b.Id, b.编码, b.名称, b.操作类型, b.服务对象, b.站点, d.手术类型,E.简码"
...
'加载权限比操作员低的医生
    ...
    strSql = "Select DISTINCT a.Id, A.性别" & IIf(Val(cboDept.ItemData(cboDept.ListIndex)) = -1, "", ",b.部门ID,e.名称 as 所属部门") & ",a.姓名,a.手术等级, Upper(zlSpellCode(a.姓名)) As 拼音简码, Upper(Zlwbcode(a.姓名)) As 五笔简码" & vbNewLine & _
            ...
            "   " & IIf(Val(cboDept.ItemData(cboDept.ListIndex)) = -1, "", "And b.部门id=[2]")
...
Private Sub cbsMain_Resize()
    ...
    End With
    rptDoc.Height = fraDoctor.Height - 1250
    ...
    With fraOPS
        ...
        vsOPS.Width = .Width - 200
        vsOPS.Height = .Height - 350
    End With
...
Private Sub chkEdit_Click()
    If chkExec.Value = 0 And chkEdit.Value = 0 Then
        ...
        mblnNotRef = False
    End If
    If mblnNotRef = True Then Exit Sub
    Call LoadItem
End Sub
...
Private Sub Form_Load()
    ...
    'vsFlexGrid
    '-----------------------------------------------------
    strHead = "开单,700,1;执行,700,1 ;编码,1000,1;手术名称,2500,1;手术等级,1000,1;手术规模,1000,1;服务对象,1000,1;站点,800,7;简码"
...
'参数:bytMode=1 打印;2 预览;3 输出到EXCEL
    ...
    If rptDoc.Records.Count > 0 Then
        ...
        strSubhead = rptDoc.SelectedRows(0).Record(col_姓名).Value & "手术权限清单"
    Else
        Exit Sub
    End If
    
    '调用打印部件处理
    Set objPrint.Body = Me.vsOPS
