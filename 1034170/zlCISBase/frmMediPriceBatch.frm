...
Private Sub setColumn(ByVal rsRecord As ADODB.Recordset)
    ...
    With vsfDetails
        ...
        For i = 1 To rsRecord.RecordCount
            ...
            .TextMatrix(i, Mcolumn.mintcol原价) = GetFormat(rsRecord!原价 * dblPrice, mintPriceDigit)
            .TextMatrix(i, Mcolumn.mintcol现价) = GetFormat(rsRecord!现价 * dblPrice, mintPriceDigit)
