...
Private Sub cmdOK_Click()
    ...
    If Me.cmdCancel.Tag = "增加" Then
        gstrSql = "zl_成药品种_INSERT('" & IIf(Me.Tag = 1, "5", "6") & "'," & _
            gstrSql & ",'" & strTemp & "'," & IIf(mbln自管药 = True, "1", "Null") & _
            "," & IIf(Trim(txtAtccode.Text) = "", "NULL,", "'" & txtAtccode.Text & _
            "',") & Me.chkTumour.Value & "," & Me.chkSolvent.Value & "," & _
            Me.chk原研药.Value & "," & Me.chk专利药.Value & "," & Me.chk单独定价.Value & "," _
            & Me.chk辅助用药.Value & ")"
    Else
        gstrSql = "zl_成药品种_UPDATE(" & gstrSql & ",'" & strTemp & "'," & _
            IIf(mbln自管药 = True, "1", "Null") & "," & IIf(Trim(txtAtccode.Text) = "", _
            "NULL,", "'" & txtAtccode.Text & "',") & Me.chkTumour.Value & "," & _
            Me.chkSolvent.Value & "," & Me.chk原研药.Value & "," & Me.chk专利药.Value & _
            "," & Me.chk单独定价.Value & "," & Me.chk辅助用药.Value & ")"
    End If
