...
Public Function ShowMe(frmParent As Object, ByVal str类别 As String, ByVal lng病人科室ID As Long, Optional ByVal str性别 As String, _
    Optional ByVal blnMultiSel As Boolean, Optional ByVal blnICD10 As Boolean = True, Optional ByVal strSel编码 As String) As ADODB.Recordset
    mstr类别 = str类别
        ...
        If Not mrsList.EOF Then
            With vsList
                ...
                For i = 1 To mrsList.RecordCount
                    ...
                    str编码 = NVL(mrsList!编码)
                    .TextMatrix(i, 1) = str编码
                    If mstrSel编码 <> "" Then
                    ...
                    .Cell(flexcpData, i, 1) = CStr(str编码)
                    If str编码 = .Cell(flexcpData, i - 1, 1) Then
