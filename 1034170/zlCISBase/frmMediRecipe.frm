...
Private Sub txt名称_KeyUp(Index As Integer, KeyCode As Integer, Shift As Integer)
    Me.txt拼音(Index).Text = zlGetSymbol(Me.txt名称(Index).Text, 0, Me.txt拼音(Index).MaxLength)
    Me.txt五笔(Index).Text = zlGetSymbol(Me.txt名称(Index).Text, 1, Me.txt五笔(Index).MaxLength)
End Sub
