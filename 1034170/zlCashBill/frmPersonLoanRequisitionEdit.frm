...
Private Function IsValied() As Boolean
    ...
    If ctl.Text = cbo借出人.Text Then
        ...
        Call zlCtlSetFocus(cbo借出人, True)
        Exit Function
    End If
...
Private Sub cmdOK_Click()
    ...
    Call ClearCtrl
    zlCtlSetFocus txtEdit(mIdxTxt.idx_借款金额), True
    mlngID = 0
    mblnSucceed = True: mblnChange = False
End Sub
...
Private Sub Form_Activate()
    ...
    ElseIf mEditType = FN_取消借出 Then
        zlCtlSetFocus txtEdit(mIdxTxt.idx_取消原因), True
    Else
        zlCtlSetFocus cmdOK, True
    End If
    mblnChange = False
End Sub
