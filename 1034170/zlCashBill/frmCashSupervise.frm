...
Private Function LoadGroups() As Boolean
    ...
    With rsTemp
        ...
        If Not zlCheckPrivs(mstrPrivs, "所有人员组") Then
...
'功能:由于有的用户权限不够,故使一些菜单项或按钮不可见
    If InStr(mstrPrivs, "删除缴款") = 0 And InStr(mstrPrivs, "手工缴款") = 0 _
        ...
        And InStr(mstrPrivs, "按日缴款") = 0 And zlCheckPrivs(mstrPrivs, "成员分组") = False Then
    ...
    Else
        ...
        End If
        mnuEditPersonGroup.Visible = zlCheckPrivs(mstrPrivs, "成员分组")
