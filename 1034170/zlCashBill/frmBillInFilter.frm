...
Private Sub Form_Resize()
    ...
    If ScaleWidth - (txt登记人.Width + txt登记人.Left + 50 + chk仅有余额.Width) < 0 Then
        ...
        chk仅有余额.Top = dtpStartDate(0).Top + dtpStartDate(0).Height + 100
        cmd刷新.Left = txt登记人.Left
        cmd刷新.Top = chk仅有余额.Top - 20
    ...
    Else
        ...
        chk仅有余额.Top = txt登记人.Top + (txt登记人.Height - chk仅有余额.Height) \ 2
         If ScaleWidth - (chk仅有余额.Width + chk仅有余额.Left + cmd刷新.Width + 50) < 0 Then
            ...
            RaiseEvent WindowsHeight(900)
         Else
            RaiseEvent WindowsHeight(500)
            cmd刷新.Left = chk仅有余额.Left + chk仅有余额.Width + cmd刷新.Width + 50
            cmd刷新.Top = chk仅有余额.Top - 50
         End If
    End If
    mblnNotSize = False
End Sub
