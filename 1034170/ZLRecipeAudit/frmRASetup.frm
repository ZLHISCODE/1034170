...
Begin VB.Form frmRASetup 
   ...
   Begin TabDlg.SSTab sstMain 
      ...
      Tab(2).Control(0)=   "lblDiagnose"
      Tab(2).Control(1)=   "lblFind(2)"
      Tab(2).Control(2)=   "optDiagnose(0)"
      Tab(2).Control(3)=   "optDiagnose(1)"
      Tab(2).Control(4)=   "vsfDiagnose"
      Tab(2).Control(5)=   "txtFind(2)"
    ...
    With lvwDept
        ...
        For i = 1 To .ListItems.Count
            ...
            If Len(strIDs) > 3900 Or i >= .ListItems.Count Then
                ...
                gstrSQL = gstrSQL & mdlDefine.FormatString("'[1]')", strIDs)              'ID串
    ...
    With vsfDiagnose
        ...
        For i = 1 To .Rows - 1
            ...
            If Len(strIDs) > 3900 Or i >= .Rows - 1 Then
                ...
                gstrSQL = "ZL_处方审查条件_UPDATE"
                gstrSQL = gstrSQL & mdlDefine.FormatString("([1],", IIf(optDiagnose(0).Value, "3", "4"))  '类别，3-诊断；4-疾病
                gstrSQL = gstrSQL & intSN & ","                                             '序号
                gstrSQL = gstrSQL & mdlDefine.FormatString("'[1]')", strIDs)                              'ID串
...
'功能：给tvwDrug填充数据
    ...
    With rsTmp
        ...
        Do While .EOF = False
            ...
            strTmp = mdlDefine.FormatString("【[1]】[2]", !编码, !名称)
        ...
        If nodVar.Child Is Nothing And nodVar.Image = 3 Then
            ...
            If blnVar Then
                With vsfDrug
                    ...
                    mrsDrug.Filter = mdlDefine.FormatString("ID='[1]'", nodVar.Key)
        ...
        Case 0, 1   '0-科室；1-医生
            ...
            With lvwVar
                ...
                If mintRecno > .ListItems.Count Then
                    If MsgBox("已查找到底部，是否从头继续查找？", vbYesNo + vbQuestion + vbDefaultButton1) = vbYes Then
...
Private Sub vsfDiagnose_CellButtonClick(ByVal Row As Long, ByVal Col As Long)
    ...
    '调用统一的疾病选择器
    Set rsDiagnose = zlDatabase.ShowILLSelect(Me, IIf(optDiagnose(1).Value = False, "1,2", "D,Y,M,B"), 0, , True, optDiagnose(1).Value, strSel)
